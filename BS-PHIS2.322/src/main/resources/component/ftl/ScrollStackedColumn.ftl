...
<chart caption="${title}" subcaption="${subTitle}" scrollHeight="10" scrollBtnWidth="10" useRoundEdges='1' use3DLighting="1" showSum="1" numberScaleValue="10000,10000" numberScaleUnit="万,亿" labelDisplay="none"  yAxisName='' showValues='1' legendPosition ="RIGHT">
	<categories>
	<#list rs as r>
		<#if r_index = limit>
			<#break>
