 ...
 */
public class ClinicLisInvalidRecordService extends HISAbstractService {
...
//		System.out.println("接收LIS作废数据："+paramMap);
		PHISLisBillOperationModel lbm = new PHISLisBillOperationModel(paramContext);
		try {
			Map<String, Object> result = lbm.clinicLisInvalidRecord(paramMap);
			res.putAll(result);
