...
/**
 * @description 住院病人信息修改
 * @author <a href="mailto:chengzx@bsoft.com.cn">chzhxiang</a>
 */
public class UpdateHISInhospPatientInfoService extends HISAbstractService {
	...
	public Map<String, Object> process(Map<String, Object> paramMap,
		...
		try {
			Map<String, Object> result = dam.updateInhospPatientDate(op, paramMap);
