...
/**
 * @description 住院医技取消作废
 * @author <a href="mailto:chengzx@bsoft.com.cn">chzhxiang</a>
 */
public class InhospLisUnInvalidRecordService extends HISAbstractService {
	...
	public Map<String, Object> process(Map<String, Object> paramMap,
		...
		try {
			Map<String, Object> result = lbm.inhospLisUnInvalidRecord(paramMap);
			res.putAll(result);
