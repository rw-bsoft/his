...
/**
 * @description 住院医技取消执行
 * @author <a href="mailto:chengzx@bsoft.com.cn">chzhxiang</a>
 */
public class InhospLisCancelExecuteRecordService extends HISAbstractService {
	...
	public Map<String, Object> process(Map<String, Object> paramMap,
		...
		List yjxhs = (List) paramMap.get("yjxhs");
		PHISLisBillOperationModel lbm = new PHISLisBillOperationModel(paramContext);
		try {
			Map<String, Object> result = lbm
					.inhospLisCancelExecuteRecord(yjxhs);
			res.putAll(result);
