...
phis.application.tcm.script.ZyDiagnosisContrast = function(cfg) {
	phis.application.tcm.script.ZyDiagnosisContrast.superclass.constructor.apply(
			this, [cfg]);
}
 ...
 * 【中医馆】中医疾病对照
 */
Ext.extend(phis.application.tcm.script.ZyDiagnosisContrast,
