...
phis.application.med.script.MZProjectEditorList = function(cfg) {
	// cf.requestData.cnd
	...
	phis.application.med.script.MZProjectEditorList.superclass.constructor.apply(this,
			[cfg])

}
Ext.extend(phis.application.med.script.MZProjectEditorList, phis.script.EditorList, {
	doInsertAfter : function(i,e){
		this.doCreate(i,e);
	},
	initPanel : function(sc) {
		var grid = phis.application.med.script.MZProjectEditorList.superclass.initPanel
				.call(this, sc)
...
//		this.grid.startEditing(insertIndex, 1);
	...
	setBackInfo : function(obj, record) {
		...
		phis.script.rmi.jsonRequest({
					...
					rowItem.set('YLDJ_Y', record.get("FYDJ"));
