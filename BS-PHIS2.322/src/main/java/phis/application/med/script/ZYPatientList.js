...
$import("phis.script.SimpleList");
		...
		phis.application.med.script.ZYPatientList = function(cfg) {
			cfg.height = 200;
			cfg.autoLoadData = false;
			phis.application.med.script.ZYPatientList.superclass.constructor
					.apply(this, [ cfg ]);
		...
		Ext
				.extend(
						phis.application.med.script.ZYPatientList,
