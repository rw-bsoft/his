...
phis.application.med.script.ZYProjectEditorList = function(cfg) {
	// cf.requestData.cnd
	...
	phis.application.med.script.ZYProjectEditorList.superclass.constructor.apply(this,
			[cfg])

}
Ext.extend(phis.application.med.script.ZYProjectEditorList, phis.script.EditorList, {
	doInsertAfter : function(i,e){
		this.doCreate(i,e);
	},
	initPanel : function(sc) {
		var grid = phis.application.med.script.ZYProjectEditorList.superclass.initPanel
				.call(this, sc)
