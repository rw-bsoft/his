...
public class ZjzfUtil {
	 ...
	 * @throws Exception
	 */
	public Map<String, Object> getCarInfo15W(String card)
			throws Exception {
		Map<String, Object> map = new HashMap<String, Object>();
	...
	public String charSetConvert(String xmlResponse){
        try {
            //byte[] b = xmlResponse.getBytes(xmlResponse);
            //xmlResponse = new String(b, "UTF-8");
            //byte[] b=xmlResponse.getBytes("UTF-8");
            //return new String(b,"UTF-8");
            return java.net.URLDecoder.decode(xmlResponse,"UTF-8");
            //xmlResponse = new String(b, getEncoding(xmlResponse));
        } catch (Exception e) {
