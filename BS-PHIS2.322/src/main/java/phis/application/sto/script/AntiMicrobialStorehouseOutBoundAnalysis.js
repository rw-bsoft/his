...
phis.application.sto.script.AntiMicrobialStorehouseOutBoundAnalysis = function(cfg) {
	cfg.autoLoadData = true;
	phis.application.sto.script.AntiMicrobialStorehouseOutBoundAnalysis.superclass.constructor.apply(
			this, [cfg]);
	this.printurl = util.helper.Helper.getUrl();
};
Ext.extend(phis.application.sto.script.AntiMicrobialStorehouseOutBoundAnalysis,
	...
	initPanel : function(sc) {
		...
		var grid = phis.application.sto.script.AntiMicrobialStorehouseOutBoundAnalysis.superclass.initPanel
						.apply(this, sc);
	...
	loadData: function() {
		...
		phis.application.sto.script.AntiMicrobialStorehouseOutBoundAnalysis.superclass.loadData.call(this);
	},
	...
	doPrint : function() {
		...
		this.type="1";
		var pages="phis.prints.jrxml.ReportForAntiMicrobialOutBoundAnalysis";
