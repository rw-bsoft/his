...
phis.application.sto.script.StorehouseMedicinesConservationDetailForm = function(cfg) {
	cfg.disabledField=["YHRQ","BZXX"];//如果是查看 界面需要灰掉的标签ID
	cfg.conditionId="";
	phis.application.sto.script.StorehouseMedicinesConservationDetailForm.superclass.constructor.apply(
			this, [cfg]);
}
Ext.extend(phis.application.sto.script.StorehouseMedicinesConservationDetailForm,
