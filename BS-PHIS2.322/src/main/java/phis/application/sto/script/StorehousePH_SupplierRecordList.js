...
phis.application.sto.script.StorehousePH_SupplierRecordList = function(cfg) {
	...
	phis.application.sto.script.StorehousePH_SupplierRecordList.superclass.constructor.apply(
			this, [cfg]);
}

Ext.extend(phis.application.sto.script.StorehousePH_SupplierRecordList,
