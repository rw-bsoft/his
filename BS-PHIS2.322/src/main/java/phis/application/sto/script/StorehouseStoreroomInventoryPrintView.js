...
phis.application.sto.script.StorehouseStoreroomInventoryPrintView = function(cfg) {
	this.printurl = util.helper.Helper.getUrl();
	phis.application.sto.script.StorehouseStoreroomInventoryPrintView.superclass.constructor
			.apply(this, [cfg])
}
Ext.extend(phis.application.sto.script.StorehouseStoreroomInventoryPrintView,
		app.desktop.Module, {
			initPanel : function() {
			...
			printPreview : function(btn) {
				...
				//if (page == 'single') {	
					var pages="phis.prints.jrxml.StorehouseStoreroomInventory";
					 var url="resources/"+pages+".print?silentPrint=1&type="
							+ type + "&xtsb=" + this.xtsb + "&pddh="
							+ this.pddh;
					 if(type == 1){
						var LODOP=getLodop();
