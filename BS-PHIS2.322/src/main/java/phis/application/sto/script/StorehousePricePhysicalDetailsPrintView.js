...
phis.application.sto.script.StorehousePricePhysicalDetailsPrintView = function(cfg) {
	this.printurl = util.helper.Helper.getUrl();
	phis.application.sto.script.StorehousePricePhysicalDetailsPrintView.superclass.constructor
			.apply(this, [cfg])
}
Ext.extend(phis.application.sto.script.StorehousePricePhysicalDetailsPrintView,
		app.desktop.Module, {
			initPanel : function() {
			...
			printPreview : function(btn) {
				...
				if (page == 'single') {
					var pages="phis.prints.jrxml.MedicinesPricePhysicalDetails";
					 var url="resources/"+pages+".print?silentPrint=1&type="
							+ type + "&ypxh=" + this.requestData;
					 if(type == 1){
						var LODOP=getLodop();
