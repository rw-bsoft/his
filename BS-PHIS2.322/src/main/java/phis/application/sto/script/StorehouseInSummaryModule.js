...
phis.application.sto.script.StorehouseInSummaryModule = function(cfg) {
	phis.application.sto.script.StorehouseInSummaryModule.superclass.constructor.apply(
			this, [cfg]);
}
Ext.extend(phis.application.sto.script.StorehouseInSummaryModule,
		phis.script.SimpleList, {
			...
			phis.application.sto.script.StorehouseInSummaryModule.superclass.loadData.call(this);
			},
			doLook:function(){
				var module = this.createModule("rkhzmx", this.refList)
			...
			doPrint : function() {
				var pages="phis.prints.jrxml.SummaryMedicinesInOfStorage";
				var type="1";
