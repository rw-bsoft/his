...
phis.application.sto.script.StorehousePaymentDetailsPrintView = function(cfg) {
	this.printurl = util.helper.Helper.getUrl();
	phis.application.sto.script.StorehousePaymentDetailsPrintView.superclass.constructor
			.apply(this, [cfg])
}
Ext.extend(phis.application.sto.script.StorehousePaymentDetailsPrintView,
		app.desktop.Module, {
			initPanel : function() {
			...
			printPreview : function(btn) {
				...
				var pages="phis.prints.jrxml.StorehousePaymentDetails";
				 var url="resources/"+pages+".print?silentPrint=1&type="
						+ type + "&dwxh=" + this.requestData;
				 if(type == 1){
				 var LODOP=getLodop();
