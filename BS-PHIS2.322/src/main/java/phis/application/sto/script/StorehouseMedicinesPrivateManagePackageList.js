...
phis.application.sto.script.StorehouseMedicinesPrivateManagePackageList = function(cfg) {
	cfg.winState = "center";// cfg.winState=[100,50]两个写法都可以
	cfg.headPlug=true;
	phis.application.sto.script.StorehouseMedicinesPrivateManagePackageList.superclass.constructor.apply(
			this, [cfg])
}
Ext.extend(phis.application.sto.script.StorehouseMedicinesPrivateManagePackageList,
		phis.script.SimpleList, {
			...
			// 加上鼠标移动提示记录是否已作废功能
			onReady : function() {
				phis.application.sto.script.StorehouseMedicinesPrivateManagePackageList.superclass.onReady
						.call(this);
