...
phis.application.sto.script.StorehouseStoreroomInventoryForm = function(cfg) {
	cfg.showButtonOnTop = false;
	phis.application.sto.script.StorehouseStoreroomInventoryForm.superclass.constructor
			.apply(this, [cfg])
}
Ext.extend(phis.application.sto.script.StorehouseStoreroomInventoryForm,
