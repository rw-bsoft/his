...
phis.application.sto.script.AntiMicrobialStorehousePurchaseAnalysis = function(cfg) {
	cfg.autoLoadData = true;
	phis.application.sto.script.AntiMicrobialStorehousePurchaseAnalysis.superclass.constructor.apply(
			this, [cfg]);
	this.printurl = util.helper.Helper.getUrl();
};
Ext.extend(phis.application.sto.script.AntiMicrobialStorehousePurchaseAnalysis,
	...
	initPanel : function(sc) {
		...
		var grid = phis.application.sto.script.AntiMicrobialStorehousePurchaseAnalysis.superclass.initPanel
						.apply(this, sc);
	...
	loadData: function() {
		...
		phis.application.sto.script.AntiMicrobialStorehousePurchaseAnalysis.superclass.loadData.call(this);
	},
	...
	onDblClick : function(grid, index, e) {
		...
		record["de"] = de;
		if(!this.stDetails){
			var details = this.createModule("antiMicrobialStorehousePurchaseDetails", this.AntiMicrobialStorehousePurchaseDetails);
