...
phis.application.sto.script.StorehousePurchaseAnalysis = function(cfg) {
	cfg.autoLoadData = false;
	cfg.summaryable = true;
	cfg.disablePagingTbr = true;
	cfg.rootVisible = true;// 设置根节点
	cfg.parentText = "全部药品";// 根节点名称
	phis.application.sto.script.StorehousePurchaseAnalysis.superclass.constructor.apply(
			this, [cfg]);
};
Ext.extend(phis.application.sto.script.StorehousePurchaseAnalysis, phis.script.FilterList, {
...
//		this.setTreeRoot();
	...
	loadData: function() {
		...
		phis.application.sto.script.StorehousePurchaseAnalysis.superclass.loadData.call(this);
	},
	loadReport: function() {
	...
	getCountList: function(sc) {
		var grid = phis.application.sto.script.StorehousePurchaseAnalysis.superclass.initPanel.call(this,sc);
		this.requestData.serviceId=this.serviceId;
		this.requestData.serviceAction=this.serviceAction;
		return grid;
	},
	getReport: function() {
		var pages="phis.prints.jrxml.ReportForPurchaseAnalysis";
