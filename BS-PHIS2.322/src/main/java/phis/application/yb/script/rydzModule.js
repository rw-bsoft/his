...
phis.application.yb.script.rydzModule = function(cfg) {
	phis.application.yb.script.rydzModule.superclass.constructor.apply(
			this, [cfg]);
}
Ext.extend(phis.application.yb.script.rydzModule,
		phis.script.SimpleModule, {
			...
			doCz:function(){
				...
				if(!r||!r.get("PERSONID")||r.get("PERSONID")==null||r.get("PERSONID")==""){
					return;
				}
				r.set("YBDM","");
				this.leftList.updateRecord[r.get("PERSONID")]=r.data;
			},
			//保存
			doSave:function(){
