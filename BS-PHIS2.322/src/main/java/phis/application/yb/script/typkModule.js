...
phis.application.yb.script.typkModule = function(cfg) {
	phis.application.yb.script.typkModule.superclass.constructor.apply(this,
			[cfg]);
}
Ext.extend(phis.application.yb.script.typkModule, phis.script.SimpleModule, {
