...
phis.application.yb.script.jcbwModule = function(cfg) {
	phis.application.yb.script.jcbwModule.superclass.constructor.apply(this,
			[cfg]);
}
Ext.extend(phis.application.yb.script.jcbwModule, phis.script.SimpleModule, {
			...
			// 	if (!r || !r.get("PERSONID") || r.get("PERSONID") == null
			// 			|| r.get("PERSONID") == "") {
			// 		return;
			// 	}
			// 	r.set("YBDM", "");
