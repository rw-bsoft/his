...
phis.application.hph.script.HospitalPharmacyMedicineBackHZ = function(cfg) {
	this.exContext = {};
	phis.application.hph.script.HospitalPharmacyMedicineBackHZ.superclass.constructor
			.apply(this, [ cfg ]);
}

Ext.extend(phis.application.hph.script.HospitalPharmacyMedicineBackHZ,
		phis.script.SimpleModule, {
			...
			doPrint : function() {
				...
				var module = this.createModule(
						"hospitalPharmacyMedicineBackHZ",
						this.refHospitalPharmacyMedicineBackHZPrint);
