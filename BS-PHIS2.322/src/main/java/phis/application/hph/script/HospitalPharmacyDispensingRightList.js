...
phis.application.hph.script.HospitalPharmacyDispensingRightList = function(cfg) {
	...
	this.chall=true;
	phis.application.hph.script.HospitalPharmacyDispensingRightList.superclass.constructor
			.apply(this, [cfg])
	this.on("loadData", this.onLoadData, this);
}

Ext.extend(phis.application.hph.script.HospitalPharmacyDispensingRightList,
		phis.script.SelectList, {
			...
			loadData : function() {
				...
				phis.application.hph.script.HospitalPharmacyDispensingRightList.superclass.loadData
						.call(this);
			},
			...
			checkAll : function(sm, rowIndex, record) {
				//update  by caijy for 根据不同的取整 对应不同的选中
