...
phis.application.hph.script.HospitalPharmacyDispensingLeftList = function(cfg) {
	cfg.disablePagingTbr = true;
	cfg.autoLoadData = false;
	cfg.cnds = [ 'eq', [ '$', 'a.FYBZ' ], [ 'i', 0 ] ];
	cfg.initCnd = [ 'eq', [ '$', '1' ], [ 'i', 2 ] ];
	phis.application.hph.script.HospitalPharmacyDispensingLeftList.superclass.constructor
			.apply(this, [ cfg ])
}

Ext.extend(phis.application.hph.script.HospitalPharmacyDispensingLeftList,
