...
phis.application.hph.script.HospitalPharmacyDispensingRightCollectList = function(
		cfg) {
	cfg.autoLoadData = false;
	cfg.disablePagingTbr = true;
	phis.application.hph.script.HospitalPharmacyDispensingRightCollectList.superclass.constructor
			.apply(this, [ cfg ])
}

Ext.extend(
		phis.application.hph.script.HospitalPharmacyDispensingRightCollectList,
