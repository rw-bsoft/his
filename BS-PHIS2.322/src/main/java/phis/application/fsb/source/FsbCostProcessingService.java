...
public class FsbCostProcessingService extends AbstractActionService
		implements DAOSupportable {
	protected Logger logger = LoggerFactory
			.getLogger(FsbCostProcessingService.class);
	...
	public void doQueryItemInfo(Map<String, Object> req, Map<String, Object> res,
		...
		FsbCostProcessingModel hpm = new FsbCostProcessingModel(dao);
		try {
