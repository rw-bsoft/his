 ...
 * 日终结账和日终汇总
 */
public class FamilySickBedizationCheckoutService extends AbstractActionService
		implements DAOSupportable {
	private static FamilySickBedizationCheckoutService cck = null;
//	public static Date JZRQ = null;
	private FamilySickBedizationCheckoutService() {
	}
	...
	public void doIsreckon(Map<String, Object> req, Map<String, Object> res,
		...
		FamilySickBedizationCheckoutModel model = new FamilySickBedizationCheckoutModel(
				dao);
...
//	}
	...
	public static FamilySickBedizationCheckoutService getInstance() {
		if (cck == null) {
			cck = new FamilySickBedizationCheckoutService();
		}
		return cck;
	}
	//取消日报查询
...
//			Map<String, Object> body = (Map<String, Object>) req.get("body");
			FamilySickBedizationCheckoutModel model = new FamilySickBedizationCheckoutModel(dao);
