...
phis.application.fsb.script.FamilySickBedDetailsTabModule = function(cfg) {
	this.width = 600
	this.height = 500
	this.showButtonOnTop = true
	this.requestData = {};
	phis.application.fsb.script.FamilySickBedDetailsTabModule.superclass.constructor.apply(this,
			[cfg])
}

Ext.extend(phis.application.fsb.script.FamilySickBedDetailsTabModule, phis.script.TabModule, {
	initPanel : function() {
		if (this.tab) {
			return this.tab;
		}
