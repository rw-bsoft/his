...
phis.application.fsb.script.FamilySickBedBackMedicineToWardList = function(
		cfg) {
	...
	cfg.cnds = [
			...
			['and', ['eq', ['$', 'a.TJBZ'], ['i', 1]],
					['isNull', ['$', 'a.TYRQ']]]];
	phis.application.fsb.script.FamilySickBedBackMedicineToWardList.superclass.constructor
			.apply(this, [cfg])
}

Ext.extend(phis.application.fsb.script.FamilySickBedBackMedicineToWardList,
