...
phis.application.fsb.script.FamilySickBedCostsListQueryModule = function(cfg) {
	cfg.width = 960;
	cfg.height = 500;
	cfg.modal = true;
	Ext.apply(this, app.modules.common)
	phis.application.fsb.script.FamilySickBedCostsListQueryModule.superclass.constructor
			.apply(this, [cfg])
}
var radioValue = 1;
Ext.extend(phis.application.fsb.script.FamilySickBedCostsListQueryModule,
...
//						.setValue(this.data.YP_ZFHJ);
			...
			doPrint : function() {
				...
				if(printStyle=='汇总格式'){pages='phis.prints.jrxml.FamilySickBedCostHzgs';}
				if(printStyle=='医嘱格式'){pages='phis.prints.jrxml.FamilySickBedCostYzgs';}
