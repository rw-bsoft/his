...
phis.application.fsb.script.FamilySickBedCancelCommitForm = function(cfg) {
	cfg.colCount = 1;
...
//	cfg.labelWidth = 65;
	...
	cfg.height = 200;
	cfg.width = 500;
	phis.application.fsb.script.FamilySickBedCancelCommitForm.superclass.constructor
			.apply(this, [cfg])
//	this.showButtonOnTop = true;
}

Ext.extend(phis.application.fsb.script.FamilySickBedCancelCommitForm,
