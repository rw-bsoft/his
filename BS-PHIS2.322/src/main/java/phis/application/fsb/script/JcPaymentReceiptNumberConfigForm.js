...
phis.application.fsb.script.JcPaymentReceiptNumberConfigForm = function(cfg) {
	cfg.width = 750;
	phis.application.fsb.script.JcPaymentReceiptNumberConfigForm.superclass.constructor
			.apply(this, [cfg])
	this.on("beforeSave", this.onBeforeSave, this);
}
Ext.extend(phis.application.fsb.script.JcPaymentReceiptNumberConfigForm,
		phis.script.TableForm, {
			onReady : function() {
				phis.application.fsb.script.JcPaymentReceiptNumberConfigForm.superclass.onReady
						.call(this)
			...
			onBeforeSave : function(entryName, op, saveData) {
				var sfqyjkgycs = phis.script.rmi.miniJsonRequestSync({
					serviceId : "jcPaymentReceiptNumberConfigService",
