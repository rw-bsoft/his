...
phis.application.fsb.script.FamilySickBedPatientCardsViewModule = function(cfg) {
	Ext.apply(this, app.modules.common)
	cfg.width = 680;
	cfg.height = 500;
	cfg.modal = true;
	phis.application.fsb.script.FamilySickBedPatientCardsViewModule.superclass.constructor
			.apply(this, [cfg])
}

Ext.extend(phis.application.fsb.script.FamilySickBedPatientCardsViewModule,
