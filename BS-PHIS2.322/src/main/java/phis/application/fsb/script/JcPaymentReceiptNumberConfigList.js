...
phis.application.fsb.script.JcPaymentReceiptNumberConfigList = function(cfg) {
	cfg.selectFirst = false
	phis.application.fsb.script.JcPaymentReceiptNumberConfigList.superclass.constructor
			.apply(this, [cfg]);
}

Ext.extend(phis.application.fsb.script.JcPaymentReceiptNumberConfigList,
