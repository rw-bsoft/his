...
phis.application.fsb.script.FamilySickBedFeesDetalisList = function(cfg) {
	cfg.autoLoadData = false;
	cfg.disablePagingTbr = true;
	cfg.height = 181
	cfg.showRowNumber = false;
	phis.application.fsb.script.FamilySickBedFeesDetalisList.superclass.constructor
			.apply(this, [ cfg ]);
}

Ext
		.extend(
				phis.application.fsb.script.FamilySickBedFeesDetalisList,
				phis.script.SimpleList,
				{
					loadData : function() {
						...
						phis.application.fsb.script.FamilySickBedFeesDetalisList.superclass.loadData
								.call(this);
					},
					doCancel : function() {
					...
					onRowClick : function(grid, index, e) {
						...
						for ( var i = 0; i < this.details.length; i++) {
							...
							if (this.openBy == "sfxm"
								...
								this.opener.DetailsList.requestData.schema = "phis.application.fsb.schemas.JC_FYMX_RQMX";
								...
								this.opener.DetailsList.requestData.schema = "phis.application.fsb.schemas.JC_FYMX_MX";
