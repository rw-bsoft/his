...
phis.application.fsb.script.FamilySickBedMedicalBackApplicationModule = function(cfg) {
	this.exContext = {};
	//this.initDataId=20
	cfg.width=1000
	phis.application.fsb.script.FamilySickBedMedicalBackApplicationModule.superclass.constructor
			.apply(this, [cfg]);
			this.on("winShow",this.afterOpen,this);
}

Ext.extend(phis.application.fsb.script.FamilySickBedMedicalBackApplicationModule,
		phis.script.SimpleModule, {
			...
			afterOpen : function() {
				...
				this.form.loadData();
				this.leftList.loadData(this.initDataId);
