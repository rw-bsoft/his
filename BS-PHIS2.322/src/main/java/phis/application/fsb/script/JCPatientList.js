...
$import("phis.script.SimpleList");
		...
		phis.application.fsb.script.JCPatientList = function(cfg) {
			cfg.height = 200;
			cfg.autoLoadData = false;
			phis.application.fsb.script.JCPatientList.superclass.constructor
					.apply(this, [ cfg ]);
		...
		Ext
				.extend(
						phis.application.fsb.script.JCPatientList,
							...
							print : function() {
								...
								if (!selectRow) {
									...
									var r = phis.script.rmi
											.miniJsonRequestSync({
												serviceId : "medicalTechnologyProjectService",
												serviceAction : "queryJCBG01Search",
												YJXH : YJXH
											});
									if (r.code > 200) {
