...
phis.application.fsb.script.FamilySickBedSettlementManagementQueryList = function(cfg) {
	cfg.autoLoadData = false;
	cfg.disablePagingTbr = true;
	cfg.sortable = false;// 不能排序
	phis.application.fsb.script.FamilySickBedSettlementManagementQueryList.superclass.constructor
			.apply(this, [cfg]);
}

Ext.extend(phis.application.fsb.script.FamilySickBedSettlementManagementQueryList,
	...
	onReady : function() {
		...
		// }, this);
			...
			loadData : function() {
				...
				phis.application.fsb.script.FamilySickBedSettlementManagementQueryList.superclass.loadData
						.call(this);
			},
