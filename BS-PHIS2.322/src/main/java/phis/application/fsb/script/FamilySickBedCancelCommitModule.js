...
phis.application.fsb.script.FamilySickBedCancelCommitModule = function(cfg) {
	phis.application.fsb.script.FamilySickBedCancelCommitModule.superclass.constructor
			.apply(this, [cfg])
}

Ext.extend(phis.application.fsb.script.FamilySickBedCancelCommitModule,
