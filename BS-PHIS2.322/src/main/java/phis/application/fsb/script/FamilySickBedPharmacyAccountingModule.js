...
phis.application.fsb.script.FamilySickBedPharmacyAccountingModule = function(cfg) {
	//cfg.noDefaultBtnKey = true;
	this.noDefaultBtnKey = true;
	phis.application.fsb.script.FamilySickBedPharmacyAccountingModule.superclass.constructor.apply(this,
			[cfg]);
	this.on("shortcutKey", this.shortcutKeyFunc, this);// 监听快捷键
}

Ext.extend(phis.application.fsb.script.FamilySickBedPharmacyAccountingModule,
