...
phis.application.fsb.script.FsbPatientDepartmentTabModule = function(cfg) {
	this.width = 1100
	this.height = 600
	this.activateId = 0;// 默认打开的标签页
	this.showButtonOnTop = true
	this.frame = false;
	phis.application.fsb.script.FsbPatientDepartmentTabModule.superclass.constructor.apply(
			this, [cfg]);
	this.on("winShow",this.onWinShow,this);
}

Ext.extend(phis.application.fsb.script.FsbPatientDepartmentTabModule,
