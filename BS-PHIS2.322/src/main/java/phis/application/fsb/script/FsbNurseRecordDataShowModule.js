...
phis.application.fsb.script.FsbNurseRecordDataShowModule = function(cfg) {

	this.printurl = util.helper.Helper.getUrl();
	phis.application.fsb.script.FsbNurseRecordDataShowModule.superclass.constructor
			.apply(this, [cfg])
}
Ext.extend(phis.application.fsb.script.FsbNurseRecordDataShowModule,
		app.desktop.Module, {
			initPanel : function(data) {
				this.frameId = "FsbNurseRecordFid";
				this.mainFormId = "FsbNurseRecordPanel";
				if (this.panel) {
					return this.panel;
				}
				this.zyh = data.zyh;
				var panel = new Ext.Panel({
					...
					html : "<iframe id='"
							...
							// + this.zyh + "'></iframe>"
							+ "' width='100%' height='100%' src='resources/phis.prints.jrxml.FsbNurseRecordPrint.print?zyh="
							+ this.zyh + "'></iframe>"
				});
				this.panel = panel;
				return this.panel;
