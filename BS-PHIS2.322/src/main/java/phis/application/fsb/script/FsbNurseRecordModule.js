...
phis.application.fsb.script.FsbNurseRecordModule = function(cfg) {
	// this.exContext = {};
	// this.listServiceId = "wardPatientManageService";
	// this.modeName = "dataview";
	cfg.width = 1024;
	cfg.height = 900;
	phis.application.fsb.script.FsbNurseRecordModule.superclass.constructor
			.apply(this, [ cfg ]);
}

Ext.extend(phis.application.fsb.script.FsbNurseRecordModule,
		phis.script.SimpleModule, {
			...
			doPrint : function() {
				...
				var module = this.createModule("fsbNurseRecordDataShowprint",
						"phis.application.fsb.FSB/FSB/FSB130704")
				module.ZYH = this.zyh;
				module.initPanel();
				module.doPrint();
			},
