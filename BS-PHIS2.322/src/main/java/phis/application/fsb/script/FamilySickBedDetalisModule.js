...
phis.application.fsb.script.FamilySickBedDetalisModule = function(cfg) {
	cfg.width = 840;
	cfg.height = 500;
	cfg.modal = true;
	Ext.apply(this, app.modules.common)
	phis.application.fsb.script.FamilySickBedDetalisModule.superclass.constructor
			.apply(this, [ cfg ])
}
var radioValue = 1;
Ext
		.extend(
				phis.application.fsb.script.FamilySickBedDetalisModule,
