...
phis.application.fsb.script.FamilySickBedDrugSubmissionLeftList = function(cfg) {
	Ext.apply(this, phis.application.mds.script.MySimpleListCommon)
	phis.application.fsb.script.FamilySickBedDrugSubmissionLeftList.superclass.constructor
			.apply(this, [cfg])
}
Ext.extend(phis.application.fsb.script.FamilySickBedDrugSubmissionLeftList,
