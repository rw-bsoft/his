...
phis.application.fsb.script.JcWardOutPharmacySet = function(cfg) {
	phis.application.fsb.script.JcWardOutPharmacySet.superclass.constructor.apply(this,
			[cfg]);

	this.on("afterCellEdit", this.afterMyCellEdit, this);
}
Ext.extend(phis.application.fsb.script.JcWardOutPharmacySet, phis.script.EditorList, {
			...
			doCommit : function() {
				...
				var resData = phis.script.rmi.miniJsonRequestSync({
							serviceId : "jcOutPharmacySetService",
