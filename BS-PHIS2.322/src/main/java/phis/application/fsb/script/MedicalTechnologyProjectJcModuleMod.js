...
$import("phis.script.SimpleModule", "phis.script.widgets.MyMessageTip",
		...
		phis.application.fsb.script.MedicalTechnologyProjectJcModuleMod = function(
				cfg) {
			phis.application.fsb.script.MedicalTechnologyProjectJcModuleMod.superclass.constructor
					.apply(this, [ cfg ]);
		},

		Ext
				.extend(
						phis.application.fsb.script.MedicalTechnologyProjectJcModuleMod,
