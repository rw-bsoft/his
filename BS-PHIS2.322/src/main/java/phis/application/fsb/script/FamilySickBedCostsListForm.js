...
phis.application.fsb.script.FamilySickBedCostsListForm = function(cfg) {
	cfg.autoLoadData = false;
	cfg.showButtonOnTop=false;
	cfg.labelWidth = 55;
	phis.application.fsb.script.FamilySickBedCostsListForm.superclass.constructor.apply(this,
			[cfg])
}

Ext.extend(phis.application.fsb.script.FamilySickBedCostsListForm, phis.script.TableForm,
		{
