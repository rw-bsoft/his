...
phis.application.fsb.script.FsbNursePlanDataShowModule = function(cfg) {

	this.printurl = util.helper.Helper.getUrl();
	phis.application.fsb.script.FsbNursePlanDataShowModule.superclass.constructor
			.apply(this, [cfg])
}
Ext.extend(phis.application.fsb.script.FsbNursePlanDataShowModule,
		app.desktop.Module, {
			initPanel : function(data) {
				this.frameId = "FsbNursePlanFid";
				this.mainFormId = "FsbNursePlanPanel";
				if (this.panel) {
					return this.panel;
				}
				this.zyh = data.zyh;
				var panel = new Ext.Panel({
					...
					html : "<iframe id='"
							...
							// + this.zyh + "'></iframe>"
							+ "' width='100%' height='100%' src='resources/phis.prints.jrxml.FsbNursePlanPrint.print?zyh="
							+ this.zyh + "'></iframe>"
				});
				this.panel = panel;
				return this.panel;
