...
phis.application.fsb.script.FamilySickBedProjectExecutionLeftList = function(cfg) {
	Ext.apply(this, phis.application.mds.script.MySimpleListCommon)
	phis.application.fsb.script.FamilySickBedProjectExecutionLeftList.superclass.constructor
			.apply(this, [cfg])
}
Ext.extend(phis.application.fsb.script.FamilySickBedProjectExecutionLeftList,
