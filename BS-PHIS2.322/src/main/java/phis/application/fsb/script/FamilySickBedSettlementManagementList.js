...
phis.application.fsb.script.FamilySickBedSettlementManagementList = function(cfg) {
	cfg.autoLoadData = false;
	cfg.disablePagingTbr = true;
	cfg.sortable = false;// 不能排序
	phis.application.fsb.script.FamilySickBedSettlementManagementList.superclass.constructor
			.apply(this, [cfg]);
}

Ext.extend(phis.application.fsb.script.FamilySickBedSettlementManagementList,
	...
	onReady : function() {
		...
		// }, this);
			...
			loadData : function() {
				...
				phis.application.fsb.script.FamilySickBedSettlementManagementList.superclass.loadData
						.call(this);
			},
