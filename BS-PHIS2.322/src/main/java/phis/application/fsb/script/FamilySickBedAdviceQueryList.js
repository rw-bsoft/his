...
phis.application.fsb.script.FamilySickBedAdviceQueryList = function(cfg) {
	...
	phis.application.fsb.script.FamilySickBedAdviceQueryList.superclass.constructor
			.apply(this, [cfg])
	this.on("loadData", this.myLoadData, this);
}
Ext.extend(phis.application.fsb.script.FamilySickBedAdviceQueryList,
		phis.script.SimpleList, {
			initPanel : function(sc) {
				var grid = phis.application.fsb.script.FamilySickBedAdviceQueryList.superclass.initPanel
						.call(this, sc)
				return grid
			},
			...
			onReady : function() {
				phis.application.fsb.script.FamilySickBedAdviceQueryList.superclass.onReady
						.call(this);
