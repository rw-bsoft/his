...
phis.application.pha.script.MySimpleDetailModule = function(cfg) {
	cfg.width = 1020;
	cfg.height = 550;
	...
	phis.application.pha.script.MySimpleDetailModule.superclass.constructor.apply(this,
			[cfg]);
	this.on('doSave', this.doSave, this);
	this.on("beforeclose", this.doClose, this);
}
Ext.extend(phis.application.pha.script.MySimpleDetailModule,
