...
phis.application.pha.script.PharmacyDispensingForm = function(cfg) {
	cfg.height=this.height=100
	cfg.width = this.width=1000
//	cfg.autoFieldWidth=false;
	cfg.labelWidth=60;
//	cfg.fldDefaultWidth=130
	cfg.showButtonOnTop = false;
	phis.application.pha.script.PharmacyDispensingForm.superclass.constructor.apply(this,
			[cfg])
}
Ext.extend(phis.application.pha.script.PharmacyDispensingForm,
