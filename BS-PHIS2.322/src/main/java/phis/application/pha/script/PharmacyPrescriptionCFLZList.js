...
phis.application.pha.script.PharmacyPrescriptionCFLZList = function(cfg) {
	var defaultCfg = {
		searchFormWidth : 360,
		searchFormHeight : 20,
	...
	cfg.entryName="phis.application.pha.schemas.YF_CF01_SH_CFLZ";
	cfg.serviceId="phis.pharmacyManageService";
	cfg.serviceAction="queryPrescriptionCFLZ";
	phis.application.pha.script.PharmacyPrescriptionCFLZList.superclass.constructor.apply( this, [cfg]);
}

Ext.extend(phis.application.pha.script.PharmacyPrescriptionCFLZList, phis.script.SimpleList, {
			initPanel:function(sc){
				var grid = phis.application.pha.script.PharmacyPrescriptionCFLZList.superclass.initPanel.call(this,sc);
				this.grid = grid;
				return grid;
			},
			...
			loadData : function(){
				...
				phis.application.pha.script.PharmacyPrescriptionCFLZList.superclass.loadData.call(this);
			},
