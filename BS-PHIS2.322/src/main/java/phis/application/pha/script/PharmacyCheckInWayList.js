...
phis.application.pha.script.PharmacyCheckInWayList = function(cfg) {
	phis.application.pha.script.PharmacyCheckInWayList.superclass.constructor.apply(
			this, [cfg])
	this.on("beforeRemove", this.onBeforeRemove, this);
}
Ext.extend(phis.application.pha.script.PharmacyCheckInWayList,
		phis.script.SimpleList, {
			initPanel : function(sc) {
				...
				var grid = phis.application.pha.script.PharmacyCheckInWayList.superclass.initPanel
						.call(this, sc);
				this.grid = grid;
				return grid;
			},
