...
phis.application.pha.script.PharmacyMedicinesApplyList = function(cfg) {
	cfg.width = 1024;
	cfg.height = 550;
	cfg.cnds = ['eq', ['$', 'LYPB'], ['i', 1]];
	cfg.modal = this.modal = true;
	cfg.autoLoadData = false;
	phis.application.pha.script.PharmacyMedicinesApplyList.superclass.constructor.apply(this,
			[cfg])
}
Ext.extend(phis.application.pha.script.PharmacyMedicinesApplyList, phis.script.SimpleList,
		{// 生成日期框
