...
phis.application.pha.script.PharmacyMedicinesApplyDetailForm = function(cfg) {
	cfg.showButtonOnTop = false;
	phis.application.pha.script.PharmacyMedicinesApplyDetailForm.superclass.constructor
			.apply(this, [cfg])
}
Ext.extend(phis.application.pha.script.PharmacyMedicinesApplyDetailForm,
		phis.script.TableForm, {
			onReady : function() {
				phis.application.pha.script.PharmacyMedicinesApplyDetailForm.superclass.onReady
						.call(this);
...
//						if(it.type=="timestamp"&&it.id=="LYRQ"){
