 ...
 *            cfg
 */
phis.application.chr.script.CaseMZHistoryReviewModule = function(cfg) {
	phis.application.chr.script.CaseMZHistoryReviewModule.superclass.constructor.apply(
			this, [cfg])
}

Ext.extend(phis.application.chr.script.CaseMZHistoryReviewModule,
		phis.script.SimpleModule, {
			...
			initFormData : function(recordId) {
				...
				var r = phis.script.rmi.miniJsonRequestSync({
							...
							serviceAction : "getMZFormDataFromDB",
							BLBH : recordId
						});
				if (r.code > 300) {
