...
phis.application.sup.script.InventoryInKSList = function(cfg) {
	cfg.serviceId = "inventoryService";
	cfg.listServiceId = "getInventoryKSInfo";
	cfg.saveActionId = "getInventoryPD02KS";
	cfg.modal = true;
	...
	phis.application.sup.script.InventoryInKSList.superclass.constructor.apply(this,
			[cfg])
	this.on("winShow", this.onWinShow, this);

}
var recordIds = new Array();
Ext.extend(phis.application.sup.script.InventoryInKSList, phis.script.SelectList, {
			expansion : function(cfg) {
				cfg.sm.handleMouseDown = Ext.emptyFn
