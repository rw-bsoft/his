...
phis.application.sup.script.InventoryTZList = function(cfg) {
	cfg.serviceId = "inventoryService";
	cfg.listServiceId = "getInventoryTZKSInfo";
	cfg.saveActionId = "getInventoryZCZB";
	cfg.modal = true;
	...
	phis.application.sup.script.InventoryTZList.superclass.constructor.apply(
			this, [ cfg ])
	this.on("winShow", this.onWinShow, this);

}
var recordIds = new Array();
Ext.extend(phis.application.sup.script.InventoryTZList, phis.script.SelectList,
		{
