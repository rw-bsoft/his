...
phis.application.sup.script.InventoryEjEditorList = function(cfg) {
	cfg.selectOnFocus = true;
	cfg.autoLoadData = false;
    cfg.disablePagingTbr = true;
	phis.application.sup.script.InventoryEjEditorList.superclass.constructor.apply(this,
			[cfg])
}
Ext.extend(phis.application.sup.script.InventoryEjEditorList, phis.script.EditorList,
		{
			loadData : function() {
