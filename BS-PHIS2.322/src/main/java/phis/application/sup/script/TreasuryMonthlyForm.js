...
phis.application.sup.script.TreasuryMonthlyForm = function(cfg) {
	phis.application.sup.script.TreasuryMonthlyForm.superclass.constructor.apply(this,
			[cfg])
}
Ext.extend(phis.application.sup.script.TreasuryMonthlyForm, phis.script.SimpleForm, {
