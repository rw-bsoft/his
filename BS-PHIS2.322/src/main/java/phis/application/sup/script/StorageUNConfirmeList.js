...
phis.application.sup.script.StorageUNConfirmeList = function(cfg) {
	cfg.width = 1024;
	cfg.height = 550;
	...
	phis.application.sup.script.StorageUNConfirmeList.superclass.constructor
			.apply(this, [ cfg ])
	this.on("beforeclose", this.doCancel, this);
}
Ext
		.extend(
				phis.application.sup.script.StorageUNConfirmeList,
				phis.script.SimpleList,
				{
					expansion : function(cfg) {
						...
						cfg.tbar = [];
						cfg.tbar.push([
								"<h1 style='text-align:center'>未记账入库确认单:</h1>",
