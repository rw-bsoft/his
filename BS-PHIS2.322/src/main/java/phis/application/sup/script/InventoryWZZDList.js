...
phis.application.sup.script.InventoryWZZDList = function(cfg) {
	cfg.serviceId = "inventoryService";
	cfg.listServiceId = "getInventoryWZZDInfo";
	cfg.saveActionId = "getInventoryWZZD";
	cfg.modal = true;
	...
	phis.application.sup.script.InventoryWZZDList.superclass.constructor.apply(this,
			[cfg])
	this.on("winShow", this.onWinShow, this);

}
var recordIds = new Array();
Ext.extend(phis.application.sup.script.InventoryWZZDList, phis.script.SelectList, {
			...
			openModule : function(cmd, r, xy) {
				...
				phis.script.cfg.ConfigCostEditorList.superclass.openModule
						.call(this, cmd, r, xy)
