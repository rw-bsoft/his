...
phis.application.sup.script.RepairRequestrYSForm = function(cfg) {
	cfg.width = 700;
	cfg.height = 600;
	cfg.colCount = 3;
	phis.application.sup.script.RepairRequestrYSForm.superclass.constructor.apply(this,[cfg])
}
Ext.extend(phis.application.sup.script.RepairRequestrYSForm, phis.script.TableForm, {
			doYS : function() {
				phis.application.sup.script.RepairRequestrYSForm.superclass.doNew.call(this);
