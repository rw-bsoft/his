...
phis.application.sup.script.InventoryInTZList = function(cfg) {
	cfg.serviceId = "inventoryService";
	cfg.listServiceId = "getInventoryTZKSInfo";
	cfg.saveActionId = "getInventoryPD02TZ";
	cfg.modal = true;
	...
	phis.application.sup.script.InventoryInTZList.superclass.constructor.apply(
			this, [ cfg ])
	this.on("winShow", this.onWinShow, this);

}
var recordIds = new Array();
Ext.extend(phis.application.sup.script.InventoryInTZList,
		phis.script.SelectList, {
			...
			onStoreLoadData : function(store, records, ops) {
				...
				store.each(function(record, index) {
					if (_ctx.containsArray(recordIds, record.get("KSDM"))) {
						rows.push(index);
					}
				});
			...
			openModule : function(cmd, r, xy) {
				...
				phis.application.cfg.ConfigCostEditorList.superclass.openModule
						.call(this, cmd, r, xy)
