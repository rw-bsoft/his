...
phis.application.sup.script.MaintenanceMsgTabModule = function(cfg) {
	phis.application.sup.script.MaintenanceMsgTabModule.superclass.constructor
			.apply(this, [ cfg ]);
}
Ext.extend(phis.application.sup.script.MaintenanceMsgTabModule,
