...
phis.application.sup.script.InventoryTZModule = function(cfg) {
	this.width = 1024;
	this.height = 500;
	cfg.listIsUpdate = true;
	phis.application.sup.script.InventoryTZModule.superclass.constructor.apply(
			this, [ cfg ]);
}
Ext
		.extend(
				phis.application.sup.script.InventoryTZModule,
				phis.script.SimpleModule,
				{
					...
					doCallIn : function() {
						...
						var module = this.createModule("getSUP10010303",
								"phis.application.sup.SUP/SUP/SUP10010303");
		            ...
		            doPrint : function() {
		                var module = this.createModule("inventoryTzPrint",
