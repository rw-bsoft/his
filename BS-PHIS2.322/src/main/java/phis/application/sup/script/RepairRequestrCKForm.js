...
phis.application.sup.script.RepairRequestrCKForm = function(cfg) {
	cfg.width = 700;
	cfg.height = 600;
	cfg.colCount = 3;
	phis.application.sup.script.RepairRequestrCKForm.superclass.constructor.apply(this,[cfg])
}
Ext.extend(phis.application.sup.script.RepairRequestrCKForm, phis.script.TableForm, {
			doYS : function() {
				phis.application.sup.script.RepairRequestrCKForm.superclass.doNew.call(this);
