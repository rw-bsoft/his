...
public class StorageOfMaterialsService extends AbstractActionService implements
		DAOSupportable {
	...
	public void doSaveCheckIn(Map<String, Object> req, Map<String, Object> res,
		...
		StorageOfMaterialsModel smm = new StorageOfMaterialsModel(dao);
		try {
	...
	public void doIsEnoughInventory(Map<String, Object> req,
		...
		StorageOfMaterialsModel smm = new StorageOfMaterialsModel(dao);
		try {
			smm.doIsEnoughInventory(body, res, ctx);
		} catch (ModelDataOperationException e) {
			res.put(RES_CODE, e.getCode());
			res.put(RES_MESSAGE, e.getMessage());
			throw new ServiceException(e);
