...
phis.application.twr.script.DRItemCategoryList = function(cfg) {
	cfg.autoLoadData = false;
	cfg.selectOnFocus = true;
	cfg.showRowNumber = false;
	phis.application.twr.script.DRItemCategoryList.superclass.constructor.apply(this,
			[cfg])
}
 ...
 */
Ext.extend(phis.application.twr.script.DRItemCategoryList, phis.script.SelectList,
		{
			onReady : function() {
				this.data = {}
			},
								...
								if (body) {
									...
									for (var i = 0; i < json.body.length; i++) {
										var rec = {
											...
											"classifyCode" : json.body[i].classifyCode,// 项目分类代码
											"classifyName" : json.body[i].classifyName
										};
