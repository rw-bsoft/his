...
phis.application.twr.script.DRTwoWayCheckApplicationModule = function(cfg) {
	phis.application.twr.script.DRTwoWayCheckApplicationModule.superclass.constructor
			.apply(this, [cfg]);
}
Ext.extend(phis.application.twr.script.DRTwoWayCheckApplicationModule,
		phis.script.SimpleModule, {
			initPanel : function() {
				if (this.panel) {
					this.form.jianchasqdh = this.jianchasqdh;
					this.form.loadData();
					this.list.zhuanzhendh = this.jianchasqdh;
