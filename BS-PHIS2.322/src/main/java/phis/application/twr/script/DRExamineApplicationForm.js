...
phis.application.twr.script.DRExamineApplicationForm = function(cfg) {
	cfg.showButtonOnTop = true;
	this.colCount = cfg.colCount = 4;
	phis.application.twr.script.DRExamineApplicationForm.superclass.constructor
			.apply(this, [cfg]);
	this.brid = '';
	this.mzhm = '';
	this.csny = '';
...
Ext.extend(phis.application.twr.script.DRExamineApplicationForm,
