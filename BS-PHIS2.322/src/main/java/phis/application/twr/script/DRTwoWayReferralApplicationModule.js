...
phis.application.twr.script.DRTwoWayReferralApplicationModule = function(cfg) {
	phis.application.twr.script.DRTwoWayReferralApplicationModule.superclass.constructor
			.apply(this, [cfg]);
}
Ext.extend(phis.application.twr.script.DRTwoWayReferralApplicationModule,
