...
phis.application.twr.script.TwoWayReferralClinicForm = function(cfg) {
	cfg.autoLoadData = false;
	this.colCount = cfg.colCount = 4;
	phis.application.twr.script.TwoWayReferralClinicForm.superclass.constructor
			.apply(this, [cfg]);
	this.brid = '';
	this.mzhm = '';
	this.csny = '';
...
Ext.extend(phis.application.twr.script.TwoWayReferralClinicForm,
...
//					form.findField("JGDH").setValue(111111);
				}
			},
			doSubmit : function() {
