 ...
 *@date : 2013.08.14
 */
phis.application.drc.script.DRNewHospitalizationApplicationList = function(cfg) {
	...
	phis.application.drc.script.DRNewHospitalizationApplicationList.superclass.constructor.apply(this, [cfg])
}
var recordIds = {};
var datas = {};

Ext.extend(phis.application.drc.script.DRNewHospitalizationApplicationList,
		phis.script.SimpleList, {
			loadData : function() {
				this.requestData.cnd = ['and',['eq',['$','empiId'],['s',this.exContext.empiId]],['eq',['$','yewulx'],['s','3']]];
				this.clear();
				if (this.store) {
