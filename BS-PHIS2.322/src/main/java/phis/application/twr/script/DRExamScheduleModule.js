...
phis.application.twr.script.DRExamScheduleModule = function(cfg) {
	this.exContext = {};
	phis.application.twr.script.DRExamScheduleModule.superclass.constructor
			.apply(this, [cfg]);
}

Ext.extend(phis.application.twr.script.DRExamScheduleModule,
		phis.script.SimpleModule, {
			...
			getHisList : function() {
				...
				hisModule.opener = this;
				hisModule.exContext=this.exContext;
			...
			onOpenWin : function(e, t) {
				this.hisModule.showJCSQ(t.toLocaleDateString());
			}
		});