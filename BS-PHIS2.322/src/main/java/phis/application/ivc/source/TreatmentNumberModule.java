...
public class TreatmentNumberModule {
	protected BaseDAO dao;
	protected Logger logger = LoggerFactory
			.getLogger(TreatmentNumberModule.class);

	public TreatmentNumberModule(BaseDAO dao) {
		this.dao = dao;
	}

	// 判断所有号码是否重复
	public void treatmentNumberVerification(Map<String, Object> body,
		...
		if ("create".equals(op)) {
			...
			if (body.get("SYHM") != null) {
				Map<String, Object> parameters = new HashMap<String, Object>();
				String sql = "SYHM=:SYHM and PJLX=1 and JGID=:JGID";
			...
			if (body.get("SYHM") != null) {
				String sql = "SYHM=:SYHM and JLXH<>:JLXH and PJLX=1 and JGID=:JGID";
				Map<String, Object> parameters = new HashMap<String, Object>();
				parameters.put("SYHM", body.get("SYHM"));
				parameters.put("JLXH", body.get("JLXH"));
				parameters.put("JGID", jgid);
	...
	// 判断号码段是否冲突
	public void treatmentNumberRangeVerification(Map<String, Object> body,
			Map<String, Object> res, String schemaDetailsList, String op,
			BaseDAO dao, Context ctx) throws ModelDataOperationException {
		UserRoleToken user = UserRoleToken.getCurrent();
		String jgid = user.getManageUnitId();// 用户的机构ID
