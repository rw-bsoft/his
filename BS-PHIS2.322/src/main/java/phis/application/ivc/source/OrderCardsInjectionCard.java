 ...
 * 
 */
public class OrderCardsInjectionCard implements IHandler {
...
//			 yzlb = 2;
			...
			for (int j = 0; j < list.size(); j++) {
				...
				map.put("SYPC", (String) map.get("SYPC") + "");
				map.put("XMMC", (String) map.get("XMMC") + "");
				map.put("JLDW", (String) map.get("JLDW") + "");
	...
	public List<Map<String, Object>> getList(Map<String, Object> request,
		...
		try {
			...
			if (arr_zyh.length() != 0) {// 如果没有传进用户医嘱人
				...
				sql.append("SELECT b.YZMC as YZMC,b.YPLX as YPLX,b.YPXH as YPXH,b.KSSJ as KSSJ,b.TZSJ as TZSJ,b.YCSL as YCSL,b.YCJL as YCJL,"
						...
						+ "b.JGID = :JGID and ( :FHBZ = 0 or b.FHBZ = 1) ORDER BY d.BRCH ASC,"
						+ "b.YZZH ASC");
				...
				body = SchemaUtil.setDictionaryMassageForList(body, "phis.application.war.schemas.ZY_BQYZ");
