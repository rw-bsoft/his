...
phis.application.ivc.script.ClinicInvoiceQueriesPagingToolbar = function(cfg) {
	phis.application.ivc.script.ClinicInvoiceQueriesPagingToolbar.superclass.constructor.apply(this, [cfg])
	this.addEvents({
				"beforePageChange" : true,
				"pageChange" : true
			})
}
Ext.extend(phis.application.ivc.script.ClinicInvoiceQueriesPagingToolbar, Ext.util.Observable, {})
Ext.extend(phis.application.ivc.script.ClinicInvoiceQueriesPagingToolbar, Ext.PagingToolbar, {
	initComponent : function() {
		...
		var label = new Ext.form.Label({
			html : "<div id='FPCX_JE' align='center' style='color:blue'>合计金额:￥0.00&nbsp;&nbsp;&nbsp;&nbsp;医保统筹:￥0.00</div>"
		})
	...
	onClick : function(which) {
		...
		phis.application.ivc.script.ClinicInvoiceQueriesPagingToolbar.superclass.onClick.call(this, which)
