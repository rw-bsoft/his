...
phis.application.ivc.script.OutPatientNumberForm = function(cfg) {
	cfg.width = 750;
	phis.application.ivc.script.OutPatientNumberForm.superclass.constructor.apply(this,
			[cfg])
	this.on("beforeSave", this.onBeforeSave, this);
}
Ext.extend(phis.application.ivc.script.OutPatientNumberForm, phis.script.TableForm, {
			onReady : function() {
				phis.application.ivc.script.OutPatientNumberForm.superclass.onReady
						.call(this)
			...
			onBeforeSave : function(entryName, op, saveData) {
				...
				var r = phis.script.rmi.miniJsonRequestSync({
							serviceId : "outPatientNumberService",
							serviceAction : "outPatientNumberVerification",
				...
				var r = phis.script.rmi.miniJsonRequestSync({
							serviceId : "outPatientNumberService",
							serviceAction : "outPatientNumberRangeVerification",
							schemaDetailsList : "MS_YGPJ",
							op : this.op,
							body : dataConflict
						});
