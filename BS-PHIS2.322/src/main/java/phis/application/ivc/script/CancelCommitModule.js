...
phis.application.ivc.script.CancelCommitModule = function(cfg) {
	phis.application.ivc.script.CancelCommitModule.superclass.constructor
			.apply(this, [cfg])
}

Ext.extend(phis.application.ivc.script.CancelCommitModule,
