...
phis.application.cfg.script.ConfigDrugLimitEditorList = function(cfg) {
	cfg.autoLoadData = false;
	this.serviceId = "configPatientPropertiesService";
	this.actionId = "saveLimit";
	this.listServiceId = "listLimit";
	this.xyyp = [];
	cfg.minListWidth = 480;
	cfg.remoteUrl = "MedicineBasic";
	cfg.remoteTpl = '<td width="3px" style="background-color:#deecfd">{numKey}.</td><td width="100px">{YPMC}</td><td width="50px">{YFGG}</td><td width="20px">{YPDW}</td>';
	phis.application.cfg.script.ConfigDrugLimitEditorList.superclass.constructor
			.apply(this, [cfg])

}

Ext.extend(phis.application.cfg.script.ConfigDrugLimitEditorList,
		phis.script.EditorList, {
			loadData : function() {
				...
				this.requestData.schema = "GY_YPJY";
				if (this.store) {
			...
			initPanel : function(sc) {
				var grid = phis.application.cfg.script.ConfigDrugLimitEditorList.superclass.initPanel
						.call(this, sc)
			...
			totalYYZL : function(v, params, data) {
				return v == null
						? '0'
