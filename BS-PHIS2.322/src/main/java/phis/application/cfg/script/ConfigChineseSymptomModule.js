...
$import("app.modules.common", "phis.script.SimpleModule","util.dictionary.TreeDicFactory")

phis.application.cfg.script.ConfigChineseSymptomModule = function(cfg) {
	...
	phis.application.cfg.script.ConfigChineseSymptomModule.superclass.constructor.apply(this,[cfg])
}

Ext.extend(phis.application.cfg.script.ConfigChineseSymptomModule, phis.script.SimpleModule, {
