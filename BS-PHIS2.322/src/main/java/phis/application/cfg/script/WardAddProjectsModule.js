...
phis.application.cfg.script.WardAddProjectsModule = function(cfg) {
	this.exContext = {};
	phis.application.cfg.script.WardAddProjectsModule.superclass.constructor.apply(this,
			[cfg]);
}
Ext.extend(phis.application.cfg.script.WardAddProjectsModule,
