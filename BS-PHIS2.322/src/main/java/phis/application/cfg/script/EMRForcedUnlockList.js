...
phis.application.cfg.script.EMRForcedUnlockList = function(cfg) {
	cfg.autoLoadData = true;
	cfg.autoLoadSchema = false;
	cfg.disablePagingTbr = false;
	phis.application.cfg.script.EMRForcedUnlockList.superclass.constructor.apply(this,
			[cfg]);
...
Ext.extend(phis.application.cfg.script.EMRForcedUnlockList, phis.script.SimpleList, {
