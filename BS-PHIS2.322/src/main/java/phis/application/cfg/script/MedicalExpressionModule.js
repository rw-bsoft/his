...
phis.application.cfg.script.MedicalExpressionModule = function(cfg) {
	cfg.exContext = {};
	phis.application.cfg.script.MedicalExpressionModule.superclass.constructor.apply(
			this, [cfg]);
}
var emr_this = emr_this || {};
Ext.extend(phis.application.cfg.script.MedicalExpressionModule,
			...
			getActiveXPanel : function() {
				...
				var panel = new Ext.Panel({
					...
					html : '<div id="emrOcxContainer_' + this.mKey
							+ '"><IFRAME id=' + this.mKey + ' name="emrOcxFrame" width="100%" height="700" src="'
							+ url + '?mKey=' + this.mKey
