...
phis.application.cfg.script.ConfigDepartmentsInForm = function(cfg) {
	cfg.showButtonOnTop = false;
	cfg.colCount = 5;
	phis.application.cfg.script.ConfigDepartmentsInForm.superclass.constructor
			.apply(this, [ cfg ])
	this.wzxh = 0;
	this.cjxh = 0;
	this.zblb = 0;
...
Ext
		.extend(
				phis.application.cfg.script.ConfigDepartmentsInForm,
