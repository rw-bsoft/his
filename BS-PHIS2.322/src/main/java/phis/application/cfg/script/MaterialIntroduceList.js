...
phis.application.cfg.script.MaterialIntroduceList = function(cfg) {
	cfg.serviceId = "materialInformationManagement";
	cfg.listServiceId = "getMaterialInformation";
	cfg.saveActionId = "saveCallin";
	cfg.modal = true;
	...
	phis.application.cfg.script.MaterialIntroduceList.superclass.constructor.apply(this,
			[cfg])
	this.on("winShow", this.onWinShow, this);

}
var recordIds = new Array();
Ext.extend(phis.application.cfg.script.MaterialIntroduceList, phis.script.SelectList,
		{
