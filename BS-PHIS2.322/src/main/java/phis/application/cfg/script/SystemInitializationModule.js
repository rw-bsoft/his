...
$import("phis.script.SimpleModule", "phis.script.rmi.miniJsonRequestSync",
		"util.dictionary.TreeDicFactory", "util.dictionary.SimpleDicFactory","phis.script.widgets.TreeLoader")

phis.application.cfg.script.SystemInitializationModule = function(cfg) {
	cfg.width = 400;
	cfg.height = 300;
	phis.application.cfg.script.SystemInitializationModule.superclass.constructor
			.apply(this, [cfg])

}
Ext.extend(phis.application.cfg.script.SystemInitializationModule,
