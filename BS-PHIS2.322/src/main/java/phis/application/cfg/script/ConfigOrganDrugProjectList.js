...
phis.application.cfg.script.ConfigOrganDrugProjectList = function(cfg) {
	this.initCnd = ['eq', ['$', 'FYFL'], ['$', '2']]; // modified by zhangxw
	this.closeAction = true;
	cfg.disablePagingTbr = false;
	phis.application.cfg.script.ConfigOrganDrugProjectList.superclass.constructor.apply(
			this, [cfg])
	this.exContext['FYFL'] = "2"
}
Ext.extend(phis.application.cfg.script.ConfigOrganDrugProjectList,
		phis.script.SimpleList, {
			...
			openModule : function(cmd, r, xy) {
				phis.application.cfg.script.ConfigOrganDrugProjectList.superclass.openModule
						.call(this, cmd, r, xy)
