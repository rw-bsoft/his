...
phis.application.cfg.script.ConfigOtherProjectList = function(cfg) {
	this.initCnd = ['eq', ['$', 'FYFL'], ['$', '3']]; // modified by zhangxw
	this.closeAction = true;
	cfg.disablePagingTbr = false;
	phis.application.cfg.script.ConfigOtherProjectList.superclass.constructor.apply(
			this, [cfg])
	this.exContext['FYFL'] = "3"
}
Ext.extend(phis.application.cfg.script.ConfigOtherProjectList,
		phis.script.SimpleList, {
			openModule : function(cmd, r, xy) {
				phis.application.cfg.script.ConfigOtherProjectList.superclass.openModule
						.call(this, cmd, r, xy)
