...
phis.application.xnh.script.NhclinicallChargesPrintView = function(cfg) {
	this.width = 800
	this.height = 500
	...
	this.conditions = []
	this.jzDate = "";
	phis.application.xnh.script.NhclinicallChargesPrintView.superclass.constructor.apply(this,
			[cfg])
}
Ext.extend(phis.application.xnh.script.NhclinicallChargesPrintView, phis.script.SimpleModule,
		{
			initPanel : function() {
				this.frameId = "SimplePrint_frame_phis.prints.jrxml.nhclinicallCharges";
				this.conditionFormId = "SimplePrint_form_phis.prints.jrxml.nhclinicallCharges";
				this.mainFormId = "SimplePrint_mainform_phis.prints.jrxml.nhclinicallCharges";
				var panel = new Ext.Panel({
					...
					html : "<iframe id='"
							+ this.frameId
							+ "' width='100%' height='100%' onload='simplePrintMask(\"phis.prints.jrxml.nhclinicallCharges\")'></iframe>"
				})
				this.panel = panel
				return panel
			},
			...
			doPrint : function() {
				...
				var pages = "phis.prints.jrxml.nhclinicallCharges";
