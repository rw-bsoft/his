...
phis.application.xnh.script.NhMedicinesCompareModule = function(cfg) {
	this.exContext = {};
	phis.application.xnh.script.NhMedicinesCompareModule.superclass.constructor.apply(this,
			[cfg]);
}
Ext.extend(phis.application.xnh.script.NhMedicinesCompareModule,
		phis.script.SimpleModule, {
			...
			onnhypmlListRowDblClick : function(){
				...
				if(yyml_r.get("NHBM_SH")=="1"){
					alert("药品"+yyml_r.get("YPMC")+"农合已审核！不能再次匹配！");
					return;
				}
