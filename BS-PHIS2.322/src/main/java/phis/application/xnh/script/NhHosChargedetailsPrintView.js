...
phis.application.xnh.script.NhHosChargedetailsPrintView = function(cfg) {
	this.width = 800
	this.height = 500
	...
	this.conditions = []
	this.jzDate = "";
	phis.application.xnh.script.NhHosChargedetailsPrintView.superclass.constructor.apply(this,
			[cfg])
}
Ext.extend(phis.application.xnh.script.NhHosChargedetailsPrintView, phis.script.SimpleModule,
		{
			initPanel : function() {
				this.frameId = "SimplePrint_frame_phis.prints.jrxml.NhHosChargedetails";
				this.conditionFormId = "SimplePrint_form_phis.prints.jrxml.NhHosChargedetails";
				this.mainFormId = "SimplePrint_mainform_phis.prints.jrxml.NhHosChargedetails";
				var panel = new Ext.Panel({
					...
					html : "<iframe id='"
							+ this.frameId
							+ "' width='100%' height='100%' onload='simplePrintMask(\"phis.prints.jrxml.NhHosChargedetails\")'></iframe>"
				})
				this.panel = panel
				return panel
			},
			...
			doPrint : function() {
				...
				var pages = "phis.prints.jrxml.NhHosChargedetails";
