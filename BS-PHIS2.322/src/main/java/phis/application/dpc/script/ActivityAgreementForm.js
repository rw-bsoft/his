...
phis.application.dpc.script.ActivityAgreementForm = function(cfg) {
    cfg.labelAlign = "left";
    ...
    cfg.colCount = 2;
    cfg.width = 710;
    phis.application.dpc.script.ActivityAgreementForm.superclass.constructor.apply(this, [cfg]);
    this.on("save", this.onSave, this);
    this.on("loadData", this.onLoadData, this);
}

Ext.extend(phis.application.dpc.script.ActivityAgreementForm, chis.script.BizTableFormView, {
    doNew : function() {
        debugger
        phis.application.dpc.script.ActivityAgreementForm.superclass.doNew.call(this);
    ...
    onReady : function() {
        phis.application.dpc.script.ActivityAgreementForm.superclass.onReady.call(this);
        var form = this.form.getForm();
    },
