...
phis.application.dpc.script.ExtractionAgreementForm = function(cfg) {
    cfg.labelAlign = "left";
    ...
    cfg.colCount = 2;
    cfg.width = 710;
    phis.application.dpc.script.ExtractionAgreementForm.superclass.constructor.apply(this, [cfg]);
    this.on("save", this.onSave, this);
    this.on("loadData", this.onLoadData, this);
}

Ext.extend(phis.application.dpc.script.ExtractionAgreementForm, chis.script.BizTableFormView, {
    doNew : function() {
        debugger
        phis.application.dpc.script.ExtractionAgreementForm.superclass.doNew.call(this);
    ...
    onReady : function() {
        phis.application.dpc.script.ExtractionAgreementForm.superclass.onReady.call(this);
        var form = this.form.getForm();
    },
