...
public class HospitalPatientManagementService extends AbstractActionService
		implements DAOSupportable {
	protected Logger logger = LoggerFactory
			.getLogger(HospitalPatientManagementService.class);
	...
	public void doLoadBrxx(Map<String, Object> req, Map<String, Object> res,
		...
		HospitalPatientManagementModel ham = new HospitalPatientManagementModel(dao);
		try {
