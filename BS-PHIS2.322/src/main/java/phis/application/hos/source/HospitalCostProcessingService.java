...
public class HospitalCostProcessingService extends AbstractActionService
		implements DAOSupportable {
	protected Logger logger = LoggerFactory
			.getLogger(HospitalCostProcessingService.class);
	...
	public void doQueryItemInfo(Map<String, Object> req, Map<String, Object> res,
		...
		HospitalCostProcessingModel hpm = new HospitalCostProcessingModel(dao);
		try {
	...
	public void doQueryMedicalRecordHomePage(Map<String, Object> req,
		...
		HospitalCostProcessingModel hpm = new HospitalCostProcessingModel(dao);
		try {
			hpm.doQueryMedicalRecordHomePage(req,res,ctx);
		} catch (ModelDataOperationException e) {
