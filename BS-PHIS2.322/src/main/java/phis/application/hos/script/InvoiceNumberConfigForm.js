...
phis.application.hos.script.InvoiceNumberConfigForm = function(cfg) {
	cfg.width = 750;
	phis.application.hos.script.InvoiceNumberConfigForm.superclass.constructor.apply(
			this, [cfg])
	this.on("beforeSave", this.onBeforeSave, this);
}
Ext.extend(phis.application.hos.script.InvoiceNumberConfigForm,
		phis.script.TableForm, {
			onReady : function() {
				phis.application.hos.script.InvoiceNumberConfigForm.superclass.onReady
						.call(this)
			...
			onBeforeSave : function(entryName, op, saveData) {
				var sfqyfpgycs = phis.script.rmi.miniJsonRequestSync({
					serviceId : "invoiceNumberConfigService",
