...
phis.application.hos.script.HospitalPaymentProcessingTabModule = function(cfg) {
	phis.application.hos.script.HospitalPaymentProcessingTabModule.superclass.constructor
			.apply(this, [cfg])
}

Ext.extend(phis.application.hos.script.HospitalPaymentProcessingTabModule,
