...
phis.application.hos.script.CostsListTabModule = function(cfg) {
	this.width = 1100
	this.height = 600
	this.showButtonOnTop = true
	this.requestData = {};
	phis.application.hos.script.CostsListTabModule.superclass.constructor.apply(this,
			[cfg])
}

Ext.extend(phis.application.hos.script.CostsListTabModule, phis.script.TabModule, {
