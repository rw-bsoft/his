...
phis.application.hos.script.HospitalCostAccountingForm = function(cfg) {
	phis.application.hos.script.HospitalCostAccountingForm.superclass.constructor
			.apply(this, [cfg])
}

Ext.extend(phis.application.hos.script.HospitalCostAccountingForm,
		phis.script.TableForm, {
			...
			createRemoteDicField : function(it) {
				...
				var remoteTpl = '<td width="18px" style="background-color:#deecfd">{#}.</td><td width="60px" style="color:red">{YYZBM}</td><td width="150px">{FYMC}</td><td width="60px">{BFGG}</td><td width="70px">{FYDJ}</td><td width="30px">{FYDW}</td><td width="100px">{CDMC}</td>';
