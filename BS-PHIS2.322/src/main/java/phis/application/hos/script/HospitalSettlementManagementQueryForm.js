...
phis.application.hos.script.HospitalSettlementManagementQueryForm = function(cfg) {
	cfg.autoLoadData = false;
	cfg.showButtonOnTop = false;
	cfg.labelWidth = 55;
	phis.application.hos.script.HospitalSettlementManagementQueryForm.superclass.constructor
			.apply(this, [cfg])
}

Ext.extend(phis.application.hos.script.HospitalSettlementManagementQueryForm,
