...
phis.application.hos.script.HospitalSettlementManagementList = function(cfg) {
	cfg.autoLoadData = false;
	cfg.disablePagingTbr = true;
	cfg.sortable = false;// 不能排序
	phis.application.hos.script.HospitalSettlementManagementList.superclass.constructor
			.apply(this, [cfg]);
}

Ext.extend(phis.application.hos.script.HospitalSettlementManagementList,
	...
	onReady : function() {
		...
		// }, this);
			...
			loadData : function() {
				...
				phis.application.hos.script.HospitalSettlementManagementList.superclass.loadData
						.call(this);
			},
