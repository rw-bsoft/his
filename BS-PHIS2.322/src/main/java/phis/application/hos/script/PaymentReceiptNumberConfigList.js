...
phis.application.hos.script.PaymentReceiptNumberConfigList = function(cfg) {
	cfg.selectFirst = false
	this.initCnd = ['eq', ['$', 'PJLX'], ['d', cfg.PJLX]]
	phis.application.hos.script.PaymentReceiptNumberConfigList.superclass.constructor
			.apply(this, [cfg]);
}

Ext.extend(phis.application.hos.script.PaymentReceiptNumberConfigList,
