...
phis.application.hos.script.HospitalCostsListModule = function(cfg) {
	cfg.width = 960;
	cfg.height = 500;
	cfg.modal = true;
	Ext.apply(this, app.modules.common)
	phis.application.hos.script.HospitalCostsListModule.superclass.constructor
			.apply(this, [ cfg ])
}
var radioValue = 1;
Ext
		.extend(
				phis.application.hos.script.HospitalCostsListModule,
				phis.script.SimpleModule,
				{
					...
					doPrint : function() {
						...
						if (printStyle == '汇总格式') {
							pages = 'phis.prints.jrxml.HospitalCostHzgs';
						}
						if (printStyle == '医嘱格式') {
							pages = 'phis.prints.jrxml.HospitalCostYzgs';
						}
