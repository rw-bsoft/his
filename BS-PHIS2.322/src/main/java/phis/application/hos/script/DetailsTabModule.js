...
phis.application.hos.script.DetailsTabModule = function(cfg) {
	this.width = 600
	this.height = 500
	this.showButtonOnTop = true
	this.requestData = {};
	phis.application.hos.script.DetailsTabModule.superclass.constructor.apply(this,
			[cfg])
}

Ext.extend(phis.application.hos.script.DetailsTabModule, phis.script.TabModule, {
	initPanel : function() {
		if (this.tab) {
			return this.tab;
		}
