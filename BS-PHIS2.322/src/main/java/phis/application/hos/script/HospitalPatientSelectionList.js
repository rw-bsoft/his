...
phis.application.hos.script.HospitalPatientSelectionList = function(cfg) {
	cfg.autoLoadData = false;
	cfg.disablePagingTbr = true;
	cfg.showRowNumber = false;
	phis.application.hos.script.HospitalPatientSelectionList.superclass.constructor
			.apply(this, [cfg]);
}

Ext.extend(phis.application.hos.script.HospitalPatientSelectionList,
		phis.script.SimpleList, {
			onReady : function() {
				phis.application.hos.script.HospitalPatientSelectionList.superclass.onReady
						.call(this);
			...
			loadData : function() {
				...
				phis.application.hos.script.HospitalPatientSelectionList.superclass.loadData
						.call(this);
			},
