...
phis.application.hos.script.HospitalRefundsDetailsList = function(cfg) {
	this.serverParams = {
		serviceAction : cfg.serviceAction
	}
	cfg.autoLoadData = false;
	phis.application.hos.script.HospitalRefundsDetailsList.superclass.constructor.apply(
			this, [cfg]);
}

Ext.extend(phis.application.hos.script.HospitalRefundsDetailsList,
