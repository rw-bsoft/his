...
phis.application.hos.script.HospitalCostList = function(cfg) {
	cfg.autoLoadData = false;
	this.serverParams = {
		serviceAction : cfg.serviceAction
	}
	phis.application.hos.script.HospitalCostList.superclass.constructor.apply(this,
			[cfg]);

}

Ext.extend(phis.application.hos.script.HospitalCostList, phis.script.SimpleList, {
