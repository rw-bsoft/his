...
phis.application.hos.script.YbFeeUploadLeftList = function(cfg) {
	cfg.autoLoadData = false;
	cfg.disablePagingTbr = true;
	phis.application.hos.script.YbFeeUploadLeftList.superclass.constructor
			.apply(this, [cfg])
}
Ext.extend(phis.application.hos.script.YbFeeUploadLeftList,
		phis.script.SelectList, {
			loadData : function() {
				this.requestData.serviceId = this.serviceId;
				this.requestData.serviceAction = this.serviceAction;
				phis.application.hos.script.YbFeeUploadLeftList.superclass.loadData
						.call(this);
			},
