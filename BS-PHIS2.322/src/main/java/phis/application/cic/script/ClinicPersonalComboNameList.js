...
phis.application.cic.script.ClinicPersonalComboNameList = function(cfg) {
	cfg.disablePagingTbr = false;
	cfg.showRowNumber = true;
	cfg.cnds = ['and', ['eq', ['$', 'ZTLB'], ['i', 1]],
			['eq', ['$', 'SSLB'], ['i', 1]]];
	cfg.initCnd = ['and', ['eq', ['$', 'ZTLB'], ['i', 1]],
			['eq', ['$', 'SSLB'], ['i', 1]]];
	phis.application.cic.script.ClinicPersonalComboNameList.superclass.constructor
			.apply(this, [cfg])
	this.on("beforeRemove", this.onBeforeRemove, this);
	this.on("remove", this.onRemove, this);
}
Ext.extend(phis.application.cic.script.ClinicPersonalComboNameList,
		phis.script.SimpleList, {
			openModule : function(cmd, r, xy) {
				phis.application.cic.script.ClinicPersonalComboNameList.superclass.openModule
						.call(this, cmd, r, xy)
			...
			onReady : function() {
				phis.application.cic.script.ClinicPersonalComboNameList.superclass.onReady
						.call(this);
