...
phis.application.cic.script.IdrReport_HFMD = function(cfg) {
	cfg.actions = [{
				id : "confirm",
				name : "保存",
				iconCls : "common_add"
	...
	//cfg.schema = "";
	phis.application.cic.script.IdrReport_HFMD.superclass.constructor
			.apply(this, [ cfg ]);
	this.on("winShow", this.onWinShow, this);
};
Ext.extend(phis.application.cic.script.IdrReport_HFMD,
	phis.script.TableForm,{
			doConfirm : function() {
				debugger
				var r = this.data;//IdrReport_HFMD//this.opener.opener.getSelectedRecord();
