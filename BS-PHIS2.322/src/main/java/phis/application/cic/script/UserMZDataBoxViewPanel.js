...
phis.application.cic.script.UserMZDataBoxViewPanel = function(cfg) {
	phis.application.cic.script.UserMZDataBoxViewPanel.superclass.constructor.apply(this,
			[cfg]);
}

Ext.extend(phis.application.cic.script.UserMZDataBoxViewPanel, phis.script.SimpleModule, {
			initPanel : function() {
