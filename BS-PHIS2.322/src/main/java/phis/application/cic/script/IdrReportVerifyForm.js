...
phis.application.cic.script.IdrReportVerifyForm = function(cfg) {
	cfg.actions = [{
				id : "confirm",
				name : "确定",
				iconCls : "common_add"
	...
	phis.application.cic.script.IdrReportVerifyForm.superclass.constructor
			.apply(this, [ cfg ]);
	this.on("winShow", this.onWinShow, this);
};
Ext.extend(phis.application.cic.script.IdrReportVerifyForm,
	phis.script.TableForm,{
			doConfirm : function() {
				var r = this.opener.opener.getSelectedRecord();
				if (r == null) {
					return;
				}
				var _this = this;
				...
				body["IDR_Report"].RecordID = r.data.RecordID;
