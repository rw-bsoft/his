...
phis.application.cic.script.CFLZ_WLXXPhisModule = function(cfg){
//	cfg.layOutRegion="north";
//	cfg.itemHeight = 200;
	phis.application.cic.script.CFLZ_WLXXPhisModule.superclass.constructor.apply(this,[cfg]);
}

Ext.extend(phis.application.cic.script.CFLZ_WLXXPhisModule,phis.script.SimpleModule,{
	initPanel : function() {
		if (this.panel)
			return this.panel;
	...
	getCrbForm : function(){
		var module = this.createModule("CFLZForm",this.CFLZForm);
		this.CrbForm = module;
