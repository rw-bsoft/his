...
phis.application.cic.script.UserMZDataBoxModule = function(cfg) {
	phis.application.cic.script.UserMZDataBoxModule.superclass.constructor.apply(
			this, [cfg]);
	this.indexId = 11;
	this.on("winShow", this.onWinShow, this);
}
var emr_this = emr_this || {};
Ext.extend(phis.application.cic.script.UserMZDataBoxModule,
