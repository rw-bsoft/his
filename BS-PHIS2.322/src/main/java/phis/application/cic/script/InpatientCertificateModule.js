...
phis.application.cic.script.InpatientCertificateModule = function(cfg) {
	phis.application.cic.script.InpatientCertificateModule.superclass.constructor
			.apply(this, [ cfg ]);
};
Ext.extend(phis.application.cic.script.InpatientCertificateModule,
		phis.script.SimpleModule, {
			...
			doAdvance : function() {
				...
				var body = {
					...
					"BQDM" : this.yyform.form.getForm().findField("BQDM").getValue(),
					"BRCH" : this.yyform.form.getForm().findField("BRCH").getValue(),
					"YZ" : this.yyform.form.getForm().findField("YZ").getValue(),
					"LXRM" : this.yyform.form.getForm().findField("LXRM").getValue(),
					"LXGX" : this.yyform.form.getForm().findField("LXGX").getValue(),
					"LXDZ" : this.yyform.form.getForm().findField("LXDZ").getValue(),
					"LXDH" : this.yyform.form.getForm().findField("LXDH").getValue(),
					"REMARK" : this.yyform.form.getForm().findField("REMARK").getValue(),
					"INHOSMETHOD" : this.yyform.form.getForm().findField("INHOSMETHOD").getValue(),
					"BRDHHM" : this.yyform.form.getForm().findField("BRDHHM").getValue()
				};
...
//					MyMessageTip.msg("提示", "取消成功!", true);
			...
			doPrint : function(yyks) {
				...
				var pages = "phis.prints.jrxml.InpatientCertificate";
