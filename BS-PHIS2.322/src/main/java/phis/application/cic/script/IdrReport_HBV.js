...
phis.application.cic.script.IdrReport_HBV = function(cfg) {
	cfg.actions = [{
				id : "confirm",
				name : "保存",
				iconCls : "common_add"
	...
	//cfg.schema = "";
	phis.application.cic.script.IdrReport_HBV.superclass.constructor
			.apply(this, [ cfg ]);
	this.on("winShow", this.onWinShow, this);
};
Ext.extend(phis.application.cic.script.IdrReport_HBV,
	phis.script.TableForm,{
			doConfirm : function() {
				debugger
				var r = this.data;//IdrReport_HBV//this.opener.opener.getSelectedRecord();
