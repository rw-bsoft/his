...
phis.application.cic.script.InpatientCertificateForm = function(cfg) {
	cfg.colCount = 4;
	phis.application.cic.script.InpatientCertificateForm.superclass.constructor
			.apply(this, [ cfg ]);
};
Ext.extend(
	phis.application.cic.script.InpatientCertificateForm,
	phis.script.TableForm,{
		onReady : function() {
			phis.application.cic.script.InpatientCertificateForm.superclass.onReady
					.call(this);
