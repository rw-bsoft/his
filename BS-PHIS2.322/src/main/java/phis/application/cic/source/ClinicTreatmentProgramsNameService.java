...
public class ClinicTreatmentProgramsNameService extends AbstractActionService
		implements DAOSupportable {
	protected Logger logger = LoggerFactory
			.getLogger(TreatmentNumberService.class);

	@SuppressWarnings("unchecked")
	public void doClinicTreatmentProgramsNameVerification(
			Map<String, Object> req, Map<String, Object> res, BaseDAO dao,
			Context ctx) throws ModelDataOperationException {
		ClinicTreatmentProgramsNameModel ctpnm = new ClinicTreatmentProgramsNameModel(
				dao);
