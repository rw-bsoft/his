		...
		try {
			...
			for (Map<String, Object> med : cf02_List) {
				...
				StringBuffer hql = new StringBuffer(
						"select a.YPXH as YPXH,a.YPMC as YPMC,b.YFGG as YFGG,a.YPDW as YPDW,a.PSPB as PSPB,a.JLDW as JLDW,a.YPJL as YPJL,a.GYFF as GYFF,a.YFBZ as YFBZ,d.LSJG as LSJG,d.YPCD as YPCD,f.CDMC as YPCD_text,a.TYPE as TYPE,a.TSYP as TSYP,b.YFDW as YFDW,d.LSJG as YPDJ,a.ZBLB as FYGB,a.KSBZ as KSBZ,a.KSSDJ as KSSDJ,a.YQSYFS as YQSYFS,decode(e.YYZBM,'',' ','医保可报销') as YYZBM");
				hql.append(" from YK_TYPK a,YF_YPXX b,YF_KCMX d,YK_CDDZ f,YK_CDXX e  ");
				hql.append(" where  ( a.YPXH = d.YPXH ) AND ( b.YPXH = a.YPXH ) AND ( b.YFSB = d.YFSB ) AND ( a.ZFPB = 0 ) AND ( b.YFZF = 0 ) AND ( d.JYBZ = 0 ) AND (d.YPCD=f.YPCD) AND e.JGID=:JGID and e.YPXH=d.YPXH and e.YPCD=d.YPCD AND  b.YFSB=:YFSB   AND a.YPXH = :YPXH and d.YPCD=:YPCD ORDER BY d.SBXH");
