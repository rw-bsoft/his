...
phis.application.emr.script.EMRPersonalModeManageTree = function(cfg) {
	this.checkModel = 'cascade';// 'multiple':多选; 'single':单选; 'cascade':级联多选
	this.checkTree = false;// 是否构建可以选择的树
	this.showDepth = 1; // 显示的节点层数,0表示不限制
	phis.application.emr.script.EMRPersonalModeManageTree.superclass.constructor.apply(this, [cfg])
}
Ext.extend(phis.application.emr.script.EMRPersonalModeManageTree,
