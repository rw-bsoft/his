...
phis.application.emr.script.EMRClinicDefaultSelectList = function(cfg) {
	cfg.mutiSelect=false;
	cfg.disablePagingTbr=true;
	phis.application.emr.script.EMRClinicDefaultSelectList.superclass.constructor.apply(this, [cfg])
}

Ext.extend(phis.application.emr.script.EMRClinicDefaultSelectList,
