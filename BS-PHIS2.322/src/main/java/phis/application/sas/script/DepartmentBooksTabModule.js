...
phis.application.sas.script.DepartmentBooksTabModule = function(cfg) {
	phis.application.sas.script.DepartmentBooksTabModule.superclass.constructor
			.apply(this, [ cfg ]);
}
Ext.extend(phis.application.sas.script.DepartmentBooksTabModule,
