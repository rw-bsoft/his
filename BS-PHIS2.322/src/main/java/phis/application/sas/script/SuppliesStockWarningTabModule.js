...
phis.application.sas.script.SuppliesStockWarningTabModule = function(cfg) {
	phis.application.sas.script.SuppliesStockWarningTabModule.superclass.constructor
			.apply(this, [ cfg ]);
}
Ext.extend(phis.application.sas.script.SuppliesStockWarningTabModule,
