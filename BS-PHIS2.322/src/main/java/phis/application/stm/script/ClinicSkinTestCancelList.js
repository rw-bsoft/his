...
phis.application.stm.script.ClinicSkinTestCancelList = function(cfg) {
	cfg.disablePagingTbr = true;
	cfg.showButtonOnTop = false;
	cfg.serverParams = {
		'openBy' : 'cancelTestSkin'
	}
	phis.application.stm.script.ClinicSkinTestCancelList.superclass.constructor
			.apply(this, [cfg])
	this.on("firstRowSelected", this.onRowClick, this)
	this.on("loadData", this.afterLoad, this)
}
Ext.extend(phis.application.stm.script.ClinicSkinTestCancelList,
