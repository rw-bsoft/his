...
phis.application.ccl.script.CheckApplyForm_CIC = function(cfg) {
	this.colCount = 3;
	this.autoFieldWidth = true
	this.showButtonOnTop = 0;
	phis.application.ccl.script.CheckApplyForm_CIC.superclass.constructor.apply(
			this, [cfg])
}

Ext.extend(phis.application.ccl.script.CheckApplyForm_CIC, phis.script.TableForm,
		{
			init : function(){
