...
phis.application.ccl.script.CheckApplyExchangedApplicationModule_CIC = function(
		cfg) {
	phis.application.ccl.script.CheckApplyExchangedApplicationModule_CIC.superclass.constructor
			.apply(this, [cfg])
}
Ext.extend(phis.application.ccl.script.CheckApplyExchangedApplicationModule_CIC,
