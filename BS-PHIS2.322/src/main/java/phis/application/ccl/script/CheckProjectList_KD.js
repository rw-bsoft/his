...
phis.application.ccl.script.CheckProjectList_KD = function(cfg) {
	cfg.autoLoadData = false;
	cfg.disablePagingTbr = true;
	phis.application.ccl.script.CheckProjectList_KD.superclass.constructor
			.apply(this, [cfg]);
}
Ext.extend(phis.application.ccl.script.CheckProjectList_KD,
		phis.script.SimpleList, {
			loadData : function() {
				...
				phis.application.ccl.script.CheckProjectList_KD.superclass.loadData
						.call(this)
			},
			onDblClick : function() {
