...
phis.application.ccl.script.CheckApplyExchangedApplicationList3 = function(cfg) {
	phis.application.ccl.script.CheckApplyExchangedApplicationList3.superclass.constructor
			.apply(this, [cfg]);
}
Ext.extend(phis.application.ccl.script.CheckApplyExchangedApplicationList3,
		phis.script.SimpleList, {
			loadData : function() {
				...
				if(this.openby == "CIC"){
					...
					['and',['eq', ['$', 'b.BRID'],['l',this.opener.exContext.ids.brid]],
...
//					
					...
					this.requestData.body={
						dateFrom : dateFrom,
						dateTo : dateTo,
						zyh : this.opener.kdInfo.zyh,
						zt : zt
					}
				}
				phis.application.ccl.script.CheckApplyExchangedApplicationList3.superclass.loadData
						.call(this);
			},
			onRowClick : function(){
