...
phis.application.ccl.scriptCheckApplyModule_CIC = function(cfg) {
	phis.application.ccl.script.CheckApplyModule_CIC.superclass.constructor.apply(this,
			[cfg])
	this.zdxh = [];
	this.zdmc = [];
	this.jcbw = [];
}
Ext.extend(phis.application.ccl.script.CheckApplyModule_CIC,
