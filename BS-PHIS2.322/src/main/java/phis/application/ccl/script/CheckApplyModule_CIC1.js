...
phis.application.ccl.script.CheckApplyModule_CIC1 = function(cfg) {
	phis.application.ccl.script.CheckApplyModule_CIC1.superclass.constructor.apply(this,
			[cfg])
	this.zdxh = [];
	this.zdmc = [];
	this.jcbw = [];
}
Ext.extend(phis.application.ccl.script.CheckApplyModule_CIC1,
		phis.script.SimpleModule, {
			...
			getCheckApplyList : function() {
				...
				this.checkApplyList.brxm = this.exContext.empiData.personName
				this.checkApplyList.zdmc = this.zdmc;
				this.checkApplyList.zdys = this.mainApp.uname;
