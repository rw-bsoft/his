...
public class ChartBean 
{
 ...
 private Integer zIndex=1000; //层级
...
private Boolean isZIndex=Boolean.FALSE;
 public Boolean getIsZIndex() {
	return isZIndex;
}
public void setIsZIndex(Boolean isZIndex) {
	this.isZIndex = isZIndex;
}
