...
public abstract class BaseChart {
	 ...
	 * 
	 * <pre>
	 * setBackgroundImg(&quot;images/bg.gif&quot;)
	 * </pre>
	 * 
	 * @param fileName
	 *            文件名
	 * @throws Exception
	 */
	public void setBackgroundImg(HttpServletRequest request, String fileName)
			throws Exception {
		ImageIcon icon = new ImageIcon(request.getSession().getServletContext()
