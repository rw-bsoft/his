...
phis.application.war.script.AdditionalProjectsTabModule = function(cfg) {
	this.westWidth = cfg.westWidth || 250;
	this.showNav = true;
	this.height = 450;
	phis.application.war.script.AdditionalProjectsTabModule.superclass.constructor
			.apply(this, [cfg]);
},

Ext.extend(phis.application.war.script.AdditionalProjectsTabModule,
