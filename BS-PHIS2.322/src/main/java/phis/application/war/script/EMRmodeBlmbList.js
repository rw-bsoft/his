...
phis.application.war.script.EMRmodeBlmbList = function(cfg) {

	phis.application.war.script.EMRmodeBlmbList.superclass.constructor.apply(
			this, [cfg])
	this.autoLoadData = false;
	this.disablePagingTbr = true;
}

Ext.extend(phis.application.war.script.EMRmodeBlmbList, phis.script.SimpleList,
		{
			expansion : function(cfg) {
				...
				// radioGroup.on("change", this.doRefresh, this);
