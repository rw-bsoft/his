...
phis.application.war.script.WardAppendProjectList = function(cfg) {
	this.removeRecords = [];
	...
	phis.application.war.script.WardAppendProjectList.superclass.constructor.apply(this,
			[cfg])
	this.on("loadData", this.afterLoadData, this);
}
Ext.extend(phis.application.war.script.WardAppendProjectList, phis.script.EditorList,
		{
			initPanel : function(sc) {
				var grid = phis.application.war.script.WardAppendProjectList.superclass.initPanel
						.call(this, sc)
