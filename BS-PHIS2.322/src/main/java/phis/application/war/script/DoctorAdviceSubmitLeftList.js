...
phis.application.war.script.DoctorAdviceSubmitLeftList = function(cfg) {
	cfg.autoLoadData = false;
	cfg.disablePagingTbr = true;
	phis.application.war.script.DoctorAdviceSubmitLeftList.superclass.constructor
			.apply(this, [cfg])
}
Ext.extend(phis.application.war.script.DoctorAdviceSubmitLeftList,
		phis.script.SelectList, {
			loadData : function() {
				this.requestData.serviceId = this.serviceId;
				this.requestData.serviceAction = this.serviceAction;
				phis.application.war.script.DoctorAdviceSubmitLeftList.superclass.loadData
						.call(this);
			},
