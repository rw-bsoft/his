...
phis.application.war.script.AdditionalProjectsSubmitAxmModule = function(cfg) {
	phis.application.war.script.AdditionalProjectsSubmitAxmModule.superclass.constructor
			.apply(this, [cfg]);
}
Ext.extend(phis.application.war.script.AdditionalProjectsSubmitAxmModule,
		phis.script.SimpleModule, {
			...
			// 获取左边的list
			getLList : function() {
				this.leftList = this.createModule("leftList_axm", this.refLList);
				this.leftList.on("selectRecord",this.onSelectRecord,this);
				return this.leftList.initPanel();
			},
			// 获取右边的list
			getRList : function() {
				this.rightList = this.createModule("rightList_axm", this.refRList);
			...
			this.rightList.requestData.XMXHS=xmxhs;
