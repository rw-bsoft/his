...
phis.application.war.script.AdditionalProjectsModule = function(cfg) {
	...
	phis.application.war.script.AdditionalProjectsModule.superclass.constructor.apply(
			this, [cfg]);
	this.on("winShow", this.onWinShow, this);
	this.on("close", this.onWinClose, this);// 关闭时抛出事件
},

Ext.extend(phis.application.war.script.AdditionalProjectsModule,
