...
phis.application.war.script.MedicalExpressionForm = function(cfg) {
	cfg.colCount = 1;
	phis.application.war.script.MedicalExpressionForm.superclass.constructor.apply(this,
			[cfg]);
...
Ext.extend(phis.application.war.script.MedicalExpressionForm, phis.script.TableForm,
		{
