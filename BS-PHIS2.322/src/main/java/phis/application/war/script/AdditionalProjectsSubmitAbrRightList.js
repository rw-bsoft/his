...
phis.application.war.script.AdditionalProjectsSubmitAbrRightList = function(cfg) {
	cfg.autoLoadData = false;
	cfg.disablePagingTbr = true;
	phis.application.war.script.AdditionalProjectsSubmitAbrRightList.superclass.constructor
			.apply(this, [cfg])
	this.on("loadData", this.afterLoadDate, this);
	this.on("afterCellEdit", this.afterGridEdit, this)
}
Ext.extend(phis.application.war.script.AdditionalProjectsSubmitAbrRightList,
		phis.script.EditorList, {
			...
			loadData : function() {
				...
				phis.application.war.script.AdditionalProjectsSubmitAbrRightList.superclass.loadData
						.call(this);
			},
			...
			getCM : function(items) {
				var cm = phis.application.war.script.AdditionalProjectsSubmitAbrRightList.superclass.getCM
						.call(this, items)
