...
phis.application.war.script.AdditionalProjectsSubmitAbrLeftList = function(cfg) {
	cfg.autoLoadData = false;
	cfg.disablePagingTbr = true;
	phis.application.war.script.AdditionalProjectsSubmitAbrLeftList.superclass.constructor
			.apply(this, [cfg])
}
Ext.extend(phis.application.war.script.AdditionalProjectsSubmitAbrLeftList,
		phis.script.SelectList, {
			loadData : function() {
				this.requestData.serviceId = this.serviceId;
				this.requestData.serviceAction = this.serviceAction;
				phis.application.war.script.AdditionalProjectsSubmitAbrLeftList.superclass.loadData
						.call(this);
			},
