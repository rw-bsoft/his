...
phis.application.war.script.NurseRecordTree = function(cfg) {
	this.checkModel = 'cascade';// 'multiple':多选; 'single':单选; 'cascade':级联多选
	this.checkTree = false;// 是否构建可以选择的树
	phis.application.war.script.NurseRecordTree.superclass.constructor.apply(
			this, [cfg]);
}

Ext.extend(phis.application.war.script.NurseRecordTree,
