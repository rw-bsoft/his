...
phis.application.war.script.MedicalBackApplicationRightModule = function(cfg) {
	 this.exContext={};
	 this.width = 1024;
	this.height = 550;
	phis.application.war.script.MedicalBackApplicationRightModule.superclass.constructor.apply(
			this, [cfg]);
}
Ext.extend(phis.application.war.script.MedicalBackApplicationRightModule,
