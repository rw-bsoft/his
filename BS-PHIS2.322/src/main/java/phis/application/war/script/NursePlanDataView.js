...
phis.application.war.script.NursePlanDataView = function(cfg) {
	cfg.colCount = 1;
	// this.serverParams = {
...
//	cfg.isCombined=true;
	...
	phis.application.war.script.NursePlanDataView.superclass.constructor.apply(
			this, [cfg]);
}

Ext.extend(phis.application.war.script.NursePlanDataView,
		phis.script.TableForm, {
			onReady : function() {
				phis.application.war.script.NursePlanDataView.superclass.onReady
						.call(this);
			...
			initPanel : function(sc) {
				...
				var grid = phis.application.war.script.NursePlanDataView.superclass.initPanel
						.call(this);
				return grid;
			},
			doSave : function() {
			...
			doNodeClick : function(node) {
				this.initDataId = node.attributes.attributes.JLBH;
				this.op = "update";
				this.loadData();
			},
			/**
