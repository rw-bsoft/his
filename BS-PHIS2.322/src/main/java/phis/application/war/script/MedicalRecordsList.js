...
phis.application.war.script.MedicalRecordsList = function(cfg) {
	...
	phis.application.war.script.MedicalRecordsList.superclass.constructor
			.apply(this, [cfg]);

},

Ext.extend(phis.application.war.script.MedicalRecordsList,
