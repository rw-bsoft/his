...
phis.application.war.script.DoctorAdviceDetailList = function(cfg) {
	cfg.disablePagingTbr = true; // 分页暂时不要
	phis.application.war.script.DoctorAdviceDetailList.superclass.constructor.apply(
			this, [cfg]);
}

Ext.extend(phis.application.war.script.DoctorAdviceDetailList,
