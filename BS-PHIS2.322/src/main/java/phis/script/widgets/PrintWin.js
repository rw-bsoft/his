...
$import("app.desktop.Module","util.rmi.loadXML","phis.script.widgets.LodopFuncs","util.widgets.SpinnerField")

phis.script.widgets.PrintWin = function(cfg) {
	phis.script.widgets.PrintWin.superclass.constructor.apply(this, [cfg])
}
Ext.extend(phis.script.widgets.PrintWin, app.desktop.Module, {
	initPanel:function(){
