...
phis.script.WelcomePortal_phsa = function(cfg) {
	this.portlets = {}
	this.portletModules = {}
	this.pModules = {}
	this.cmd = "weladd"
	...
	this.actions  = [
		{text:"1格布局",iconCls:"layone",count:1,row:1},
	...
	//this.title = "我的首页"
	phis.script.WelcomePortal_phsa.superclass.constructor.apply(this,[cfg])
}
Ext.extend(phis.script.WelcomePortal_phsa, app.desktop.Module, {
...
//			  ],
    ...
    processRemove:function(panel){
    	var data = [this.appId,panel.moduleId]
    	var cmd = "remove"
    	if(this.roleModule){
    		cmd = "saveModule"   		
