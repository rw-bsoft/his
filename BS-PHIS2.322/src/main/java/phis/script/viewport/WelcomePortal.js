$package("phis.script.viewport")
$import(
          "org.ext.ux.portal.Portal",
          "app.modules.list.SimpleListView", 
          "app.modules.chart.DiggerChartView"
          )
phis.script.viewport.WelcomePortal = function(cfg) {
   this.portlets = {}
   this.portletModules = {}
   this.colCount = 2;
   this.rowCount = 3;
   this.title = "我的首页"
   phis.script.viewport.WelcomePortal.superclass.constructor.apply(this,[cfg])
}
Ext.extend(phis.script.viewport.WelcomePortal, app.desktop.Module, {
   initPanel : function() {
      if(this.portal){
          return this.portal;
      }
...
var portlets = this.portlets;
   ...
   getPortlet:function(module){
      ...
      if(module.id == 'MYPAGE03' || module.id == 'MYPAGE06'){
         bgUrl = "background:url("+ClassLoader.stylesheetHome+"phis/resources/css/app/biz/images/nav_bg_yellow.gif) repeat-x 0 0;color:#fff;";
      }else{
         bgUrl="background:url("+ClassLoader.stylesheetHome+"phis/resources/css/app/biz/images/colum_bg.gif) repeat-x left top;color:#000;";
      }
