...
phis.prints.script.AccountsDetailPrintView = function(cfg) {
	this.width = 800
	this.height = 500
	this.printurl = util.helper.Helper.getUrl();
	this.conditions = []
	phis.prints.script.AccountsDetailPrintView.superclass.constructor.apply(
			this, [cfg])
	this.title = "";
}
Ext.extend(phis.prints.script.AccountsDetailPrintView, app.desktop.Module, {
	initPanel : function() {
		this.frameId = "SimplePrint_frame_AccountsDetail";
		this.conditionFormId = "SimplePrint_form_AccountsDetail";
		this.mainFormId = "SimplePrint_mainform_AccountsDetail";
