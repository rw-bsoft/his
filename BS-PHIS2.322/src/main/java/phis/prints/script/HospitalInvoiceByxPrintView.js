...
phis.prints.script.HospitalInvoiceByxPrintView = function(cfg) {
	this.width = 800
	this.height = 500
	...
	this.conditions = []
	this.dyrq = "";
	phis.prints.script.HospitalInvoiceByxPrintView.superclass.constructor.apply(
			this, [cfg])
}
Ext.extend(phis.prints.script.HospitalInvoiceByxPrintView, app.desktop.Module, {
	initPanel : function() {
		this.frameId = "SimplePrint_frame_hospitalInvoiceByx";
		this.conditionFormId = "SimplePrint_form_hospitalInvoiceByx";
		this.mainFormId = "SimplePrint_mainform_hospitalInvoiceByx";
		var panel = new Ext.Panel({
			...
			html : "<iframe id='"
					+ this.frameId
					+ "' width='100%' height='100%' onload='simplePrintMask(\"hospitalInvoiceByx\")'></iframe>"
		})
		this.panel = panel
		return panel
	},
	...
	doPrint : function() {
		...
		var url = "";
		//url = this.printurl
			//	+ "*.print?pages=phis.prints.jrxml.HospitalInvoiceByxby&silentPrint=0"
		 var pages="phis.prints.jrxml.HospitalInvoiceByxby";
