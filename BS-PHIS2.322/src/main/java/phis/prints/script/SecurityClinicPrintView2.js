...
phis.prints.script.SecurityClinicPrintView2 = function(cfg) {
	this.width = 800
	this.height = 500
	...
	this.conditions = []
	this.dyrq = "";
	phis.prints.script.SecurityClinicPrintView2.superclass.constructor.apply(
			this, [cfg])
}
Ext.extend(phis.prints.script.SecurityClinicPrintView2, app.desktop.Module, {
	initPanel : function() {
	...
	doPrint : function() {
		...
		//		+ ".print?pages=InvoiceOfBzlbff&silentPrint=1&execJs="
			//	+ this.getExecJs() + "&fphm=" + this.fphm;
		var pages="InvoiceOfBzlbff";
