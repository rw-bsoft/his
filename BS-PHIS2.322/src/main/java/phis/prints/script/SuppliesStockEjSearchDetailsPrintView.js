...
phis.prints.script.SuppliesStockEjSearchDetailsPrintView = function(cfg) {
	this.printurl = util.helper.Helper.getUrl();
	phis.prints.script.SuppliesStockEjSearchDetailsPrintView.superclass.constructor
			.apply(this, [cfg])
}
Ext.extend(phis.prints.script.SuppliesStockEjSearchDetailsPrintView,
		app.desktop.Module, {
			initPanel : function() {
			...
			printPreview : function(btn) {
				...
				if (page == 'single') {
					//var url = this.printurl
						//	+ "*.print?pages=phis.prints.jrxml.SuppliesStockEjSearchDetails2&silentPrint=1&type="
						//	+ type + "&wzxh=" + this.requestData;
					
					var pages="phis.prints.jrxml.SuppliesStockEjSearchDetails2";
