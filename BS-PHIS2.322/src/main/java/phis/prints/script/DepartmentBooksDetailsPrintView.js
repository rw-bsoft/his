...
phis.prints.script.DepartmentBooksDetailsPrintView = function(cfg) {
	this.printurl = util.helper.Helper.getUrl();
	phis.prints.script.DepartmentBooksDetailsPrintView.superclass.constructor
			.apply(this, [ cfg ])
}
Ext
		.extend(
				phis.prints.script.DepartmentBooksDetailsPrintView,
				app.desktop.Module,
				{
					initPanel : function() {
					...
					printPreview : function(btn) {
						...
						if (page == 'single') {
							var pages="phis.prints.jrxml.DepartmentBooksDetails";
							 var url="resources/"+pages+".print?silentPrint=1&type="+ type + "&ZBLB=" + this.requestData;
							 if(type == 1){
								 var LODOP=getLodop();
