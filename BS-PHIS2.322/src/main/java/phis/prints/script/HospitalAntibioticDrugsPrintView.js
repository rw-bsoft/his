...
//抗生素开方统计
phis.prints.script.HospitalAntibioticDrugsPrintView = function(cfg) {
	this.width = 200 
	this.height = 200
	...
	this.exContext={};
	phis.prints.script.HospitalAntibioticDrugsPrintView.superclass.constructor.apply(
			this, [cfg])
}
Ext.extend(phis.prints.script.HospitalAntibioticDrugsPrintView, phis.script.SimpleModule, {
	initPanel : function() {
		this.frameId = "SimplePrint_frame_HospitalAntibioticDrugs";
		this.conditionFormId = "SimplePrint_form_HospitalAntibioticDrugs";
		this.mainFormId = "SimplePrint_mainform_HospitalAntibioticDrugs";
		...
		var panel = new Ext.Panel({
			...
			html : "<iframe id='"
					+ this.frameId
					+ "' width='100%' height='100%' onload='simplePrintMask(\"HospitalAntibioticDrugs\")'></iframe>"
		})
		this.panel = panel
		return panel
	},
	...
	doQuery : function() {
		...
		var pages="phis.prints.jrxml.HospitalAntibioticDrugs";
