...
phis.prints.script.DRCheckRegisterReqOrderPrintView = function(cfg) {
	this.printurl = util.helper.Helper.getUrl();
	phis.prints.script.DRCheckRegisterReqOrderPrintView.superclass.constructor.apply(
			this, [cfg])
}
Ext.extend(phis.prints.script.DRCheckRegisterReqOrderPrintView,
		phis.script.SimpleModule, {
			initPanel : function() {
				this.frameId = "SimplePrint_frame_phis.prints.jrxml.RegisterCheckReqOrder";
				this.conditionFormId = "SimplePrint_form_phis.prints.jrxml.RegisterCheckReqOrder";
				this.mainFormId = "SimplePrint_mainform_phis.prints.jrxml.RegisterCheckReqOrder";
				var panel = new Ext.Panel({
					...
					html : "<iframe id='"
							+ this.frameId
							+ "' width='100%' height='100%' onload='simplePrintMask(\"phis.prints.jrxml.RegisterCheckReqOrder\")'></iframe>"
				})
				this.panel = panel
			...
			onReady : function() {
				...
				var url = "resources/" + pages
						...
						+ this.zhuanzhendh;
						//alert(this.frameId)
						//alert(document.getElementById(this.frameId))
