...
phis.prints.script.FsbPaymentQueriesPrintView = function(cfg) {
	this.printurl = util.helper.Helper.getUrl();
	phis.prints.script.FsbPaymentQueriesPrintView.superclass.constructor
			.apply(this, [cfg])
}
Ext.extend(phis.prints.script.FsbPaymentQueriesPrintView,
		app.desktop.Module, {
			initPanel : function() {
			...
			printPreview : function(btn) {
				...
				var pages="phis.prints.jrxml.FsbPaymentQueries";
