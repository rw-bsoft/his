...
phis.prints.script.HospitalBedManagementPrintView = function(cfg) {
	this.printurl = util.helper.Helper.getUrl();
	phis.prints.script.HospitalBedManagementPrintView.superclass.constructor
			.apply(this, [cfg])
}
Ext.extend(phis.prints.script.HospitalBedManagementPrintView,
		app.desktop.Module, {
			initPanel : function() {
			...
			printPreview : function(btn) {
				...
				if (page == 'single') {
					var pages="phis.prints.jrxml.HospitalBedManagement";
					 var url="resources/"+pages+".print?type=" + type+ "&brch=" + this.requestData;
					 if(type == 1){
						 var LODOP=getLodop();
					...
					var pages="phis.prints.jrxml.HospitalBedManagement";
					 var url="resources/"+pages+".print?type=" + type+ "&brch=0";
					 if(type == 1){
					 var LODOP=getLodop();
						LODOP.PRINT_INIT("打印控件");
						LODOP.SET_PRINT_PAGESIZE("0","","","");
