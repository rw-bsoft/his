...
phis.prints.script.RegisterReqOrderPrintView = function(cfg) {
	this.printurl = util.helper.Helper.getUrl();
	phis.prints.script.RegisterReqOrderPrintView.superclass.constructor.apply(
			this, [cfg])
}
Ext.extend(phis.prints.script.RegisterReqOrderPrintView,
		phis.script.SimpleModule, {
			initPanel : function() {
				this.frameId = "SimplePrint_frame_phis.prints.jrxml.RegisterReqOrder";
				this.conditionFormId = "SimplePrint_form_phis.prints.jrxml.RegisterReqOrder";
				this.mainFormId = "SimplePrint_mainform_phis.prints.jrxml.RegisterReqOrder";
				var panel = new Ext.Panel({
					...
					html : "<iframe id='"
							+ this.frameId
							+ "' width='100%' height='100%' onload='simplePrintMask(\"phis.prints.jrxml.RegisterReqOrder\")'></iframe>"
				})
				this.panel = panel
