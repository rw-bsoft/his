...
phis.prints.script.StorehouseGDCPrintView = function(cfg) {
	this.printurl = util.helper.Helper.getUrl();
	phis.prints.script.StorehouseGDCPrintView.superclass.constructor.apply(
			this, [ cfg ])
}
Ext
		.extend(
				phis.prints.script.StorehouseGDCPrintView,
				app.desktop.Module,
				{
					initPanel : function() {
					...
					printPreview : function(btn) {
						...
						var url = "";
						if (page == 'single') {
							var pages = "phis.prints.jrxml.StorehouseGDC";
							url = "resources/" + pages
									+ ".print?silentPrint=0&type=" + type
									+ "&ypxh=" + this.requestData;
						} else {
							// var url = this.printurl +
							// "*.print?pages=phis.prints.jrxml.OutpatientWorkLog&silentPrint=0&type="
							// + type +
							// "&jzxh=0&kssj="+this.kssj+"&jssj="+this.jssj;
							var pages = "phis.prints.jrxml.StorehouseGDC";
							url = "resources/" + pages
									+ ".print?silentPrint=0&type=" + type
									+ "&ypxh=0";
