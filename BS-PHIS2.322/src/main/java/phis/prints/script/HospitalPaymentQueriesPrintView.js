...
phis.prints.script.HospitalPaymentQueriesPrintView = function(cfg) {
	this.printurl = util.helper.Helper.getUrl();
	phis.prints.script.HospitalPaymentQueriesPrintView.superclass.constructor
			.apply(this, [cfg])
}
Ext.extend(phis.prints.script.HospitalPaymentQueriesPrintView,
		app.desktop.Module, {
			initPanel : function() {
			...
			printPreview : function(btn) {
				...
				var pages="phis.prints.jrxml.HospitalPaymentQueries";
				var url ="resources/"+pages+".print?type="+type+"&config="+encodeURI(encodeURI(Ext.encode(printConfig)))
				 if(type == 1){
					 var LODOP=getLodop();
