...
phis.prints.script.BasicDrugUseStatistics_ZY = function(cfg) {
	this.width = 800
	this.height = 500
	...
	this.conditions = []
	this.sfrbrq = "";
	phis.prints.script.BasicDrugUseStatistics_ZY.superclass.constructor.apply(this,
			[cfg])
	Ext.apply(this, phis.script.common);
}
Ext.extend(phis.prints.script.BasicDrugUseStatistics_ZY, app.desktop.Module, {
	initPanel : function() {
		this.frameId = "SimplePrint_frame_BasicDrugUseStatistics_ZY";
		this.conditionFormId = "SimplePrint_form_BasicDrugUseStatistics_ZY";
		this.mainFormId = "SimplePrint_mainform_BasicDrugUseStatistics_ZY";
		var panel = new Ext.Panel({
			...
			html : "<iframe id='"
					+ this.frameId
					+ "' width='100%' height='100%' onload='simplePrintMask(\"BasicDrugUseStatistics_ZY\")'></iframe>"
		})
		this.panel = panel
		this.panelq = panel
...
//		var url = this.printurl + ".print?pages=AntimicrobialDrugDepartmentUseInformation";
		var pages="phis.prints.jrxml.BasicDrugUseStatistics_ZY";
...
//		var url = this.printurl + ".print?pages=AntimicrobialDrugDepartmentUseInformation";
	...
	doQueryDetil: function(ksdm){
		var module = this.createModule("ZY_BasicDrugUseStatistics",'phis.application.war.WAR/WAR/WAR72');
		module.ksdm=ksdm;
		...
		if (iframe.attachEvent) {
			iframe.attachEvent("onload", function() {
						_ctx .simplePrintMask(iframe,
										"BasicDrugUseStatistics_ZY");
					});
		} else {
			iframe.onload = function() {
				_ctx.simplePrintMask(iframe, "BasicDrugUseStatistics_ZY");
			};
		}
	},
	/**
