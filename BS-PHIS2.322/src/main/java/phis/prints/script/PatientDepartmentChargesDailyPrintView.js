...
phis.prints.script.PatientDepartmentChargesDailyPrintView = function(cfg) {
	this.width = 800
	this.height = 500
	...
	this.conditions = []
	this.jzDate = "";
	phis.prints.script.PatientDepartmentChargesDailyPrintView.superclass.constructor
	.apply(this, [cfg])
	// Ext.apply(this, phis.script.SimpleModule);
}
Ext.extend(phis.prints.script.PatientDepartmentChargesDailyPrintView,
		phis.script.SimpleModule, {
			initPanel : function() {
				this.frameId = "SimplePrint_frame_patientDepartmentChargesDaily";
				this.conditionFormId = "SimplePrint_form_patientDepartmentChargesDaily";
				this.mainFormId = "SimplePrint_mainform_patientDepartmentChargesDaily";
				var panel = new Ext.Panel({
					...
					html : "<iframe id='"
						+ this.frameId
						+ "' width='100%' height='100%' onload='simplePrintMask(\"patientDepartmentChargesDaily\")'></iframe>"
				})
				this.panel = panel
				this.panelq = panel
			...
			doPrint : function() {
				...
				var pages="phis.prints.jrxml.PatientDepartmentChargesDaily";
