...
phis.prints.script.FixedAssetsSearchPrintView = function(cfg) {
	this.printurl = util.helper.Helper.getUrl();
	phis.prints.script.FixedAssetsSearchPrintView.superclass.constructor.apply(
			this, [ cfg ])
}
Ext
		.extend(
				phis.prints.script.FixedAssetsSearchPrintView,
				app.desktop.Module,
				{
					initPanel : function() {
					...
					printPreview : function(btn) {
						...
						if (page == 'single') {
							var pages="phis.prints.jrxml.FixedAssetsSearch";
