...
//按科室界面
phis.prints.script.BasicDrugUseStatistics_ZYCF = function(cfg) {
	this.width = 800;
	this.height = 500;
	this.printurl = util.helper.Helper.getUrl();
	this.sfrbrq = "";
	phis.prints.script.BasicDrugUseStatistics_ZYCF.superclass.constructor.apply(this,
			[cfg]);
	Ext.apply(this, phis.script.common);
};
Ext.extend(phis.prints.script.BasicDrugUseStatistics_ZYCF, app.desktop.Module, {
	initPanel : function() {
		this.frameId = "SimplePrint_frame_BasicDrugUseStatistics_ZYCF";
		this.conditionFormId = "SimplePrint_form_BasicDrugUseStatistics_ZYCF";
		this.mainFormId = "SimplePrint_mainform_BasicDrugUseStatistics_ZYCF";
	...
	doPrint : function() {
		...
		this.type="1";		
		var pages="phis.prints.jrxml.BasicDrugUseStatistics_ZYCF";
				...
				if (iframe.attachEvent) {
					iframe.attachEvent("onload", function() {
								_ctx .simplePrintMask(iframe,
												"BasicDrugUseStatistics_ZYCF");
							});
				} else {
					iframe.onload = function() {
						_ctx.simplePrintMask(iframe, "BasicDrugUseStatistics_ZYCF");
					};
				}
			},
			/**
