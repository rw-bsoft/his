...
phis.prints.script.StorehouseMonthlyReportPrintView = function(cfg) {
	this.exContext = {};
	this.width = 800
	this.height = 500
	this.printurl = util.helper.Helper.getUrl();
	phis.prints.script.StorehouseMonthlyReportPrintView.superclass.constructor.apply(this, [cfg])
	// this.on("loadData",this.onLoadData,this);
}
Ext.extend(phis.prints.script.StorehouseMonthlyReportPrintView,
		app.desktop.Module, {
			initPanel : function() {
			...
			doQuery : function() {
				...
				url += "&dateFrom=" + dateFrom + "&dateTo=" + dateTo + "&zblb="
						+ zblb + "&xtsb=" + this.mainApp.storehouseId
