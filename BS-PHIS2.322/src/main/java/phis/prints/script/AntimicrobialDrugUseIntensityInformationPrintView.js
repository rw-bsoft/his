...
phis.prints.script.AntimicrobialDrugUseIntensityInformationPrintView = function(cfg) {
	this.width = 1200
	this.height = 500
	this.printurl = util.helper.Helper.getUrl();
	this.conditions = []
	this.sfrbrq = "";
	phis.prints.script.AntimicrobialDrugUseIntensityInformationPrintView.superclass.constructor.apply(this,
			[cfg])
	Ext.apply(this, phis.script.SimpleModule);
}
Ext.extend(phis.prints.script.AntimicrobialDrugUseIntensityInformationPrintView, phis.script.SimpleModule, {
	initPanel : function() {
		this.frameId = "SimplePrint_frame_AntimicrobialDrugUseIntensityInformation";
		this.conditionFormId = "SimplePrint_form_AntimicrobialDrugUseIntensityInformation";
		this.mainFormId = "SimplePrint_mainform_AntimicrobialDrugUseIntensityInformation";
	...
	doPrint : function() {
		...
		var dateTo = this.panel.getTopToolbar().items.get(3).getValue()
				.format('Y-m-d');
//		var url = this.printurl + ".print?pages=AntimicrobialDrugUseIntensityInformation";
		var pages="phis.prints.jrxml.AntimicrobialDrugUseIntensityInformation";
					...
					iframe.attachEvent("onload", function() { 
								_ctx
										.simplePrintMask(iframe,
												"AntimicrobialDrugUseIntensityInformation");
							});
				} else {
