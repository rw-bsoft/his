...
phis.prints.script.TransferAccountingPrintView = function(cfg) {
	this.exContext = {};
	this.width = 800
	this.height = 500
	this.printurl = util.helper.Helper.getUrl();
	phis.prints.script.TransferAccountingPrintView.superclass.constructor.apply(
			this, [cfg])
}
Ext.extend(phis.prints.script.TransferAccountingPrintView, app.desktop.Module, {
	initPanel : function() {
		...
		this.frameId = "SimplePrint_frame_phis.prints.jrxml.TransferAccountingServlet";
		this.conditionFormId = "SimplePrint_form_phis.prints.jrxml.TransferAccountingServlet";
		this.mainFormId = "SimplePrint_mainform_phis.prints.jrxml.TransferAccountingServlet";
		var panel = new Ext.Panel({
			...
			html : "<iframe id='"
					+ this.frameId
					+ "' width='100%' height='100%' onload='simplePrintMask(\"phis.prints.jrxml.TransferAccountingServlet\")'></iframe>"
		})
		this.panel = panel;
		return panel;
	},
	...
	doQuery : function() {
		...
		// 后台servelt
	//	var url = "*.print?pages=phis.prints.jrxml.TransferAccountingServlet&config="
		//	+ encodeURI(encodeURI(Ext.encode(printConfig)))
		//	+ "&silentPrint=1";
		var pages="phis.prints.jrxml.TransferAccountingServlet";
