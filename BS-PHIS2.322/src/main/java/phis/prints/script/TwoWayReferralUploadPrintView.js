...
phis.prints.script.TwoWayReferralUploadPrintView = function(cfg) {
	this.exContext = {};
	this.width = 800
	this.height = 500
	this.printurl = util.helper.Helper.getUrl();
	phis.prints.script.TwoWayReferralUploadPrintView.superclass.constructor.apply(
			this, [cfg])
	this.ib_ks = 1;
	this.ib_ys = 0;
	this.depValue = [];
}
Ext.extend(phis.prints.script.TwoWayReferralUploadPrintView, phis.script.SimpleModule, {
	initPanel : function() {
		this.frameId = "SimplePrint_frame_phis.prints.jrxml.TwoWayReferralUpload";
		this.conditionFormId = "SimplePrint_form_phis.prints.jrxml.TwoWayReferralUpload";
		this.mainFormId = "SimplePrint_mainform_phis.prints.jrxml.TwoWayReferralUpload";
		var panel = new Ext.Panel({
			...
			html : "<iframe id='"
					+ this.frameId
					+ "' width='100%' height='100%' onload='simplePrintMask(\"phis.prints.jrxml.TwoWayReferralUpload\")'></iframe>"
		})
		this.panel = panel
	...
	onReady : function() {
		...
		// + "&silentPrint=1";
		var pages="phis.prints.jrxml.TwoWayReferralUpload";
