...
phis.prints.script.ChargeSummaryMZPrintView = function(cfg) {
	this.width = 800
	this.height = 500
	...
	this.conditions = []
	this.dyrq = "";
	phis.prints.script.ChargeSummaryMZPrintView.superclass.constructor.apply(
			this, [cfg])
	Ext.apply(this, phis.script.SimpleModule);
}
Ext.extend(phis.prints.script.ChargeSummaryMZPrintView, app.desktop.Module, {
	initPanel : function() {
		this.frameId = "SimplePrint_frame_ChargeSummaryMZ";
		this.conditionFormId = "SimplePrint_form_ChargeSummaryMZ";
		this.mainFormId = "SimplePrint_mainform_ChargeSummaryMZ";
		var panel = new Ext.Panel({
			...
			html : "<iframe id='"
					+ this.frameId
					+ "' width='100%' height='100%' onload='simplePrintMask(\"ChargeSummaryMZ\")'></iframe>"
		})
		this.panel = panel
		return panel
	},
