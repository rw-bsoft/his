...
//按科室界面
phis.prints.script.BasicDrugUseStatistics_MZ = function(cfg) {
	this.width = 800
	this.height = 500
	this.printurl = util.helper.Helper.getUrl();
	this.sfrbrq = "";
	phis.prints.script.BasicDrugUseStatistics_MZ.superclass.constructor.apply(this,
			[cfg])
	Ext.apply(this, phis.script.common);
}
Ext.extend(phis.prints.script.BasicDrugUseStatistics_MZ, app.desktop.Module, {
	initPanel : function() {
		this.frameId = "SimplePrint_frame_BasicDrugUseStatistics_MZ";
		this.conditionFormId = "SimplePrint_form_BasicDrugUseStatistics_MZ";
		this.mainFormId = "SimplePrint_mainform_BasicDrugUseStatistics_MZ";
	...
	doPrint : function() {
		...
		this.type="1";		
		var pages="phis.prints.jrxml.BasicDrugUseStatistics_MZ";
...
//		var url = this.printurl + ".print?pages=AntimicrobialDrugDoctorUseInformation";
	...
	doQueryDetil: function(ksdm){
		var module = this.createModule("MZ_BasicDrugUseStatistics",'phis.application.war.WAR/WAR/WAR71');
		module.ksdm=ksdm;
				...
				if (iframe.attachEvent) {
					iframe.attachEvent("onload", function() {
								_ctx .simplePrintMask(iframe,
												"BasicDrugUseStatistics_MZ");
							});
				} else {
					iframe.onload = function() {
						_ctx.simplePrintMask(iframe, "BasicDrugUseStatistics_MZ");
					};
				}
			},
			/**
