...
phis.prints.script.HospiatlPatientJbflPrintView = function(cfg) {
	this.exContext = {};
	this.width = 800
	this.height = 500
	...
	phis.prints.script.HospiatlPatientJbflPrintView.superclass.constructor
			.apply(this, [cfg])
}
Ext.extend(phis.prints.script.HospiatlPatientJbflPrintView,
...
//										text : "药品类别"
			...
			doQuery : function() {
				...
				Ext.getCmp(this.mainFormId).el.mask("正在生成报表...",
						"x-mask-loading");
				var pages = "phis.prints.jrxml.HospiatlPatientJbfl";
