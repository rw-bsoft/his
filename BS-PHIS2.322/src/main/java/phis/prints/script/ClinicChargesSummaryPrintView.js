...
phis.prints.script.ClinicChargesSummaryPrintView = function(cfg) {
	this.width = 800
	this.height = 500
	...
	this.conditions = []
	this.jzDate = "";
	phis.prints.script.ClinicChargesSummaryPrintView.superclass.constructor.apply(this,
			[cfg])
}
Ext.extend(phis.prints.script.ClinicChargesSummaryPrintView, phis.script.SimpleModule,
		{
			initPanel : function() {
				this.frameId = "SimplePrint_frame_phis.prints.jrxml.ClinicChargesSummary";
				this.conditionFormId = "SimplePrint_form_phis.prints.jrxml.ClinicChargesSummary";
				this.mainFormId = "SimplePrint_mainform_phis.prints.jrxml.ClinicChargesSummary";
				var panel = new Ext.Panel({
					...
					html : "<iframe id='"
							+ this.frameId
							+ "' width='100%' height='100%' onload='simplePrintMask(\"phis.prints.jrxml.ClinicChargesSummary\")'></iframe>"
				})
				this.panel = panel
				return panel
			},
			...
			doPrint : function() {
				...
				var pages = "phis.prints.jrxml.ClinicChargesSummary";
