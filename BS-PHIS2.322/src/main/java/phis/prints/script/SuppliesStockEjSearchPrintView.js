...
phis.prints.script.SuppliesStockEjSearchPrintView = function(cfg) {
	this.printurl = util.helper.Helper.getUrl();
	phis.prints.script.SuppliesStockEjSearchPrintView.superclass.constructor
			.apply(this, [cfg])
}
Ext.extend(phis.prints.script.SuppliesStockEjSearchPrintView,
		app.desktop.Module, {
			initPanel : function() {
			...
			printPreview : function(btn) {
				...
				if (page == 'single') {
					...
					//		+ "*.print?pages=phis.prints.jrxml.SuppliesStockEjSearch2&silentPrint=1&type="
					//		+ type + "&jlxh=" + this.requestData;
					var pages="phis.prints.jrxml.SuppliesStockEjSearch2";
