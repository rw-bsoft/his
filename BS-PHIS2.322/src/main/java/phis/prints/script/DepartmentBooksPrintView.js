...
phis.prints.script.DepartmentBooksPrintView = function(cfg) {
	this.printurl = util.helper.Helper.getUrl();
	phis.prints.script.DepartmentBooksPrintView.superclass.constructor.apply(
			this, [ cfg ])
}
Ext
		.extend(
				phis.prints.script.DepartmentBooksPrintView,
				app.desktop.Module,
				{
					initPanel : function() {
					...
					printPreview : function(btn) {
						...
						if (page == 'single') {
							var pages="phis.prints.jrxml.DepartmentBooks";
