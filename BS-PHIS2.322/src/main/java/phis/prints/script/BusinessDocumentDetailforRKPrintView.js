...
phis.prints.script.BusinessDocumentDetailforRKPrintView = function(cfg) {
	this.printurl = util.helper.Helper.getUrl();
	phis.prints.script.BusinessDocumentDetailforRKPrintView.superclass.constructor
			.apply(this, [ cfg ])
}
Ext
		.extend(
				phis.prints.script.BusinessDocumentDetailforRKPrintView,
				app.desktop.Module,
				{
					initPanel : function() {
					...
					printPreview : function(btn) {
						...
						//	var url = this.printurl
							//		+ "*.print?pages=phis.prints.jrxml.BusinessDocumentDetailforRK&silentPrint=1&type="
							//		+ type;
							var pages="phis.prints.jrxml.BusinessDocumentDetailforRK";
							 var url="resources/"+pages+".print?type="+type+"&silentPrint="+1;
							printWin = window
									.open(
											url,
											"",
