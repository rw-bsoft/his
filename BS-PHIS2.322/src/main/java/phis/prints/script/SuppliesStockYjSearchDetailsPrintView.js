...
phis.prints.script.SuppliesStockYjSearchDetailsPrintView = function(cfg) {
	this.printurl = util.helper.Helper.getUrl();
	phis.prints.script.SuppliesStockYjSearchDetailsPrintView.superclass.constructor
			.apply(this, [cfg])
}
Ext.extend(phis.prints.script.SuppliesStockYjSearchDetailsPrintView,
		app.desktop.Module, {
			initPanel : function() {
			...
			printPreview : function(btn) {
				...
				if (page == 'single') {
					var pages="phis.prints.jrxml.SuppliesStockEjSearchDetails";
