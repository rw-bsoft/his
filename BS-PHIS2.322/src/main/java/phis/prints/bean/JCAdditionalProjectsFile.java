...
import phis.application.fsb.source.FamilySickBedProjectExecutionModel;
...
public class JCAdditionalProjectsFile implements IHandler{
	...
	public void getFields(Map<String, Object> request,
		...
		FamilySickBedProjectExecutionModel advice = new FamilySickBedProjectExecutionModel(dao);
		try {
