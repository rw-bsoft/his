...
public class FsbCostAccountingDetailPrint implements IHandler {
	...
	public void getParameters(Map<String, Object> request,
		...
		String sql = "SELECT b.ZYHM as ZYHM, b.BRXM as BRXM,a.JFRQ as JFRQ, to_char(a.FYRQ,'yyyy-mm-dd') as FYRQ," +
				" a.YPLX as YPLX,a.FYXH as FYXH,a.FYMC as FYMC,a.FYSL as FYSL,a.FYDJ as FYDJ,a.ZFBL as ZFBL," +
				" a.FYKS as FYKS,c.PERSONNAME as YGXM,a.JGID as JGID,a.ZJJE as ZJJE " +
				" FROM JC_FYMX  a,JC_BRRY  b ,SYS_Personnel c WHERE (a.SRGH = c.PERSONID) AND ( a.ZYH = b.ZYH )  AND ( a.JGID = b.JGID ) AND  ( a.JGID = :manaUnitId ) AND  ( a.XMLX = 4) ";
