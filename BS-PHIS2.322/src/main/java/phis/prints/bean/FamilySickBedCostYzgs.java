 ...
 * 
 */
public class FamilySickBedCostYzgs implements IHandler {
...
//		System.out.println(parameterFyhj);
		...
		sqlfyhj.append(" group by YPLX,FYXH,FYMC,FYDJ,ZFBL ");
		sqlfyhj.append(" order by KSRQ desc,YPLX, FYXH ,FYSL,FYDJ,ZFBL desc");
