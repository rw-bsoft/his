...
public class HospitalPharmacyMedicineBackHZFile implements IHandler {
	...
	public void getFields(Map<String, Object> request,
		...
		try {
			StringBuffer sqlString = new StringBuffer(
					"select a.YPGG as YPGG,a.YFDW as YPDW,sum(a.YPSL) as YPSL,a.YFSB as YFSB,a.YPXH as YPXH,d.CDMC as YPCD,b.YPMC as YPMC,b.YPSX as YPSX,a.YPDJ as YPDJ,sum(a.LSJE) as LSJE from YF_ZYFYMX a,YK_TYPK b,ZY_BRRY c,YK_CDDZ d  where a.JGID=:jgid and a.LYBQ=:bqsb and a.YPXH=b.YPXH and a.ZYH=c.ZYH and a.JGID=c.JGID and a.YPCD=d.YPCD and a.YPSL<0 ");
			...
			sqlString
					.append(" group by a.YFSB,a.YPXH,a.YPCD,d.CDMC,b.YPMC,a.YPGG,b.YPSX,a.YFDW,a.YPDJ");
	...
	public void getParameters(Map<String, Object> request,
		...
		try {
			...
			if (null != request.get("dateTo")) {
				response.put(
						"dateTo",
						sdf.format(BSHISUtil.toDate(request.get("dateTo")
								+ " 23:59:59")));
			}
			response.put("TITLE", TITLE + "病区退药明细清单汇总");
			if (bq != 0) {
				Map<String, Object> parameter = new HashMap<String, Object>();
