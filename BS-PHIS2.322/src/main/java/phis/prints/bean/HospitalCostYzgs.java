 ...
 * 
 */
public class HospitalCostYzgs implements IHandler {
...
//			System.out.println(response);
	...
	public void getFields(Map<String, Object> request,
		...
		parameterFyhj.put("ZYH",ZYH);
//		System.out.println(parameterFyhj);
		StringBuilder sqlfyhj=new StringBuilder("select  to_char(min(a.FYRQ),'yyyy-mm-dd') as KSRQ, to_char(max(a.FYRQ),'yyyy-mm-dd') as ZZRQ,");
		sqlfyhj.append(" a.YPLX as YPLX, a.FYXH as FYXH, a.FYMC as FYMC,");
		sqlfyhj.append(" sum(a.FYSL) as FYSL,a.FYDJ as FYDJ,sum(a.ZJJE) as FYJE,sum(a.ZFJE) as ZFJE,sum(a.ZLJE) as ZLJE,");
		sqlfyhj.append(" a.ZFBL as ZFBL,a.FYKS as FYKS");
		sqlfyhj.append(" from ZY_FYMX a WHERE");
		...
		sqlfyhj.append(" group by YPLX,FYXH,FYMC,FYDJ,ZFBL,FYKS ");
		sqlfyhj.append(" order by KSRQ desc,YPLX, FYXH ,FYSL,FYDJ,ZFBL,FYKS desc");
