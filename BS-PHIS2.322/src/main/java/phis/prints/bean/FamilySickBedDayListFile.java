...
public class FamilySickBedDayListFile implements IHandler {
	...
	public void getFields(Map<String, Object> request,
		...
		// +"JC_FYMX t WHERE t.ZYH =:ZYH "+sqlwhere +" ORDER BY t.FYRQ DESC ";
		String sqlsum = "select t.FYXM as FYXM,'【'||s.SFMC||'】:￥' as SFMC,sum(t.ZJJE) as ZJJE from "
				+ "JC_FYMX t,GY_SFXM s WHERE t.FYXM=s.SFXM and t.ZYH =:ZYH "
		...
		try {
			...
			String sqlSumDetails = "select '合计:' as FYMC,sum(t.FYSL) as FYSL,sum(t.ZJJE) as FYJE,sum(t.ZFJE) as ZFJE,sum(t.ZLJE) as ZLJE from "
					+ "JC_FYMX t WHERE t.ZYH =:ZYH " + sqlwhere;
	...
	public void getParameters(Map<String, Object> request,
		...
		try {
			...
			Map<String, Object> csnyMap = dao
					.doLoad("select RYNL as RYNL,BRXB as BRXB,ZSYS as ZSYS from JC_BRRY WHERE ZYH=:ZYH",
							parameters);
