...
public class DispensingDetailsFile implements IHandler {
	...
	public void getFields(Map<String, Object> request,
		...
		map_par.clear();
		hql.append("select to_char(d.KSSJ,'yyyy-MM-dd hh24:mi:ss') as KSSJ,c.BRCH as BRCH,c.BRXM as BRXM,b.YPMC as YPMC,b.YPGG as YPGG,b.YFDW as YPDW,d.YCJL as JL,e.PCMC as YF,sum(a.LSJE) as JE,sum(a.YPSL) as ZSL,a.YPDJ as YPDJ from YF_ZYFYMX a,YK_TYPK b,ZY_BRRY c,ZY_BQYZ d,GY_SYPC e where a.YPXH=b.YPXH and a.ZYH=c.ZYH and a.YZXH=d.JLXH and a.JLID=:jlid and d.SYPC=e.PCBM group by a.YPXH,a.YPCD,c.BRCH,c.BRXM,b.YPMC,b.YPGG,b.YFDW,d.YCJL,e.PCMC,d.KSSJ,a.YPDJ order by c.BRCH");
		hql_jyjz.append("select to_char(a.FYRQ,'yyyy-MM-dd hh24:mi:ss') as KSSJ,c.BRCH as BRCH,c.BRXM as BRXM,b.YPMC as YPMC,b.YPGG as YPGG,b.YFDW as YPDW,'' as JL,'' as YF,sum(a.LSJE) as JE,sum(a.YPSL) as ZSL,a.YPDJ as YPDJ from YF_ZYFYMX a,YK_TYPK b,ZY_BRRY c where a.YPXH=b.YPXH and a.ZYH=c.ZYH  and a.JLID=:jlid  group by a.YPXH,a.YPCD,c.BRCH,c.BRXM ,b.YPMC,b.YPGG,b.YFDW,a.FYRQ,a.YPDJ order by c.BRCH");
	...
	public void getParameters(Map<String, Object> request,
		...
		BaseDAO dao = new BaseDAO(ctx);
		StringBuffer hql = new StringBuffer();
		hql.append("select to_char(a.FYSJ, 'yyyy-MM-dd hh24:mi:ss') as FYSJ,a.fylx,(select fsmc from ZY_FYFS where fyfs = a.fyfs) as FSMC,c.OFFICENAME as KSMC from YF_FYJL a left join SYS_Office c on a.fybq = c.id ");
		try {
			Map<String, Object> map_par = new HashMap<String, Object>();
			map_par.clear();
			hql.append(" where a.jlid =:jlid");
			map_par.put("jlid", MedicineUtils.parseLong(request.get("JLID")));
			...
			response.put("BQ", map_fyjl.get("KSMC"));
