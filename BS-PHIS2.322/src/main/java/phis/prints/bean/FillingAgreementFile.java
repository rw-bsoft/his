...
public class FillingAgreementFile implements IHandler {
    ...
    public void getParameters(Map<String, Object> request, Map<String, Object> response, Context ctx) throws PrintException {
        ...
        if(id != null||!"null".equals(id)){
            ...
            String sql = "select a.personname as PERSONNAME, a.sex as SEX, a.age as AGE, a.diagnosis as DIAGNOSIS,a.proposed as PROPOSED,a.cost as COST,to_char(a.operationdate,'YYYY-MM-DD') as OPERATIONDATE，b.organizname as JGMC from DPC_FillingAgreement a,sys_organization b where a.createunit=b.organizcode and id='"+id+"'";
            try {
