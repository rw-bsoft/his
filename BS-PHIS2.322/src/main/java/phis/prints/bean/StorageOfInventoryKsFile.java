...
//DynamicPrint
public class StorageOfInventoryKsFile implements IHandler {
	...
	public void getFields(Map<String, Object> request,
		...
		try {
			...
			SchemaUtil.setDictionaryMassageForList(list,BSPHISEntryNames.WL_PD02 + "_KS");
		...
		for (int i = 0; i < list.size(); i++) {
			...
			m.put("PCSL", String.format("%1$.2f", m.get("PCSL")));
			records.add(m);
		}
	}
