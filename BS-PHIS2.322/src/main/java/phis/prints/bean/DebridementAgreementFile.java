...
public class DebridementAgreementFile implements IHandler {
	...
	public void getParameters(Map<String, Object> request,
		...
		if(id != null||!"null".equals(id)){
			...
			//params.put("id", id);
			String sql = "select personName as personName, sex as sex, age as age, diagnosis as diagnosis from DPC_DEBRIDEMENTAGREEMENT where id='"+id+"'";
			try {
