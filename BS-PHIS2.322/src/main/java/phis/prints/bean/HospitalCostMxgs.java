 ...
 * 
 */
public class HospitalCostMxgs implements IHandler {
...
//			System.out.println(response);
	...
	public void getFields(Map<String, Object> request,
		...
		parameterFyhj.put("ZYH",ZYH);
//		System.out.println(parameterFyhj);
		StringBuilder sqlfyhj=new StringBuilder("select a.ZYH as ZYH,to_char(a.FYRQ,'yyyy-mm-dd') as FYRQ,a.FYMC as FYMC,a.FYSL as FYSL,a.FYDJ as FYDJ,a.ZJJE as FYJE,a.ZFBL as ZFBL,a.ZFJE as ZFJE,a.FYKS as FYKS,a.SRGH as GH ");
		sqlfyhj.append(" from ZY_FYMX a WHERE ");
		try {
		if (cnd != null) {
			if (cnd.size() > 0) {
		...
		sqlfyhj.append(" order by a.FYRQ desc");
...
//			System.out.println(fyhjList.size());
//			System.out.println(parameterFyhj);
//			System.out.println(sqlfyhj.toString());
