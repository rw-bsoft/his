...
public class FixedAgreementFile implements IHandler {
    ...
    public void getParameters(Map<String, Object> request, Map<String, Object> response, Context ctx) throws PrintException {
        ...
        if(id != null||!"null".equals(id)){
            ...
            //params.put("id", id);
            //String sql = "select personName as PERSONNAME, sex as SEX, age as AGE, diagnosis as DIAGNOSIS,proposed as PROPOSED,cost as COST,to_char(operationdate,'YYYY-MM-DD') as OPERATIONDATE from DPC_FixedAgreement where id='"+id+"'";
            String sql = "select a.personname as PERSONNAME, a.sex as SEX, a.age as AGE, a.diagnosis as DIAGNOSIS,a.proposed as PROPOSED,a.cost as COST,to_char(a.operationdate,'YYYY-MM-DD') as OPERATIONDATE，b.organizname as JGMC from DPC_FixedAgreement a,sys_organization b where a.createunit=b.organizcode and id='"+id+"'";
            try {
