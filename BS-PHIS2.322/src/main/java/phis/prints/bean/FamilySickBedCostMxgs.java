 ...
 * 
 */
public class FamilySickBedCostMxgs implements IHandler {
...
//			System.out.println(response);
	...
	public void getFields(Map<String, Object> request,
		...
		//根据住院号码查询明细清单
		Map<String, Object> parameterFyhj= new HashMap<String, Object>();
		StringBuilder sqlfyhj=new StringBuilder("select a.ZYH as ZYH,to_char(a.FYRQ,'yyyy-mm-dd') as FYRQ,a.FYMC as FYMC,a.FYSL as FYSL,a.FYDJ as FYDJ,a.ZJJE as FYJE,a.ZFBL as ZFBL,a.ZFJE as ZFJE,a.SRGH as GH ");
		sqlfyhj.append(" from JC_FYMX a WHERE ");
		try {
			if (cnd != null) {
				if (cnd.size() > 0) {
