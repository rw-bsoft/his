...
public class DispensingDetailsHZFile implements IHandler {
	...
	public void getFields(Map<String, Object> request,
		...
		map_par.clear();
		hql.append("select b.YPMC as YPMC,b.YPGG as YPGG,b.YFDW as YPDW,f.cdmc as CDMC,sum(a.YPSL) as ZSL,a.LSJG as YPDJ,sum(a.LSJE) as JE from YF_ZYFYMX a,YK_TYPK b,ZY_BRRY c,ZY_BQYZ d,GY_SYPC e ,YK_CDDZ f where a.YPXH=b.YPXH and a.ZYH=c.ZYH and a.YZXH=d.JLXH and a.JLID=:jlid and d.SYPC=e.PCBM and a.ypcd=f.ypcd group by b.YPMC,b.YPGG,b.YFDW,f.cdmc,a.LSJG order by b.YPMC");
		//为啥写两遍？？？？
		hql_jyjz.append("select b.YPMC as YPMC,b.YPGG as YPGG,b.YFDW as YPDW,f.cdmc as CDMC,sum(a.YPSL) as ZSL,a.LSJG as YPDJ,sum(a.LSJE) as JE from YF_ZYFYMX a,YK_TYPK b,ZY_BRRY c,ZY_BQYZ d,GY_SYPC e ,YK_CDDZ f where a.YPXH=b.YPXH and a.ZYH=c.ZYH and a.YZXH=d.JLXH and a.JLID=:jlid and d.SYPC=e.PCBM and a.ypcd=f.ypcd group by b.YPMC,b.YPGG,b.YFDW,f.cdmc,a.LSJG order by b.YPMC");
	...
	public void getParameters(Map<String, Object> request,
		...
		try {
			...
			if (fylxint == 1) {
				...
				response.put("TITLE", UserRoleToken.getCurrent()
						.getManageUnitName() + "发药汇总清单(急诊用药)");
			} else if (fylxint == 3) {
				response.put("TITLE", UserRoleToken.getCurrent()
						.getManageUnitName() + "发药汇总清单(出院带药)");
			} else if (fylxint == 5) {
				response.put("TITLE", UserRoleToken.getCurrent()
						.getManageUnitName() + "发药汇总清单(病区退药)");
			}
