...
public class PeriodontalAgreementFile implements IHandler {
    ...
    public void getParameters(Map<String, Object> request, Map<String, Object> response, Context ctx) throws PrintException {
        ...
        if(id != null||!"null".equals(id)){
            ...
            //params.put("id", id);
            String sql = "select personName as PERSONNAME, sex as SEX, age as AGE, diagnosis as DIAGNOSIS,proposed as PROPOSED from DPC_PeriodontalAgreement where id='"+id+"'";
            try {
