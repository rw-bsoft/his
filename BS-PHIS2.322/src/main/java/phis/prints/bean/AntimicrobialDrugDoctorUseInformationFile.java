	...
	public void getParameters(Map<String, Object> request,
		...
		try {
			...
			if("1".equals(flag)){//部门
				 ...
				 hql = getSqlAndParameters_Doctor(request, JGID, parameters);	 
