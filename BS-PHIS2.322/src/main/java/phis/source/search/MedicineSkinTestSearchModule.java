...
public class MedicineSkinTestSearchModule extends AbstractSearchModule {
	/**
	 * 病人性质实现药品查询功能
	 */
	...
	public void execute(Map<String, Object> req, Map<String, Object> res,
		...
		try {
			String hql = "select DISTINCT new phis.source.bean.Medicines(a.YPXH,a.YPMC,a.YPGG,a.YPDW,a.GMYWLB,a.YYBS) from YK_TYPK a,YK_YPBM b where a.YPXH=b.YPXH and (a.PSPB=1 or a.PSPB=2) and b."
					+ SEARCH_TYPE
					+ " LIKE '"
					+ searchText
					+ "%' order by length(a.YPMC),a.YPXH";
			String hql_count = "select count(DISTINCT a.YPXH) from YK_TYPK a,YK_YPBM b where a.YPXH=b.YPXH and a.ZFPB=0 and b.BMFL=1 and (a.PSPB=1 or a.PSPB=2) and b."
