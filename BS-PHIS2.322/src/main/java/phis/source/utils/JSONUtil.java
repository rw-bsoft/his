...
public final class JSONUtil {
	...
	public static List<Map<String, Object>> ConvertObjToMapList(List<?> list) {
		List<Map<String, Object>> rt_list = new ArrayList<Map<String, Object>>();
		for (Object o : list) {
			rt_list.add(ConvertObjToMap(o));
		}
		return rt_list;
	}
	...
	public static String toJson(final Object o) {
		...
		if (o instanceof Date) // add by yangl 
		{
			return BSHISUtil.toString((Date)o);
		}
