...
package phis.source.ws.CityEhrBrowseAPIService.impl;

/*市健康档案浏览器调阅接口（统计次数）*/
public class OuterEncryServiceImplServiceLocator extends org.apache.axis.client.Service implements phis.source.ws.CityEhrBrowseAPIService.impl.OuterEncryServiceImplService {
    ...
    public phis.source.ws.CityEhrBrowseAPIService.EncryWebService getOuterEncryServiceImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public phis.source.ws.CityEhrBrowseAPIService.EncryWebService getOuterEncryServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            phis.source.ws.CityEhrBrowseAPIService.impl.OuterEncryServiceImplServiceSoapBindingStub _stub = new phis.source.ws.CityEhrBrowseAPIService.impl.OuterEncryServiceImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (phis.source.ws.CityEhrBrowseAPIService.EncryWebService.class.isAssignableFrom(serviceEndpointInterface)) {
                phis.source.ws.CityEhrBrowseAPIService.impl.OuterEncryServiceImplServiceSoapBindingStub _stub = new phis.source.ws.CityEhrBrowseAPIService.impl.OuterEncryServiceImplServiceSoapBindingStub(new java.net.URL(OuterEncryServiceImplPort_address), this);
                _stub.setPortName(getOuterEncryServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
