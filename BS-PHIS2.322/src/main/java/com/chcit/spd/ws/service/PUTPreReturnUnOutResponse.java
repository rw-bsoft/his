...
@XmlRootElement(name = "PUT_PreReturnUnOutResponse")
public class PUTPreReturnUnOutResponse {

	@XmlElementRef(name = "return", namespace = "http://service.ws.spd.chcit.com", type = JAXBElement.class)
