 ...
 *          </p>
 *          <p>
 *          <b>Note. As of ExtJS 3.3 this no longer has to be configured as a
 *          plugin of the GridPanel.</b>
 *          </p>
 *          <p>
 *          Example usage:
 *          </p>
 ...
 * </code></pre>
 * 
 * In addition to toggling a Boolean value within the record data, this class
	 ...
	 */
     processEvent : function(name, e, grid, rowIndex, colIndex){
        if (name == 'mousedown') {
            ...
            if(!grid.fireEvent("beforeCheckedit",record)){
            record.set(this.dataIndex, !record.data[this.dataIndex]); 
            record.set(this.dataIndex, !record.data[this.dataIndex]); 
           	grid.fireEvent("afterCheckedit", {id:record.data['id'],column:this.dataIndex,value:record.data[this.dataIndex]}); //fire 
            return false;
            }
            record.set(this.dataIndex, !record.data[this.dataIndex]);   
            grid.fireEvent("afterCheckedit", {id:record.data['id'],column:this.dataIndex,value:record.data[this.dataIndex]}); //fire   
