...
<entry entityName="gp.application.thr.schemas.MDC_TumourHighRiskVisitPlan" tableName="gp.application.thr.schemas.MDC_TumourHighRisk" alias="易患人群表(高危人群)">
  	<item ref="d.planId" alias="计划编号" pkey="true" display="0" queryable="true"/>
  	
	<item id="phrId" alias="档案编号" type="string" length="32" generator="assigned" queryable="true" width="160" display="3"/>
	<item id="empiId" alias="empiId" type="string" length="32" display="0"/>
	
  	<item ref="d.visitDate" alias="随访日期" display="1" queryable="true"/>
	...
	<item id="turnHighRiskDate" alias="转易患日期" type="date" defaultValue="%server.date.date" not-null="1"/>
	<item id="turnHighRiskDoctor" alias="转易患医生" type="string" length="10" not-null="1" defaultValue="%user.userId" queryable="true" width="180">
