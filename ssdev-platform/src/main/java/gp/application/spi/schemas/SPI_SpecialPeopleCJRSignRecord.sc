...
<entry entityName="gp.application.spi.schemas.SPI_SpecialPeopleCJRSignRecord" alias="特殊人群-残疾人实际签约人数">
	<item id="PHRID" alias="健康档案号" length="30" width="130" pkey="true"/>
	...
	<item id="CJRLB" alias="残障类别" type="string" length="1">
		<dic>
			<item key="1" text="肢体"/>  
			<item key="2" text="脑瘫"/>  
			<item key="3" text="智力"/> 
