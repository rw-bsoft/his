...
<entry alias="高血压档案" entityName="gp.application.hy.schemas.MDC_HypertensionRecordManage"  sort="a.createDate desc">
	...
	<item id="eateHabit" alias="饮食习惯" type="string" length="64" display="2">
