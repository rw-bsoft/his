...
<entry  alias="高血压随访" entityName="gp.application.hy.schemas.MDC_HypertensionVisit" sort="a.empiId">
	...
	<item id="visitEvaluate" alias="随访分类" type="string" length="1">
		<dic>
	...
	<item id="agencyAndDept" alias="机构及科别" type="string"/>
	<!-- 新增 -->
