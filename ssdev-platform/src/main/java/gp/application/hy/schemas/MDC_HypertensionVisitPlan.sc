...
<entry alias="高血压档案" entityName="gp.application.hy.schemas.MDC_HypertensionRecord"  sort="a.createDate desc">
	<item ref="d.planDate" display="1" />
	<item id="phrId" alias="档案编号" type="string" length="30" width="160" queryable="true" display="3"/>
