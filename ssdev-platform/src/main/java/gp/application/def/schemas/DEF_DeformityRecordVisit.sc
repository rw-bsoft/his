...
<entry entityName="gp.application.def.schemas.DEF_DeformityRecordVisit" alias="残疾人随访">
	...
	<item id="TRAININGDATE" alias="训练日期" type="date" defaultValue="%server.date.today" maxValue="%server.date.today"/>
