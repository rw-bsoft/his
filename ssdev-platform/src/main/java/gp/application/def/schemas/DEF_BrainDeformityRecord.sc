...
<entry alias="残疾人训练登记" entityName="gp.application.def.schemas.DEF_BrainDeformityRecord">
	...
	<item id="explanation" alias="需要说明的情况" length="500" colspan="3" xtype="textarea" width="200"/>
