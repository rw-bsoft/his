...
<entry entityName="gp.application.fdBase.schemas.EHR_HealthRecordVindicateRate" tableName="gp.application.hr.schemas.EHR_HealthRecord" alias="个人健康档案" sort="a.phrId desc">
	...
	<item id="familyId" alias="家庭编号" type="string" width="150" length="30"/>
	<item id="manaDoctorId" alias="家庭医生" type="string" length="20" width="150" not-null="true" queryable="true" update="false">
		<dic id="chis.dictionary.user01" render="Tree" onlySelectLeaf="true" keyNotUniquely="true"/>
	</item>
	<item id="masterFlag" alias="是否户主" type="string" display="0"  length="1">
		<dic id="chis.dictionary.yesOrNo" render="Tree"/>
	</item>
	<item id="relaCode" alias="与户主关系" type="string" length="2" display="0" colspan="2">
	...
	<item id="signFlag" alias="签约标志" display="0" type="string" length="1" defaultValue="n" canInput="true" validateOnBlur="false">
	...
	<item id="createUnit" alias="建档单位" display="0" type="string" length="20" update="false" width="180" fixed="true" defaultValue="%user.manageUnit.id">
		<dic id="chis.@manageUnit" includeParentMinLen="6" render="Tree" onlySelectLeaf="true" parentKey="%user.manageUnit.id"/>
		<set type="exp">['$','%user.manageUnit.id']</set>
	</item>
	<item id="createUser" alias="建档人" type="string" display="0" length="20" fixed="true" update="false" defaultValue="%user.userId" queryable="true">
		<dic id="chis.dictionary.user" render="Tree" onlySelectLeaf="true" parentKey="%user.manageUnit.id"/>
		<set type="exp">['$','%user.userId']</set>
	</item>
	<item id="createDate" alias="建档日期" type="datetime"  display="0" xtype="datefield" update="false" fixed="true" defaultValue="%server.date.today" queryable="true">
	...
	<item id="isDiabetes" alias="是否糖尿病" type="string" length="1" defaultValue="n" queryable="true" display="0">
		<dic id="chis.dictionary.yesOrNo"/>
	</item>
	<item id="isHypertension" alias="是否高血压" type="string" length="1" defaultValue="n" queryable="true" display="0">
		<dic id="chis.dictionary.yesOrNo"/>
	</item>
	<item ref="c.year" display="0"/>
	<relations>
		<relation type="parent" entryName="gp.application.mpi.schemas.MPI_DemographicInfo"/>
		<relation type="children" entryName="gp.application.log.schemas.LOG_EHR_VindicateNumber">
