...
<entry entityName="gp.application.fdBase.schemas.EHR_FamilyRecordContract" tableName="chis.application.fhr.schemas.EHR_FamilyRecord" alias="家庭健康档案" sort="familyId desc">
	...
	<item ref="b.FC_Sign_Flag" display="1" queryable="true"/>
	<item ref="b.FC_CreateUser" display="1" queryable="true"/>
	<item ref="b.FC_CreateUnit" display="1" queryable="true"/>
	<item ref="b.FC_CreateDate" display="1" queryable="true"/>
	
	<item id="regionCode" alias="网格地址" type="string" length="25"  display="1"
		not-null="1" queryable="true" width="200" colspan="2" anchor="100%" update="false">
		<dic id="chis.dictionary.areaGrid_family"  render="Tree" onlySelectLeaf="true"  />
	</item>
	<item id="familyAddr" alias="家庭地址" type="string" colspan="2" length="100" display="1" width="180"/>
	<item id="manaDoctorId" alias="家庭医生" type="string" length="20" not-null="1" queryable="true" update="false" >
	...
	<item id="manaUnitId" alias="管辖机构" type="string" length="20" display="0" width="180" not-null="1" queryable="true" fixed="true">
		<dic id="chis.@manageUnit" includeParentMinLen="6" sliceType = "3" render="Tree" onlySelectLeaf="true"/>
	</item>
	<item id="familyHome" alias="家庭电话" type="string" length="20" queryable="true" display="0" />
	...
	<item id="createUnit" alias="建档单位" type="string" length="20" update="false" display="0"
		width="180"  fixed="true" defaultValue="%user.manageUnit.id">
		<dic id="chis.@manageUnit" includeParentMinLen="6"  render="Tree" onlySelectLeaf="true" parentKey="%user.manageUnit.id"/>
		<set type="exp">['$','%user.manageUnit.id']</set>
	</item>
	<item id="createUser" alias="建档人" type="string" length="20" update="false" display="0"
		fixed="true" defaultValue="%user.userId" queryable="true">
		<dic id="chis.dictionary.user" render="Tree" onlySelectLeaf="true" parentKey="%user.manageUnit.id"/>
		<set type="exp">['$','%user.userId']</set>
	</item>
	<item id="createDate" alias="建档日期" type="datetime"  display="0" xtype="datefield" fixed="true" defaultValue="%server.date.today" queryable="true" update="false">
	...
	<relations>
		<relation type="children" entryName="chis.application.fhr.schemas.EHR_FamilyContractBase">
			<join parent = "familyId" child = "F_Id" />
		</relation>
	</relations>
</entry>