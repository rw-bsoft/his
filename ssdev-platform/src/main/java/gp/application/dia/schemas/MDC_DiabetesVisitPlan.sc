...
<entry entityName="gp.application.dia.schemas.MDC_DiabetesRecord" alias="糖尿病档案" sort="a.createDate desc" version="1332292315384" filename="D:\Program Files\eclipse3.6\workspace\BSCHIS22\WebRoot\WEB-INF\config\schema\mdc/MDC_DiabetesRecord.xml">
	<item ref="d.planDate" display="1" />
	<item id="phrId" alias="档案编号" type="string" length="30" width="165" queryable="true" fixed="true"/>
