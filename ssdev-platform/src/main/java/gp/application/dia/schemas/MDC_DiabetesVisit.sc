...
<entry entityName="gp.application.dia.schemas.MDC_DiabetesVisit" alias="糖尿病随访" version="1344848127031" filename="D:\workspace\BSCHIS\WebRoot\WEB-INF\config\schema\mdc/MDC_DiabetesVisit.xml"> 
	...
	<item id="nextDate" alias="下次预约时间" type="date" not-null="0"/>  
	...
	<item id="smokeCount" alias="日吸烟量(支)" type="int" length="3" not-null="1"/>  
	<item id="targetSmokeCount" alias="目标量(支)" type="int" length="3"/>  
	<item id="drinkTypeCode" alias="饮酒种类" type="string" display="2" length="20" not-null="1"> 
		<dic id="chis.dictionary.drinkTypeCode" render="LovCombo"/> 
	</item>  
	<item id="drinkCount" alias="日饮酒量(两)" type="int" length="3" not-null="1" enableKeyEvents="true"/>  
	<item id="targetDrinkCount" alias="目标量(两)" type="int" length="3"/>  
	<item id="trainTimesWeek" alias="周运动次数" type="int" length="2" not-null="1"/>  
	<item id="targetTrainTimesWeek" alias="目标运动次数" type="int" length="3"/>  
	<item id="trainMinute" alias="每次时长(分)" type="int" length="3" not-null="1"/>  
	<item id="targetTrainMinute" alias="目标时长(分)" type="int" length="3"/>  
	...
	<item id="food" alias="主食(克/天)" type="int" length="3" not-null="1"/>  
	<item id="targetFood" alias="目标(克/天)" type="int" length="3"/>  
	...
	<item id="testDate" alias="检查日期" type="date" colspan="2"/>  
	...
	<item id="complicationChange" alias="并发症变化" type="string" length="10" display="2"> 
		<dic render="LovCombo"> 
   ...
   <item id="temperature" alias="体温" type="string" length="10" />
	...
	<item ref="e.status" display="0"/>  
	<item ref="e.manaDoctorId" display="0" queryable="true"/>  
	...
	<relations> 
		...
		<relation type="children" entryName="gp.application.dia.schemas.MDC_DiabetesRecord"> 
			<join parent="phrId" child="phrId"/> 
		</relation> 
	</relations> 
</entry>
