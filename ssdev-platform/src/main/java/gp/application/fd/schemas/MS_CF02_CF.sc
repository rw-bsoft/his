...
<entry entityName="MS_CF02_CF" tableName="MS_CF02" alias="药品信息" version="1331024845687" sort="YPZH,SBXH">
	<!-- 药品基本信息 -->
	...
	<item id="YCJL" alias="剂量" width="60" type="double" precision="3" max="9999999.999"
		not-null="true" />
	...
	<item id="YPDJ" width="70" type="double" alias="单价" precision="4" fixed="true"/>
