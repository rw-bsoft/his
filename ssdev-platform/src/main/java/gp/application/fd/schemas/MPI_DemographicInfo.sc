...
<entry entityName="gp.application.mpi.schemas.MPI_DemographicInfo" alias="EMPI个人基本信息" sort=" createTime desc" version="1332124044000" filename="E:\MyProject\BZWorkspace\BSgp\WebRoot\WEB-INF\config\schema\mpi/MPI_DemographicInfo.xml">
	...
	<item id="nationalityCode" alias="国籍" type="string" length="3" defaultValue="CN">
		<dic id="gp.dictionary.nationality"/>
	</item>
