...
<role id="phis.50" name="全科门诊医生角色" parent="base" pageCount="4" version="1565095213108">
  <accredit>
    <apps>
      ...
      <app id="phis.application.menu.QKZL">
        ...
        <catagory id="REG">
          ...
          <module id="REG0108">
            <action id="readcard"/>
            <action id="readsmcard"/>
            <action id="save"/>
            <action id="readcard_hh"/>
          </module>
          <module id="REG0109">
            <action id="save"/>
          </module>
        ...
        <catagory id="IVC">
          ...
          <module id="IVC050202"/>
          <module id="IVC06">
            <action id="ChargesSummary"/>
            <action id="ChargesSummarySearch"/>
            <action id="ItemizeSummary"/>
            <action id="OutstandingChargesSummary"/>
            <action id="ClinicCompensateSummary"/>
            <action id="ClinicCompensateSummaryjm"/>
          </module>
          <module id="IVC06_1"/>
          <module id="IVC06_1_1"/>
          <module id="IVC06_2"/>
      ...
      <app id="phis.application.menu.TJFX">
        ...
        <catagory id="STO">
          ...
          <module id="STO18010101">
            <others/>
          </module>
          <module id="STO18010102">
            <others/>
          </module>
          <module id="STO180102">
            <others/>
          </module>
          <module id="STO18010201">
            <others/>
          </module>
          <module id="STO18010202">
            <others/>
          </module>
          <module id="STO19">
            <others/>
      ...
      <!--<module id="DR01">
        ...
        <catagory id="HY">
          ...
          <module id="C20-2">
            <action id="HypertensionSimilarityCheckForm"/>
            <action id="HypertensionSimilarityCheckList"/>
          </module>
          <module id="C20-2-1">
            <action id="save"/>
            <action id="confirm"/>
      ...
      <app id="chis.application.tcm.TCM">
        <catagory id="TCM">
          <others/>
        </catagory>
      </app>
      <app id="phis.application.xnh.XNH">
        <catagory id="XNH">
          <module id="XNH04">
            <others/>
          </module>
    ...
    <storage acType="whitelist"> 
      ...
      <store id="phis.application.sto.schemas.YK_YPXX" acValue="1111"> 
        <conditions> 
          <condition type="filter">['eq',['$','a.YKSB'],["$",'%user.properties.storehouseId']]</condition> 
        </conditions>  
        <items> 
          <others acValue="1111"/> 
        </items> 
      ...
      <store id="phis.application.sto.schemas.YK_CDXX_JGGL" acValue="1111"> 
        <conditions> 
          <condition type="filter">['and',['eq',['$','a.JGID'],["$",'%user.manageUnit.id']],['eq',['$','d.YKSB'],["$",'%user.properties.storehouseId']]]</condition> 
        </conditions>  
        <items> 
          <others acValue="1111"/> 
        </items> 
