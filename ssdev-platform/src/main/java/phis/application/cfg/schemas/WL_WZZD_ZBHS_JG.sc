...
<entry id="WL_WZZD_ZBHS_JG" tableName="WL_WZZD" alias="物资字典(WL_WZZD)">
	...
	<item id="GCSL" alias="高储数量" type="double" length="12" precision="2" display="2"/>
	<item id="DCSL" alias="低储数量" type="double" length="12" precision="2" display="2"/>
	...
	<item id="GLKF" alias="管理库房" type="int" length="8" display="2">
