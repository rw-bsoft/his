...
<entry entityName="GY_YLSF" alias="医疗收费" sort="PYDM">
	...
	<item id="FYDW" alias="单位" type="string" length="16"/>
	<item id="PYDM" alias="拼音码" type="string" length="50" target="FYMC" codeType="py" queryable="true" />
	...
	<item id="WBDM" alias="五笔代码" display="2" type="string" length="50" target="FYMC" codeType="wb"/>
	<item id="JXDM" alias="角形代码" display="2" type="string" length="50" target="FYMC" codeType="jx"/>
	<item id="BHDM" alias="笔画代码" display="2" type="string" length="50" target="FYMC" codeType="bh"/>
	<item id="QTDM" alias="其他代码" display="2" type="string" length="50"/>
	...
	<item id="JCDL" alias="检查大类" type="string" length="2">
		<dic>
			<item key="01" text="超声类" />
			<item key="02" text="放射类" />
		</dic>
	</item>
	<item id="ZYCJGB" alias="中医创建归并" type="string" length="1" width="150">
		<dic id="phis.dictionary.ZYCJGB" autoLoad="true"></dic>
	</item>	
	<item id="WJBM" alias="物价编码"  type="string" length="20" />
	<item id="ZYZLF" alias="中医治疗费" type="string" length="1" width="150">
