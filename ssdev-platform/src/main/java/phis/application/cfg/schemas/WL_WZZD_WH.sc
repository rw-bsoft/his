...
<entry id="WL_WZZD_WH" tableName="WL_WZZD" alias="物资字典">
	...
	<item id="GLKF" alias="管理库房" type="int" length="8" >
		<dic id="phis.dictionary.treasury_glkf"  filter="['eq',['$map',['s','JGID']],['$','%user.manageUnit.id']]" autoLoad="true" />
	</item>
	...
	<item id="ZDXH" virtual="true" alias="字典序号" length="20" display="0"/>
</entry>
