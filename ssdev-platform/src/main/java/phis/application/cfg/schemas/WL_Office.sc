...
<entry id="WL_Office" tableName="SYS_Office" alias="机构报表">
	<item id="ID" alias="编号" type="long" pkey="true" keyGenerator="auto" length="50" display="0"/>
	<item id="OFFICECODE" alias="科室代码" type="string" width="100" update="false" not-null="1" length="50"/>
	<item id="OFFICENAME" alias="科室名称" type="string" colspan="1" width="120" not-null="1" length="50"/>
