...
<entry id="WL_CSKC_KSZY" tableName="WL_CSKC" alias="初始库存">
	...
	<item id="KSDM" alias="在用科室" type="long" length="18">
		<dic id="phis.dictionary.department" autoLoad="true" filter="['eq',['$','item.properties.ORGANIZCODE'],['$','%user.manageUnit.ref']]" searchField="PYCODE"/>
	</item>
