...
<entry entityName="GY_FKFS_ZY" tableName="GY_FKFS" alias="付款方式">
	...
	<item id="SYLX" alias="使用类型" display="2" defaultValue="2" not-null="1" length="6" fixed="true">
		<dic id="phis.dictionary.typeOfUse"/>
	</item>
	<item id="FKLB" alias="付款类别" length="18" not-null="1" defaultValue="1">
		<dic id="phis.dictionary.payCategoryZy"/>
	</item>
