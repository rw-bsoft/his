...
<entry entityName="EMR_GRCY" alias="个人常用诊断">
	...
	<item id="MSZD" alias="诊断名称" type="string" length="100" width="200"/>
	<item id="FJBS_text" alias="疾病部位/中医证候" virtual="true" display="0"/>
	<item id="FJBS" alias="疾病部位/中医证候" type="long" length="9" display="0"/>
