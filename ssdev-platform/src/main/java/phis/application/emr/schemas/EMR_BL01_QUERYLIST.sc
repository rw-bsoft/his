...
<entry alias="病历01表" entityName="EMR_BL01">
	...
	<item id="CJKS" alias="书写科室" length="10" queryable="true">
	...
	<item id="BRBQ" alias="病人病区" type="long" length="18"  queryable="true">
	...
	<item id="SSYS" alias="所属医生" length="8" queryable="true">
		<dic id="phis.dictionary.doctor" filter="['eq',['$','item.properties.ORGANIZCODE'],['$','%user.manageUnit.ref']]" sliceType="1"/>
	</item>
