...
<entry entityName="EMR_HLJH" tableName="EMR_HLJH" alias="护理计划表" sort="JLBH asc">
	...
	<item id="JGID" alias="机构id" type="string" length="20" display="0" defaultValue="%user.manageUnit.ref" not-null="1"/>
</entry>
