...
<entry entityName="EMR_ZYZDJL" alias="住院患者诊断记录">
	...
	<item id="ZZBZ" alias="主" type="int" width="30" length="1" renderer="onRenderer" fixed="true"/>
	...
	<item id="JBBW_FJBS" alias="疾病部位/中医证候" type="long" length="18" width="120" mode="remote"/>
	<item id="JBBW_text" alias="疾病部位"  display="0"/>
	<item id="JBBW" alias="疾病部位" type="long" length="18" display="0">
		<dic id="phis.dictionary.clinicSite" autoLoad="true"/>
	</item>
	<item id="FJBS_text" alias="中医证候"  display="0"/>
	<item id="FJBS" alias="中医证候ID" type="long" length="18" display="0">
		<dic id="phis.dictionary.TcmSymptoms" autoLoad="true"/>
	</item>
	<item id="ZDYS" alias="诊断医生" type="string" length="10" defaultValue="%user.userId">
		<dic autoLoad="true" id="phis.dictionary.user06"  sliceType="1" filter="['eq',['$','item.properties.manageUnit'],['$','%user.manageUnit.id']]"/>
	</item>
