...
<entry entityName="V_EMR_BLMB" alias="病历模版表">
	...
	<item ref="d.ID" alias="科室模板订阅ID" display="0"/>
	<relations>
		<relation type="child" entryName="phis.application.emr.schemas.EMR_KBM_BLLB" >
			<join parent="MBLB" child="LBBH"></join>
		</relation>
		<relation type="child" entryName="phis.application.emr.schemas.EMR_ZKFL" >
			<join parent="SSZK" child="ZKFL"></join>
		</relation>
		<relation type="child" entryName="phis.application.emr.schemas.EMR_KSMBDY" >
			<join parent="MBBH" child="TEMPLATE_ID"></join>
		</relation>
	</relations>
</entry>
