...
<entry id="WL_CK01_FOR_CKMX" tableName="WL_CK01" alias="出库单据(WL_CK01)">
    ...
    <item id="LZFS" alias="流转方式" type="long" length="12" readOnly="true">
        <dic id="phis.dictionary.transfermodes" filter = "['and',['or',['eq',['$','item.properties.DJLX'],['s','SL']],['eq',['$','item.properties.DJLX'],['s','CK']]],['eq',['$','item.properties.KFXH'],['$','%user.properties.treasuryId']]]" autoLoad="true">
        </dic>  
    </item>
    ...
    <item id="SLGH" alias="申领人员" length="10" display="1">
        <dic id="phis.dictionary.doctor" filter = "['eq',['$','item.properties.JGID'],['$','%user.manageUnit.id']]" autoLoad="true" searchField="PYDM">
        </dic>
    </item>
