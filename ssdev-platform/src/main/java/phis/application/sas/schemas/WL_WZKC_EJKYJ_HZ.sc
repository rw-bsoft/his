...
<entry id="WL_WZKC_YJKEJ_HZ" tableName="WL_WZKC"  alias="物资库存(WL_WZKC)">
	...
	<item id="KFXH" alias="所属库房" type="int" length="8" display="0" not-null="true" queryable="true">
        <dic id="phis.dictionary.treasury"  filter="['and',['eq',['$','item.properties.JGID'],['$','%user.manageUnit.id']],['eq',['$','item.properties.EJKF'],['$','null']]]" autoLoad="true" />
    </item>
	<item id="WZXH" alias="物资序号" type="long" length="18" display="0" />
	<item id="CJXH" alias="厂家序号" type="long" length="12" display="0"/>
	<item id="WZMC" alias="物资名称" virtual="true" length="60" queryable="true" width="150"/>
	...
	<item id="WZJG" alias="物资价格" type="double" length="18" display="0" precision="4" width="100"/>
