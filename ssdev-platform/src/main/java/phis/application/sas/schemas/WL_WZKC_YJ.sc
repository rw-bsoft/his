...
<entry id="WL_WZKC_YJ" tableName="WL_WZKC"  alias="物资库存(WL_WZKC)">
    ...
    <item id="YKSL" alias="预扣数量" type="double" length="18" precision="2" defaultValue="0" display="0"/>
	...
	<item ref="b.SXYJ" alias="失效预警" length="60"/>
    ...
    <relations>
	  <relation type="child" entryName="phis.application.sas.schemas.WL_WZZD_forYJ" >
