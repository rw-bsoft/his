...
<entry id="WL_CK01_FOR_EJCX" tableName="WL_CK01" alias="出库单据(WL_CK01)">
    ...
    <item id="LZFS" alias="流转方式" type="long" length="12" readOnly="true">
        <dic id="phis.dictionary.transfermodes" filter = "['and',['eq',['$','item.properties.KFXH'],['$','%user.properties.treasuryId']],['eq',['$','item.properties.DJLX'],['s','CK']]]" autoLoad="true">
        </dic>  
    </item>
