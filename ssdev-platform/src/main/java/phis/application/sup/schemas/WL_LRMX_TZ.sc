...
<entry id="WL_LRMX_TZ" tableName="WL_LRMX" alias="盘点录入明细(WL_LRMX)">
	...
	<item id="WZBH" alias="资产编号"  type="long" fixed="true" virtual="true" length="18"/>
	...
	<item id="WZJG" alias="物资价格" type="double" display="0" length="18" precision="4"/>
	...
	<item id="KCSL" alias="库存数量" type="double" display="0" length="18" precision="2"/>
	<item id="PCSL" alias="盘点数量" type="double" display="0" length="18" precision="2"/>
	<item id="PCJE" alias="盘存金额" type="double" display="0" length="18" precision="4"/>
	...
	<item id="PDBZ" alias="是否存在" type="int" length="1">
