...
<entry entityName="WL_WXBG" alias="维修报告(WL_WXBG)">
	...
	<item id="JJCD" alias="紧急程度" type="int" length="1">
		<dic>
			<item key="1" text="一般"/>
			<item key="2" text="紧急"/>
		</dic>
	</item>
	<item id="GZXZ" alias="工作性质" length="200"/>
	<item id="GZXX" alias="故障现象" length="200"/>
	<item id="GZYY" alias="故障原因" length="200"/>
	<item id="GZNR" alias="工作内容" length="200"/>
	...
	<item id="WXLB" alias="维修类别"  type="int"  length="1">
		<dic>
			<item key="1" text="内维修"/>
			<item key="2" text="外维修"/>
		</dic>
	</item>
	<item id="KFXH" alias="维修库房" type="int"  length="12">
	...
	<item id="WXSJ" alias="维修时间" length="8" type="double" precision="2"/>
	<item id="WXFY" alias="维修费用"  type="double"  length="18" precision="4"/>
	...
	<item id="TJRQ" alias="提交日期" type="date"/>
	...
	<item id="YSGH" alias="验收人员" length="10">
		<dic id="phis.dictionary.wzdoctor_yjqx" defaultIndex="0" filter = "['eq',['$','item.properties.ORGANIZCODE'],['$','%user.manageUnit.ref']]" autoLoad="true" searchField="PYDM">
		</dic>
	</item>
	<item id="YSRQ" alias="验收日期" type="date"/>
	...
	<item id="WXZT" alias="维修状态" type="int" length="1">
		<dic id="phis.dictionary.repairStatus" autoLoad="true"/>
	</item>
	<item id="GLXH" alias="关联序号" type="long" length="18" display="0"/>
	<item id="GLLB" alias="关联类别" type="int" length="1" display="0"/>
	<item id="BZXX" alias="备注信息" length="200"/>
	<item id="JSCD" alias="及时程度" type="int" length="1">
		<dic>
	...
	<item id="MYCD" alias="满意程度" type="int" length="1">
		<dic>
