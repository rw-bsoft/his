...
<entry id="phis.application.sup.schemas.WL_RK01_FORM" tableName="WL_RK01" alias="入库单据(WL_RK01)">
	...
	<item id="DWMC" alias="供货单位" length="100"  type="string"  mode="remote"/>
	...
	<item id="JBGH" alias="经办人" length="10" defaultValue="%user.userId">
		<dic id="phis.dictionary.doctor" filter ="['and',['eq',['$','item.properties.ORGANIZCODE'],['$','%user.manageUnit.ref']],['ne',['$','item.properties.LOGOFF'],['s','1']]]"> 
		</dic>
	</item>
