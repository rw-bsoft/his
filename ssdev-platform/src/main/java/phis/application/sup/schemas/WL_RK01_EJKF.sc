...
<entry id="phis.application.sup.schemas.WL_RK01_EJKF" alias="入库单据(WL_RK01)" tableName="WL_RK01" sort="DJXH desc">
    ...
    <item id="DWXH" alias="供货单位" type="long" length="12" display="0">
        <dic id="phis.dictionary.supplyUnit" filter="['eq',['$',['s','KFXH']],['$','%user.properties.treasuryId']]" autoLoad="true">
        </dic> 
    </item>
