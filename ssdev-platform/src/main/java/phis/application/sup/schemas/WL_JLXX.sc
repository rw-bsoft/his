...
<entry entityName="WL_JLXX" alias="计量信息(WL_JLXX)">
	...
	<item id="JLBH" alias="计量编号" type="string" length="12" width="120"/>
	...
	<item id="CJXH" alias="生产厂家" type="long" length="12" display="0"/>
	<item id="KSDM" alias="科室代码" length="18" type="long" display="0"/>
	<item id="KSMC" alias="在用科室" type="string" length="60" width="150" />
	<item id="DWXH" alias="供货单位" type="long" length="12" display="0"/>
	<item id="CCBH" alias="出厂编号" type="string" length="50" display="0"/>
	<item id="WZDW" alias="计量单位" type="string" length="10" display="0"/>
	<item id="WZDJ" alias="物资单价" length="18" precision="4" type="double" display="0"/>
	<item id="GRRQ" alias="购入日期" type="date" display="0"/>
	<item id="GRGH" alias="购入人" type="string" length="10" display="0"/>
	<item id="JLQJFL" alias="计量器具分类" length="2" type="int" width="100">
	...
	<item id="QJBZ" alias="强检标志" length="1" type="int" >
		<dic>
            <item key="0" text="不强检"/>
            <item key="1" text="强检"/>
        </dic>
