...
<entry entityName="WL_CK01_EJKF" tableName="WL_CK01" alias="出库单据(WL_CK01)">
	...
	<item id="LZDH" alias="流转单号" type="string" length="30" display="1" width="128"/>
	<item id="LZFS" alias="流转方式" type="long" length="12" readOnly="true">
		<dic id="phis.dictionary.transfermodes" filter = "['and',['and',['eq',['$','item.properties.KFXH'],['$','%user.properties.treasuryId']],['eq',['$','item.properties.DJLX'],['s','CK']]],['eq',['$','item.properties.YWLB'],['i',-1]]]" autoLoad="true">
		</dic>  
	</item>
	...
	<item id="BRXM" alias="病人姓名" type="string" length="30" virtual="true" queryable="true"/>
	<item id="BRLY" alias="病人来源" type="string" length="10" virtual="true" queryable="true">
		<dic>
			<item key="1" text="门诊"/>
			<item key="2" text="住院"/>
		</dic>
	...
	<item id="SLGH" alias="申领人员" length="10" display="1">
		<dic id="phis.dictionary.doctor" filter = "['eq',['$','item.properties.ORGANIZCODE'],['$','%user.manageUnit.ref']]" autoLoad="true" searchField="PYCODE">
		</dic>
	</item>
	...
	<item id="DJBZ" alias="单据备注" length="160" width="260"/>
