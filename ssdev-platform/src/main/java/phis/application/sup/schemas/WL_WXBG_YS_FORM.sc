...
<entry id="WL_WXBG_YS_FORM" tableName="WL_WXBG" alias="维修报告(WL_WXBG)">
	...
	<item id="JSCD" alias="及时程度" not-null="1" defaultValue="5" length="1">
		<dic>
	...
	<item id="MYCD" alias="满意程度" not-null="1" defaultValue="5" length="1">
		<dic>
