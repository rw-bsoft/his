...
<entry entityName="WL_CK02_DBGL" tableName="WL_CK02" alias="出库明细(WL_CK02)">
	...
	<item id="WZMC" alias="物资名称" fixed="true" width="200" mode="remote" virtual="true"/>
	<item id="WZGG" alias="物资规格" fixed="true" width="120" virtual="true"/>
	<item id="WZDW" alias="物资单位" fixed="true" virtual="true"/>
	<item id="GLFS" fixed="true" display="0" virtual="true"/>
	...
	<item id="WZSL" alias="调拨数量" type="double" fixed="true" length="18" precision="2"/>
