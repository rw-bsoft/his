...
<entry id="WL_WXBG_BG" tableName="WL_WXBG" alias="维修报告(WL_WXBG)">
	...
	<item id="WXBH" alias="维修编号" length="20" width="120"/>
	<item id="FZGH" alias="维修负责人" length="10">
	...
	<item id="LXDH" alias="联系电话" length="20" display="0"/>
