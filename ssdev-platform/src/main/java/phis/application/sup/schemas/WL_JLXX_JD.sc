...
<entry id="WL_JLXX_JD" tableName="WL_JLXX" alias="计量信息(WL_JLXX)">
	...
	<item id="JLBH" alias="计量编号" width="120" length="12" />
	...
	<item id="KSMC" alias="在用科室" length="60" width="150" />
	...
	<item id="JLQJFL" alias="计量器具分类" length="2" width="100" type="int">
		<dic id="phis.dictionary.jlqjfl">
		</dic>
	</item>
	<item id="JLLB" alias="计量类别" length="1">
	...
	<item id="XCJD" alias="下次检定" type="date" />
