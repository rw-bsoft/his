...
<entry id="WL_WZZD_SBWX" tableName="WL_WZZD" alias="物资字典(WL_WZZD)">
	<item id="WZXH" alias="物资序号" type="long" length="18" not-null="1"
		display="0" generator="assigned" pkey="true">
		<key>
			<rule name="increaseId" defaultFill="0" type="increase"
				startPos="1" />
		</key>
	</item>
	...
	<item id="FLXH" alias="分类序号" type="long" virtual="true" length="8"
		display="0" />
	<item id="LBXH" alias="类别序号" type="long" virtual="true" length="8"
		display="0" />
	<item id="ZDXH" alias="诊断序号" type="long" virtual="true" length="8"
		display="0" />
	...
	<item id="WZGG" alias="物资规格" length="40" readOnly="true" />
	<item id="WZDW" alias="物资单位" length="10" readOnly="true" />
	<item id="PYDM" alias="拼音代码" display="0" length="10" />
