...
<entry entityName="WL_PD01_FORM" tableName="WL_PD01" alias="盘点单据(WL_PD01)">
	...
	<item id="FSMC" alias="方式名称" type="string" fixed="true" defaultValue="库存管理" virtual="true"/>
	<item id="GLFS" alias="盘点方式" type="string" display="0"  defaultValue="1"/>
	<item id="LZDH" alias="流转单号" type="string" length="30" display="0"/>
	<item id="DJZT" alias="单据状态" type="int" display="0" length="1"/>
	<item id="ZDGH" alias="制单人员" type="string" length="10"  fixed="true">
		<dic id="phis.dictionary.doctor" autoLoad="true"/>	
	</item>
	<item id="ZDRQ" alias="制单日期" type="date" display="0"/>
	<item id="SHGH" alias="审核人员" type="string" length="10"  fixed="true">
		<dic id="phis.dictionary.doctor" autoLoad="true"/>	
	</item>
	<item id="SHRQ" alias="审核日期" type="date" display="0"/>
	<item id="JZGH" alias="记帐人员" type="string" length="10"  fixed="true">
		<dic id="phis.dictionary.doctor" autoLoad="true"/>	
	</item>
	<item id="JZRQ" alias="记帐日期" type="date" display="0"/>
	<item id="DJBZ" alias="单据备注" type="string" length="160"/>
</entry>
