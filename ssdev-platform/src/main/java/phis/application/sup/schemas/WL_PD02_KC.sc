...
<entry entityName="WL_PD02_KC" tableName="WL_PD02" alias="盘点明细(WL_PD02)">
	...
	<item id="CJMC" alias="生产厂家" type="string" virtual="true" fixed="true" length="1" width="160" not-null="true"/>
	<item id="WZPH" alias="物资批号" type="string" length="20" fixed="true"/>
