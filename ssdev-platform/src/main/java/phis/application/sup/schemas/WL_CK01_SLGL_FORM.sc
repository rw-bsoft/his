...
<entry id="phis.application.sup.schemas.WL_CK01_SLGL_FORM" tableName="WL_CK01" alias="出库单据(WL_CK01)">
	...
	<item id="LZFS" alias="流转方式" type="long" length="12" not-null="1">
		<dic id="phis.dictionary.transfermodes" defaultIndex="0"
			...
			['eq',['$','item.properties.DJLX'],['s','SL']]],
			['eq',['$','item.properties.YWLB'],['i',-1]]],
			['eq',['$','item.properties.FSZT'],['i',1]]]" 
			autoLoad="true" />
	</item>
	<item id="CKRQ" alias="领用日期" type="date" not-null="1" defaultValue="%server.date.date"/>
	<item id="JBGH" alias="领用人员" length="10" defaultValue="%user.userId">
	...
	<item id="SLGH" alias="领用人员" length="10" display="0" defaultValue="%user.userId">
		<dic id="phis.dictionary.doctor" filter = "['and',['eq',['$','item.properties.ORGANIZCODE'],['$','%user.manageUnit.ref']],['ne',['$','item.properties.LOGOFF'],['s','1']]]" autoLoad="true" searchField="PYCODE">
		</dic>
	</item>
