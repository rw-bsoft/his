...
<entry id="phis.application.sup.schemas.WL_CK01_FORM_XHMX" tableName="WL_CK01" alias="出库单据(WL_CK01)">
	...
	<item id="LZFS" alias="流转方式" type="long" length="12" not-null="1">
		<dic id="transfermodes" autoLoad="true">
		</dic>
	</item>
	<item id="CKRQ" alias="出库日期" type="date" not-null="1"/>
	<item id="CKFS" alias="出库方式" type="int" length="1"  not-null="1">
		<dic>
	...
	<item id="SLGH" alias="申领人员" type="string" length="10"  >
		<dic id="doctor" filter = "['and',['eq',['$map',['s','JGID']],['$','%user.manageUnit.id']],['ne',['$','item.properties.LOGOFF'],['s','1']]]" autoLoad="true" searchField="PYDM">
		</dic>
	</item>
	<item id="KSDM" alias="出库科室" type="int" length="8">
		<dic id="department" filter = "['and',['eq',['$map',['s','JGID']],['$','%user.manageUnit.id']],['ne',['$','item.properties.LOGOFF'],['s','1']]]" autoLoad="true" searchField="PYDM">
		</dic>
	</item>
	<item id="BRXM" alias="病人姓名" length="30" virtual="true"  fixed="true"/>
	<item id="BRLY" alias="病人来源" length="10" virtual="true"  fixed="true"/>
