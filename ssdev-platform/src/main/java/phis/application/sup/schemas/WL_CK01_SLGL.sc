...
<entry id="phis.application.sup.schemas.WL_CK01_SLGL" tableName="WL_CK01" alias="出库单据(WL_CK01)" sort="DJXH desc">
    ...
    <item id="LZFS" alias="流转方式" type="long" length="12">
        <dic id="phis.dictionary.transfermodes" filter = "['and',['and',['eq',['$',['s','KFXH']],['$','%user.properties.treasuryId']],['eq',['$map',['s','DJLX']],['s','CK']]],['eq',['$map',['s','YWLB']],['i',-1]]]" autoLoad="true">
        </dic>  
    </item>
    ...
    <item id="JBGH" alias="申领人员" length="10"  readOnly="true">
    ...
    <item id="CKRQ" alias="出库日期" type="date" display="0"/>
