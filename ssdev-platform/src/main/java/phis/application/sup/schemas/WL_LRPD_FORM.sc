...
<entry entityName="WL_LRPD_FORM" tableName="WL_LRPD" alias="盘点录入单据(WL_LRPD)">
	...
	<item id="PDGH" alias="盘点人员" type="string" defaultValue="%user.userId" fixed="true" length="10">
		<dic id="phis.dictionary.doctor" filter = "['ne',['$','item.properties.LOGOFF'],['s','1']]" autoLoad="true"/>	
	</item>
	<item id="PDFS" alias="盘点方式" type="int" display="0" defaultValue="1" length="1"/>
</entry>
