...
<entry entityName="JC_BRZD" tableName="JC_BRZD" alias="家床诊断信息" sort="JLBH ASC">
	...
	<item id="ZDLB" alias="诊断类型" defaultValue="1" type="int" length="20" >
		<dic id="phis.dictionary.fsbDiaType" autoLoad="true" />
	</item>
	<item id="ZDMC" alias="诊断名称" not-null="1" type="string" length="60" width="140" mode="remote" />
	<item id="ZDXH" alias="诊断序号" not-null="1" type="long" display="0" length="10" />
	<item id="ICD10" alias="ICD码" not-null="1" type="string" fixed="true" length="10" />
	<item id="ZDYS" alias="诊断医生" not-null="1" type="string" display="0" length="10" />
	<item id="ZGQK" alias="转归情况" type="string" length="8">
		<dic id="phis.dictionary.outcomeSituation" autoLoad="true" />
	</item>
	<item id="ZDSJ" alias="诊断时间" type="datetime" width="140" />
</entry>
