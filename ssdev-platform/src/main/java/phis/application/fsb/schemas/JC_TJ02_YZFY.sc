...
<entry entityName="JC_TJ02_YZFY" tableName="JC_TJ02" alias="病区提交明细表"  sort="a.YZXH,a.QRRQ">
	<item ref="c.BRXM" alias="姓名" display="0" queryable="false"/>
	<item ref="c.ZYHM" alias="住院号码" display="0" queryable="false"/>
	<item id="ZT" alias="状态" defaultValue="0" virtual="true" width="40" renderer="onRenderer"/>
	<item ref="b.YPMC" alias="药品名称" width="200"/>
	<item ref="h.XMLX" alias="项目类型" display="0" width="30"/>
	<item id="YFGG" alias="规格" length="20" renderer="onRendererNull"/>
	<item id="YCSL" alias="数量" type="double" length="8" not-null="1" width="40"/>
	<item id="FYSL" alias="实发数量" type="double" length="8" precision="2" not-null="1" />
	<item id="YFDW" alias="单位" length="4" renderer="onRendererNull" width="40"/>
	<item id="YPDJ" alias="单价" type="double" length="12" precision="4" not-null="1"/>
	<item id="FYJE" alias="金额" type="double" length="12" precision="2" not-null="1" />
	...
	<item id="KSSJ" alias="开嘱时间" type="datetime" not-null="1" width="130"/>
	<item id="QRRQ" alias="确认日期" type="datetime" not-null="1" width="140"/>
	<item ref="d.FYFS" display="0"/>
	<item ref="d.TJBQ" display="0"/>
	<item ref="d.YZLX" display="0"/>
	...
	<item id="FYRQ" alias="发药日期" type="datetime" display="0"/>
	...
	<item id="QZCL"  display="0" type="int" />
	...
	<relations>
		...
		<relation type="child" entryName="phis.application.fsb.schemas.JC_TJ01" >
