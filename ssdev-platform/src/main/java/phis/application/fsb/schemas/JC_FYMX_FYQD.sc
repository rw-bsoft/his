...
<entry entityName="JC_FYMX_FYQD" sort="FYRQ desc" tableName="JC_FYMX" alias="病人入院">
	...
	<item id="ZFJE" alias="自负金额" display="0" type="double" length="12" precision="2" not-null="1"/>
	<item id="ZLJE" alias="自理金额" display="0" type="double" length="12" precision="2" not-null="1"/>
	<item id="ZFBL" alias="自负比例" type="double" length="4" precision="3" not-null="1"/>
	<item id="FYKS" alias="费用科室" type="long" length="18" not-null="1" width="120" display="0">
