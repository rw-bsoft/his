...
<entry entityName="JC_TYMX_TYSQ_YT" tableName="JC_TYMX" alias="家床退药申请" sort="a.TYRQ">
	<item id="ZT"  virtual="true" alias="状态" display="1" renderer="onRenderer"/>
	...
	<item id="YPSL" alias="退药数量" type="double" length="9" precision="2" min="0" max="999999.99" renderer="onRenderer_positive"/>
	...
	<item id="SQRQ" alias="申请日期" type="date" not-null="1" display="0"/>
	<item id="TYRQ" alias="退药日期" type="date" display="0"/>
	...
	<item id="THSJ" alias="退回时间" type="date" display="0"/>
	<item id="THR" alias="退回人" length="10" display="0"/>
	<item id="ZYH" alias="住院号" length="18" type="long" width="50" display="0"/>
	<item id="TYLX" alias="退药类型" length="18" type="long" width="50" display="0"/>
	<item id="KTSL" alias="可退数量" length="18" type="long" width="50" display="0" virtual="true"/>
	<relations>
