...
<entry entityName="JC_BRYZ" alias="病区医嘱"
	...
	<item id="SRCS" alias="首日次数" type="int" max="999999" not-null="true"
		length="6" width="80" renderer="srcsRender" defaultValue="0" />
	<item id="YYTS" alias="天数" type="int" length="4" width="60" />
	<item id="TJZRQ" alias="提交至日期" type="string" width="80" fixed="true" />
	<item id="YTJZRQ" alias="提交至日期" type="string" width="80" display="0"
		virtual="true" />
	...
	<item id="TZSJ" alias="停嘱时间" type="datetime" renderer="dateFormat"
		width="120" />
	<item id="TZYS" alias="停嘱医生" type="string" length="10">
		<dic id="phis.dictionary.doctor_cfqx" searchField="PYCODE"
			autoLoad="true"
