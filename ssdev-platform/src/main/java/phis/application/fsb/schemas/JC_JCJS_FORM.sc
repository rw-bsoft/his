...
<entry entityName="JC_JCJS" alias="费用清单">
	...
	<item id="TCJE" alias="统筹金额" length="10" readOnly="true" display="0" layout="JSJE"/>
	...
	<item id="FFFS" alias="付款方式" type="int" length="18" layout="JSJEBT">
