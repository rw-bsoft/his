...
<entry entityName="JC_BRRY" alias="病人入院">
	...
	<item id="ZYHM" alias="家床号"   length="10" colspan="2" emptyText="请输入住院号码回车查询" not-null="1"/>
	<item id="JCBH" alias="家床编号" length="10"/>
	<item id="MZHM" alias="门诊号码" length="32"/>
	<item id="BRXZ" alias="病人性质" type="long" length="18" defaultValue="6" not-null="1">
	...
	<item id="BRKS" alias="病人科室" type="long" length="18" not-null="1">
		<dic id="phis.dictionary.department_zy" searchField="PYCODE" autoLoad="true" filter="['eq',['$','item.properties.ORGANIZCODE']],['$','%user.manageUnit.id']]"/>
	</item>
	<item id="BRBQ" alias="病人病区" type="long" length="18"/>
	<item id="BRCH" alias="病人床号" length="12" colspan="2" emptyText="请输入病人床号回车查询" not-null="1"/>
	<item id="DJRQ" alias="登记日期" type="date" not-null="1"/>
	<item id="RYRQ" alias="入院日期" type="datetime" xtype="datetimefield" not-null="1"/>
	<item id="CYRQ" alias="出院日期" type="datetime" xtype="datetimefield"/>
