...
<entry entityName="JC_BRYZ" alias="家床医嘱提交" >
	...
	<item ref="b.ZYHM" alias="家床号码" fixed="true" />
	...
	<item id="YCSL" alias="总量" type="long" length="8" not-null="1" fixed="true"/>
	<item id="JE" virtual="true" defaultValue="" type="double" alias="金额" length="10" fixed="true"/>
