...
<entry entityName="JC_TJ02_FY" tableName="JC_TJ02" alias="病区提交明细表"  sort="a.YZXH,a.QRRQ">
	<item ref="c.BRXM" alias="姓名" type="string" display="0" queryable="false"/>
	<item ref="b.YPMC" alias="药品名称" type="string" width="120"/>
	<item ref="h.CFTS" alias="帖" display="3" width="30"/>
	...
	<item id="QRRQ" alias="确认日期" type="datetime" not-null="1" width="130"/>
