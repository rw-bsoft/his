...
<entry entityName="JC_FYMX" alias="费用明细费用汇总">
	<item id="FYXH" alias="费用序号" length="80" display="0"/>
	<item id="FYMC" alias="费用名称" length="80" width="175"/>
	<item id="FYSL" alias="费用数量" type="double" length="10" precision="2" not-null="1" width="75"/>
