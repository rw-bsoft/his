...
<entry entityName="ZY_BRRY" alias="病人入院">
	...
	<item id="LXDZ" alias="联系地址" length="50"/>
	...
	<item id="XZZ_QTDZ" alias="现住址_其他地址" length="30"/>
	<item id="HKDZ_QTDZ" alias="户口地址_其他地址" length="30"/>
	...
	<item id="MZZD" alias="门诊诊断" type="long"  length="18">
