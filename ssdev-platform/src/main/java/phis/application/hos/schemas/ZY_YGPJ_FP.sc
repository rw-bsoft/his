...
<entry  entityName="ZY_YGPJ"  alias="票据号码维护">
	...
	<item id="YGDM" alias="领用人" length="10" not-null="1" defaultValue="%user.userId">
		<dic id="phis.dictionary.user_zybill" sliceType="1" filter="['eq',['$','item.properties.manageUnit'],['$','%user.manageUnit.id']]"/>
	</item>
	...
	<item id="PJLX" alias="票据类型" type="int" display="0" length="1" not-null="1" defaultValue="1"/>
