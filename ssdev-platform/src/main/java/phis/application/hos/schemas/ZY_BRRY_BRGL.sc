...
<entry  entityName="ZY_BRRY" alias="病人入院">
	...
	<item id="RYRQ" alias="入院日期" type="datetime" not-null="1" layout="part7" queryable="true"/>
	...
	<item id="NJJBYLLB" alias="南京金保医疗类别" type="string" updates="true" defaultValue="20" layout="part7" >
		<dic id="phis.dictionary.ybyllb_zy" autoLoad="true" />
	</item>
	<item id="YBMCS" alias="医保病种选择" type="string" updates="true" layout="part7" >
		<dic id="phis.dictionary.ybJbbm"  searchField="PYDM" autoLoad="true" />
	</item>
	<item id="YBMC" alias="医保病种" type="string" updates="true" not-null="1" layout="part7" >
		<dic id="phis.dictionary.ybJbbm" render="LovCombo" searchField="PYDM" autoLoad="true" />
	</item>
	<item id="YBZY" alias="医保转院" type="string" updates="true" layout="part7" >
