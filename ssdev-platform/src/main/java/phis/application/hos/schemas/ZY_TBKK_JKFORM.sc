...
<entry entityName="ZY_TBKK"  alias="退补FORM" >
	<item id="SJHM" alias="收据号码" length="20" readOnly="true" not-null="1" queryable="true"/>
	<item id="ZYHM" alias="住院号码" length="10" emptyText="请输入住院号码回车查询" not-null="1"/>
	<item id="BRCH" alias="病人床号" length="12" emptyText="请输入病人床号回车查询"/>
	<item id="BRXM" alias="病人姓名" length="40" />
	<item id="JKJE" alias="缴款金额" type="double" minValue="0.01" maxValue="99999999.99" length="11" precision="2" not-null="1" update="true"/>
