...
<entry entityName="ZY_ZYJS" alias="住院结算表">
  ...
  <item id="NHBXID" alias="农合报销ID" type="string" display="2" length="20"/>
  <item id="DRGS" alias="单病种名称" type="string" display="2" length="20"/>
  <item id="TCJE" alias="医保统筹金额" type="double" length="10" precision="2"/>
  <item id="ZHZF" alias="医保账户支付" type="double" length="10" precision="2"/>
