...
<entry entityName="phis.application.dpc.schemas.DPC_DebridementAgreement" alias="清创缝合手术同意书">
	...
	<item id="diagnosis" alias="术前诊断" type="string" xtype="textarea" length="500" width="250" not-null="0"/>
