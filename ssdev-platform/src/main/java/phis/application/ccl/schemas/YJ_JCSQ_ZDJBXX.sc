...
<entry entityName="YJ_JCSQ_ZDJBXX" alias="检查申请诊断基本信息">
	...
	<item id="LCZD" alias="临床诊断"  length="20" type="string" fixed="true" colspan="3"/>
	<item id="ZDYS" alias="诊断医生"  length="20" type="string" fixed="true" colspan="2"/>
	<item id="XLV" alias="心律"  length="200" type="string" not-null="1">
		<dic autoLoad="true">
			<item key="齐 " text="齐"/>
			<item key="不齐" text="不齐"/>
		</dic>
	...
	<item id="CTXX" alias="查体信息"  length="1000" type="string" colspan="6" display="0"/>
	<item id="TW" alias="体温(℃)"  length="200" type="string" display="0"/>
	<item id="HXPL" alias="呼吸频率(次/分)" length="200" type="string" display="0"/>
	<item id="MB" alias="脉搏(次/分)" length="200" type="string" display="0"/>
	<item id="SSY" alias="收缩压(mmHg)" length="200" type="string" display="0"/>
	<item id="SZY" alias="舒张压(mmHg)" length="200" type="string" display="0"/>
</entry>