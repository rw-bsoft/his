...
<entry entityName="ZY_BQYZ" alias="按项目提交病人集合">
	...
	<item ref="b.ZYHM" alias="住院号码"  fixed="true" />
	<item id="ZYH" alias="住院号" type="long" length="18" not-null="1" fixed="true" display="0"/>
	<item ref="b.BRXM" alias="病人姓名"  fixed="true"/>
	<item ref="b.BRXZ" alias="病人性质"  fixed="true" display="0"/>
	
	<item id="YZMC" alias="药嘱名称" type="string" length="100"  fixed="true" display="0"/>
	...
	<item id="JE" virtual="true" defaultValue="" type="string" alias="金额 X 次数" length="10" fixed="true"/>
	<item id="ZXKS" alias="执行科室" type="long" length="18" xtype="combo" >
