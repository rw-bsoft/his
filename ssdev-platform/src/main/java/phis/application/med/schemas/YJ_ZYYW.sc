...
<entry entityName="YJ_ZYYW" alias="门诊住院表单01表">
	...
	<item id="JGID" alias="机构ID" type="long" length="20"  not-null="1" fixed="true"  display="0" />
	<item id="ZYH" alias="住院号" type="long" length="18"  display="0" fixed="true"    />
	<item id="ZYHM" alias="住院号码" type="string" length="10"  fixed="true" display="1" />
	...
	<item id="KDRQ" alias="申检时间" type="string" width="130"   display="1"  fixed="true"/>
