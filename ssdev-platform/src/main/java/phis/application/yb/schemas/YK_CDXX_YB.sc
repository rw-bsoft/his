...
<entry alias="本地药品对照表" entityName="V_YPXX_YB">
	...
	<item id="YPDW" alias="单位" type="string" length="4" fixed="true"/>
	<item id="CDMC" alias="药品产地" type="string" length="15" width="200" fixed="true"/>
	<item id="LSJG" alias="零售价格" type="double"  length="12" fixed="true"/>
	<item id="PYDM" alias="拼音码" type="string" length="10" selected="true" queryable="true" fixed="true"/>
	<item id="YYZBM" alias="医保编码" type="string" queryable="true" length="20" />
</entry>