...
<entry entityName="MS_YGPJ"  alias="票据号码维护">
	...
	<item id="PJLX" alias="票据类型" not-null="1" type="int" display="0" defaultValue="1"/>
	...
	<item id="LYRQ" alias="领用日期" not-null="1" width="150" xtype="datetimefield" type="datetime" defaultValue="%server.date.datetime" />
</entry>
