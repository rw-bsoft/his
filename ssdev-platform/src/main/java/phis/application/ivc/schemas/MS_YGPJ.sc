...
<entry entityName="MS_YGPJ"  alias="票据号码维护">
	...
	<item id="PJLX" alias="票据类型" not-null="1" type="int" display="0" defaultValue="3"/>
	...
	<item id="YGDM" alias="领用人" length="10" type="string" not-null="1" defaultValue="%user.userId">
		<dic id="phis.dictionary.user_bill" filter="['eq',['$','item.properties.manaUnitId'],['$','%user.manageUnit.id']]"/>
	</item>
