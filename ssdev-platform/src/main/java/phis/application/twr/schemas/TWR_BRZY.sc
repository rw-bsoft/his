...
<entry entityName="TWR_BRZY" alias="住院转诊申请">
	...
	<item id="MSZD" alias="病人诊断" mode="remote" length="50" not-null="true" type="long"/>
	...
	<item id="ZLJG" alias="治疗经过" length="1000" colspan="4" xtype="textarea" height="40" not-null="true" type="string"/>
	...
	<item id="ZYSX" alias="注意事项" length="1000" colspan="4" xtype="textarea" height="30" type="string"/>
