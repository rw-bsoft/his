...
<entry id="DR_CLINICRECORDLHISTORYLIST" tableName="DR_CLINICRECORDLHISTORY"  alias="转诊历史记录" sort="a.ZHUANZHENRQ DESC">
	<!--(目前暂时先放在本地数据库)-->
	...
	<item id="MZHM" alias="门诊号码" type="string" length="32" queryable="true"/>
	...
	<item id="BINGRENSFZH" width="150" alias="病人身份证号" length="18"  type="string" queryable="true"/>
	<item id="ZHUANZHENRQ" alias="转诊日期" length="16"  type="string" />
	<item ref="b.JIUZHENSJ" alias="转诊时间" length="16"  type="string" />
	<item id="SHENQINGJGMC" width="150" alias="转出机构" length="32"  type="string" />
	<item id="ZHUANRUYYMC" width="150" alias="转入机构" length="32" virtual="true" type="string" />
	...
	<item id="ZHUANRUYYDM" alias="转入机构代码" length="30"  type="string" display="0"/>
	<item id="ZHUANRUKSDM" alias="转入科室代码" length="30" virtual="true" type="string" display="0"/>
	<item id="YISHENGDM" alias="医生代码" length="30" virtual="true" type="string" display="0"/>
	<item id="JIUZHENSJ" alias="就诊时间" length="32" virtual="true" type="string" display="0"/>
	<item id="GUAHAOXH" alias="挂号序号" length="32" virtual="true" type="string" display="0"/>
	<item id="QUHAOMM" alias="取号密码" length="10" virtual="true" type="string"/>
	...
	<relations>
		<relation type="parent" entryName="phis.application.twr.schemas.DR_CLINICZZRECORDHISTORY">
			<join parent="ZHUANZHENDH" child="ZHUANZHENDH"/>
		</relation>
	</relations>
</entry>
