...
<entry entityName="TWR_BRZL" alias="接收上转申请">
	...
	<item id="MSZD" alias="转诊诊断" mode="remote"  length="50" not-null="true" type="string"/>
	<item id="ZZYY" alias="转诊原因" length="50" not-null="true" colspan="3" type="string"/>
	<item id="BQMS" alias="病情描述" length="500" colspan="4" xtype="textarea" not-null="true" type="string" />
	<item id="ZLJG" alias="治疗经过" length="500" colspan="4" not-null="true" xtype="textarea" type="string" />
	...
	<item id="YSDH" alias="医生电话" length="20" type="string" />
	...
	<item id="YYSJ" alias="预约时间" length="20" not-null="true" display="0" type="string" />
</entry>