...
<entry  entityName="MS_BCJL" tableName="MS_BCJL" alias="门诊病历(病程记录)">
	...
	<item id="LEFTVISION" alias="左眼视力" type="double"  length="6"  precision="2" />
	<item id="RIGHTVISION" alias="右眼视力" type="double"  length="6"  precision="2"/>
	<item id="LEFTCORRECTEDVISION" alias="左眼矫正视力" type="double"  length="6" precision="2" />
	<item id="RIGHTCORRECTEDVISION" alias="右眼矫正视力" type="double" length="6"  precision="2" />
	...
	<item id="DYBZ" alias="打印标志" type="string">	    
	</item>
	<item id="BQGZ" alias="病情告知" type="string" length="1000"/>
	<item id="RSBZ" alias="妊娠标志" type="int" length="1"/>
	<item id="YCFJM" alias="孕产妇减免" type="int" length="1"/>
	<item id="ZZ" alias="治则" type="string" length="1000"/>
	<item id="ZZDM" alias="症状代码" type="string" length="20"/>
	<item id="ZZMC" alias="症状名称" type="string" length="100"/>
</entry>
