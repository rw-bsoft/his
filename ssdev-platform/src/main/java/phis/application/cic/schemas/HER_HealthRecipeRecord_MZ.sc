...
<entry entityName="HER_HealthRecipeRecord_MZ" alias="健康处方维护">
	...
	<item id="recipeName" alias="健康处方名称" type="string" length="100" width="200" colspan="3"/>
	<item id="examineUnit" alias="就诊机构" type="string" length="50" width="100" hidden="true"/>
	<item id="diagnoseName" alias="诊断名称" type="string" length="100" width="200"/>
	<item id="ICD10" alias="ICD10" type="string" length="50" width="100" update="false"/>
	<item id="guideDate" alias="指导日期" type="datetime"  xtype="datefield" hidden="true"
		defaultValue="%server.date.today">
	</item>
	<item id="guideUser" alias="指导医生" type="string" length="20" width="150" hidden="true" defaultValue="%user.userId">
		<dic id="chis.dictionary.user" render="Tree" onlySelectLeaf="true"   parentKey="%user.manageUnit.id"/>
	</item>
	<item id="healthTeach" alias="指导建议" type="string" height="260" hidden="true" length="2000" width="200" colspan="3" xtype="textarea">
	</item>
	<item id="guideWay" alias="指导途径" type="string" length="2" hidden="true" defaultValue="01">
		<dic>
			<item key="01" text="门诊"/>
