...
<entry entityName="MPI_DemographicInfo_BGK" tableName="MPI_DemographicInfo" alias="EMPI个人基本信息" sort=" createTime desc">
	<item id="empiId" alias="EMPI" type="string" length="32" display="0" pkey="true" />
	<item id="cardNo" alias="卡号" type="string" virtual="true" display="2" update="false" length="20" queryable="true"/>
	<item id="personName" alias="姓名" type="string" length="20" queryable="true" not-null="1"/>
	<item id="photo" alias="" type="string" display="2" rowspan="5"/>
	...
	<item id="createTime" alias="建档时间" update="false" type="datetime" display="0">
	...
	<item id="lastModifyTime" alias="最后修改时间" type="datetime" display="1">
		<set type="exp">['$','%server.date.datetime']</set>
	</item>
