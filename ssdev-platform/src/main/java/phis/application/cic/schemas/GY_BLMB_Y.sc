...
<entry entityName="GY_BLMB_Y" tableName="GY_BLMB" alias="模版类型">
	...
	<item id="ZSXX" alias="主诉信息" type="string"	xtype="textarea" not-null="1" length="500" />
	<item id="XBS" alias="现病史" type="string"	xtype="textarea" not-null="1" length="500"/>
	<item id="JWS" alias="既往史" type="string"	xtype="textarea"  length="500"/>
	<item id="GMS" alias="过敏史" type="string"	xtype="textarea"  length="500" />
	<item id="TGJC" alias="体格检查" type="string"	xtype="textarea"  length="500"/>
	<item id="FZJC" alias="辅助检查" type="string"	xtype="textarea"  length="500"/>
	<item id="JKJYNR" alias="健康教育" type="string"	xtype="textarea"  length="500" />
