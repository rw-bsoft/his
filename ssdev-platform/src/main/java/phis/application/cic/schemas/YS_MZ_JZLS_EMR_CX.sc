...
<entry entityName="YS_MZ_JZLS" tableName="YS_MZ_JZLS" alias="就诊历史" sort="a.JZXH desc">
	...
	<item ref="b.MZHM" alias="门诊号码" type="string" length="32" width="120" not-null="1"/>
	<item ref="b.BRXZ" alias="性质" fixed="true" length="18" width="60" />
	<item ref="b.BRXM" alias="姓名" fixed="true" type="string" length="40" width="60" />
	...
	<item id="KSSJ" alias="开始时间" type="date" not-null="1" width="140"  queryable="true" selected="true"/>
	...
	<item ref="d.BLBH" display="0"/>
	<item ref="d.BLLB" display="0"/>
	<item ref="d.BLMC" display="0"/>
	<item ref="d.BLLX" display="0"/>
	<item ref="d.MBLB" display="0"/>
	<item ref="d.BLZT" display="0"/>
	<relations>
		...
		<relation type="parent" entryName="phis.application.emr.schemas.OMR_BL01">
