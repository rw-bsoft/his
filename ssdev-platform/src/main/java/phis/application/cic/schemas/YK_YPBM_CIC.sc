...
<entry entityName="YK_YPBM" tableName="YK_YPBM" alias="药品别名" sort="a.BMXH desc">
	...
	<item id="YPXH" alias="药品内码" type="long" length="18"  display="2"  hidden="true" />
	...
	<item id="BMFL" alias="编码方式" type="int" length="2" defaultValue="1"  hidden="true"/>
</entry>
