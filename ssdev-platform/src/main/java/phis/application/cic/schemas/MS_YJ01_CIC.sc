...
<entry entityName="MS_YJ01_CIC" tableName="MS_YJ01" alias="门诊医技单01表">
	...
	<item id="KSDM" alias="申检科室" type="long" length="18" >
		<dic id="phis.dictionary.department_leaf" autoLoad="true" filter="['eq',['$','item.properties.ORGANIZCODE'],['$','%user.manageUnit.ref']]" searchField="PYCODE"/>
	</item>
	...
	<item id="BGSJ" alias="报告时间" type="timestamp" display="0" length="20" fixed="true"/>
