...
<entry entityName="MS_YJ02" alias="门诊医技单02表" sort="YJZH ,SBXH asc">
	...
	<property name="JCBWDM" type="java.lang.String" length="5" display="0"/>
    <property name="JCBWMS" type="java.lang.String" length="255" display="0"/>
    <property name="JCBWMC" type="java.lang.String" length="100" display="0"/>
