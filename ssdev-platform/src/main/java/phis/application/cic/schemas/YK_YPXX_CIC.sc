...
<entry  entityName="YK_YPXX" tableName="YK_YPXX" alias="药库药品信息" sort="b.TYPE,a.YPXH">
	...
	<item ref="b.TYMC" fixed="true" layout="JBXX"/>	
	...
	<item ref="b.YPJL" fixed="true" layout="JBXX"/>
	<item ref="b.JLDW" fixed="true" layout="JBXX"/>
	<item ref="b.YPDC" fixed="true" layout="JBXX"/>
	<item ref="b.YPXQ" fixed="true" layout="JBXX"/>
	<item ref="b.ABC" fixed="true" layout="JBXX"/>
    ...
    <item ref="b.YCXL" fixed="true" layout="QT" defaultValue="0"/>
	...
	<item id="JGID" alias="机构ID" length="20" not-null="1"  display="0" 
		defaultValue="%user.manageUnit.id"  layout="GDC" update="false" pkey="true"  type="string"/>
	...
	<relations>
		<relation type="parent" entryName="phis.application.cic.schemas.YK_TYPK_YKYPXX" >
