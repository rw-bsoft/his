...
<entry entityName="YS_MZ_ZT01_CS" tableName="YS_MZ_ZT01" sort="a.ZTBH desc" alias="个人处方组套">
	...
	<item id="ZTLB" alias="组套类别" type="int" length="1" display="0" defaultValue="4">
		<dic>
			<item key="4" text="项目"/>
		</dic>
	</item>
	...
	<item id="KSDM" alias="科室代码" type="sting" length="10" display="0"/>
