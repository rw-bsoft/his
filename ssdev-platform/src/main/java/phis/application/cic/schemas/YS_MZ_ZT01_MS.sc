...
<entry entityName="YS_MZ_ZT01_MS" tableName="YS_MZ_ZT01" sort="a.ZTBH desc" alias="个人处方组套">
	...
	<item id="ZTLB" alias="组套类别" type="int" length="1" defaultValue="1">
		<dic id="phis.dictionary.storeroomType" autoLoad="true"/>
	</item>
