...
<entry entityName="MPI_DemographicInfo_SMQ"  tableName="MPI_DemographicInfo" alias="EMPI个人基本信息" sort=" createTime desc">
	<item id="empiId" alias="EMPI" type="string" length="32" display="0"
		pkey="true" />
	<item id="cardNo" alias="卡号" type="string" virtual="true" display="2"
		update="false" length="20" queryable="true" />
	<item id="MZHM" alias="门诊号码" type="string" length="32" virtual="true"
		not-null="1" queryable="true" editable="true" xtype="lookupfield_his" />
	<item id="photo" alias="" xtype="imagefield"
		display="2" rowspan="5" />
	<item id="BRXZ" alias="性质" virtual="true" length="18" not-null="1" defaultValue="1000" >
	...
	<item id="idCard" alias="身份证" type="string" length="20" width="160"
		queryable="true" vtype="idCard" enableKeyEvents="true" />
	<item id="sexCode" alias="性别" type="string" length="1" width="40"
		queryable="true" defaultValue="1" not-null="1">
		<dic id="phis.dictionary.gender" autoLoad="true" />
	</item>
	<item id="birthday" alias="出生日期" type="date" width="75" queryable="true"
	...
	<item id="workPlace" alias="工作单位" type="string" length="40" />
	<item id="mobileNumber" alias="本人电话" type="string" length="16"
		width="90" />
	<item id="phoneNumber" alias="家庭电话" type="string" length="16" />
	<item id="contact" alias="联系人" type="string" length="20" />
	<item id="contactPhone" alias="联系人电话" type="string" length="16" />
	...
	<item id="educationCode" alias="文化程度" type="string" length="2">
		<dic id="phis.dictionary.education" render="Tree" onlySelectLeaf="true"/>
	</item>
	...
	<item id="maritalStatusCode" alias="婚姻状况" type="string" length="2"
		...
		<dic id="phis.dictionary.maritals" render="Tree" onlySelectLeaf="true"/>
	</item>
	<item id="homePlace" alias="出生地" type="string" length="100" width="90"
		display="0" />
	<item id="zipCode" alias="邮政编码" type="string" length="6" />
	<item id="address" alias="联系地址" type="string" length="40" width="200" />
	...
	<item id="smq" alias="扫码枪" width="400" type="string" length="100" colspan="3"  enableKeyEvents="true"  style="color:red" />
	...
	<item id="insuranceCode" alias="医疗支付方式" type="string" length="2" display="0" />
	<item id="insuranceType" alias="其他支付方式" type="string" length="100" display="0" fixed="true"/>
	<item id="insuranceText" alias="其他支付" type="string" length="50"  display="0"/>
	<item id="definePhrid" alias="自定义档案编号" type="string" length="60" display="0"/>
</entry>