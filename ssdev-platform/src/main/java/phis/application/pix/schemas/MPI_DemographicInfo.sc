...
<entry entityName="MPI_DemographicInfo" alias="EMPI个人基本信息" sort=" createTime desc">
	...
	<item id="photo" alias="" xtype="imagefield"
		display="2" rowspan="5" />
	<item id="BRXZ" alias="性质" length="18" virtual="true" not-null="1" defaultValue="1000" >
	...
	<item id="contactRelation" alias="与联系人关系" type="string" length="16" />
	...
	<item id="crowdType" alias="人群类型"  type="string" length="20" >
	      <dic render="LovCombo">
			<item key="01" text="老年人"/>
