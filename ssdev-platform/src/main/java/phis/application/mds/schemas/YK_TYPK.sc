...
<entry entityName="YK_TYPK" alias="药品信息" sort="a.YPXH desc">
	...
	<item id="YPGG" alias="规格" type="string" length="64" layout="JBXX" />
	...
	<!-- add by lizhi 2017-07-14 增加药品级别，对应机构级别 -->
	<item id="GRADE" alias="药品级别" type="string" length="10" defaultValue="1"
		display="2" layout="JBXX">
	...
	<item id="ZXDW" alias="最小单位" type="string" length="4" display="2"
		layout="YPBZ" />
	<item id="YFGG" alias="药房规格" type="string" length="64" display="2"
		layout="YPBZ" />
	...
	<item id="BFGG" alias="病房规格" type="string" length="64" display="2"
		layout="YPBZ" />
	...
	<item id="GYFF" alias="给药方法" type="long" length="18" display="2" not-null="true"
		layout="QT">
	...
	<item id="ZFYP" defaultValue="0" alias="转方药品" type="int" length="1"
		display="2" layout="KSS">
		<dic id="phis.dictionary.confirm" />
	</item>
