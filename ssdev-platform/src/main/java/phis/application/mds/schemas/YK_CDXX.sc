...
<entry entityName="YK_CDXX" alias="药品产地" >
	<item id="JGID" alias="机构ID"  length="20"  not-null="1"   display="0" defaultValue="%user.manageUnit.id" pkey="true"/>
	...
	<!--<item ref="b.PYDM" />-->
	<item ref="b.CDMC" mode = "remote" renderer="onRenderer"/>
	...
	<item id="JHJE" alias="进货金额" fixed="true"  width="80"  type="double"  length="12" maxValue="99999999.99" minValue="0" not-null="true" precision="2" defaultValue="0" display="0"/>
	<item id="PFJE" alias="批发金额" fixed="true"  width="80"  type="double"  length="12" maxValue="99999999.99" minValue="0"  precision="2" defaultValue="0" display="0"/>
	<item id="LSJE" alias="零售金额" fixed="true"  width="80"  type="double"  length="12" maxValue="99999999.99" minValue="0" not-null="true" precision="2" defaultValue="0" display="0"/>
	...
	<!--以后改成数据字典-->
	<item id="DJFS" alias="零售价格定价方式"  fixed="true" width="150" type="int"  length="1" not-null="true" defaultValue="0">
		<dic id="phis.dictionary.pricingWay"></dic>
	</item>
	<item id="DJGS" alias="定价计算" type="string"  width="200" length="250"  display="0"/>
