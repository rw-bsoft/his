...
<entry entityName="BQ_FYYF" alias="病区发药药房" sort="TYPE asc">
	...
	<item id="BQDM" alias="病区" type="long" length="18" not-null="1" fixed="true" >
	...
	<item id="TYPE" alias="医嘱类型" type="int" length="1" not-null="1" defaultValue="1" >
		<dic id="phis.dictionary.advicetype" autoLoad="true"/>
	</item>
