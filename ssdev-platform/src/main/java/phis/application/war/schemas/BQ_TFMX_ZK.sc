...
<entry entityName="BQ_TFMX" alias="退费明细">
	...
	<item id="FYXM" alias="费用项目" type="long" length="18" width="120"/>
	<item id="JGID" alias="机构ID" type="long" length="8" display="0"/>
	<item id="TFRQ" alias="退费日期"  type="date" display="0"/>
	...
	<item id="ZFBL" alias="自负比例" type="double" length="4" display="0"/>
	
	<item id="YEPB" alias="婴儿判别" type="long" length="1" display="0"/>
	<item id="TFBQ" alias="退费病区" type="long" length="18" width="80"/>
