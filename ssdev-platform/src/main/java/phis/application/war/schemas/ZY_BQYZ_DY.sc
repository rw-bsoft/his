...
<entry entityName="ZY_BQYZ" alias="病区医嘱" sort="YZPX ASC">
	...
	<item id="YYTS" alias="天数" type="int" length="4" width="60" max="99999999" defaultValue="1"/>
	<item id="YCSL" alias="总量" type="int" length="8" min="0.01" max="99999999" not-null="true" width="60" defaultValue="1"/>
	<item id="YFDW" alias="单位" type="String" fixed="true" length="4" width="60"/>
	...
	<item id="BZXX" alias="备注" type="string" length="125" width="80"/>
	...
	<item id="KSBZ" alias="抗生素标志" type="int" virtual="true" display="0" />
	<item id="SFSP" alias="是否需要审批" virtual="true" type="int" display="0" />
	<item id="msg" virtual="true" alias="提示信息" type="string" display="0" />
	<item id="YCYL" alias="一次用量" type="int" virtual="true" display="0" />
	<item id="YQSY" alias="医技主项" type="int" display="0" />
	<item id="ZXKS" alias="执行科室" type="long" display="0"/>
	<item id="YJXH" alias="医技序号" type="long" display="0"/>
	<item id="XMLX" alias="项目类型" type="int"  display="0" defaultValue="3"/>
