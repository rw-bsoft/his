...
<entry entityName="ZY_BQYZ" alias="病区医嘱" sort="YZZH asc,YJZX desc,JLXH asc">
    ...
    <item ref="b.BRCH" />
    <item ref="b.BRXM" width="120"/>
    <item id="KSSJ" alias="开嘱时间" type="datetime" width="150" renderer="dateFormat" />
    ...
    <item id="TZSJ" alias="停嘱时间" type="datetime" renderer="dateFormat" width="150" />
    ...
    <item id="SRKS" alias="病区科室" type="long" display="0"/>
    ...
    <item id="YZZH_SHOW" alias=" " type="long" length="1" fixed="true" width="10" renderer="showColor" virtual="true" display="0"/>
    ...
    <item id="YCJL" alias="剂量" type="double" max="9999999.999" length="10" precision="3" not-null="1" width="60" display="0"/>
    <item id="JLDW" alias=" " display="0" width="30" fixed="true" virtual="true"/>
	
	
    <item id="MRCS" alias="每日次数" type="int" display="0"/>
    <item id="YZZXSJ" alias="执行时间" length="80" fixed="true" display="0"/>
    <item id="SRCS" alias="首日次数" type="int" max="999999" length="6" width="80" renderer="srcsRender" display="0"/>
	
    <item id="YPDJ" alias="单价" type="double" length="12" precision="4" nullToValue="0" not-null="1" width="70" display="0"/>
	
    <item id="YSTJ" alias="状态" type="int" defaultValue="0" width="60" renderer="YstjRender" fixed="true" display="0"/>
    <item id="YSBZ" alias=" " type="int" length="1" fixed="true" width="30"  defaultValue="0" renderer="ysbzRender" display="0"/>
	
	
    <item id="BZXX" alias="说明" type="string" length="150" width="80" display="0"/>
    <item id="YPCD" alias="产地" type="long" length="18" not-null="1" fixed="true" display="0">
        <dic id="medicinePlace" autoLoad="true"/>
    </item>
    <item id="YFSB" alias="发药药房" type="long" length="18" not-null="1" display="0">
