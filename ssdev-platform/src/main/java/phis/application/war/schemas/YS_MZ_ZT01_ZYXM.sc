...
<entry entityName="YS_MZ_ZT01" sort="ZTLB,ZTBH" alias="个人处方组套">
	...
	<item id="ZTMC" alias="组套名称"  anchor="100%" colspan="2" width="240" type="string" length="20" not-null="1"/>
	<item id="ZTLB" alias=" " type="string" length="1" display="0" defaultValue="1" />
	...
	<item id="SFQY" alias="启用" type="int" width="50" length="1" display="0" defaultValue="0" />
