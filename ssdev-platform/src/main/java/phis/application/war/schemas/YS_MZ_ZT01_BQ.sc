...
<entry entityName="YS_MZ_ZT01" sort="a.ZTBH desc" alias="个人处方组套">
	...
	<item id="ZTMC" alias="组套名称"  anchor="100%" colspan="2" width="180" type="string" length="20" not-null="1"/>
	...
	<item id="ZTLB" alias="组套类别" type="int" length="1" display="0" />
</entry>