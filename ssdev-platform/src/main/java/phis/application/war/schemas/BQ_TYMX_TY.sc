...
<entry entityName="BQ_TYMX" alias="病区退药明细">
	<item ref="e.BRCH" alias="床号" width="50"/>
	<item ref="e.BRXM" alias="病人姓名"/>
	...
	<item ref="e.ZSYS" display="0"/>
	<item ref="b.FYFS" display="0"/>
	<item ref="e.ZLXZ" display="0"/>
	...
	<relations>
		...
		<relation type="child" entryName="phis.application.mds.schemas.YK_CDXX" >
			<join parent="YPCD" child="YPCD"></join>
			<join parent="YPXH" child="YPXH"></join>
