...
<entry entityName="YK_CK01" alias="出库01" >
	...
	<item id="CKFS" alias="领药方式" length="4" not-null="1" type="int" fixed="true" pkey="true">
		<dic id="phis.dictionary.storehouseDelivery" autoLoad="true"/>
	</item>
	<item id="SQRQ" alias="申请日期" type="datetime"  defaultValue="%server.date.datetime" display="2"   update = "false"/>
	<item id="CKBZ" alias="出库备注" type="string" length="30"  />
	<item id="CKRQ" alias="出库日期" type="datetime"  display="2" fixed="true"/>
	<item id="LYRQ" alias="领用日期" type="datetime"  fixed="true"/>
	...
	<item id="SQTJ" alias="申请提交" length="1" not-null="1"  display="0" defaultValue="0" type="int"/>
