...
<entry entityName="YK_CK02" alias="出库02"  >
	...
	<item id="KCSL" alias="库存" length="12" type="double" precision="2" max="999999.9999" min="0"  virtual="true" fixed="true"/>
	<item id="SQSL" alias="申请数量" length="10" type="double" precision="2" max="999999.99" min="0" not-null="1" fixed="true"/>
	<item id="SFSL" alias="实发数量" length="10" precision="2" not-null="1"  max="999999.99" min="0"   defaultValue="0" type="double"/>
	<item id="LSJE" alias="零售金额" length="12" type="double" precision="4" max="99999999.9999" min="0" not-null="1" fixed="true"/>
	<item id="JHJG" alias="进货价格" length="12" type="double" precision="4" not-null="1" fixed="true"/>
	<item id="JHJE" alias="进货金额" length="12" type="double" precision="4" not-null="1" fixed="true"/>
	...
	<item id="YPXQ" alias="效期" type="datetime"  defaultValue="%server.date.datetime" fixed="true" width="150"/>
	<item id="TYPE" alias="库存性质" length="6" display="0" type="int" fixed="true">
		<dic>
			<item key="1" text="合格"/>
			<item key="2" text="次品"/>
			<item key="3" text="伪劣"/>
	...
	<item id="YFKC" alias="药房库存" length="12" type="double" precision="2" max="999999.9999" min="0"  virtual="true" fixed="true"/>
	<relations>
