...
<entry entityName="YK_CK01" alias="出库01" >
	...
	<item id="CKFS" alias="退药方式" length="4" not-null="1" type="int" pkey="true" display="0">
	...
	<item id="CKDH" alias="退药单号" length="6" not-null="1" type="int" pkey="true"/>
	<item id="SQRQ" alias="申请日期" type="datetime"  width="140"  />
