...
<entry entityName="YK_RK01" alias="入库01" >
	...
	<item ref="b.DWMC" mode="remote"  alias="进货单位" not-null="1" showRed="true" nextFocus="RKBZ"/>
	<item id="CGRQ" alias="采购日期" type="datetime" defaultValue="%server.date.datetime" display="2"/>
	...
	<item id="RKBZ" alias="备注" type="string" length="30" display="2" nextFocus="fire_createRow"/>
