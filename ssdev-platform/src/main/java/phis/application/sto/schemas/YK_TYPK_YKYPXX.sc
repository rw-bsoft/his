...
<entry  entityName="YK_TYPK" alias="药品信息"  >
	...
	<item id="ZBLB" alias="账簿类别" display="2"  not-null="1" 
		type="long"  layout="JBXX" >
		<dic id="phis.dictionary.booksCategories"/>
	</item>
	<item id="YPSX" alias="剂型"   not-null="1" type="string"
		length="18" layout="JBXX">
		<dic id="phis.dictionary.dosageForm"/>
	</item>
	<item id="YPJL" alias="包装剂量" type="string"  length="10"
	...
	<item id="YPDM" alias="药品类型" type="string" length="16" layout="JBXX" display="2" >	
	...
	<item id="PYDM" alias="拼音码" type="string" length="10" selected="true"
	...
	<item id="JXDM" alias="角形码" type="string" length="10" queryable="true" layout="JBXX">
