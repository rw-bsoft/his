...
<entry entityName="YK_RK02" alias="入库02_财务验收"  >
	...
	<item ref="b.YPDW" fixed="true"/>
	<item ref="c.CDMC"  alias="生产厂家" fixed="true"/>
	<item id="JHJG" alias="进货价格" length="11" precision="4" not-null="1" min="0" max="999999.9999" type="double" />
	<item id="JHHJ" alias="进货合计" length="11" precision="4" not-null="1" min="-9999999.99" max="99999999.99" type="double" />
	<item id="YPKL" alias="药品扣率" length="3" precision="2" not-null="1" type="double" defaultValue="0" max="1" min="0" />
	<item id="FKJE" alias="付款金额" length="12" precision="4" not-null="1" type="double"  defaultValue="0" min="-9999999.99" max="99999999.99"/>
	<item id="JXCJ" alias="进销差价" length="12" precision="2" not-null="1" type="double"  defaultValue="0" fixed="true"  renderer="onRenderer" virtual="true"/>
	<item id="LSJG" alias="零售价格" length="11" precision="4" not-null="1" min="0" max="999999.9999" type="double" fixed="true"/>
	<item id="RKSL" alias="入库数量" length="9" precision="2" not-null="1" min="-999999.99" max="999999.99" type="double" fixed="true"/>
