...
<entry entityName="YK_CK02" alias="出库02"  >
	...
	<item id="SQSL" alias="申请数量" length="10" type="double" precision="2" min="-999999.99" max="0" not-null="1"/>
	<item id="SFSL" alias="实发数量" length="10" precision="2" not-null="1" min="-999999.99" max="0"  defaultValue="0" type="double" fixed="true"/>
	<item id="KCSL" alias="药房库存(大包装)" length="12" width="160" type="double" precision="2" max="999999.9999" min="0"  virtual="true" fixed="true"/>
	<!--<item ref="d.YPSL" fixed="true" alias="药房库存"/>-->
	<item id="LSJE" alias="零售金额" length="12" type="double" precision="4" min="-99999999.9999" max="0" not-null="1" fixed="true" display="0"/>
	...
	<relations>
		<relation type="parent" entryName="phis.application.mds.schemas.YK_TYPK" />
		         <join child="SBXH" parent="SBXH"/>
		<relation type="parent" entryName="phis.application.mds.schemas.YK_CDDZ" />
		           <join child="SBXH" parent="SBXH"/>
		<!--<relation type="parent" entryName="YF_KCMX" >
				<join child="YFKCSB" parent="SBXH"/>
			</relation>-->
	</relations>
</entry>
