...
<entry entityName="YK_RK02" alias="入库02_财务验收">
	...
	<item id="JHHJ" alias="进货合计" length="12" precision="4" not-null="1" min="-9999999.99" max="99999999.99" type="double" />
	<item id="YPKL" alias="药品扣率" length="3" precision="2" not-null="1" type="double" defaultValue="0" />
	<item id="FKJE" alias="付款金额" length="12" precision="2" not-null="1" type="double"  defaultValue="0" min="-9999999.99" max="99999999.99"/>
	<item id="JXCJ" alias="进销差价" length="12" precision="2" not-null="1" type="double"  defaultValue="0"  renderer="onRenderer" virtual="true"/>
	<item id="YPPH" alias="批号" type="string" length="20"  display="0"/>
	<item id="YPXQ" alias="效期" type="datetime" defaultValue="%server.date.datetime"  display="0"/>
	<item id="SHHM" alias="随货号" type="string" length="12"  display="0"/>
	...
	<item id="ZRJE" alias="折让金额" length="10" precision="2" type="double" display="0"/>
	<item id="PFJE" alias="批发金额" length="12" precision="4"  type="double" display="0"/>
	<item id="LSJE" alias="零售金额" length="12" precision="4" not-null="1" type="double" display="0"/>
	...
	<item id="YFJE" alias="已付金额" length="12" precision="4" not-null="1" type="double"  defaultValue="0" display="0"/>
