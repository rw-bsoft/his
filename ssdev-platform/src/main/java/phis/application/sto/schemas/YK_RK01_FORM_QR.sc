...
<entry entityName="YK_RK01" alias="入库01" >
	...
	<item ref="c.DWMC" mode="remote"  alias="进货单位" fixed="true" />
	...
	<item id="PWD" alias="购入方式" length="1" not-null="1" defaultValue="0" type="int" display="2" fixed="true" >
		<dic>
	...
	<item id="RKBZ" alias="备注" type="string" length="30" display="2" fixed="true" />
