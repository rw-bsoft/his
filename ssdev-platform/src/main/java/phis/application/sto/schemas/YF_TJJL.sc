...
<entry entityName="YF_TJJL" alias="药房调价记录">
	...
	<item id="YLSJ" alias="原零售价" length="13" precision="4" not-null="1" fixed="true" type="double" max="999999.9999" min="0" renderer="onRenderer_four"/>
	<item id="YJHJ" alias="原进货价" length="13" precision="4" not-null="1" fixed="true" type="double" max="999999.9999" min="0" renderer="onRenderer_four"/>
	<item id="XLSJ" alias="新零售价" length="13" precision="4" not-null="1"  type="double" max="999999.9999" min="0" renderer="onRenderer_four"/>
	<item id="XJHJ" alias="新进货价" length="13" precision="4" not-null="1"  type="double" max="999999.9999" min="0" renderer="onRenderer_four"/>
	<item id="TJSL" alias="调价数量" length="11" defaultValue="0" precision="2" not-null="1"  fixed="true" type="double" max="999999.99" min="0" renderer="onRenderer_tow"/>
	<item id="XLSE" alias="调价金额" length="12"  defaultValue="0" precision="4" not-null="1"  fixed="true" type="double" max="99999999.99" min="0" renderer="onRenderer_four"/>
	<item id="XPFJ" alias="新批发价" length="13" defaultValue="0" precision="6"  type="double" max="999999.9999" min="0" display="0"/>
	<item id="YPFJ" alias="原批发价" length="13" defaultValue="0" precision="6"  type="double" max="999999.9999" min="0" display="0"/>
	<item id="JGID" alias="机构ID" length="20" not-null="1" display="0" type="string" defaultValue="%user.manageUnit.id"/>
	<item id="YKSB" alias="药库识别" length="18" not-null="1" type="long" display="0" />
	...
	<item id="YPPH" alias="药品批号" type="string" length="50" display="0"/>
	<item id="YPXQ" alias="药品效期" type="date" display="0"/>
	<item id="YLSE" alias="原零售额" length="12" defaultValue="0" precision="4" not-null="1" type="double" max="999999.9999" min="0" display="0"/>
	<item id="YPFE" alias="原批发额" length="12" defaultValue="0" precision="4"  type="double" max="999999.9999" min="0" display="0"/>
	<item id="XPFE" alias="新批发额" length="12" defaultValue="0" precision="4"  type="double" max="999999.9999" min="0" display="0"/>
