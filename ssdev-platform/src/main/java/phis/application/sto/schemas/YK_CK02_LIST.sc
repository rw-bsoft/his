...
<entry entityName="YK_CK02" alias="出库02" >
	...
	<item id="YPXQ" alias="药品效期" type="datetime" defaultValue="%server.date.datetime" display="0"/>
	<item id="PFJG" alias="批发价格" length="12" precision="6"  display="0"  type="double"/>
	<item id="SFSL" alias="实发数量" length="10" precision="4" not-null="1" display="0" defaultValue="0" type="double"/>
	...
	<item id="YFKCSL" alias="药房库存" length="12" type="double" precision="2" max="999999.9999" min="0"  virtual="true" fixed="true"/>
	<relations>
