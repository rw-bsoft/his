...
<entry entityName="SCM_NewService" alias="新增服务项目表">
    ...
    <item id="gridAddress" alias="服务地址" type="string" length="100" not-null="1">
        <dic id="chis.dictionary.areaGrid"  render="Tree" />
    </item>
    <item id="detailedAddress" alias="详细地址" type="string" length="150" not-null="1"/>
    ...
    <item id="createUser" alias="创建人" type="string" length="20" not-null="1" defaultValue="%user.userId">
        <dic id="chis.dictionary.user01" render="Tree" onlySelectLeaf="true" keyNotUniquely="true" />
    </item>
    <item id="serviceDesc" alias="服务说明" type="string" length="200" xtype="textarea" colspan="2" rowspan="2" />
    <item id="dataSource" alias="数据来源" type="string" length="1"  display="0"/>
    <item id="fphm" alias="发票号码" type="string" length="32"  display="0"/>
    <item id="deleted" alias="删除标识" type="int" length="1"  display="0"/>
</entry>
