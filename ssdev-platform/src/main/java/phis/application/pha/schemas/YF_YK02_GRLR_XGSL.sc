...
<entry entityName="YF_YK02_GRLR" alias="药房盈亏个人录入" >
	...
	<item ref="b.PERSONNAME" alias="录入人员" fixed="true"/>
	<item id="YKSL" alias="实盘数量" length="10" precision="4" not-null="1" type="double" max="999999.99" min="0"/>
	<item id="YKDW" alias="单位" type="string" length="4" fixed="true"/>
	...
	<item id="YPGG" alias="药品规格" type="string" length="20" fixed="true" display="0"/>
	<item id="PQSL" alias="盘前数量" length="10" precision="2" not-null="1" type="double" max="999999.99" min="0" fixed="true" display="0"/>
	<item id="LSJG" alias="零售价格" length="12" precision="4" not-null="1" type="double" max="999999.9999" min="0" fixed="true" display="0"/>
	<item id="JHJG" alias="进货价格" length="12" precision="4" not-null="1" type="double" max="999999.9999" min="0" fixed="true" display="0"/>
	...
	<relations>
		<relation type="child" entryName="phis.application.cic.schemas.SYS_Personnel" >
			<join parent="LRRY" child="PERSONID"></join>
		</relation>
	</relations>
</entry>
