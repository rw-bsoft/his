...
<entry entityName="YF_DB01" alias="药房调拔01"  >
	...
	<item id="MBYF" alias="目标药房" length="18" type="long" fixed="true">
		<dic id="phis.dictionary.pharmacy_db" autoLoad="true"></dic>
	</item>
	<item id="SQRQ" alias="申请日期" type="datetime" defaultValue="%server.date.datetime"/>
	...
	<item id="TYPB" alias="退药判别" length="1" not-null="1" type="int" defaultValue="1" display="0"/>
