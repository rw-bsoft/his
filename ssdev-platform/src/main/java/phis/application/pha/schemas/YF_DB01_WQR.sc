...
<entry entityName="YF_DB01" alias="药房调拔01"  >
	...
	<item id="SQRQ" alias="申请日期" type="datetime" width="120"/>
	<item id="JHJE" alias="进货金额" type="double" precision="4" virtual="true"/>
	<item id="LSJE" alias="零售金额" type="double" precision="4" virtual="true"/>
