...
<entry entityName="YF_YK02_GRLR" alias="药房盈亏个人录入" sort="d.KWBM,b.YPMC,b.YPSX">
	...
	<item ref="b.YPMC" fixed="true" anchor="100%"/>
	...
	<item id="YKSL" alias="实盘数量" length="10" precision="2" not-null="1" type="double" max="999999.99" min="0"/>
