...
<entry entityName="YF_DB02" alias="药房调拔02"  >
	...
	<item id="YPSL" alias="申领数量" length="10" precision="2" not-null="1" type="double" min="0" max="999999.99"/>
	<item id="QRSL" alias="实发数量" length="10" precision="2" not-null="1" type="double" min="0" max="999999.99" fixed="true"/>
	...
	<item id="LSJE" alias="零售金额" length="12" precision="4" not-null="1" type="double" min="0" max="99999999.99" display="0"/>
	<item id="PFJE" alias="批发金额" length="12" precision="4"  type="double" min="0" max="99999999.99" display="0"/>
	<item id="JHJE" alias="进货金额" length="12" precision="4" not-null="1" type="double" min="0" max="99999999.99" display="0"/>
