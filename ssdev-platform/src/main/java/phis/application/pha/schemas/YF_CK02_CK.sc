...
<entry entityName="YF_CK02" alias="出库02"  >
	...
	<item id="PFJG" alias="批发价格" length="12" type="double" precision="6" not-null="1" display="0"/>	
	<item id="PFJE" alias="批发金额" length="12" type="double" precision="4" not-null="1" display="0"/>
	...
	<item id="CKSL" alias="出库数量" length="10" type="double" fixed="true" precision="2" not-null="1" width="80" min="0" max="999999.99"/>
