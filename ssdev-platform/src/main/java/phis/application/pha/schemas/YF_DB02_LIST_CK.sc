...
<entry entityName="YF_DB02" alias="药房调拔02" >
	...
	<item ref="b.YPMC"/>
	<item id="QRGG" alias="药房规格" type="string" length="20" fixed="true"/>
	<item id="QRDW" alias="单位" type="string" length="4"  fixed="true"/>
	<item id="YFGG" alias="药房规格" type="string" length="20" fixed="true" display="0"/>
	<item id="YFDW" alias="单位" type="string" length="4" fixed="true" width="60" display="0"/>
	...
	<item id="YPSL" alias="申领数量" length="10" precision="2" not-null="1" type="double" min="-999999.99" max="999999.99" fixed="true"/>
	<item id="QRSL" alias="实发数量" length="10" precision="2" not-null="1" type="double" min="-999999.99" max="999999.99" />
	...
	<item id="LSJE" alias="零售金额" length="12" precision="4" not-null="1" type="double" min="-99999999.99" max="99999999.99" display="0"/>
	<item id="PFJE" alias="批发金额" length="12" precision="4"  type="double" min="-99999999.99" max="99999999.99" display="0"/>
	<item id="JHJE" alias="进货金额" length="12" precision="4" not-null="1" type="double" min="-99999999.99" max="99999999.99" display="0"/>
