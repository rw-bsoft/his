...
<entry id="YF_YFLB" tableName="YF_YFLB" alias="药房列表" sort="a.YFSB">
	...
	<item id="YFMC" alias="药房名称" layout="JBXX" disableKeyFilter ="true" not-null="1"  length="30">
	</item>
	...
	<item id="SJJG" alias="上级发药机构"   length="20" layout="JBXX" width="150">
		<dic id="phis.@manageUnit" slice="0"/> 	
	</item>
	<item id="SJYF" alias="上级发药药房"   length="18" type="long" layout="JBXX" width="150">
	...
	<item id="LYKS" alias="领药科室" type="string" defaultValue="0" display="2" layout="FYKS"  width="500" length="200" >
		<dic id="phis.dictionary.publicDepartment" render="Checkbox" autoLoad="true" searchField="PYDM" columnWidth="150" columns="3"/>
	</item>
