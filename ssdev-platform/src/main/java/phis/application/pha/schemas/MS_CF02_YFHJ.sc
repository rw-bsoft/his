...
<entry entityName="MS_CF02_YFHJ" tableName="MS_CF02" alias="药房划价_处方02"
	version="1331024845687" sort="a.CFSB,a.YPZH,a.SBXH">
	<!-- 药品基本信息 -->
	...
	<item id="CF_NEW" alias=" " width="25" type="string" fixed="true" virtual="true"
		display="0" />
	<item id="CFLX_show" alias=" " fixed="true" width="25" virtual="true"
		renderer="renderCflx" />
	...
	<item id="YCJL" alias="剂量" width="60" type="double" precision="3"
		max="9999999.999" not-null="true" display="0" />
	...
	<item id="YYTS" alias="天数" not-null="true" type="int" width="50" display="0"
		defaultValue="1" max="99999999" />
	<item id="YPSL" alias="数量" width="80" type="int" defaultValue="1"
		max="99999999" />
