...
<entry entityName="YF_CK01" alias="出库01" sort="a.CKDH">
	...
	<item id="CKFS" alias="出库方式" length="4" not-null="1" display="2" type="int" pkey="true" fixed="true">
	...
	<item id="CKRQ" alias="出库日期" type="datetime" defaultValue="%server.date.datetime" display="2" fixed="true" />
	...
	<!--用户的工号,变量待查-->
	<item id="CZGH" alias="操作员" type="string" length="10" fixed="true" defaultValue="%user.userId">
