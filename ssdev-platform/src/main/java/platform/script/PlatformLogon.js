...
$import("util.rmi.miniJsonRequestSync", "util.rmi.miniJsonRequestAsync",
		"util.codec.RSAUtils")
platform.script.PlatformLogon = function(config) {
	this.forConfig = false
	this.deep = false
	this.photoHome = "photo/"
	this.requestDefineDeep = 3
	platform.script.PlatformLogon.superclass.constructor.apply(this, [config]);
}

Ext.extend(platform.script.PlatformLogon, app.desktop.Module, {
	init : function() {
