...
<entry entityName="SYS_Organization" alias="机构报表">
	...
	<item id="speciality" alias="业务特长" type="string"  colspan="3" width="250" height="50" xtype="textarea" length="500"/>
	<item id="grade" alias="机构级别" type="string">
		<dic id="platform.reg.dictionary.grade"/>
	</item>
	<item id="institLevel" alias="机构等次" type="string">
