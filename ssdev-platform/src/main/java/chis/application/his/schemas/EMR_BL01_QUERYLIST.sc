...
<entry alias="病历01表" entityName="EMR_BL01">
	<item id="BLMC" alias="病历名称" length="100" width="160"/>
	<item id="BLLB" alias="病历类别" type="int" length="9">
		<dic id="phis.dictionary.caseFramework"/>
	</item>
	<item id="SXYS" alias="医生" type="long" length="18">
		<dic id="phis.dictionary.user06" filter="['eq',['$','item.properties.manageUnit'],['$','%user.manageUnit.id']]"/>
	</item>
	<item id="CJKS" alias="科室" length="10">
		<dic id="phis.dictionary.department" filter="['eq',['$','item.properties.JGID'],['$','%user.manageUnit.id']]"/>
	</item>
	...
	<item id="BRBH" alias="病人编号" length="18" display="0"/>
	...
	<item id="JLSJ" alias="记录时间" type="date" display="0"/>
	<item id="XTSJ" alias="创建时间" type="date" display="0"/>
	...
	<item id="BRCH" alias="病人床号" length="10" display="0"/>
	<item id="BRNL" alias="病人年龄" length="20" display="0"/>
	...
	<item id="JGID" alias="医疗机构" type="string" length="20" display="0">
	...
	<item id="MBBH" alias="指定模板" length="9" display="0">
		<dic id="phis.dictionary.model"/>
	</item>
	<item id="SSYS" alias="所属医生" length="8" display="0">
		<dic id="phis.dictionary.user06" filter="['eq',['$','item.properties.manageUnit'],['$','%user.manageUnit.id']]"/>
	</item>
