...
<entry entityName="MS_YJ02_CIC" tableName="MS_YJ02" alias="门诊医技单02表" sort="YJZH ,SBXH asc">
	...
	<item ref="c.ZXRQ" alias="执行时间" type="datetime" length="20" width="150" display="1"/>
	<item id="YJZH" type="int" length="1" fixed="true" width="30" display="0" renderer="showColor" />
	...
	<item ref="b.FYMC" alias="项目名称" mode="remote" width="240"/>
	<item id="YLSL" alias="数量" type="double" length="8" precision="2" max="999999.99" min="0.01" defaultValue="1"/>
	<item ref="b.FYDW" fixed="true"/>
	<item id="YLDJ" alias="医疗单价" type="double" length="10" display="0" precision="2" defaultValue="0" nullToValue="0"/>
	
	<item id="HJJE" alias="划价金额" type="double" fixed="true" display="0" length="12" precision="2" not-null="1"/>
	...
	<item id="ZFBL" alias="自负比例" type="double" display="0" length="6" precision="3" nullToValue="0" defaultValue="1" fixed="true"/>
	<item id="BZXX" alias="备注信息" type="string" length="255"/>
	<item ref="c.ZXPB" display="0"/>
	<item id="SFZX" alias="是否执行" length="20" type="string" virtual="true"/>
	...
	<relations>
		...
		<relation type="parent" entryName="chis.application.his.schemas.MS_YJ01_CIC">
			<join parent="YJXH" child="YJXH"></join>
		</relation>
	</relations>
</entry>
