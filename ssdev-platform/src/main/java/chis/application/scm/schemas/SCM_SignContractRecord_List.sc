...
<entry entityName="chis.application.scm.schemas.SCM_SignContractRecord" sort="a.createDate desc" alias="签约表">
	...
	<item id="payOrNot" alias="是否收费" type="string" length="20" fixed="true">
		<dic>
			<item key="1" text="是" />
			<item key="2" text="否" />			
		</dic>
	...
	<item ref="b.contactPhone" display="1" fixed="true" group="居民信息 "/>
	<!-- <item ref="c.regionCode_text" display="1" group="居民信息 "/>
	<item ref="c.empiId" alias = "asasas" display="1" group="居民信息 " />
	<item ref="c.manaUnitId"  display="1" queryable="true" group="居民信息 "/>
	<item ref="c.phrId" alias="档案编号"  display="1" queryable="true" group="居民信息 " /> -->
	...
	<item id="createUnit" alias="签约团队" type="string" length="20" not-null="1" queryable="true"  width="180">
        <dic id="chis.dictionary.scm_team" render="Tree" onlySelectLeaf="true"  parentKey="%user.manageUnit.id"/>
    </item>
	...
	<item id="app" alias="签约来源" type="string" length="1" queryable="true" defaultValue="0" not-null="1" fixed="true" group="签约信息" >
		<dic>
			<item key="0" text="电脑" />
	...
	<item id="peopleFlag" alias="人群分类" type="string" not-null="1" length="2" queryable="true" width="800" group="签约信息"  >
		<dic render="LovCombo">
