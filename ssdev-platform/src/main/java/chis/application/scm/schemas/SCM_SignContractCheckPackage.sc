...
<entry entityName="chis.application.scm.schemas.SCM_SignContractCheckPackage" tableName="SCM_ServicePackageItems" sort="b.sortNumberSP,a.sortNumberSPI" alias="签约服务包项目表">
    <item id="SPIID" alias="服务包项目编号" type="string" length="20" generator="assigned" pkey="true" width="120" not-null="1"
    ...
    <item ref="c.parentCode" alias="父节点编码" type="string" length="20" display="0" hidden="true"/>
    ...
    <item ref="b.packageIntendedPopulation" width="75" display="1" fixed="true" hidden="true"/>
    <item ref="c.intendedPopulation" display="1" width="150" fixed="true"/>
    <item id="SERVICETIMES" alias="服务次数" type="int" length="3" display="1" width="75"  readOnly="true" />
   ...
   <item ref="c.price" alias="单价" display="0" readOnly="true" fixed="true"/>
    ...
    <item ref="c.hisZFBL" display="1"  width="75"  readOnly="true" hidden="true"/>
     <item ref="b.remark" display="0" width="300" readOnly="true" hidden="true"/>    
