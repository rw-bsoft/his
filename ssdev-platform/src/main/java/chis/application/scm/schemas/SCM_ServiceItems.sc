...
<entry entityName="chis.application.scm.schemas.SCM_ServiceItems" alias="签约服务项目表">
    ...
    <item id="serviceTimes" alias="服务次数" type="int" length="3" group="基础信息"/><!--此处服务次数用于标记减免次数  group="基础信息" -->
    ...
    <item id="intendedPopulation" alias="适应人群" type="string" colspan="2" length="1" not-null="1" queryable="true"  defaultValue="9" group="公卫信息">
