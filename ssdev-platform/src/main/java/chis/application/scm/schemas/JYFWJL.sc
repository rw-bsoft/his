...
<entry entityName="chis.application.scm.schemas.JYFWJL" alias="家医服务记录列表" sort="recodeId desc">
	...
	<item ref="b.sexCode" alias="性别" type="string" length="1" fixed="true" display="1"  queryable="true" update="false">
		<dic id="chis.dictionary.gender"/>
	</item>   	  
	<item ref="b.idCard" alias="身份证号码" type="string" width="150" queryable="true" update="false"/>
	...
	<item id="name" alias="姓名" type="string"  length="100" display="2" />
	<item id="sex" alias="性别" type="string"  length="100" display="2" />
	<item id="age" alias="年龄" type="string"  length="100"  />
	<item id="telephone" alias="电话" type="string"  length="100" display="2" />
	
	<item id="isjkgl" alias="健康管理服务" type="string" fixed="true" length="10"   display="2">
		<dic>
			<item key="0" text="无"/>
			<item key="1" text="有"/>
		</dic>
	</item>
	<item id="isjksj" alias="健康数据监测" type="string" fixed="true" length="10"  display="2">
		<dic>
			<item key="0" text="无"/>
			<item key="1" text="有"/>
		</dic>
	</item>
	<item id="ishlyy" alias="合理用药指导" type="string" fixed="true" length="10"  display="2">
	<dic>
			<item key="0" text="无"/>
			<item key="1" text="有"/>
		</dic>
	</item>
	<item id="ispsyz" alias="配送医嘱内药品" type="string" fixed="true" length="10"  display="2">
		<dic>
			<item key="0" text="无"/>
			<item key="1" text="有"/>
		</dic>
	</item>
	<item id="islxdc" alias="联系代采购药品" type="string" fixed="true" length="10"  display="2">
		<dic>
			<item key="0" text="无"/>
			<item key="1" text="有"/>
		</dic>
	</item>
	<item id="isfyjk" alias="妇幼健康项目咨询服务" type="string" fixed="true" length="10"  display="2">
		<dic>
			<item key="0" text="无"/>
			<item key="1" text="有"/>
		</dic>
	</item>
	<item id="iskzmx" alias="开展慢性病等重点人群自我管理小组活动" type="string" fixed="true" length="10"  display="2">
		<dic>
			<item key="0" text="无"/>
			<item key="1" text="有"/>
		</dic>
	</item>
	<item id="iszyyj" alias="中医药健康管理" type="string" fixed="true" length="10"  display="2">
		<dic>
			<item key="0" text="无"/>
			<item key="1" text="有"/>
		</dic>
	</item>
	<item id="isbyzd" alias="避孕指导、药具发放" type="string" fixed="true" length="10"  display="2">
		<dic>
			<item key="0" text="无"/>
			<item key="1" text="有"/>
		</dic>
	</item>
	<item id="iszzyy" alias="转诊、预约就诊等联络" type="string" fixed="true" length="10"  display="2">
		<dic>
			<item key="0" text="无"/>
			<item key="1" text="有"/>
		</dic>
	</item>
	<item id="isyytj" alias="预约体检时间" type="string" fixed="true" length="10"  display="2">
		<dic>
			<item key="0" text="无"/>
			<item key="1" text="有"/>
		</dic>
	</item>
	<item id="isjdtj" alias="解读体检报告" type="string" fixed="true" length="10"  display="2">
		<dic>
			<item key="0" text="无"/>
			<item key="1" text="有"/>
		</dic>
	</item>
	<item id="isxlgh" alias="心理关怀" type="string" fixed="true" length="10"  display="2">
		<dic>
			<item key="0" text="无"/>
			<item key="1" text="有"/>
		</dic>
	</item>
	<item id="iskzjy" alias="开展家医签约" type="string" fixed="true" length="10"  display="2">
		<dic>
			<item key="0" text="无"/>
			<item key="1" text="有"/>
		</dic>
	</item>
	<item id="isqt" alias="其他" type="string" fixed="true" length="10"  display="2">
		<dic>
			<item key="0" text="无"/>
			<item key="1" text="有"/>
		</dic>
	...
	<item id="createUnit" alias="录入机构" type="string" length="20" queryable="true" update="false"
