...
<entry entityName="chis.application.cvd.schemas.CVD_AssessRegister" alias="心血管危险因素评估登记表"
	...
	<item id="homeAddress" alias="家庭地址" type="string" length="100"
		colspan="2" display="2" />
	...
	<item id="height" alias="身高(cm)" type="double" length="6"
		precision="2" enableKeyEvents="true" not-null="1" display="2"  maxValue="9999.99"/>
	<item id="weight" alias="体重(kg)" type="double" length="6"
		precision="2" enableKeyEvents="true" not-null="1" display="2"  maxValue="9999.99"/>
	<item id="bmi" alias="BMI" type="double" length="6"  fixed="true"
		precision="2" enableKeyEvents="true"  display="2"  maxValue="9999.99" virtual ="true"/>
	<item id="waistLine" alias="腰围(cm)" type="double" length="6"
		precision="2" enableKeyEvents="true" not-null="1" display="2"  maxValue="9999.99"/>
	<item id="hipLine" alias="臀围(cm)" type="double"  length="6"  precision="2"   enableKeyEvents="true" not-null="1" display="2"  maxValue="99999"/>
	<item id="wh" alias="腰臀比" type="double" length="6"
		precision="2" enableKeyEvents="true"  display="2"  maxValue="9999.99" virtual ="true"/>
	<item id="tc" alias="总胆固醇(mmol/L)" length="8" precision="2" type="double"  maxValue="999999.99"
		enableKeyEvents="true" display="2" />
	<item id="ldl" alias="低密度脂蛋白" length="8" precision="2" type="double"  maxValue="999999.99"
		display="2" />
	<item id="th" alias="TC/HDL-C" type="double" length="6"
		precision="2" enableKeyEvents="true"  display="2"  maxValue="9999.99" virtual ="true"/>
	<item id="hdl" alias="高密度脂蛋白" length="8" precision="2" type="double"  maxValue="999999.99"
		enableKeyEvents="true" display="2" />
	<item id="tg" alias="甘油三酯" length="8" precision="2" display="2"  maxValue="999999.99"
		type="double" />
	<item id="diabetes" alias="是否糖尿病" type="string" length="1"
		not-null="1" display="2">
		<dic id="chis.dictionary.yesOrNo" />
	</item>
	<item id="fbs" alias="空腹血糖(mmol/L)" type="double" length="8"  maxValue="999999.99"
		precision="2" display="2" not-null="1" />
	<item id="pbs" alias="餐后血糖(mmol/L)" type="double" length="8"  maxValue="999999.99"
		precision="2" display="2" not-null="1"/>
	<item id="rbs" alias="随机血糖(mmol/L)" type="double" length="8"  maxValue="999999.99"
		precision="2" display="2" />
	<item id="hypertension" alias="是否有高血压" type="string" length="1" not-null="1"
		display="2">
		<dic id="chis.dictionary.yesOrNo" />
	</item>
	...
	<item id="hypertensionTreat" alias="是否高血压治疗" type="string" length="1"
		not-null="1" display="2" defaultValue="n">
		<dic id="chis.dictionary.yesOrNo" />
	</item>
	...
	<item id="inputDate" alias="评测日期" type="date" defaultValue="%server.date.date"
		not-null="true">
	</item>
	<item id="inputUnit" alias="建档机构" type="string" length="20" width="180"
		update="false" colspan="2" defaultValue="%user.manageUnit.id">
		<dic id="chis.@manageUnit" includeParentMinLen="6" render="Tree"
			onlySelectLeaf="true" parentKey="%user.manageUnit.id" />
		<set type="exp">['$','%user.manageUnit.id']</set>
	</item>
	<item id="inputUser" alias="建档人员" type="string" not-null="1"
	...
	<item id="lastModifyDate" alias="最后修改日期" type="timestamp" xtype="datefield"
