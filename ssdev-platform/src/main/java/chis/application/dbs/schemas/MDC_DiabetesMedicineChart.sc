...
<entry entityName="chis.application.dbs.schemas.MDC_DiabetesMedicineChart" alias="糖尿病服药情况">
	...
	<item id="medicineType" alias="药物种类" type="string"
		...
		<dic id="chis.dictionary.medicineTypeTNB"/>
	</item>
	<item id="medicineName" alias="药物名称" type="string" not-null="1"
		length="50" width="120" colspan="2" mode="remote">
	</item>

	<item id="medicineFrequency" alias="用法" type="string" not-null="1"
		length="20" >
		<dic id="chis.dictionary.medicineFrequency"/>
	</item>
	<item id="days" alias="天数" type="int" length="20" display="0"
		defaultValue="1" />

	<item id="medicineDosage" alias="每次剂量" type="String" not-null="1" length="100" enableKeyEvents="true"/>
	<item id="medicineMoring" alias="早上剂量" type="double" length="10" enableKeyEvents="true" display="0"/>
	<item id="medicineNoon" alias="中午剂量" type="double" length="10" enableKeyEvents="true" display="0"/>
	<item id="medicineNight" alias="晚上剂量" type="double" length="10" enableKeyEvents="true" display="0"/>
	<item id="medicineSleep" alias="睡前剂量" type="double" length="10" enableKeyEvents="true" display="0"/>
	...
	<item id="otherMedicineDesc" alias="其他用药描述" type="string"
		length="100" colspan="2" width="150"  display="0"/>
