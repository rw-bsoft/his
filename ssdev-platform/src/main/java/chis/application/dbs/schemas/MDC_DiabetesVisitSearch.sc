...
<entry entityName="chis.application.dbs.schemas.MDC_DiabetesRecord" sort="a.createDate desc" version="1332292315384" filename="D:\Program Files\eclipse3.6\workspace\BSCHIS22\WebRoot\WEB-INF\config\schema\mdc/MDC_DiabetesRecord.xml">
    ...
    <item ref="d.recordId"  display="1" queryable="true"/> 
	...
	<item id="diagnosisDate" alias="确诊年月" type="date" display="2" defaultValue="%server.date.date" enableKeyEvents="true" not-null="1" maxValue="%server.date.date"/>
	...
	<item id="height" alias="身高(cm)" type="double" length="6" display="2" minValue="130" maxValue="250" not-null="1" enableKeyEvents="true"/>
	<item id="weight" alias="体重(kg)" type="double" length="6" display="2" minValue="20" maxValue="140" not-null="1" enableKeyEvents="true"/>
	<item id="bmi" alias="BMI" type="double" display="2" fixed="true" virtual="true"/>
	...
	<item id="createDate" alias="建档日期" type="date" update="false" fixed="true" defaultValue="%server.date.date" queryable="true">
	...
	<item id="lastModifyDate" alias="最后修改日期" type="datetime"  xtype="datefield"  defaultValue="%server.date.date" display="1">
