...
<entry alias="高血压档案" sort="a.createDate desc" entityName="chis.application.dbs.schemas.MDC_DiabetesRecord">
	...
	<item id="diabetesGroup" alias="糖尿病组别" type="string" length="2" display="1" fixed="true" queryable="true" defaultValue="01">
		<dic>
			<item key="01" text="一组"/>
			<item key="02" text="二组"/>
		</dic>
