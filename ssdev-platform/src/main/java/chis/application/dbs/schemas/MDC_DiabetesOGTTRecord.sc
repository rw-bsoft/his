...
<entry entityName="chis.application.dbs.schemas.MDC_DiabetesOGTTRecord" alias="糖尿病高危档案" sort="a.OGTTID desc">
	...
	<item id="fbs1" alias="空腹血糖(mmol\L)" type="double" length="6" enableKeyEvents="true" group="第一次"/>
	<item id="pbs1" alias="餐后血糖(mmol\L)" type="double" length="6" enableKeyEvents="true" group="第一次"/>
	<item id="result1" alias="结果" type="string" length="1" fixed="true" group="第一次">
		<dic id="chis.dictionary.OGTTResult"/>
	</item>
	<item id="checkUser1" alias="核实人" type="string" length="20" queryable="true" group="第一次">
		<dic id="chis.dictionary.user" render="Tree" onlySelectLeaf="true" parentKey="%user.manageUnit.id"/>
	</item>
	<item id="checkDate1" alias="核实日期" type="date" queryable="true" group="第一次">
	</item>
	<item id="clinicSymptom1" alias="有临床症状" type="string" length="1" group="第一次">
		<dic id="chis.dictionary.haveOrNot"/>
	</item>
	<item id="fbs2" alias="空腹血糖(mmol\L)" type="double" length="6" enableKeyEvents="true" group="第二次"/>
	<item id="pbs2" alias="餐后血糖(mmol\L)" type="double" length="6" enableKeyEvents="true" group="第二次"/>
	<item id="result2" alias="结果" type="string" length="1" fixed="true" group="第二次">
		<dic id="chis.dictionary.OGTTResult"/>
	</item>
	<item id="checkUser2" alias="核实人" type="string" length="20" queryable="true" group="第二次">
		<dic id="chis.dictionary.user" render="Tree" onlySelectLeaf="true" parentKey="%user.manageUnit.id"/>
	</item>
	<item id="checkDate2" alias="核实日期" type="date" queryable="true" group="第二次">
	</item>
	<item id="clinicSymptom2" alias="有临床症状" type="string" length="1" group="第二次">
		<dic id="chis.dictionary.haveOrNot"/>
	</item>
	<item id="fbs3" alias="空腹血糖(mmol\L)" type="double" length="6" enableKeyEvents="true" group="第三次"/>
	<item id="pbs3" alias="餐后血糖(mmol\L)" type="double" length="6" enableKeyEvents="true" group="第三次"/>
	<item id="result3" alias="结果" type="string" length="1" fixed="true" group="第三次">
		<dic id="chis.dictionary.OGTTResult"/>
	</item>
	<item id="checkUser3" alias="核实人" type="string" length="20"  queryable="true" group="第三次">
		<dic id="chis.dictionary.user" render="Tree" onlySelectLeaf="true" parentKey="%user.manageUnit.id"/>
	</item>
	<item id="checkDate3" alias="核实日期" type="date" queryable="true" group="第三次">
	</item>
	<item id="clinicSymptom3" alias="有临床症状" type="string" length="1" group="第三次">
		<dic id="chis.dictionary.haveOrNot"/>
	</item>
