...
<entity>
	<permissions>
		...
		<p principal="T04" mode="15">
			<conditions>			 
				<filter action="query">
					['like',['$','a.manaUnitId'],['concat',['substring',['$','%user.manageUnit.id'], 0,9],['s','%']]]
				</filter>			
			</conditions>
		</p>
		<p principal="T05" mode="15">
			<conditions>			 
				<filter action="query">
					['like',['$','a.manaUnitId'],['concat',['substring',['$','%user.manageUnit.id'],
						0,9],['s','%']]]
				</filter>			
			</conditions>
		</p>
		...
		<p principal="T08" mode="15">
			<conditions>			 
				<filter action="query">
					['or',['like',['$','a.manaUnitId'],['concat',['$','%user.manageUnit.id'],['s','%']]], ['eq',['$','a.createUser'],["$",'%user.userId']]]
				</filter>			
			</conditions>
		</p>
