...
<entry entityName="chis.application.mhc.schemas.MHC_PregnantRecord" alias="孕妇基本信息"
  ...
  <item id="empiId" alias="EMPIID" length="32" not-null="1"   type="string" 
    display="0" />
  <item id="phrId" alias="健康档案编号" length="30" width="160" display="1"   type="string" 
    not-null="1" queryable="true"/>
  <item id="pregnantBookId" alias="孕册号" length="50" width="160"   type="string" 
    not-null="1" anchor="100%" queryable="true"/>
  <item id="manaDoctorId" alias="责任医生" type="string" length="20" width="160"  not-null="1" queryable="true" fixed="true">
    <dic id="chis.dictionary.user01" render="Tree" onlySelectLeaf="true"  parentKey="%user.manageUnit.id"/>
  </item>
  <item id="ownerArea" alias="孕妇归属地"  type="string"  width="160" length="16"
    defaultValue="1" not-null="1"  update="false" >  
    <dic id="chis.dictionary.pregnantOwnerArea" />
  </item>
  <item id="homeAddress" alias="户籍地址" length="25"   type="string"    colspan="2" update="false" not-null="1" width="300">
  ...
  <item id="homeAddress_text" alias="户籍地址" type="string" length="200" display="0" width="300"/>
  <item id="mhcDoctorId" alias="妇保医生" type="string" length="20"
    not-null="1" width="160" update="false">
  ...
  <item id="manaUnitId" alias="管辖机构" type="string" length="20"
    fixed="true" not-null="1" colspan="2" queryable="true" width="180">
    <dic id="chis.@manageUnit" includeParentMinLen="6"  render="Tree" onlySelectLeaf="true" lengthLimit="9" querySliceType="0"/>
  </item>
  <item id="restRegionCode" alias="产休地" length="25" display="2"  type="string" 
    colspan="2" not-null="1" update="false" width="200">
    <dic id="chis.dictionary.areaGrid" minChars="4" includeParentMinLen="6" filterMin="10" filterMax="18" render="Tree" onlySelectLeaf="true" />
  </item>
  <item id="restRegionCode_text" type="string" length="200" display="0"/>
  <item id="realRegionCode" alias="居(暂)住地址" length="21" colspan="2"  type="string" 
  ...
  <item id="residenceCode" alias="居(暂)住证号" width="160" length="20"
    type="string"  fixed="true" queryable="true"/>
  ...
  <item id="vaginalDelivery" alias="阴道分娩次数" not-null="1" type="int"  width="100"/>
  ...
  <item id="preGestationMode" alias="终止方式" length="20" display="2"  type="string">
    <dic id="chis.dictionary.gestationMode" minChars="1" render="Tree" onlySelectLeaf="true" />
  </item>
  <item id="preDeliveryDate" alias="前次分娩日期" type="date" display="2" />
  <item id="preDeliveryMode" alias="分娩方式" length="20" display="2"  type="string">
    <dic id="chis.dictionary.deliveryType" render="Tree" minChars="1" onlySelectLeaf="true" />
  </item>
  ...
  <item id="dbp" alias="舒张压(mmHg)" display="2" type="int" minValue="10"
    maxValue="500" enableKeyEvents="true" validationEvent="false" not-null = "1" />
  <item id="gestationNeuropathy" alias="妊娠并发症史" length="20"  type="string"
    display="2" colspan="2" />
  <item id="pastHistory" alias="既往病史"  type="string"  length="20" display="2" >
    <dic render="LovCombo">
      <item key="1" text="无" />
      <item key="2" text="心脏病" />
  ...
  <item id="otherPastHistory" alias="其他既往病史" length="100" display="2"   type="string"
    colspan="2" fixed="true" />
  <item id="unusualBone" alias="异常孕产史" length="100" display="2"   type="string"
    colspan="2" not-null="1" defaultValue="无" />
  <item id="familyHistory" alias="家族史" length="10" display="2"   type="string">
    <dic render="LovCombo">
  ...
  <item id="otherFamilyHistory" alias="其他家族史" length="200" display="2"   type="string"
    colspan="2" fixed="true" />
  <item id="operationHistory" alias="手术史" length="100" display="2"  type="string"
    colspan="2" fixed="true" />
  <item id="personHistory" alias="个人史" length="20" display="2"  type="string">
    <dic render="LovCombo">
      <item key="1" text="吸烟" />
      <item key="2" text="饮酒" />
  ...
  <item id="otherPersonHistory" alias="其他个人史" length="200" display="2"  type="string"
    colspan="2" fixed="true" />
  <item id="gynecologyOPS" alias="妇科手术史" length="100" display="2"   type="string"
    colspan="2" />
  <item id="allergicHistory" alias="过敏史" length="100" display="2"   type="string"
    fixed="true" colspan="2" />
  <item id="husbandEmpiId" alias="丈夫EMPIID" length="32"  display="0"  type="string"/>
  <item id="husbandPhrId" alias="丈夫健康档案" length="30" hidden="true"   type="string"/>
  <item id="husbandFamilyHistory" alias="丈夫家族史" length="100"   type="string"
    fixed="true" display="2" colspan="2" />
  <item id="gestationalWeeks" alias="建册孕周" fixed="true" not-null="1"
    type="int" width="100" />
  <item id="createUnit" alias="建册单位" type="string" length="20" update="false"
    width="180" defaultValue="%user.manageUnit.id"   not-null="1"     anchor="100%" fixed="true" colspan="2">
    <dic id="chis.@manageUnit" includeParentMinLen="6"  render="Tree" onlySelectLeaf="true"
      parentKey="%user.manageUnit.id" />
    <set type="exp">['$','%user.manageUnit.id']</set>
  </item>
  <item id="createUser" alias="建册医生" type="string" length="20" update="false"
    fixed="true"  defaultValue="%user.userId"   not-null="1"     queryable="true">
    <dic id="chis.dictionary.user" render="Tree" onlySelectLeaf="true"
      parentKey="%user.manageUnit.id" />
    <set type="exp">['$','%user.userId']</set>
  </item>
  <item id="createDate" alias="建册日期" type="datetime"  xtype="datefield"  fixed="true" update="false"
    defaultValue="%server.date.today" queryable="true"   not-null="1">
    <set type="exp">['$','%server.date.datetime']</set>
  </item>
  <item id="status" alias="状态" length="1" hidden="true"  type="string"
    defaultValue="0">
    <dic>
      <item key="0" text="正常" />
      <item key="1" text="已注销" />
