...
<entity>
	<permissions>
		...
		<p principal="T04" mode="15">
			<conditions>			 
				<filter action="query">
					['like',['$','a.checkManaUnit'],['concat',['substring',['$','%user.manageUnit.id'], 0,9],['s','%']]]
				</filter>			
			</conditions>
		</p>
		<p principal="T05" mode="15">
			<conditions>			 
				<filter action="query">
					['like',['$','a.checkManaUnit'],['concat',['substring',['$','%user.manageUnit.id'],
						0,9],['s','%']]]
				</filter>			
			</conditions>
		</p>
		...
		<p principal="T07" mode="15">
			<conditions>			 
				<filter action="query">
					['like',['$','a.checkManaUnit'],['concat',['$','%user.manageUnit.id'],['s','%']]]
				</filter>			
			</conditions>
		</p>
