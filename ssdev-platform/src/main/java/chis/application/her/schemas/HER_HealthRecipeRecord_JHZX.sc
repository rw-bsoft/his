...
<entry entityName="chis.application.her.schemas.HER_HealthRecipeRecord_JHZX" alias="健康处方维护">
	...
	<item id="guideWay" alias="指导途径" type="string" length="2" defaultValue="06" hidden="true">
		<dic>
			<item key="01" text="门诊"/>
