...
<entry entityName="chis.application.her.schemas.HER_HealthRecipeRecord_MZ" alias="健康处方维护">
	...
	<item id="examineUnit" alias="就诊机构" type="string" length="50" width="100"/>
	...
	<item id="guideUser" alias="指导医生" type="string" length="20" width="150" defaultValue="%user.userId">
		<dic id="chis.dictionary.user" render="Tree" onlySelectLeaf="true"   parentKey="%user.manageUnit.id"/>
	</item>
	<item id="healthTeach" alias="指导建议" type="string" height="340" length="2000" width="200" colspan="3" xtype="textarea">
	</item>
	<item id="guideWay" alias="指导途径" type="string" length="2" defaultValue="01">
		<dic>
			<item key="01" text="门诊"/>
