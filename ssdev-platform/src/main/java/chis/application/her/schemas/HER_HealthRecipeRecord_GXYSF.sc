...
<entry entityName="chis.application.her.schemas.HER_HealthRecipeRecord_GXYSF" alias="健康处方维护">
	...
	<item id="guideWay" alias="指导途径" type="string" length="2" defaultValue="02" hidden="true">
		<dic>
			<item key="01" text="门诊"/>
	...
	<item id="inputUnit" alias="录入机构" type="string" update="false" length="20" hidden="true" fixed="true" defaultValue="%user.manageUnit.id" width="150">
		<dic id="chis.@manageUnit" includeParentMinLen="6"  render="Tree" onlySelectLeaf="true" parentKey="%user.manageUnit.id"/>
		<set type="exp">['$','%user.manageUnit.id']</set>
	</item>
	<item id="inputDate" alias="录入日期" type="datetime"  xtype="datefield" fixed="true" hidden="true" update="false"
		defaultValue="%server.date.today">
		<set type="exp">['$','%server.date.datetime']</set>
	</item>
	<item id="inputUser" alias="录入人" type="string" length="20" width="150" hidden="true" update="false" fixed="true" defaultValue="%user.userId">
		<dic id="chis.dictionary.user" render="Tree" onlySelectLeaf="true"   parentKey="%user.manageUnit.id"/>
