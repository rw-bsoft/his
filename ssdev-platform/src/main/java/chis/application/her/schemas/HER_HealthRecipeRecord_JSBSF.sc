...
<entry entityName="chis.application.her.schemas.HER_HealthRecipeRecord_JSBSF" alias="健康处方维护">
	...
	<item id="guideWay" alias="指导途径" type="string" length="2" defaultValue="05" hidden="true">
		<dic>
			<item key="01" text="门诊"/>
	...
	<item id="inputUnit" alias="录入机构" type="string" hidden="true" update="false" length="20" fixed="true" defaultValue="%user.manageUnit.id" width="150">
