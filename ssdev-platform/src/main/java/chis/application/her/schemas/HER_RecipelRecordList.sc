...
<entry entityName="chis.application.her.schemas.HER_RecipelRecord"  alias="健康教育处方" sort="a.recipelId desc">
	...
	<item id="recipelObjectType" alias="对象分类" type="string" length="2" not-null="1" width="80" queryable="true">
	...
	<item id="lastModifyDate" alias="最后修改日期" type="datetime"  xtype="datefield" width="150"
