...
<entry entityName="chis.application.her.schemas.HER_EducationPlanSet" alias="健康教育计划制定" sort="a.setId desc">
	...
	<item id="planType" alias="计划类型" type="string" length="50" not-null="1" queryable="true" width="150">
		<dic render="LovCombo">
			<item key="01" text="放VCD"/>
			<item key="02" text="版面巡展"/>
			<item key="03" text="咨询问卷"/>
			<item key="04" text="门诊问卷"/>
			<item key="05" text="小组讲座"/>
			<item key="06" text="小组讨论"/>
			<item key="07" text="大型讲座"/>
			<item key="08" text="妇科普查"/>
			<item key="09" text="门诊咨询"/>
			<item key="10" text="社区教育"/>
			<item key="11" text="发放资料"/>
			<item key="12" text="自检小屋"/>
			<item key="99" text="其它"/>
		</dic>
	</item>
	<item id="beginDate" alias="执行起始时间" type="date" queryable="true" not-null="1" />
	<item id="endDate" alias="执行终止时间" type="date" queryable="true" not-null="1" />
	...
	<item id="planDate" alias="计划制定时间" type="datetime"  xtype="datefield" fixed="true" update="false" defaultValue="%server.date.date">
