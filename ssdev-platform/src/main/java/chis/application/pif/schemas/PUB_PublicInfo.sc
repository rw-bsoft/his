...
<entry  entityName="chis.application.pif.schemas.PUB_PublicInfo"  alias="公告信息" sort="publishDate desc">
	...
	<item id="infoTitle" alias="信息主题" type="string" length="100"
		width="250" colspan="3" anchor="100%"  not-null="1" queryable="true"/>

	<item id="infoDesc" alias="信息内容" type="string" length="524288000"
		display="2" xtype="textarea" height="380" colspan="3" />

	<item id="publishUnit" alias="发布机构" type="string" length="20" update="false"  width="150" 
		defaultValue="%user.manageUnit.id" fixed="true" display="3">
		<dic id="chis.@manageUnit" includeParentMinLen="6"  render="Tree" onlySelectLeaf="true" parentKey="%user.manageUnit.id"/>
		<set type="exp">['$','%user.manageUnit.id']</set>
	</item>

	<item id="publishDate" alias="发布日期" type="datetime"  xtype="datefield" width="120" update="false"
	...
	<item id="publishUser" alias="发布人" type="string" length="20" update="false"
		defaultValue="%user.userId" fixed="true" display="3" queryable="true">
