...
<entry entityName="chis.application.cdh.schemas.CDH_DeadRegister" alias="儿童死亡登记表" sort="a.deadRegisterId desc">
  ...
  <item id="homeAddress" alias="户籍地址" length="25" anchor="100%"
    width="300" fixed="true" not-null="1">
  ...
  <item id="homeAddress_text" length="200" alias="户籍地址" display="0" width="300"/>
  ...
  <item id="motherEmpiId" alias="母亲编号" type="string" length="32"
    display="0" />
  <item id="birthday" alias="出生日期" type="date" fixed="true"  maxValue="%server.date.today"
  ...
  <item id="deathDate" alias="死亡日期" type="date" queryable="true" not-null="1" maxValue="%server.date.today"/>
  ...
  <item id="diagnose1" alias="死亡诊断" type="string" length="500"
    not-null="1" display="2"   anchor="100%" colspan="3" xtype="textarea" />
