<entry entityName="chis.application.cdh.schemas.CDH_CheckupThreeToSixPaper" alias="3～6岁儿童健康检查记录">
  ...
  <item id="weight" alias="体重(kg)" type="double" length="7"
  ...
  <item id="height" alias="身长(cm)" type="double" length="7"
    precision="1" not-null="1"  />
  ...
  <item id="hgb" alias="血红蛋白值(g/L)"  type="double" length="9" precision="2"/>
  <item id="other" alias="其他" type="string" length="64" colspan="3"/>
  <item id="tzbqhbhs" alias="吐字不清或不会说" type="string" length="1">
    <dic>
    	<item key="1" text="通过"/>
		<item key="2" text="不通过"/>
    </dic>
  </item>
  <item id="zyqbrcfj" alias="总要求别人重复讲" type="string" length="1">
    <dic>
    	<item key="1" text="通过"/>
		<item key="2" text="不通过"/>
    </dic>
  </item>
  <item id="jcyssbsz" alias="经常用手势表示主" type="string" length="1">
    <dic>
    	<item key="1" text="通过"/>
		<item key="2" text="不通过"/>
    </dic>
  ...
  <item id="illnessType" alias="两次随访间患病情况" type="string" length="20" defaultValue="0">
    <dic>
      <item key="0" text="无" height="20"/>
      <item key="1" text="肺炎" height="20"/>
      <item key="2" text="腹泻" height="20"/>
      <item key="3" text="外伤" height="20"/>
      <item key="4" text="其他" height="20"/>
    </dic>
  </item>
  <item id="pneumoniaCount" alias="肺炎次数" type="int" width="60" length="4"/>
  <item id="diarrheaCount" alias="腹泻次数" type="int" width="60" length="4"/>
  <item id="traumaCount" alias="外伤次数" type="int" width="60" length="4"/>
  <item id="otherCount" alias="其他次数" type="int" width="60" length="4"/>
  <item id="illnessName" alias="其他患病名称" type="string" width="300" length="80"/>
