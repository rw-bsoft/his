<entry entityName="chis.application.cdh.schemas.CDH_CheckupOneToTwo" alias="1～2岁儿童健康检查记录">
  ...
  <item id="checkupStage" alias="体检阶段" type="string" length="2" fixed="true"   not-null="1" anchor="100%">
    <dic id="chis.dictionary.childrenAge"  filter="['and',['ge',['$map',['s','key']],['s','12']],['lt',['$map',['s','key']],['s','36']]]"/>
  </item>
  ...
  <item id="bregmaClose" alias="前囟" type="string" length="1"  >
    <dic>
      <item key="1" text="闭合" />
      <item key="2" text="未闭" />
    </dic>
  ...
  <item id="gait" alias="步态" type="string" length="1"     defaultValue="1" >
    <dic id="chis.dictionary.hasAbnormal"/>
  </item>
  <item id="hgb" alias="血红蛋白值(g/L)"  type="double" length="6"     precision="2"/>
  <item id="development" alias="发育评估" type="string" length="1" colspan="2" >
    <dic>
      <item key="1" text="通过" />
      <item key="2" text="未过" />
    </dic>
  </item>
  <item id="kyglbtz" alias="可疑佝偻病体征" type="string" length="2">
    <dic>
      <item key="10" text="“O”型腿" />
      <item key="11" text="“X”型腿" />
    </dic>
  </item>
  <item id="yhhfy" alias="有呼唤反应" type="string" length="1">
    <dic>
      <item key="1" text="通过" />
      <item key="2" text="未过" />
    </dic>
  </item>
  <item id="zrwt" alias="指认物体" type="string" length="1">
    <dic>
      <item key="1" text="通过" />
      <item key="2" text="未过" />
    </dic>
  </item>
  <item id="wcdz" alias="完成动作" type="string" length="1">
    <dic>
      <item key="1" text="通过" />
      <item key="2" text="未过" />
    </dic>
  </item>
  <item id="mfsh" alias="模仿成人说话" type="string" length="1">
    <dic>
      <item key="1" text="通过" />
      <item key="2" text="未过" />
    </dic>
  ...
  <item id="fywss" alias="维生素(IU/日)" type="double" length="6"   precision="2"/>
  <item id="hbqk" alias="随访间患病情况" type="string" length="1" colspan="2">
    <dic>
      <item key="1" text="未患病" />
      <item key="2" text="患病" />
    </dic>
