...
<entry entityName="chis.application.cdh.schemas.CDH_HealthCard" alias="儿童保健卡" sort="a.createDate desc">
  <item id="phrId" pkey="true" alias="档案编号" type="string" length="30"
    width="160" not-null="1" fixed="true" queryable="true" display="1" />
  ...
  <item id="ownerArea" alias="归属地" width="160" length="2" not-null="1" colspan="1" update="false"  defaultValue="11">
    <dic>
  ...
  <item id="homeAddress" alias="户籍地址" length="25" colspan="2"
    anchor="100%" width="200" update="false" not-null="1"
    queryable="true">
  ...
  <item id="cdhDoctorId" alias="儿保医生" type="string" length="8"
  ...
  <item id="manaUnitId" alias="管辖机构" type="string" length="20" fixed="true" not-null="1" queryable="true" >
  ...
  <item id="healthNo" alias="保健号" type="string" length="20"
    not-null="1" />
  ...
  <item id="litters" alias="胎数" type="string" length="1" not-null="1"
    display="2">
    <dic>
  ...
  <item id="conception" alias="第几胎" type="int" display="2"
    not-null="1" />
  <item id="birth" alias="第几产" type="int" display="2" not-null="1" />
  <item id="birthWeight" alias="体重(kg)" type="bigDecimal" length="8"
    not-null="1" display="2" precision="2" />
  <item id="birthHeight" alias="身长(cm)" type="bigDecimal" length="8"  not-null="1"
  ...
  <item id="deliveryConditions" alias="产时情况" type="string" display="2"
    not-null="1" length="1" defaultValue="1">
    <dic>
  ...
  <item id="defectsType" alias="出生缺陷类型" type="string" length="100"
    width="180" fixed="true" display="2" anchor="100%">
  ...
  <item id="screenRecord" alias="新生儿疾筛" type="string" length="2"
    not-null="1" display="2" defaultValue="1">
    <dic>
      <item key="1" text="正常"></item>
  ...
  <item id="highRiskType" alias="高危儿分类" type="string" length="100"
    fixed="true" display="2" colspan="2">
    <dic id="chis.dictionary.highRiskType"  render="LovCombo"  />
  </item>
  <item id="otherType" alias="其他分类" type="string" length="100"
    fixed="true" display="2" colspan="2">
  </item>
  <item id="endManageFlag" alias="结案标志" type="string" length="1" defaultValue="n"
    fixed="true" queryable="true" hidden="true">
    <dic id="chis.dictionary.closeFlag" />
  </item>
  <item id="endManageUnit" alias="结案单位" type="string" length="20"
    fixed="true" display="2" colspan="2" anchor="100%" hidden="true">
    <dic id="chis.@manageUnit" includeParentMinLen="6"  render="Tree" onlySelectLeaf="true" />
  </item>
  <item id="endManageDoctor" alias="结案医生" type="string" length="20"
    fixed="true" display="2"  hidden="true">
    <dic id="chis.dictionary.user" render="Tree" onlySelectLeaf="true" />
  </item>
  <item id="endManageDate" alias="结案时间" type="date" fixed="true" hidden="true"  display="2" />
  <item id="createUnit" alias="建档机构" type="string" length="20" update="false"
    width="180" defaultValue="%user.manageUnit.id" anchor="100%" colspan="2"     fixed="true">
    <dic id="chis.@manageUnit" includeParentMinLen="6"  render="Tree" onlySelectLeaf="true" />
    <set type="exp">['$','%user.manageUnit.id']</set>
  </item>
  <item id="createUser" alias="建档人员" type="string" length="20" update="false"
