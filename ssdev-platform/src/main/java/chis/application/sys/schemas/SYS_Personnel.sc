...
<entry entityName="SYS_Personnel" alias="人员注册">
	...
	<item id="familyGroup" alias="所在团队" type="string" width="200" display="-1">
		<dic render="Tree" id="chis.dictionary.familygroup" />
	</item>
	<item id="groupLeader" alias="团队长" type="string" width="200" display="-1">
		<dic>
			<item key="1" text="是" />
			<item key="2" text="否" />
		</dic>
	...
	<item id="remark" alias="医生简介" type="string"  colspan="2"
