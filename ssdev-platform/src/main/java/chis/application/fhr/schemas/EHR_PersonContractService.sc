...
<entry entity-name="chis.application.fhr.schemas.EHR_FamilyContractService"
	alias="家庭签约服务项目">
	...
	<item ref="d.FC_Begin"/>	
    <item ref="d.FC_End"/>
    <item ref="d.FC_Stop_Date"/>
    <item ref="d.FC_Stop_Reason"/>
    <item ref="d.FC_Phone"/>	
    <item ref="d.FC_Mobile"/>
    <item ref="d.FC_Party"/>
    <item ref="d.FC_Party2"/>
    <item ref="d.FC_Repre"/>
	<relations>
