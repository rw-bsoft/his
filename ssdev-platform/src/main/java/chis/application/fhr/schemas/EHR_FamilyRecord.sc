...
<entry alias="家庭健康档案" sort="familyId desc">
	...
	<item id="regionCode" alias="网格地址" type="string" length="25" 
		queryable="true" width="200"  anchor="100%" update="false" colspan="2" not-null="1">
		<dic id="chis.dictionary.areaGrid_family"  render="Tree" onlySelectLeaf="true"  />
	</item>
	<item id="regionCode_text" alias="网格地址" type="string" length="100" display="2" not-null="1" />
	...
	<item id="familyAddr" alias="家庭地址" type="string" colspan="2" length="100" width="394"/>
	...
	<item id="writeOffDate" alias="注销日期" type="date" display="1" />
	<item id="status" alias="档案状态" type="string" length="1" display="1"  defaultValue="0">
		<dic>
