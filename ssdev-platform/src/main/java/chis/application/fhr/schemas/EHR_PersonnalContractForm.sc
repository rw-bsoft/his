...
<entry entity-name="chis.application.fhr.schemas.EHR_PersonnalContractBase"
	...
	<item ref="b.idCard" type="string" />
	<item ref="b.personName" fixed="true"/>
	<item id="FC_Repre" alias="签约居民" not-null="1" type="string" width="110" length="60"
		hidden="true" >
	</item>
	<item id="FC_Begin" alias="签约日期" not-null="1" type="date" />
	...
	<item id="FC_Party2" alias="居民签字" not-null="1" type="string" width="110" length="60" display="2" />
	<item id="FC_CreateDate" alias="记录日期" not-null="1" type="date" display="2"
		defaultValue="%server.date.date" fixed="true" />
	<item id="FC_CreateUser" alias="签约人" not-null="1" type="string" length="20" 
		display="2" defaultValue="%user.userId" queryable="true">
	...
	<relation type="parent"
		entryName="chis.application.mpi.schemas.MPI_DemographicInfo_Simple">
		<join parent="empiId" child="FC_Repre" />
	</relation>
	</relations>
</entry>
