...
<entry entityName="chis.application.fhr.schemas.EHR_FamilyMemberList" tableName="chis.application.hr.schemas.EHR_HealthRecord" alias="个人健康档案" sort="a.phrId desc" version="1332744636000" filename="E:\MyProject\BSCHISWorkspace\BSCHIS\WebRoot\WEB-INF\config\schema\ehr/EHR_HealthRecord.xml">
	...
	<item id="isAgrRegister" alias="是否农业户籍" type="string" length="1" not-null="1" width="90" queryable="true">
		<dic id="chis.dictionary.yesOrNo"/>
	</item>
	...
	<item id="cancellationUnit" alias="注销单位" type="string" length="20" width="180" >
