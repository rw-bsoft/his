...
<entry entityName="chis.application.phq.schemas.PHQ_GeneralCaseMany" tableName="chis.application.phq.schemas.PHQ_GeneralCase" alias="健康问卷—— 一般情况" sort="a.createDate desc">
	...
	<item id="cardNo" alias="卡号" type="string"  xtype="iccardfield" virtual="true" update="false" length="20" fixed="true" colspan="3" display="2"/>
	<item id="personName" alias="姓名" type="string" length="50" queryable="true" not-null="1" fixed="true" colspan="2"/>
	<item id="idCard" alias="身份证号" type="string" length="20" width="160" queryable="true" vtype="idCard" fixed="true" colspan="2"/>
	<item id="sexCode" alias="性别" type="String" length="1" queryable="true" fixed="true" not-null="1">
	...
	<item id="educationCode" alias="文化程度" type="string" length="2" colspan="4">
	...
	<item id="maritalStatusCode" alias="婚姻状况" type="string" length="2" colspan="4">
		<dic render="Radio" colWidth="120" columns="5">
			<item key="10" text="未婚"/>
			<item key="20" text="已婚"/>
	...
	<item id="averageRevenue" alias="最近平均收入" type="string" length="2" colspan="4">
	...
	<item id="unitNature" alias="单位性质" type="string" length="2" colspan="4">
		<dic render="Radio" colWidth="120" columns="5">
	...
	<item id="highRiskType" alias="类别" type="string" length="20" not-null="true" colspan="2">
	...
	<item id="content" alias="教育内容" type="string" length="2"  display="1">
		<dic>
