...
<entry entityName="chis.application.mov.schemas.MOV_ManaInfoBatchChange" alias="批量修改管理医生列表" sort="applyDate desc">
  ...
  <item id="targetDoctor" alias="现医生" type="string" length="20" fixed="true"
    not-null="1">
  ...
  <item id="applyUser" alias="申请人" type="string" length="20"
    ...
    <dic id="chis.dictionary.user05" render="Tree" onlySelectLeaf="true"  parentKey="['substring',['$','%user.manageUnit.id'],['i',0],['i',9]]" />
  </item>
  ...
  <item id="affirmUser" alias="确认人" type="string" length="20" fixed="true"
    queryable="true" >
    <dic id="chis.dictionary.user14" render="Tree" onlySelectLeaf="true"  parentKey="['substring',['$','%user.manageUnit.id'],['i',0],['i',9]]" />
  </item>
  ...
  <item id="affirmView" alias="确认人意见" type="string" length="500"
    colspan="2" display="2"  />
  <item id="movesub" alias="同时迁移子档" type="string" fixed="true" xtype="checkbox"  defaultValue="n" >
