...
<entry entityName="chis.application.mov.schemas.MOV_ManaInfoChange"  alias="修改档案管理医生迁移列表记录" sort="applyDate desc">
	...
	<item ref="c.manaUnitId"  length="20" width="160" display="1" hidden="true"/>
