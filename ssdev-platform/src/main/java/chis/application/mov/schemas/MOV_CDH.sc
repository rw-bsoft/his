...
<entry entityName="chis.application.mov.schemas.MOV_CDH"   alias="儿童户籍地址迁移列表" sort="applyDate desc">
	...
	<item id="targetCdhDoctorId" alias="现儿保医生" type="string" length="20">
		<dic id="chis.dictionary.user02" render="Tree" onlySelectLeaf="true" fixed="true"/>
	</item>
