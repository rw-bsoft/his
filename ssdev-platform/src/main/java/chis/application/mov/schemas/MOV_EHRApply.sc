...
<entry entityName="chis.application.mov.schemas.MOV_EHR"  alias="档案迁移记录" sort="applyDate desc">
	...
	<item id="archiveType" alias="档案类别" type="string" length="1"
		not-null="1" queryable="true" defaultValue="1">
		<dic>
	...
	<item id="sourceArea" alias="原网格地址" type="string" length="25" 
		not-null="1" width="200"  queryable="true" fixed="true" >
	...
	<item id="sourceArea_text" alias="原网格地址" type="string" length="200"/>
	...
	<item id="sourceUnit" alias="原管辖机构" type="string" length="20"
		width="320" not-null="true" queryable="true"  fixed="true">
		<dic id="chis.@manageUnit" includeParentMinLen="6" render="Tree"
			onlySelectLeaf="true" />
	</item>
	<item id="targetArea" alias="现网格地址" type="string"  length="25" 
		width="200" not-null="1"  queryable="true" >
		<dic id="chis.dictionary.areaGrid"  render="Tree" onlySelectLeaf="true"/>
	</item>
	<item id="targetArea_text" alias="现网格地址" type="string"  length="200"/>
	<item id="targetDoctor" alias="现责任医生" type="string" length="20" not-null="true" queryable="true">
	...
	<item id="targetUnit" alias="现管辖机构" type="string" length="20"
		width="320" not-null="true"  queryable="true">
		<dic id="chis.@manageUnit" includeParentMinLen="6" render="Tree" onlySelectLeaf="true"/>
	</item>
	<item id="applyReason" alias="申请原因" type="string" length="500"
		display="2" />
	<item id="applyUnit" alias="申请机构" type="string" length="20" width="320" 
	...
	<item id="movesub" alias="同时迁移子档" type="string" length="1" not-null="1"  defaultValue="y" >
