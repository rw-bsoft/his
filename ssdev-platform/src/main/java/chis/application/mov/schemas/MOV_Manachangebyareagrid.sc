...
<entry entityName="chis.application.mov.schemas.MOV_Manachangebyareagrid" alias="根据网格地址批量修改责任医生">
  ...
  <item id="changeareagrid" alias="网格地址" type="string" length="25" not-null="1" width="200" colspan="2" anchor="100%"  queryable="true">
