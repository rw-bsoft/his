...
<entry entityName="chis.application.mov.schemas.MOV_ManaInfoBatchChange" alias="批量修改儿童档案管理医生确认记录" sort="applyDate desc">
  ...
  <item id="targetDoctor" alias="现儿保医生" type="string" length="20" not-null="1">
    <dic id="chis.dictionary.user02" render="Tree" onlySelectLeaf="true" parentKey="%user.manageUnit.id" keyNotUniquely="true"/>
  </item>
