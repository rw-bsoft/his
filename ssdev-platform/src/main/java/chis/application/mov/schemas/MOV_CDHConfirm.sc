...
<entry entityName="chis.application.mov.schemas.MOV_CDH"  alias="儿童户籍地址迁移确认" sort="applyDate desc">
  ...
  <item id="personName" alias="儿童姓名" type="string" length="20"  fixed="true"  queryable="true" />
  ...
  <item id="sourceOwnerArea" alias="原归属地" width="70" length="2"  not-null="1" 
    defaultValue="1" update="false" fixed="true">
    <dic>
      <item key="11" text="本市"></item>
      <item key="12" text="本市非主城区"></item>
      <item key="22" text="本省外市"></item>
      <item key="23" text="外省"></item>
    </dic>
  </item>
  <item id="sourceHomeAddress" alias="原户籍地址" type="string" length="25"  not-null="1" display="1"
  ...
  <item id="sourceHomeAddress_text" alias="原户籍地址" display="0"/> 
  ...
  <item id="targetHomeAddress" alias="现户籍地址" type="string" length="25" fixed="true" display="1"
    width="250" not-null="1" queryable="true" colspan="2">
    <dic id="chis.dictionary.areaGrid" minChars="4" includeParentMinLen="6" filterMin="10"
      filterMax="18" render="Tree" onlySelectLeaf="true" />
  </item>
  <item id="targetHomeAddress_text" alias="现户籍地址" display="0"/>  
  <item id="targetCdhDoctorId" alias="现儿保医生" type="string" length="20" not-null="true">
    <dic id="chis.dictionary.user02" render="Tree" onlySelectLeaf="true" keyNotUniquely="true"/>
  </item>
  <item id="targetManaUnitId" alias="现管辖机构" type="string" length="20" fixed="true" 
  ...
  <item id="affirmView" alias="确认人意见" type="string" length="500"  colspan="3" display="2" />
  <item id="affirmUnit" alias="确认机构" type="string" length="20"  width="250"  fixed="true" defaultValue="%user.manageUnit.id">
    <dic id="chis.@manageUnit" includeParentMinLen="6" render="Tree"   onlySelectLeaf="true" />
  </item>
  <item id="affirmUser" alias="确认人" type="string" length="20"   fixed="true"
    queryable="true"   defaultValue="%user.userId" >
    <dic id="chis.dictionary.user" render="Tree" onlySelectLeaf="true" />
  </item>
  <item id="affirmDate" alias="确认日期" type="datetime"  xtype="datefield" queryable="true"
