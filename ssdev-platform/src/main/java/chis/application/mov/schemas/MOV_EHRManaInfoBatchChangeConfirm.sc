...
<entry entityName="chis.application.mov.schemas.MOV_ManaInfoBatchChange"  alias="批量修改个人健康档案管理医生确认记录" sort="applyDate desc">
  ...
  <item id="targetDoctor" alias="现责任医生" type="string" length="20" fixed="true"
    not-null="1">
  ...
  <item id="affirmUnit" alias="确认机构" type="string" length="20" fixed="true"
    width="250" display="2" defaultValue="%user.manageUnit.id">
    <dic id="chis.@manageUnit" includeParentMinLen="6" render="Tree"
      onlySelectLeaf="true" />
  </item>
