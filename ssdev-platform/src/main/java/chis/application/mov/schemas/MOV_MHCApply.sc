...
<entry entityName="chis.application.mov.schemas.MOV_MHC"   alias="孕妇户籍地址迁移申请" sort="applyDate desc">
  ...
  <item id="personName" alias="孕妇姓名" type="string" length="20"
    not-null="1" xtype="lookupfieldex" queryable="true" />
  ...
  <item id="sourceHomeAddress_text" length="200" display="1"/>  
  ...
  <item id="sourceRestRegion_text" length="200" display="1"/>  
  ...
  <item id="targetHomeAddress" alias="现户籍地址" type="string" length="25"
    width="200" not-null="1" queryable="true" colspan="2" >
    <dic id="chis.dictionary.areaGrid" minChars="4" includeParentMinLen="6" filterMin="10"
      filterMax="18" render="Tree" onlySelectLeaf="true" />
  </item>
  <item id="targetHomeAddress_text" length="200" display="1"/>  
  ...
  <item id="targetRestRegion" alias="现产休地" type="string" length="25"
    width="200" queryable="true" not-null="1" colspan="2" >
    <dic id="chis.dictionary.areaGrid" minChars="4" includeParentMinLen="6" filterMin="10"
      filterMax="18" render="Tree" onlySelectLeaf="true" />
  </item>
  <item id="targetRestRegion_text" length="200" display="1"/>  
  <item id="targetMhcDoctorId" alias="现妇保医生" type="string" length="20" >
    <dic id="chis.dictionary.user03" render="Tree" onlySelectLeaf="true" keyNotUniquely="true" />
  </item>
  <item id="targetManaUnitId" alias="现管辖机构" type="string" length="20"
    width="250" not-null="true" queryable="true" 	colspan="3">
    <dic id="chis.@manageUnit" includeParentMinLen="6" render="Tree" lengthLimit="9" querySliceType="0" filter="['le',['len',['$','item.key']],['i',9]]"/>
  </item>
  ...
  <item id="affirmView" alias="确认人意见" type="string" length="500"
    fixed="true" colspan="3" display="1" />
  <item id="affirmUnit" alias="确认机构" type="string" length="20"
    fixed="true" width="250" display="1">
    <dic id="chis.@manageUnit" includeParentMinLen="6" render="Tree"
      onlySelectLeaf="true" />
  </item>
