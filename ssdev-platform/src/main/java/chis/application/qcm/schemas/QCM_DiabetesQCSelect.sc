...
<entry entityName="chis.application.qcm.schemas.QCM_DiabetesQCSelect" tableName="chis.application.qcm.schemas.QCM_DiabetesVisit" alias="质控糖尿病随访"> 
	...
	<item id="diabetesGroup" alias="管理组别" type="string" length="2" fixed="true"> 
		<dic id="chis.dictionary.diabetesGroup"/>
	</item>  
	...
	<item id="diabetesType" alias="病例种类" type="string" length="1">
		<dic id="chis.dictionary.diabetesType"/>
	</item>
	<item id="diabetesChange" alias="发生转型" fixed="true" type="string" defaultValue="n" length="1">
	...
	<item id="fbsTest" alias="空腹测量方式" type="string" length="1" enableKeyEvents="true">
		<dic> 
			<item key="1" text="末梢血"/>  
			<item key="2" text="血浆"/> 
		</dic>   
	...
	<item id="pbsTest" alias="餐后测量方式" type="string" length="1" enableKeyEvents="true">
		<dic> 
			<item key="1" text="末梢血"/>  
			<item key="2" text="血浆"/> 
		</dic>   
	...
	<item id="medicineNot" alias="不规律服药原因" fixed="true" type="string" length="2">
		<dic>
	...
	<item id="visitType" alias="随访分类" type="string"  colspan="2" length="1"> 
		<dic id="chis.dictionary.visitType"/> 
	</item>  
	<item id="healthProposal" alias="健康处方建议" type="string" colspan="2"  length="100">
		<dic  render="LovCombo">
	...
	<item id="complicationChange" alias="并发症变化" type="string" width="150" length="10" display="2" defaultValue="3" not-null="1"> 
		<dic> 
