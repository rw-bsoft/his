...
<entry entityName="chis.application.qcm.schemas.QCM_HypertensionQCSelect" tableName="chis.application.qcm.schemas.QCM_HypertensionVisit" alias="高血压随访" sort="a.empiId">
