...
<entry entityName="chis.application.qcm.schemas.QCM_TumourQCSelect" tableName="chis.application.qcm.schemas.QCM_TumourHighRiskVisit" alias="质控肿瘤高危随访">
	<item id="visitId" alias="随访记录ID" type="string" length="16" not-null="1" generator="assigned" pkey="true" display="0">
		<key>
			<rule name="increaseId" defaultFill="0" type="increase" length="16" startPos="1"/>
		</key>
	</item>
	<item id="indexNo" alias="序号" type="int" width="35" align="center"/>
	<item id="personName" alias="姓名" type="string" length="20" queryable="true" not-null="1"/>
	<item id="recordTypeName" alias="--" type="string" length="50" />
	...
	<item id="year" alias="管理年限" type="int" length="4" not-null="1" defaultValue="%server.date.year" colspan="2">
	...
	<item id="lostVisitReason" alias="暂时失访原因" type="string" length="100" fixed="true"  display="2" colspan="2"/>
	<item id="terminatedReason" alias="终止管理原因" type="string" length="1" display="2" colspan="2">
		<dic>
			<item key="1" text="死亡" />
			<item key="2" text="迁出" />
			<item key="3" text="失访" />
	...
	<item id="deadDate" alias="死亡日期" type="date" fixed="true" display="2" maxValue="%server.date.date" colspan="2"/>
	<item id="deadReason" alias="死亡原因" type="string" fixed="true"  length="100" display="2" colspan="2"/>
	...
	<item id="pectoralgia1" alias="胸痛" type="string" length="100" group="呼吸系统症状" colspan="2"/>
	...
	<item id="checkResult" alias="检查结果" type="string" xtype="lookupfieldex" length="500" colspan="5" group="无症状自主监测"/>
	...
	<item id="totalScore" alias="得分合计" type="int" align="center"/>
</entry>