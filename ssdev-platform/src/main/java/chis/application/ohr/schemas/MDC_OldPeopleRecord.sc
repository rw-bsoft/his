...
<entry entityName="chis.application.ohr.schemas.MDC_OldPeopleRecord" alias="老年人健康档案"
	...
	<item id="manaUnitId" alias="管辖机构" type="string" length="20" colspan="2" anchor="100%"
		width="180"  fixed="true" not-null="1" queryable="true">
		<dic id="chis.@manageUnit" includeParentMinLen="6" sliceType = "3" render="Tree" onlySelectLeaf="true" queryable="true" />
	</item>
	...
	<item id="currentProblem" alias="主要健康问题" type="string" length="200" 
		display="2">
		<dic id="chis.dictionary.healthProblem" render="LovCombo"/>
	</item>
	
	<item id="lifeSupport" alias="生活赡养" type="string" length="1"  
		display="2">
		<dic>
			<item key="1" text="本人" />
			<item key="2" text="配偶" />
	...
	<item id="abilityGrade" alias="能力评定" type="string" length="64" 
		display="2">
		<dic>
	...
	<item id="nurseStatus" alias="护理情况" type="string" length="1"  
		display="2">
		<dic>
			<item key="1" text="不需" />
			<item key="2" text="配偶" />
	...
	<item id="toothStatus" alias="牙齿状况" type="string" length="1"  
		display="2">
		<dic>
			<item key="1" text="不缺" />
			<item key="2" text="部分缺" />
	...
	<item id="sightStatus" alias="视力情况" type="string" length="1"  
		display="2">
		<dic>
	...
	<item id="psychologyStatus" alias="心理状态" type="string" length="1"  
		display="2">
		<dic>
			<item key="1" text="紧张" />
			<item key="2" text="抑郁" />
	...
	<item id="currentAddress" alias="常住地址类别" type="string" length="1"  
		display="2">
		<dic>
			<item key="1" text="城市" />
			<item key="2" text="农村" />
	...
	<item id="medicine" alias="服药依从性" type="string" length="1"  
		display="2">
		<dic>
	...
	<item id="familySmokeFlag" alias="吸烟标志" type="string" length="1"  
		display="2">
		<dic id="chis.dictionary.yesOrNo"/>
	</item>
	...
	<item id="createUser" alias="建档人" type="string" length="20" 
		 defaultValue="%user.userId" queryable="true" not-null="true">
	...
	<item id="createDate" alias="建档日期" type="datetime" fixed="true"  xtype="datefield" 
		defaultValue="%server.date.today" queryable="true" not-null="true">	
		<!--<set type="exp">['$','%server.date.datetime']</set>-->
	</item>
	<item id="inputUnit" alias="录入机构" type="string" length="200" 
		width="180" update="false" fixed="true" defaultValue="%user.manageUnit.id" queryable="true">
		<dic id="chis.@manageUnit" render="Tree" onlySelectLeaf="true" parentKey="%user.manageUnit.id"/>
	</item>
    <item id="inputUser" alias="录入人" type="string" length="20" fixed="true" update="false" defaultValue="%user.userId" queryable="true">
		<dic id="chis.dictionary.user"/>
	</item>
	<item id="inputDate" alias="录入日期" type="datetime" fixed="true"  xtype="datefield" 
		defaultValue="%server.date.today" queryable="true">	
	</item>
	<item id="sfzdcr" alias="是否自动建档" type="string" defaultValue="0" length="1" fixed="true" queryable="true">
		<dic>
			<item key="0" text="否" />
			<item key="1" text="是" />
		</dic>
