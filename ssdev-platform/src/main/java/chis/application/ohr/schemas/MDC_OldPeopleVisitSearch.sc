...
<entry entityName="chis.application.ohr.schemas.MDC_OldPeopleRecord" sort="a.createDate desc">
	...
	<item id="manaUnitId" alias="管辖机构" type="string" length="20"
		colspan="2" anchor="100%" width="180" fixed="true" not-null="1">
	...
	<item id="workExposeRiskType" alias="职业暴露种类" type="string" length="1"
		display="2">
		<dic>
			<item key="1" text="化学品" />
			<item key="2" text="毒物" />
	...
	<item id="workYear" alias="从事时长(年)" type="int" display="2" />

	<item id="familySmokeFlag" alias="吸烟标志" type="string" length="1"
		not-null="1" display="2">
		<dic id="chis.dictionary.yesOrNo" />
	</item>
	<item id="familyColeWarmFlag" alias="煤火取暖标志" type="string" length="1"
		display="2">
		<dic id="chis.dictionary.yesOrNo" />
	</item>
	<item id="familyColeWarmYear" alias="取暖时间(年)" type="int" display="2" />
	...
	<item id="createDate" alias="建档日期" type="datetime" xtype="datefield"
		fixed="true" update="false" defaultValue="%server.date.date">
		<set type="exp">['$','%server.date.datetime']</set>
	</item>
	<item id="status" alias="档案状态" type="string" length="1" hidden="true"
		defaultValue="0">
		<dic>
			<item key="0" text="正常" />
			<item key="1" text="已注销" />
	...
	<item id="lastModifyDate" alias="最后修改日期" type="datetime" xtype="datefield"
		hidden="true" defaultValue="%server.date.date">
		<set type="exp">['$','%server.date.datetime']</set>
	</item>
	...
	<item id="deadReason" alias="死亡原因" type="string" fixed="true"
		hidden="true" length="100" display="2" colspan="3" anchor="100%" />
