...
<entry entityName="chis.application.ohr.schemas.MDC_OldPeopleSelfCare" alias="老年人自理评估" sort="a.id desc">
  ...
  <item id="phrId" alias="档案编号" type="string" not-null="1"  length="30"  width="160" display="1"/>
  ...
  <item id="ZPFS" alias="总评分数" type="int" defaultValue="0" fixed="true"/>
	...
	<item id="createUser" alias="创建人员" type="string" update="false" queryable="true"  length="20" fixed="true" defaultValue="%user.userId" width="100">
		<dic id="chis.dictionary.user" render="Tree" onlySelectLeaf="true"   parentKey="%user.manageUnit.id"/>
		<set type="exp">['$','%user.userId']</set>
	</item>
	<item id="createDate" alias="创建日期" type="datetime" queryable="true" xtype="datefield" update="false"  fixed="true"  width="100"
   ...
   <item id="createUnit" alias="创建机构" type="string" update="false" length="20" defaultValue="%user.manageUnit.id" fixed="true" width="180">
	...
	<relations>
		...
		<relation type="children" entryName="chis.application.ohr.schemas.MDC_OldPeopleRecord">
			<join parent="phrId" child="phrId" />
