...
<entry entityName="chis.application.tr.schemas.MDC_TumourSeemingly" alias="疑似人群">
	...
	<item id="seeminglyDte" alias="疑似日期" type="date" not-null="1" defaultValue="%server.date.date" queryable="true"/>
	...
	<item id="recheckResult" alias="复核结果" type="string" length="2" queryable="true" display="1">
		<dic>
	...
	<item id="recheckDoctor" alias="复核医生" type="string" length="20" queryable="true" display="1">
		<dic id="chis.dictionary.user" render="Tree" onlySelectLeaf="true" keyNotUniquely="true" parentKey="%user.manageUnit.id"/>
	</item>
	<item id="recheckDate" alias="复核日期" type="date" defaultValue="%server.date.date" queryable="true" display="1"/>
	<item id="transferTreatment" alias="是否转诊" type="string" length="1" not-null="1" defaultValue="n" queryable="true" colspan="2">
		<dic id="chis.dictionary.yesOrNo"/>
	</item>
