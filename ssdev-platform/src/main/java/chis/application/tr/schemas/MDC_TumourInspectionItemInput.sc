...
<entry entityName="chis.application.tr.schemas.MDC_TumourInspectionItemInput" tableName="chis.application.tr.schemas.MDC_TumourInspectionItem" alias="筛查检查项目">
	...
	<item id="bigItemId" alias="费用归并" type="long" length="18" display="0">
		<dic id="chis.dictionary.feesDic" autoLoad="true"/>
	</item>
	<item id="bigItemName" alias="费用归并" type="string" length="20" width="100" display="0"/>
	<item id="definiteItemId" alias="项目ID" type="long" length="18" display="0"/>
	<item id="definiteItemName" alias="项目名称" type="string" length="100" not-null="1" width="200"/>
