...
<entry entryName="chis.application.tr.schemas.MDC_TumourHighRiskVisitPlanListView"  tableName="chis.application.pub.schemas.PUB_VisitPlan" alias="随访计划" sort="planDate" >
