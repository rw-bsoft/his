...
<entry entityName="chis.application.tr.schemas.MDC_TumourScreening" alias="初筛人群表" sort="b.personName asc ,b.idCard asc">
	...
	<item id="checkItem1" alias="检查项目1" type="string" xtype="lookupfieldex" length="100" queryable="true" display="1"/>
	<item id="checkResult1" alias="检查结果1" type="string" length="30" queryable="true" display="1">
		<dic id="chis.dictionary.tumourCheckResult"/>
	</item>
	<item id="checkItem2" alias="检查项目2" type="string" xtype="lookupfieldex" length="100" queryable="true" display="1"/>
	<item id="checkResult2" alias="检查结果2" type="string" length="30" queryable="true" display="1">
		<dic id="chis.dictionary.tumourCheckResult"/>
	</item>
	<item id="checkItem3" alias="检查项目3" type="string" xtype="lookupfieldex" length="100" queryable="true" display="1"/>
	<item id="checkResult3" alias="检查结果3" type="string" length="30" queryable="true" display="1">
		<dic id="chis.dictionary.tumourCheckResult"/>
	</item>
	<item id="checkItem4" alias="检查项目4" type="string" xtype="lookupfieldex" length="100" queryable="true" display="1"/>
	<item id="checkResult4" alias="检查结果4" type="string" length="30" queryable="true" display="1">
		<dic id="chis.dictionary.tumourCheckResult"/>
	</item>
