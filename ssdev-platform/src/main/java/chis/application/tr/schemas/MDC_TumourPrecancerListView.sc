...
<entry entityName="chis.application.tr.schemas.MDC_TumourPrecancerListView" tableName="chis.application.tr.schemas.MDC_TumourConfirmed" alias="癌前期人群" sort="a.empiId asc,a.createDate desc">
	...
	<!-- 
		...
		-->
	<item ref="d.assessment" alias="评定" display="1"/>
	<item ref="d.assessStage" alias="评定期别" display="1"/>
	<item ref="d.assessDate" alias="评定日期" display="1"/>
	<item ref="d.assessDoctor" alias="评定医生" display="1"/>
	<item ref="d.assessSpecialist" alias="评定专家" display="1"/>
	<item ref="d.TERID" alias="评定编号" hidden="true"/>
	...
	<relations>
		...
		<relation type="children" entryName="chis.application.tr.schemas.MDC_TumourExpertReview">
			<join parent = "TCID" child = "TCID" />
			<join parent = "cancerCase" child = "cancerCase" />
		</relation>
	</relations>
</entry>