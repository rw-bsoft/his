...
<entry entityName="chis.application.tr.schemas.MDC_TumourConfirmedListView" tableName="chis.application.tr.schemas.MDC_TumourConfirmed" alias="肿瘤确诊人群表" sort="d.assessDate desc">
