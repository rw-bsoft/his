...
<entry entityName="chis.application.tr.schemas.MDC_TumourHighRisk" alias="高危人群表" sort="a.empiId asc,a.createDate desc">
	...
	<item id="year" alias="管理年度" type="int" length="4" not-null="1" defaultValue="%server.date.year" queryable="true" display="0">
		<dic id="chis.dictionary.years" />
	</item>
	
	<item id="createStatus" alias="建卡标志" type="string" length="1" defaultValue="1" display="1">
		<dic>
			<item key="0" text="未建档"/>
			<item key="1" text="已建档"/>
		</dic>
