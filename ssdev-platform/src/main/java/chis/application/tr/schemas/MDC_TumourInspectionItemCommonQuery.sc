...
<entry entityName="chis.application.tr.schemas.MDC_TumourInspectionItemCommonQuery" tableName="MDC_TumourInspectionItem" alias="筛查检查项目">
	<item id="itemId" alias="项目ID" type="string" length="16" not-null="1" generator="assigned" pkey="true" hidden="true">
		<key>
			<rule name="increaseId" defaultFill="0" type="increase" length="16" startPos="1"/>
		</key>
	</item>
	<item id="itemCode" alias="项目代码" type="string" length="20" queryable="true"/>
	<item id="itemType" alias="项目类别" type="string" length="1" queryable="true">
		<dic id="chis.dictionary.tumourHighRiskType"/>
	</item>
	<item id="bigItemId" alias="大类" type="long" length="18" not-null="1" display="2">
	...
	<item id="definiteItemName" alias="项目名称" type="string" length="100" width="200" queryable="true"/>
	<item id="startUsing" alias="是否启用" type="string" length="1" not-null="1" defaultValue="y" fixed="true" queryable="true">
