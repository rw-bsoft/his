...
<entry entityName="chis.application.tr.schemas.MDC_TumourConfirmedPageList" tableName="chis.application.tr.schemas.MDC_TumourConfirmed" alias="肿瘤确诊人群表" sort="a.empiId asc,a.createDate desc">
	...
	<item ref="d.TERID" alias="评定编号" display="1"/>
