...
<entry entityName="chis.application.tr.schemas.MDC_TumourScreeningCheckResultGWE" alias="初筛检查表" sort="a.recordId asc">
	...
	<item id="itemPkey" alias="项目Pkey" type="string" length="16" display="0"/>
	<item id="itemId" alias="项目代码" type="string" length="20" display="1"/>
	...
	<item id="checkHospital" alias="检查医院" type="string" length="30" not-null="1" mhYY="true">
	...
	<item id="criterionType" alias="项目性质" type="string" length="1" display="0" defaultValue="1">
		<dic>
			<item key="1" text="初筛"/>
			<item key="2" text="追踪"/>
		</dic>
	</item>
	<item id="remark" alias="备注信息" type="string" length="300" colspan="3"/>
