...
<entry entityName="chis.application.tr.schemas.MDC_TumourPatientReportCard" alias="肿瘤患者报告卡">
	...
	<item id="tumourSite" alias="肿瘤位置" type="string" length="1">
		<dic>
			<item key="1" text="左侧"/>
			<item key="2" text="右侧"/>
			<item key="3" text="双侧"/>
	...
	<item id="isDeath" alias="是否死亡" type="string" length="1" not-null="1" defaultValue="y" fixed="true">
		<dic id="chis.dictionary.yesOrNo"/>
	</item>
	<item id="deathDate" alias="死亡日期" type="date"  maxValue="%server.date.date"/>
	...
	<item id="regionCode" alias="网格地址" type="string" length="25" not-null="1" colspan="3" update="false" queryable="true">
