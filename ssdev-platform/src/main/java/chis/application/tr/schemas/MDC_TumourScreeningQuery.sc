...
<entry entityName="chis.application.tr.schemas.MDC_TumourScreeningQuery" tableName="chis.application.tr.schemas.MDC_TumourScreening" alias="初筛人群表(批量)" sort="b.personName asc ,b.idCard asc">
	...
	<item id="screeningStartDate" alias="初筛开始日期" type="date" queryable="true" display="2"/>
	<item id="screeningEndDate" alias="初筛结束日期" type="date" queryable="true" display="2"/>
