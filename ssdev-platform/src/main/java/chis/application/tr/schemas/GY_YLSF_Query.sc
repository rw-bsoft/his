...
<entry entityName="chis.application.tr.schemas.GY_YLSF_Query" tableName="GY_YLSF" alias="医疗收费" sort="PYDM">
	...
	<item id="FYMC" alias="费用名称"  type="string" length="80" width="220" queryable="true"/>
	...
	<item id="FYGB" alias="费用归并" length="18" type="int" queryable="true">
		<dic id="chis.dictionary.feesDic" autoLoad="true"/>
	</item>
	<item id="ZFPB" alias="是否作废" display="1" type="int" length="2" not-null="1" defaultValue="0" queryable="true">
	...
	<item id="XMLX" alias="项目类型" display="2" type="int" length="2" queryable="true">
