...
<entry entityName="chis.application.tr.schemas.MDC_TumourHighRiskCriterionSameKind" tableName="MDC_TumourHighRiskCriterion" alias="初筛转高危标准表">
	...
	<item id="highRiskName" alias="高危名称" type="string" length="100" not-null="1"/>
	<item id="judgeType" alias="判断类型" type="string" length="2" defaultValue="3" not-null="1">
	...
	<item id="highRiskSource" alias="高危来源" type="string" length="2" not-null="1">
		<dic id="chis.dictionary.tumourHighRiskSource"/>
	</item>
	<item id="highRiskFactor" alias="高危因素" type="string" length="1" not-null="1">
		<dic>
