...
<entry entityName="chis.application.tr.schemas.MDC_TumourScreeningCheckResultBatch" tableName="chis.application.tr.schemas.MDC_TumourScreeningCheckResult" alias="初筛检查表(批量)" sort="a.recordId asc">
	...
	<item id="screeningId" alias="初筛记录号" type="string" length="16" fixed="true" display="0" hidden="true"/>
	<item id="planId" alias="随访计划ID" type="string" length="16" fixed="true" display="0" hidden="true"/>
	<item id="empiId" alias="empiId" type="string" length="32" not-null="1" fixed="true" display="0" hidden="true"/>
	<item id="itemPkey" alias="项目Pkey" type="string" length="16" display="1" fixed="true" hidden="true"/>
	<item id="itemId" alias="项目代码" type="string" length="16" display="1" fixed="true"/>
	<item id="checkItem" alias="检查项目" type="string" xtype="lookupfieldex" fixed="true" length="100" not-null="1" queryable="true"/>
	<item id="checkResult" alias="检查结果" type="string" length="30" not-null="1" queryable="true">
		<dic id="chis.dictionary.tumourCheckResult"/>
	</item>
	<item id="highRiskType" alias="高危类别" type="string" length="2" fixed="true" not-null="1" queryable="true">
	...
	<item id="checkHospital" alias="检查医院" type="string" length="30" not-null="1" mhYY="true"  width="180">
		<dic id="chis.dictionary.MHHospitalDic"/>
	</item>
