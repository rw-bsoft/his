...
<entry id="chis.application.demo.schemas.PersonInfo" alias="训练计划">
	...
	<item id="personName" alias="姓名" type="string" length="30" queryable="true" not-null="1"/>
	<item id="sex" alias="性别" type="string" length="1" defaultValue="1" queryable="true">
		<dic>
			<item key="1" text="男"/>
			<item key="2" text="女"/>
		</dic>
	</item>
	<item id="age" alias="年龄" type="int" queryable="true"/>
	<item id="phone" alias="电话" type="string" length="20"/>
	<item id="eMail" alias="E-Mail" type="string" length="100" colspan="2"/>
	<item id="createUser" alias="录入人姓名" type="string" length="20" fixed="true" update="false"
