...
<entry  entityName="chis.application.psy.schemas.PSY_PsychosisRecordWorkList" tableName="chis.application.psy.schemas.PSY_PsychosisRecord" alias="精神病个人信息表" sort="a.phrId desc">
	...
	<item ref="d.workType" alias="任务名称" display="1" />
	<item ref="d.doctorId" alias="任务责任医生" display="0" />
	
	<item id="manaDoctorId" alias="档案责任医生" type="string" length="20"
	...
	<relations>
		...
		<relation type="parent" entryName="chis.application.pub.schemas.PUB_WorkList" >
