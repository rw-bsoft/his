...
<entry  alias="精神病个人信息表" sort="a.phrId desc">
	<item id="phrId" pkey="true" alias="档案编号" length="30" type="string" fixed="true" width="150"/>
	...
	<item id="informedConsent" alias="知情同意" length="1" type="string" colspan="2">
		<dic render="Radio" colWidth="150" columns="2">
			<item key="1" text="同意参加管理"/>
			<item key="0" text="不同意参加管理"/>
		</dic>
	</item>
	<item id="icSign" alias="签字" type="string" length="30"/>
	<item id="icDate" alias="签字时间" type="date"  maxValue="%server.date.today"/>
	...
	<item id="pastHospitalization" alias="既往住院情况" type="string" colspan="2">
		<dic render="Radio" colWidth="150" columns="2">
	...
	<item id="familySocialImpact" alias="对家庭社会的影响" type="string" length="20" defaultValue="0" colspan="3">
	...
	<item id="fillTableDate" alias="填表日期" type="date" update="false"
		 defaultValue="%server.date.today" queryable="true">
	</item>
	<item id="doctorSign" alias="医生签字" type="string" length="20"
		update="false" defaultValue="%user.userId"
		queryable="true">
		<dic id="chis.dictionary.user" render="Tree" onlySelectLeaf="true"
			parentKey="%user.manageUnit.id" />
	</item>
	<item id="doctorUnit" alias="医疗机构" type="string" length="20"
	...
	<item id="createUnit" alias="建档机构" type="string" length="20"
		update="false" fixed="true" width="165" display="1"
		defaultValue="%user.manageUnit.id">
		<dic id="chis.@manageUnit" includeParentMinLen="6"  render="Tree" onlySelectLeaf="true"
			parentKey="%user.manageUnit.id" />
	...
	<item id="createDate" alias="建档日期" type="datetime"  xtype="datefield" update="false"
		fixed="true" defaultValue="%server.date.today" queryable="true" display="1">
