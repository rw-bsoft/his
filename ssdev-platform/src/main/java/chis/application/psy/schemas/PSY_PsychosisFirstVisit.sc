...
<entry entityName="chis.application.psy.schemas.PSY_PsychosisVisit" alias="精神病随访录入界面">
	...
	<item id="familySocialImpact" alias="对家庭社会的影响" type="string" length="20" defaultValue="0" colspan="4">
		<dic id="chis.dictionary.psyFamilySocialImpact" render="Checkbox" columnWidth="120" columns="6"/>
	</item>
	...
	<!--item id="lostReason" alias="失访原因" type="String" length="200" / -->
	...
	<item id="riskFactor" alias="危害度" type="string" length="200" colspan="3">
		<dic>
			<item key="1" text="口头威胁，喊叫，但没有打砸行为" />
