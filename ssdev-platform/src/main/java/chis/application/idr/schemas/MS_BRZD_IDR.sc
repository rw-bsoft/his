...
<entry entityName="chis.application.idr.schemas.MS_BRZD_IDR" tableName="MS_BRZD" alias="门诊诊断信息" sort="PLXH ASC">
	<item id="JLBH" alias="记录编号" type="String" length="18" display="0" not-null="1" generator="assigned" pkey="true">
		<key>
	...
	<item id="CFLX" alias="中西类别" type="int" virtual="true" defaultValue="1" display="1" width="70">
		<dic>
			<item key="1" text="西医"/>
			<item key="2" text="中医"/>
		</dic>
	...
	<item id="ZDMC" alias="诊断名称" not-null="1" type="string" mode="remote" length="60" width="150"/>
