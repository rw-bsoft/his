...
<entry entityName="chis.application.idr.schemas.IDR_ReportList" tableName="chis.application.idr.schemas.IDR_Report" sort="fillDate desc" alias="个人传染病报告卡列表">
 <item id="RecordID" alias="传染病报告卡记录编号" type="string" length="16" pkey="true"  not-null="1" fixed="true" hidden="true" generator="assigned" display="0"> 
  ...
  <item id="phrId" alias="档案编号" type="string" display="0"  length="30" not-null="1"/>
  <item id="icd10" alias="icd10" type="string" display="0"  length="20"/>
  <item id="MS_BRZD_JLBH" alias="门诊诊断记录编号" display="0" type="string" length="20"/>
  ...
  <item ref="b.idCard" alias="身份证号*" not-null="1"/>
  ...
  <item id="otherCategoryInfectious" alias="其他传染病" length="200" colspan="2" width="150" enableKeyEvents="true"/>
  
  <item id="correctionProblems" alias="订正病名" length="20"/>
  
  <item id="returnReason" alias="退卡原因" length="20" colspan="2" width="150"/>
  
  <item id="unitPhone" alias="联系电话" length="20" />
  ...
  <item id="comments" alias="备注" length="200" colspan="3"/>
