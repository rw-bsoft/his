...
<entry entityName="chis.application.per.schemas.PER_CheckupDetail" alias="体检明细表">
	...
	<item id="checkupProjectName" alias="体检项目名称" type="string"
		length="60" width="118" fixed="true" />
	<item id="checkupUnit" alias="单位" type="string" length="20" width="50" fixed="true"/>
	<item id="ifException" alias="体检结果" length="200" width="100" renderer="changeDisplay"/>
	<item id="checkupOutcome" alias="提示" type="string" length="1" width="50"  renderer="showResoult">
		<dic id="chis.dictionary.ifException" autoLoad="true" />
	</item>
	...
	<item id="projectOffice" alias="项目科室" type="string" length="50"
		hidden="true" />
	...
	<item id="checkupProjectId" alias="体检项目编码" type="string" length="16" hidden="true"
