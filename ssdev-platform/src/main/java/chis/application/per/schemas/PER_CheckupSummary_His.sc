...
<entry entityName="chis.application.per.schemas.PER_CheckupSummary" alias="体检小结表" sort="projectOfficeCode">
	...
	<item id="exceptionDesc" alias="异常描述" type="string" length="1000" width="600" anchor="100%"
	...
	<item id="inputDoctor" alias="录入医生" type="string" length="12"/>
