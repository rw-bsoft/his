...
<entry entityName="chis.application.tcm.schemas.TCMRegisterList" tableName="chis.application.tcm.schemas.TCM_TCMRegister" sort="a.registerDate desc,a.registerId desc" alias="中医登记">
	...
	<item id="habitusSummarizeCode" alias="体质综述" type="string" length="20" display="0">
	...
	<item id="registerDoctor" alias="登记医生" type="string" length="20" update="false" defaultValue="%user.userId">
	...
	<item id="registerUnitId" alias="登陆单位" type="string" length="20" update="false" width="320" defaultValue="%user.manageUnit.id" fixed="true">
