...
<entry entityName="chis.application.tcm.schemas.TCM_GuidanceContentLibraryQuery" tableName="chis.application.tcm.schemas.TCM_GuidanceContentLibrary" sort="GCID desc" alias="中医指导内容库">
	<item id="GCID" alias="指导内容ID" type="string" length="16" not-null="1" generator="assigned" pkey="true" hidden="true">
		<key>
			<rule name="increaseId" defaultFill="0" type="increase" length="16" startPos="1"/>
		</key>
	</item>
	<item id="itemName" alias="条目名称" type="string" length="100" width="200" colspan="4" queryable="true"/>
	<item id="ageGroupType" alias="年龄段分类" type="string" length="1" colspan="4" queryable="true">
		<dic id="chis.dictionary.TCMAgeGroupType" render="Radio" colWidth="110" columns="4"/>
	</item>
	<item id="habitusType" alias="体质分类" type="string" length="200" colspan="4" queryable="true">
		<dic id="chis.dictionary.TCMHabitusSummarize"  render="TreeCheck" onlyLeafCheckable="true"  checkModel ="childCascade"/>
	</item>
	<item id="intendedPopulation" alias="适应人群" type="string" length="1" colspan="4" queryable="true">
		<dic id="chis.dictionary.TCMIntendedPopulation" render="Radio" columnWidth="65" columns="5"/>
	</item>
	<item id="tumourType" alias="肿瘤类别" type="string" length="1" colspan="4" fixed="true" queryable="true">
		<dic id="chis.dictionary.tumourHighRiskType" render="Radio" colWidth="50" columns="6"/>
	</item>
	<item id="contentType" alias="内容分类" type="string" length="1" colspan="4" queryable="true">
		<dic id="chis.dictionary.TCMContentType" render="Radio" colWidth="90" columns="6"/>
	</item>
	<item id="content" alias="指导内容" type="string" xtype="textarea" length="2000" height="530" colspan="4" display="2" onlyShow="true"/>
