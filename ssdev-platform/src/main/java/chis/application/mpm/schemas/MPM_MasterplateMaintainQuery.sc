...
<entry entityName="chis.application.mpm.schemas.MPM_MasterplateMaintainQuery" tableName="chis.application.mpm.schemas.MPM_MasterplateMaintain" alias="模版维护">
	...
	<item id="masterplateName" alias=" 模版名称" length="100" queryable="true" colspan="3" width="200"/>
	<item id="whmb" alias="维护模板" type="string" width="240" queryable="true" length="2" >
		<dic id="chis.dictionary.masterplate"/>
	</item>
	<item id="manaUnitId" alias=" 管辖机构" type="string" length="20"
		width="320" defaultValue="%user.manageUnit.id" queryable="true">
		<dic id="chis.@manageUnit" render="Tree"/>
	</item>
	<item id="year" alias="管理年度" type="int" length="4" queryable="true">
		<dic id="chis.dictionary.years" />
	</item>
	<item id="masterplateType" alias="家医模版类型" type="string" queryable="true">
		<dic>
			<item key="1" text="服务记录"/>
			<item key="2" text="健康问卷"/>
		</dic>
	</item>
	<item id="masterplateTypezb" alias="指标模版类型" type="string" width="240" length="2" queryable="true">
		<dic id="chis.dictionary.masterplateType"/>
	</item>
	<item id="dateType" alias="时间类型" type="string" queryable="true">
		<dic>
			<item key="1" text="年"/>
			<item key="2" text="季"/>
			<item key="3" text="月"/>
