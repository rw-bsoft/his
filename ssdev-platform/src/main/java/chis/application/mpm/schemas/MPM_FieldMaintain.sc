...
<entry entityName="chis.application.mpm.schemas.MPM_FieldMaintain" alias="数据结构维护">
	<item id="fieldId" alias="字段编号" length="16" not-null="1" generator="assigned"  pkey="true" type="string" width="160" hidden="true">
		<key>
			<rule name="increaseId" defaultFill="0" type="increase" length="16" startPos="1"/>
		</key>
	</item>
	<item id="alias" alias="字段名称" length="1000" width="300" not-null="1" queryable="true"/>
	...
	<item id="maxValue" alias="最大值" length="100"/>
	<item id="minValue" alias="最小值" length="100"/>
	<item id="length" alias="长度" type="int" length="5" not-null="1"/>
	<item id="useType" alias="适用类别" type="string" length="2">
