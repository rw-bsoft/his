...
<entry  alias="高血压随访" sort="a.empiId">
	...
	<item id="medicine" alias="服药依从性" not-null="1" type="string" length="1" tag="radioGroup">
		<dic>
			<item key="1" text="规律" />
			<item key="2" text="间断" />
			<item key="3" text="不服药" />
	...
	item id="salt" alias="摄盐情况" type="int" tag="radioGroup" not-null="1" >
		<dic id="chis.dictionary.salt"/>
	</item>
	<item id="psychologyChange" alias="心理调整" type="string" length="1" tag="radioGroup" not-null="1" >
		<dic>
			<item key="1" text="良好" />
			<item key="2" text="一般" />
			<item key="3" text="差" />
	...
	<item id="medicineBadEffect" alias="药物不良反应" type="string" tag="radioGroup"
		fixed="true" defaultValue="1">
		<dic id="chis.dictionary.haveOrNot"/>
	</item>
	<
	<item id="targetSalt" alias="目标摄盐情况" type="int" tag="radioGroup" >
		<dic id="chis.dictionary.salt"/>
	</item>
		<item id="obeyDoctor" alias="遵医行为" type="string" length="1" tag="radioGroup" not-null="1" >
		<dic>
			<item key="1" text="良好" />
			<item key="2" text="一般" />
			<item key="3" text="差" />
	...
	<item id="visitEvaluate" alias="随访分类" tag="radioGroup" not-null="1" type="string" length="1">
		<dic>
	...
	<item id="diastolic" alias="舒张压(mmHg)" not-null="1" type="int" tag="text"
		minValue="50" maxValue="500" enableKeyEvents="true"
		validationEvent="false" />
	<item id="weight" alias="体重(kg)" type="double" length="6" precision="2" minValue="0" tag="text"
		maxValue="500" enableKeyEvents="true" validationEvent="false" />
	<item id="targetWeight" alias="目标体重(kg)" length="6" precision="2" type="double" minValue="0" tag="text"
		maxValue="500" enableKeyEvents="true" validationEvent="false" />

	<item id="bmi" alias="BMI" length="6" type="double" precision="2" fixed="true"  tag="text"/>
	<item id="targetBmi" alias="目标BMI" length="6" precision="2" type="double" fixed="true"  tag="text"/>
	<item id="heartRate" alias="心率" not-null="1" type="int" tag="text" />
	<item id="targetHeartRate" alias="目标心率" type="int"  tag="text"/>
	<item id="otherSigns" alias="其它体征" type="string" length="20" tag="text" />

	<item id="smokeCount" alias="日吸烟量(支)" not-null="1" type="int" tag="text"
		enableKeyEvents="true" />
	<item id="targetSmokeCount" alias="目标量(支)" type="int"  tag="text"/>
	<item id="drinkCount" alias="日饮酒量(两)" not-null="1" type="int" tag="text"
		enableKeyEvents="true" />
	
	

	<item id="targetDrinkCount" alias="目标量(两)" type="int"  tag="text"/>
	<item id="trainTimesWeek" alias="周运动次数" not-null="1" type="int"  tag="text"/>
	<item id="targetTrainTimesWeek" alias="目标次数" type="int"  tag="text"/>
	<item id="trainMinute" alias="每次时长(分)" not-null="1" type="int"  tag="text"/>

	<item id="targetTrainMinute" alias="目标时长(分)" type="int"  tag="text"/>
	<item id="loseWeight" alias="是否减轻体重"  type="string" 
		length="1" fixed="true" defaultValue="1"><!--not-null="1"-->
		<dic>
			<item key="1" text="不需要" />
			<item key="2" text="需要" />
		</dic>
	...
	<item id="medicineNot" alias="不规律服药原因" type="string" length="2"  tag="radioGroup">
		<dic>
	...
	<item id="medicineOtherNot" alias="其他原因" type="string" length="100"  tag="text">
	</item>
	
	<item id="medicineBadEffectText" alias="不良反应" type="string" tag="text"
		length="200" />
	<item id="auxiliaryCheck" alias="辅助检查" type="string" length="50" tag="text"/>
	...
	<item id="riskiness" alias="危险因素" type="string" defaultValue="0" tag="checkBox"
		length="64" colspan="2" display="2">
		<dic id="chis.dictionary.hyperRiskiness" render="LovCombo" />
	</item>

	<item id="targetHurt" alias="靶器官损害" type="string" defaultValue="0" tag="checkBox"
		length="64" colspan="2">
	...
	<item id="complicationIncrease" alias="原并发症加重" type="string" tag="radioGroup" length="1" display="2">
		<dic id="chis.dictionary.yesOrNo"/>
	</item>	
	<item id="riskLevel" alias="危险分层" type="string" length="1" tag="radioGroup"
		fixed="true" display="2">
		<dic id="chis.dictionary.riskLevel"/>
	</item>
	
	<item id="healthProposal" alias="健康处方建议" tag="checkBox" type="string" length="100">
		<dic  render="LovCombo">
			<item key="1-1" text="控制饮食" />
			<item key="1-2" text="戒烟戒酒" />
			<item key="1-3" text="减轻体重" />
			<item key="1-4" text="规律活动" />
			<item key="2-1" text="放松情绪" />
			<item key="2-2" text="定期检查" />
			<item key="2-3" text="遵医嘱服药" />
			<item key="9-1" text="其他" />
			<!--
	...
	<item id="oneDosage1" alias="每次" type="double" length="8" precision="2" minValue="0" maxValue="8000" tag="text" display="2" virtual="true"/>
	<item id="medicineUnit1" alias="单位" type="string" length="6" tag="text" display="2" virtual="true"/>
	<item id="drugNames2" alias="药物名称2" type="string" display="2" virtual="true">
	</item>
	<item id="everyDayTime2" alias="每日/次" type="string" tag="text" display="2" virtual="true"/>
	<item id="oneDosage2" alias="每次" type="double" length="8" precision="2" minValue="0" maxValue="8000" tag="text" display="2" virtual="true"/>
	<item id="medicineUnit2" alias="单位" type="string" length="6" tag="text" display="2" virtual="true"/>
	<item id="drugNames3" alias="药物名称3" type="string" display="2" virtual="true">
	</item>
	<item id="everyDayTime3" alias="每日/次" type="string" tag="text" display="2" virtual="true"/>
	<item id="oneDosage3" alias="每次" type="double" length="8" precision="2" minValue="0" maxValue="8000" tag="text" display="2" virtual="true"/>
	<item id="medicineUnit3" alias="单位" type="string" length="6" tag="text" display="2" virtual="true"/>
	<item id="drugNames4" alias="其他药物" type="string" display="2" virtual="true">
	</item>
	<item id="everyDayTime4" alias="每日/次" type="string" tag="text" display="2" virtual="true"/>
	<item id="oneDosage4" alias="每次" type="double" length="8" precision="2" minValue="0" maxValue="8000" tag="text" display="2" virtual="true"/>
	<item id="medicineUnit4" alias="单位" type="string" length="6" tag="text" display="2" virtual="true"/>
	...
	<item id="agencyAndDept" alias="机构及科别" type="string" tag="text"/>
	<!-- 新增 -->
	<item id="referralReason" alias="转诊原因" type="string" colspan="2">
	...
	<item id="needdoublevisit" alias="是否增加二次随访" type="string" display="0" tag="radioGroup"> 
		<dic>
			<item key="1" text="是"/>  
			<item key="2" text="否"/> 
		</dic> 
