...
<entry entityName="chis.application.mobileApp.schemas.TCM_TCMRegisterApp" alias="中医体质登记" sort="a.phrId desc" version="1332744636000" tableName="TCM_TCMRegister" >
	...
	<item ref="c.status" display="1" queryable="true" locked="true"/>
	...
	<item id="habitusSummarizeCode" alias="体质综述代码" type="string" length="20" display="0">
