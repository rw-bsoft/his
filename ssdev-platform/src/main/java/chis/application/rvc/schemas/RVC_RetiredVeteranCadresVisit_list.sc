...
<entry entityName="chis.application.rvc.schemas.RVC_RetiredVeteranCadresVisit" alias="离休干部随访">
	...
	<item id="visitDate" alias="随访时间" width="150" type="date"/>
	<item id="diet" alias="饮食" length="1" type="string">
		<dic>
			<item key="1" text="可"/>
			<item key="2" text="佳"/>
			<item key="3" text="差"/>
	...
	<item id="sleep" alias="睡眠" length="1" type="string">
		<dic>
			<item key="1" text="可"/>
			<item key="2" text="佳"/>
			<item key="3" text="差"/>
	...
	<item id="excrement" alias="大便" length="1" type="string">
		<dic>
			<item key="1" text="正常"/>
			<item key="2" text="便秘"/>
			<item key="3" text="其他"/>
	...
	<item id="excrementOther" alias="其他情况" length="100" type="string"/>
	<item id="pee" alias="小便" length="1" type="string">
		<dic id="chis.dictionary.isNormal2"/>
	</item>
	<item id="emotion" alias="情绪心情" length="100" type="string">
		<dic>
	...
	<item id="other" alias="其他" length="100" type="string"/>
	<item id="communityActivity" alias="社区活动" length="1" type="string">
		<dic>
			<item key="1" text="不参加"/>
	...
	<item id="currentStatus" alias="目前状况" length="100" type="string">
		<dic render="LovCombo">
			<item key="01" text="头痛"/>
			<item key="02" text="头昏"/>
	...
	<item id="otherStatus" alias="其他状况" colspan="2" length="100" type="string"/>
	<item id="sbp" alias="收缩压(mmhg)" type="int"/>
	<item id="dbp" alias="舒张压(mmhg)" type="int"/>
	<item id="heartRateN" alias="心率(次/分)" type="int"/>
	<item id="heartRate" alias="心率" length="1" type="string">
		<dic>
			<item key="1" text="齐"/>
			<item key="2" text="不齐"/>
		</dic>
	</item>
	<item id="suggest" alias="建议" length="255" colspan="2" xtype="textarea" type="string"/>
	<item id="visitUser" alias="随访人" length="20" type="string"/>
	<item id="visitWay" alias="随访方式" length="1" type="string">
		<dic id="chis.dictionary.visitWay"/> 
	</item>
	<item id="visitResult" alias="随访结果" length="1" colspan="2" type="string">
		<dic id="chis.dictionary.isNormal2"/>
	</item>
	<item id="visitResultExplain" alias="随访结果说明" length="100" type="string"/>
	<item id="nextDate" alias="下次预约时间" type="date" not-null="0" width="100"/>  
	<item id="createUnit" alias="建档机构" type="string" length="20" 
		width="180" update="false" fixed="true" defaultValue="%user.manageUnit.id" display="0">
	...
	<relations> 
		...
		<relation type="parent" entryName="chis.application.rvc.schemas.RVC_RetiredVeteranCadresRecord"> 
			<join parent="phrId" child="phrId"/> 
		</relation> 
	</relations> 
</entry>
