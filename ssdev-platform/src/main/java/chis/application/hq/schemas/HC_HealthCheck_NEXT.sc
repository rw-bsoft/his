...
<entry entityName="chis.application.hq.schemas.HC_HealthCheck_NEXT" alias="基本情况">
	...
	<item id="HIGHRISKEMPIID" alias="EMPIID" length="32" type="string" hidden="true" />
	<item id="HIGHRISKPHRID" alias="高危档案号" length="30" type="string" />
	...
	<item id="SFGL" alias="是否管理" width="100" type="string" >
		<dic id="chis.dictionary.oneyeszerono"/>
	</item>
	<item id="GLSJ" alias="管理时间" type="date" width="75" />
