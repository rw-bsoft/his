...
<entry  alias="质控数据随访" entityName="chis.application.quality.schemas.QUALITY_ZK_SJ"  >
	...
	<item id="ZKNO" alias="质控NO" type="string" length="20"   display="0"/>
	<item id="ZDF" alias="总得分" type="string" length="20"   display="0"/>
	<item id="prartNo" alias="父页面No" type="string" length="16" not-null="1"  display="0"/>
	<item id="SFZK" alias="已质控" type="string" defaultValue="0"  
		length="1">
		<dic>
			<item key="1" text="否" />
			<item key="2" text="是" />
	...
	<item id="SFPF" alias="已评分" type="string" defaultValue="0"  
		length="1">
		<dic>
			<item key="1" text="否" />
			<item key="2" text="是" />
	...
	<item id="visitId" alias="随访标识" type="string" length="16" not-null="1"  display="0"/>
	...
	<item id="visitDate" alias="随访日期" not-null="true" type="date" display="0"
		defaultValue="%server.date.today" enableKeyEvents="true"
		validationEvent="false"  />
	<item id="visitWay" alias="随访方式" type="string" length="1"  display="0"
		not-null="true">
		<dic id="chis.dictionary.visitWay" />
	</item>
	<item id="visitEffect" alias="转归" type="string" defaultValue="1" display="0"
		length="1">
		<dic>
	...
	<item id="noVisitReason" alias="原因" type="string" length="100" display="0"
		fixed="true" />
	...
	<item id="loseWeight" alias="是否减轻体重"   type="string" display="0"
	...
	<item id="visitDoctor" alias="随访医生" type="string" length="20" display="0"
	...
	<item id="inputUnit" alias="录入机构" type="string" length="20" update="false" display="0"
		fixed="true" defaultValue="%user.manageUnit.id" colspan="2">
		<dic id="chis.@manageUnit" includeParentMinLen="6" render="Tree" onlySelectLeaf="true"
			parentKey="%user.manageUnit.id" />
		<set type="exp">['$','%user.manageUnit.id']</set>
	</item>
	<item id="inputUser" alias="录入员" type="string" length="20" update="false" display="0"
		fixed="true" defaultValue="%user.userId"  >
		<dic id="chis.dictionary.user" render="Tree" onlySelectLeaf="true"
			parentKey="%user.manageUnit.id" />
		<set type="exp">['$','%user.userId']</set>
	</item>
	<item id="inputDate" alias="录入日期" type="datetime"  xtype="datefield" fixed="true" update="false"  display="0"
	...
	<relations>
		<relation type="parent" entryName="chis.application.mpi.schemas.MPI_DemographicInfo_ZK" />
		<relation type="children" entryName="chis.application.hr.schemas.EHR_HealthRecord_ZK">
