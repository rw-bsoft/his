...
<entry entityName="chis.application.quality.schemas.QUALITY_ZK_DZ"  
	   tableName="chis.application.quality.schemas.QUALITY_ZK_ZQ" >
	...
	<item id="SFWC" alias="是否完成" type="string" length="40"   >
	    </item>
