...
<entry entityName="chis.application.quality.schemas.QUALITY_ZK"   alias="项目标识字典" sort="XMBS asc">
	...
	<item id="XMMC" alias="项目名称" type="string" length="40"  not-null="1"  >
	 ...
	 <item id="XMBS" alias="项目标识" type="string" length="40"  not-null="1"   queryable="true"/>
