...
<entry  alias="质控数据随访" entityName="chis.application.quality.schemas.QUALITY_ZK_TNB"  >
  ...
  <item id="inputUser" alias="录入者" type="string" length="20" update="false" defaultValue="%user.userId" fixed="true" > 
    <dic id="chis.dictionary.user01" render="Tree" onlySelectLeaf="true"  parentKey="%user.manageUnit.id"/>  
    <set type="exp">['$','%user.userId']</set> 
  </item>  
  <item id="inputDate" alias="录入日期" type="datetime" xtype="datefield" update="false" defaultValue="%server.date.today" fixed="true" > 
  ...
  <item id="manaUnitId" alias="管辖机构" type="string" length="20" display="0" > 
  ...
  <item ref="d.manaDoctorId" display="0" />  
