...
<entry entityName="chis.application.hr.schemas.EHR_HealthRecord" alias="个人健康档案" sort="zlls,a.phrId desc" version="1332744636000" filename="E:\MyProject\BSCHISWorkspace\BSCHIS\WebRoot\WEB-INF\config\schema\ehr/EHR_HealthRecord.xml">
	...
	<item id="signFlag" alias="签约标志" type="string" length="1" defaultValue="n" canInput="true" queryable="true" validateOnBlur="false">
		<dic id="chis.dictionary.yesOrNo"/>
	</item>
	...
	<item id="cancellationDate" alias="注销日期" type="date" display="1" queryable="true"/>
	...
	<item id="cancellationReason" alias="注销原因" type="string" length="1" display="1" queryable="true">
		<dic>
			<item key="1" text="死亡"/>
			<item key="2" text="迁出"/>
			<item key="3" text="失访"/>
