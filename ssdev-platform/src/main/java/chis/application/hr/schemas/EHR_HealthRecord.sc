...
<entry entityName="chis.application.hr.schemas.EHR_HealthRecord" alias="个人健康档案" sort="zlls,a.phrId desc" version="1332744636000" filename="E:\MyProject\BSCHISWorkspace\BSCHIS\WebRoot\WEB-INF\config\schema\ehr/EHR_HealthRecord.xml">
    ...
    <item ref="b.definePhrid" alias="档案备注说明" display="1" queryable="true"/>
	<item ref="b.personName" display="1" queryable="true"/>
	<item ref="b.sexCode" display="1" queryable="true"/>
	<item ref="b.birthday" display="1" queryable="true"/>
	<item ref="b.cardtype" hidden="true"  queryable="true"/>
	<item ref="b.idCard" display="1" queryable="true"/>
	<item id="checkType" type="string" display="1"  virtual = "true"  alias="是否年检"/>
	<item ref="b.signFlag" display="1"  queryable="true" renderer="showColor"/>
	<item ref="b.sceEndDate" display="1" queryable="true"/>
	...
	<item id="manaDoctorId" alias="责任医生" type="string" length="20" width="160" not-null="true" queryable="true" >
	...
	<item id="isPovertyAlleviation" alias="是否扶贫对象" type="string" length="1"  queryable="true">
		<dic id="chis.dictionary.yesOrNo"/>
	</item>
	...
	<item id="createUnit" alias="建档单位" type="string" not-null="true" length="20"  anchor="100%" width="150"  fixed="true" queryable="true">
		<dic id="chis.@manageUnit" showWholeText="true" includeParentMinLen="6" render="Tree"/>
	</item>
	<item id="createUser" alias="建档人" type="string" width="160" length="20" not-null="true" queryable="true" >
	...
	<item id="createDate" alias="建档日期" type="datetime"  xtype="datefield"  not-null="true" defaultValue="%server.date.today" queryable="true">
	...
	<!--<item id="isRemarked" alias="是否标记" type="string"  length="1" update="false" defaultValue="0" queryable="true">
		<dic>
			<item key="0" text="未标记"/>
			<item key="1" text="已标记"/>
		</dic>
	</item>
	<item id="remarkDate" alias="标记日期" type="datetime" display="1" width="130" update="false" queryable="true" defaultValue="%server.date.today">
		<set type="exp">['$','%server.date.datetime']</set>
	</item>
	<item id="remarkPerson" alias="标记人" type="string" length="20" update="false" display="0" defaultValue="%user.userId">
