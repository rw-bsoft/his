...
<entry alias="健康卡发放">
	<item id="cardType" alias="发卡类型" type="string" defaultValue="1"
		colspan="3">
		<dic render="Radio">
			<item key="1" text="健康管理卡"></item>
			<item key="2" text="居住人口卡"></item>
		</dic>
	</item>
	<item id="cardNum" alias="健康卡号" not-null="1"></item>
	...
	<item id="grade" alias="年纪" type="string" length="20" />
