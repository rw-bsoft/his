...
<entry entityName="chis.application.hy.schemas.MDC_HypertensionRecordWorkList" tableName="chis.application.hy.schemas.MDC_HypertensionRecord" alias="高血压档案" sort="a.createDate desc">
	...
	<item id="familyHistroy" alias="家族史" type="string" fixed="true" length="64" display="2"/>
	...
	<item ref="d.manaUnitId" display="0"/> 
	<item ref="d.workType" display="0"/> 
	<relations>
		<relation type="parent" entryName="chis.application.mpi.schemas.MPI_DemographicInfo"/>
		<relation type="children" entryName="chis.application.hr.schemas.EHR_HealthRecord">
			<join parent = "phrId" child = "phrId" />
		</relation>
		<relation type="children" entryName="chis.application.pub.schemas.PUB_WorkList">
