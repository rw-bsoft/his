...
<entry entityName="chis.application.hy.schemas.MDC_HypertensionFixGroup" alias="高血压定转组信息" sort="fixId" version="1331800522000" filename="E:\MyProject\BZWorkspace\BSCHIS\WebRoot\WEB-INF\config\schema\mdc/MDC_HypertensionFixGroup.xml">
	...
	<item id="fixDate" alias="定转组日期" width="80" type="date" fixed="true" defaultValue="%server.date.date">
		<set type="exp">['$','%server.date.date']</set>
	</item>
	<item id="constriction" alias="收缩压(mmHg)" minValue="50" maxValue="500" type="int" not-null="1" enableKeyEvents="true" group="心血管危险因素"/>
	<item id="diastolic" alias="舒张压(mmHg)" minValue="50" maxValue="500" type="int" not-null="1"  enableKeyEvents="true" group="心血管危险因素"/>
	<item id="hypertensionLevel" alias="血压级别" type="string" fixed="true" colspan="2">
		<dic>
	...
	<item id="riskiness" alias="危险因素" type="string" length="64" defaultValue="0" width="180" fixed="true" colspan="3" group="心血管危险因素">
		<dic id="chis.dictionary.hyperRiskiness" render="LovCombo"/>
	</item>
	<item id="targetHurt" alias="靶器官损害" type="string" length="64" width="180" defaultValue="0" fixed="true" colspan="3" group="靶器官损害">
		<dic id="chis.dictionary.targetHurt" render="LovCombo"/>
	</item>
	<item id="complication" alias="并存的临床情况" type="string"  width="180" colspan="3" group="伴临床疾患">
	...
	<item id="fixType" alias="定转(组)情况" type="string" length="1" width="100" fixed="true">
		<dic>
	...
	<item id="fixUser" alias="定转组医生" type="string" length="20" fixed="true" update="false" defaultValue="%user.userId">
	...
	<item id="IGT" alias="糖耐量受损" type="double" length="8" precision="2" maxValue="11" display="2" enableKeyEvents="true" group="心血管危险因素"/>
	<item id="fbs" alias="空腹血糖值(mmol/L)" type="double" length="6" precision="2" display="2" enableKeyEvents="true" group="心血管危险因素"/>
	<item id="TC" alias="TC(mmol/L)" type="double" length="6" not-null="1" display="2" enableKeyEvents="true" group="心血管危险因素"/>
	<item id="LDL" alias="LDL-C(mmol/L)" type="double" length="8" display="2" enableKeyEvents="true" group="心血管危险因素"/>
	<item id="HDL" alias="HDL-C(mmol/L)" type="double" length="8" display="2" enableKeyEvents="true" group="心血管危险因素"/>
	<item id="familyHistoryOfCardiovascular" alias="心血管家族史" type="string" length="1" not-null="1" display="2" group="心血管危险因素">
		<dic id="chis.dictionary.haveOrNot"/>
	</item>
	<item id="waistLine" alias="腰围(cm)" type="double"  not-null="1" minValue="40" maxValue="200" display="2" enableKeyEvents="true" group="心血管危险因素"/>
	<item id="height" alias="身高(cm)" type="double" not-null="1"   minValue="100" maxValue="300" display="2" enableKeyEvents="true" group="心血管危险因素"/>
	<item id="weight" alias="体重(kg)" type="double"  not-null="1" minValue="30" maxValue="500" display="2" enableKeyEvents="true" group="心血管危险因素"/>
	<item id="bmi" alias="BMI" type="double" length="6" fixed="true" display="2" group="心血管危险因素" />
	
	
	<item id="SokolowLyons" alias="SokolowLyons(mv)" type="int" group="靶器官损害" display="2" />
	<item id="Cornell" alias="Cornell（mm·mms）" type="int" group="靶器官损害" display="2" />
	<item id="LVMI" alias="LVMI（g/m 2）" type="int" group="靶器官损害" display="2" />
	...
	<item id="sphygmus" alias="颈-股动脉搏波速度(m/s)" type="int" display="2" group="靶器官损害" />
