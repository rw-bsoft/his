...
<entry  alias="高血压随访" sort="a.empiId">
	...
	<item id="salt" alias="摄盐情况" type="int" tag="radioGroup" >
	...
	<item id="psychologyChange" alias="心理调整" type="string" length="1" tag="radioGroup">
		<dic>
			<item key="1" text="良好" />
			<item key="2" text="一般" />
			<item key="3" text="差" />
	...
	<item id="obeyDoctor" alias="遵医行为" type="string" length="1" tag="radioGroup">
		<dic>
			<item key="1" text="良好" />
			<item key="2" text="一般" />
			<item key="3" text="差" />
	...
	<item id="oneDosage1" alias="每次" type="string" tag="text" display="2" virtual="true"/>
	...
	<item id="oneDosage2" alias="每次" type="string" tag="text" display="2" virtual="true"/>
	...
	<item id="oneDosage3" alias="每次" type="string" tag="text" display="2" virtual="true"/>
	...
	<item id="oneDosage4" alias="每次" type="string" tag="text" display="2" virtual="true"/>
	...
	<!-- 新增 -->
	<item id="referralReason" alias="转诊原因" type="string" colspan="2"  tag="text">
	...
	<item id="notes" alias="备注" type="string" length="50" tag="text"/>
