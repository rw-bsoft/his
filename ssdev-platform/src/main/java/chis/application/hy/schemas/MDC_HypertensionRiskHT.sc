...
<entry entityName="chis.application.hy.schemas.MDC_HypertensionRiskHT" alias="糖尿病疑似健康教育">
	...
	<item id="riskAssessmentId" alias="高危评估id" type="string" length="30" hidden="true"/>
	<item id="healthTeach" alias="健康教育描述" type="string" length="2000" xtype="textarea" colspan="3"/>
