...
<entry id="chis.application.tb.schemas.TB_TuberculosisVisit" alias="肺结核患者随访">
	<item id="visitId" alias="随访ID" type="string" length="16" not-null="1" generator="assigned" pkey="true">
		<key>
	...
	<item id="treatmentMonthOrder" alias="治疗月序" type="string" not-null="1" length="10"/>
	...
	<item id="missMedicineNum" alias="漏服药次数" type="string" length="10"/>
	<item id="medicineBadReaction" alias="药物不良反应" type="string" length="1">
		<dic>
			<item key="1" text="无" />
			<item key="2" text="有" />
		</dic>
	</item>
	<item id="medicineBadReactionDesc" alias="药物不良反应详情" type="string" length="100"/>
	<item id="complicationComorbidity" alias="并发症或合并症" type="string" length="1">
		<dic>
			<item key="1" text="无" />
			<item key="2" text="有" />
		</dic>
	</item>
	<item id="complicationComorbidityDesc" alias="并发症或合并症详情" type="string" length="100"/>
	<item id="referralDivision" alias="转诊科别" type="string" length="50"/>
	<item id="referralReason" alias="转诊原因" type="string" length="100"/>
	<item id="twoWeekVisitResult" alias="2周内随访的结果" type="string" length="100"/>
	<item id="processAdvice" alias="处理意见" type="string" length="100"/>
	<item id="nextDate" alias="下次随访时间" type="date" not-null="1"/>
	<item id="visitDoctor" alias="随访医生签名" type="string" length="20" not-null="1">
		<dic id="chis.dictionary.user01" render="Tree" onlySelectLeaf="true"
			 keyNotUniquely="true" parentKey="%user.manageUnit.id"/>
	</item>
	<item id="stopTreatmentTime" alias="停止治疗时间" type="date"/>
	<item id="stopTreatmentReason" alias="停止治疗原因" type="string" length="20">
		<dic>
	...
	<item id="shouldVisitNum" alias="应访视次数" type="string" length="10"/>
	<item id="actualVisitNum" alias="实际访视次数" type="string" length="10"/>
	<item id="shouldMedicineNum" alias="应服药次数" type="string" length="10"/>
	<item id="actualMedicineNum" alias="实际服药次数" type="string" length="10"/>
	<item id="assessDoctor" alias="评估医生" type="string" length="20">
		<dic id="chis.dictionary.user01" render="Tree" onlySelectLeaf="true" 
			 keyNotUniquely="true" parentKey="%user.manageUnit.id"/>
	</item>
