...
<entry entityName="chis.application.hc.schemas.hc_m_progestationcheck"  alias="丈夫孕前检查信息" sort="a.recordId">
    ...
    <item alias="身高" id="SG" type="int" maxValue="250"/>
    <item alias="体重" id="TZ" type="int" maxValue="200"/>
    <item alias="体重指数" id="TZZS" type="double" fixed="true"/>
    <item alias="心率" id="XL" type="int" maxValue="150"/>
    <item alias="收缩压" id="SSY" type="int" maxValue="300"/>
    <item alias="舒张压" id="SZY" type="int" maxValue="200"/>
    ...
    <item alias="杂音" id="ZY" length="1" type="string">
        <dic>
			<item key="0" text="无" />
			<item key="1" text="有" />
		</dic>
    ...
    <item alias="其他问题" id="QTWT" length="50" type="string" colspan="2"/>
    <item alias="转诊建议" id="ZZJY" length="100" type="string" colspan="3"/>
    ...
    <item alias="喉结" id="HJ" length="1" type="string">
        <dic>
			<item key="0" text="有" />
			<item key="1" text="无" />
		</dic>
	</item>
    <item alias="喉结异常情况" id="HJYCQK" length="30" type="string"/>
    <item alias="阴茎" id="YJ" length="1" type="string">
        <dic>
			<item key="0" text="未见异常" />
			<item key="1" text="异常" />
		</dic>
	</item>
    <item alias="阴茎异常情况" id="YJYCQK" length="30" type="string"/>
    <item alias="包皮" id="BP" length="1" type="string">
        <dic>
			<item key="0" text="正常" />
			<item key="1" text="过长" />
			<item key="2" text="包茎" />
    ...
    <item alias="睾丸" id="GW" length="1" type="string">
        <dic>
			<item key="0" text="扪及" />
    ...
    <item alias="睾丸体积" id="GWTJ" type="double"/>
    <item alias="附睾" id="FG" length="1" type="string">
        <dic>
			<item key="0" text="正常" />
			<item key="1" text="异常" />
		</dic>
	</item>
    <item alias="附睾异常情况" id="FGYCQK" length="30" type="string"/>
    <item alias="输精管" id="SJG" length="1" type="string">
        <dic>
			<item key="0" text="未见异常" />
			<item key="1" text="异常" />
		</dic>
	</item>
    <item alias="输精管异常情况" id="SJGYCQK" length="30" type="string"/>
    <item alias="精索静脉曲张" id="JSJMQZ" length="1" type="string">
        <dic>
			<item key="0" text="无" />
			<item key="1" text="有" />
		</dic>
	</item>
    <item alias="精索静脉曲张部位" id="JSJMQZBW" length="30" type="string">
        <dic>
			<item key="1" text="左侧" />
			<item key="2" text="右侧" />
			<item key="3" text="双侧" />
    ...
    <item alias="精索静脉曲张程度" id="JSJMQZCD" length="30" type="string">
        <dic>
		    <item key="1" text="轻微" />
			<item key="2" text="中度" />
			<item key="3" text="严重" />
	...
	<item id="NKJCZZJY" alias="男科检查转诊建议"  length="200" colspan="3" type="string" />
    <item id="NKJCRQ" alias="男科检查日期" type="date" />
    <item id="NKJCYS" alias="男科检查医师"  length="100" type="string" />
    ...
    <item alias="尿液" id="NY" length="1" type="string">
        <dic>
			<item key="0" text="未见异常" />
			<item key="1" text="异常" />
		</dic>
	</item>
    <item alias="尿液异常情况" id="NQKCQK" length="30" type="string"/>
    ...
    <item id="JYJCRQ" alias="检验检查日期" type="date" />
