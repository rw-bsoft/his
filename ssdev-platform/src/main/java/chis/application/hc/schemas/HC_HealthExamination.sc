...
<entry entityName="chis.application.hc.schemas.HC_HealthExamination" alias="基本情况">
	<item id="healthCheck" alias="检查单号" length="16" width="130"
		type="string" pkey="true" generator="assigned" not-null="1" display="1">
		<key>
	...
	<item ref="b.idCard" display="0" queryable="true"/>
	...
	<item id="breathe" alias="呼吸(次/分)" type="int" display="2" />
	<item id="pulse" alias="脉率(次/分)" type="int" display="2" />
	...
	<item queryable="true" id="everyPhysicalExerciseTime" alias="锻炼时间(分/次)" type="int" fixed="true"/>
	<item queryable="true" id="insistexercisetime" alias="坚持锻炼(年)" type="int" fixed="true"/>
	...
	<item queryable="true" id="beginSmokeTime" alias="开始吸烟(岁)" type="int" fixed="true"/>
	<item queryable="true" id="stopSmokeTime" alias="戒烟年龄(岁)" type="int" fixed="true"/>
	<item queryable="true" id="smokes" alias="日吸烟量(支)" type="int" fixed="true"/>
	...
	<item queryable="true" id="alcoholConsumption" alias="日饮酒量(两)" type="int" fixed="true"/>
	...
	<item queryable="true" id="stopDrinkingTime" alias="戒酒年龄(岁)" type="int" fixed="true"/>
	<item queryable="true" id="geginToDrinkTime" alias="开始饮酒(岁)" type="int" fixed="true"/>
	...
	<item id="leftUp" alias="左上" type="int"/>
	<item id="leftDown" alias="左下" type="int"/>
	<item id="rightUp" alias="右上" type="int"/>
	<item id="rightDown" alias="右下" type="int"/>
	...
	<item id="leftEye" alias="左眼视力"  type="double" length="10"  precision="1" maxValue="5.3"/>
	<item id="rightEye" alias="右眼视力"  type="double" length="10"  precision="1"  maxValue="5.3"/>
	<item id="recLeftEye" alias="矫正左眼视力"  type="double" length="10"  />
	<item id="recRightEye" alias="矫正右眼视力"  type="double" length="10"  />
	...
	<item id="motion" alias="运动功能"  type="string" length="100"  >
		<dic>
	...
	<item queryable="true" id="footPulse" alias="足背动脉搏动" length="1" type="string" colspan="2">
		<dic>
			<item key="1" text="未触及"/>
	...
	<!-- ===============检体==e===================== -->
	<!-- ===============辅助检查=2=s========= -->
	<item id="hgb" alias="血红蛋白(g/L)"  type="double" length="10"  />
	<item id="wbc" alias="白细胞(10^9/L)"  type="double" length="10"  />
	<item id="platelet" alias="血小板(10^9/L)"  type="double" length="10"  />
	...
	<item id="fbs" alias="空腹血糖(mmol/L)"  type="double" length="10"  />
	<item id="fbs2" alias="空腹血糖2(mmol/L)"  type="double" length="10"  />
	...
	<item id="malb" alias="尿微量白蛋白"  type="double" length="10"  />
	...
	<item id="hba1c" alias="糖化血红蛋白(%)"  type="int" length="3"  />
	...
	<item id="alt" alias="血清谷丙转氨酶(U/L)"  type="double" length="10"  />
	<item id="ast" alias="血清谷草转氨酶(U/L)"  type="double" length="10"  />
	<item id="alb" alias="白蛋白(g/L)"  type="double" length="10"  />
	<item id="tbil" alias="总胆红素(μmol/L)"  type="double" length="10"  />
	<item id="dbil" alias="结合胆红素(μmol/L)"  type="double" length="10"  />
	
	<item id="cr" alias="血清肌酐(μmol/L)"  type="double" length="10"  />
	<item id="bun" alias="血尿素氮(mmol/L)"  type="double" length="10"  />
	<item id="kalemia" alias="血钾浓度(mmol/L)"  type="double" length="10"  />
	<item id="natremia" alias="血钠浓度(mmol/L)"  type="double" length="10"  />
	
	<item id="tc" alias="总胆固醇(mmol/L)"  type="double" length="10"  />
	<item id="tg" alias="甘油三酯(mmol/L)"  type="double" length="10"  />
	<item id="ldl" alias="血清LDL-C(mmol/L)"  type="double" length="10"  />
	<item id="hdl" alias="血清HDL-C(mmol/L)"  type="double" length="10"  />
	...
	<item id="psText" alias="异常描述"  type="string" length="200"  colspan="2" fixed="true"/>
	...
	<item id="otherDiseasesoneDesc" alias="其他疾病描述"
		length="100" type="string" fixed="true" display="2" />
	<!-- ===============健康评价==s========= -->
	<item id="hePing" alias="平和质" type="string" length="1" >
		<dic>
			<item key="1" text="是"/>
			<item key="2" text="基本是"/>
		</dic>
	</item>
	<item id="qiXu" alias="气虚质" type="string" length="1" >
		<dic>
			<item key="1" text="是"/>
			<item key="2" text="基本是"/>
		</dic>
	</item>
	<item id="yangXu" alias="阳虚质" type="string" length="1" >
		<dic>
			<item key="1" text="是"/>
			<item key="2" text="基本是"/>
		</dic>
	</item>
	<item id="yinXu" alias="阴虚质" type="string" length="1" >
		<dic>
			<item key="1" text="是"/>
			<item key="2" text="基本是"/>
		</dic>
	</item>
	<item id="tanShi" alias="痰湿质" type="string" length="1" >
		<dic>
			<item key="1" text="是"/>
			<item key="2" text="基本是"/>
		</dic>
	</item>
	<item id="shiRe" alias="湿热质" type="string" length="1" >
		<dic>
			<item key="1" text="是"/>
			<item key="2" text="基本是"/>
		</dic>
	</item>
	<item id="xueYu" alias="血瘀质" type="string" length="1" >
		<dic>
			<item key="1" text="是"/>
			<item key="2" text="基本是"/>
		</dic>
	</item>
	<item id="qiYu" alias="气郁质" type="string" length="1" >
		<dic>
			<item key="1" text="是"/>
			<item key="2" text="基本是"/>
		</dic>
	</item>
	<item id="teBing" alias="特禀质" type="string" length="1" >
		<dic>
			<item key="1" text="是"/>
			<item key="2" text="基本是"/>
		</dic>
	</item>
	<item id="healthAssessment" alias="健康评价" length="1"  type="string" colspan="2">
		<dic>
			<item key = "1" text="体检无异常" />
			<item key = "2" text="有异常" />
		</dic>
	</item>
	<item id="healthAssessmentExce1" alias="异常1" length="500"  type="string" colspan="2" fixed="true"/>
	<item id="healthAssessmentExce2" alias="异常2" length="500"  type="string" colspan="2" fixed="true"/>
	<item id="healthAssessmentExce3" alias="异常3" length="500"  type="string" colspan="2" fixed="true"/>
	<item id="healthAssessmentExce4" alias="异常4" length="500"  type="string" colspan="2" fixed="true"/>
	<item id="healthGuidance" alias="健康指导" length="1"  type="string" colspan="2">
		<dic render="LovCombo">
	...
	<item id="riskFactorsForControl" alias="危险因素控制" length="100"  type="string" colspan="2">
		<dic render="LovCombo">
			<item key = "1" text="戒烟" />
	...
	<item id="inoculateVaccine" alias="建议接种疫苗" length="100"  type="string" colspan="2" fixed="true"/>
	<item id="RFFCOther" alias="其他控制" length="100"  type="string" colspan="4" fixed="true"/>
	<!-- ===============健康评价==s========= -->
