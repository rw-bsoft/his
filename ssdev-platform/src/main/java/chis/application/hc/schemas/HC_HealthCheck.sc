...
<entry entityName="chis.application.hc.schemas.HC_HealthCheck" alias="基本情况" sort="a.checkDate desc,a.healthCheck desc">
	...
	<item ref="d.fbs" display="1" queryable="true"/>
	<item ref="d.fbs2" display="1" queryable="true"/>
	<item ref="d.fbs3" display="1" queryable="true"/>
	<item ref="d.alt" display="1" queryable="true"/>
	<item ref="d.ast" display="1" queryable="true"/>
	<item ref="d.alb" display="1" queryable="true"/>
	<item ref="d.tbil" display="1" queryable="true"/>
	<item ref="d.dbil" display="1" queryable="true"/>
	<item ref="d.hgb" display="1" queryable="true"/>
	<item ref="d.xjc" display="1" queryable="true"/>
	<item ref="d.wbc" display="1" queryable="true"/>
	<item ref="d.platelet" display="1" queryable="true"/>
	...
	<item id="year" alias="年度" length="32" type="string" display="0" queryable="true" update="false">
	<dic id="chis.dictionary.year"/>
	</item>
	<item id="tjlx" alias="体检类型" length="32" type="string" display="0" queryable="true" update="false">
	<dic id="chis.dictionary.tjlx"/>
	</item>
	<item id="tjcs" alias="数据来源" length="20"
		type="string" update="false" queryable="true">
		<dic>
			<item key="1" text="区人民医院" />
			<item key="2" text="区中医院" />
		</dic>
	</item>
