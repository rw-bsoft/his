...
<entry entityName="chis.application.mpi.schemas.MPI_Card" alias="卡管理">
	<item id="cardId" alias="编号" type="string"  length="16" pkey="true"
		hidden="true" >
		<key>
	...
	<item id="cardTypeCode" alias="卡类型" type="string" length="2" defaultValue="01" not-null="1">
		<dic id="chis.dictionary.card"/>
	</item>
	<item id="cardNo" alias="卡号" type="string" length="50"  not-null="1" width="160"/>
	...
	<item id="status" alias="状态" type="string" length="1" not-null="1" defaultValue="0" display="1">
		<dic>
