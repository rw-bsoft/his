...
<entry entityName="chis.application.mpi.schemas.MPI_Certificate" alias="EMPI个人基本信息">
	...
	<item id="certificateTypeCode"  alias="证件类型" defaultValue="08" type="string" length="2" not-null="true">
		<dic id="chis.dictionary.certificate"/>
	</item>
	<item id="certificateNo"    alias="证件号码"  type="string" length="32"  not-null="true" width="160"/>
</entry>