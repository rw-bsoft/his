...
<entry entityName="chis.application.mpi.schemas.MPI_Phone" alias="EMPI个人基本信息">
	...
	<item id="phoneTypeCode"  alias="电话类型"  defaultValue="04"   type="string" length="2" not-null="1">
		<dic id="chis.dictionary.phone"/>
	</item>
	<item id="phoneNo"      	alias="电话号码"       type="string" length="20" not-null="1" width="100"/>
</entry>	