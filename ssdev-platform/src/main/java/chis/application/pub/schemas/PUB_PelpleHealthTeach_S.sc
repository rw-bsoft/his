...
<entry entityName="chis.application.pub.schemas.PUB_PelpleHealthTeach" alias="健康处方维护">
  ...
  <relations>
		<relation type="parent" entryName="chis.application.pub.schemas.PUB_PelpleHealthDiagnose" >
