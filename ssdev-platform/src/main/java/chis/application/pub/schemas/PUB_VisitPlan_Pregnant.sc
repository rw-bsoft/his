...
<entry entityName="chis.application.pub.schemas.PUB_VisitPlan" alias="随访计划" tableName="PUB_VisitPlan" sort="beginDate">
  ...
  <item id="extend1" alias="孕周" type="int" length="60" width="40" display="1"/>
