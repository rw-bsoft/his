...
<entry entityName="EMR_ZYZH" alias="中医证侯">
	...
	<item id="ZHFL" alias="证侯分类" type="long" length="9" not-null="1">
        <dic id="chis.dictionary.ZYZHFL"  autoLoad="true">
        </dic>
    </item>
	...
	<item id="PYDM" alias="拼音码" type="string" length="10" target="ZHMC" codeType="py" queryable="true"/>
	...
	<relations>
		<relation type="parent" entryName="chis.application.pub.schemas.EMR_ZHFL" >
			<join parent="ZHFL" child="ZHFL"></join>
		</relation>
  </relations>
</entry>
