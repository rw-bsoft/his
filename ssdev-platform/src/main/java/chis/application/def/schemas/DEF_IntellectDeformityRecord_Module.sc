...
<entry alias="残疾人训练登记" sort="id">
	...
	<item id="homeAddress" alias="家庭住址" type="string" virtual="true" colspan="2" fixed="true" display="0"/>
	<item id="contactPhone" alias="联系电话" length="20" display="0"/>
	<item id="parentName" alias="家长姓名" length="20"  display="0"/>
	<item id="relation" alias="与残疾儿童关系" length="20" display="0">
		<dic>
			<item key="51" text="父亲" />
			<item key="52" text="母亲" />
	...
	<item id="withOtherDeformity" alias="是否伴有其他残疾" length="20" display="0">
		<dic render="LovCombo">
			<item key="1" text="视力" />
			<item key="2" text="智力" />
			<item key="3" text="听力" />
	...
	<item id="deformityDate" alias="确诊时间" type="date" not-null="1" maxValue="%server.date.today" display="0"/>
	<item id="deformityReason" alias="残疾原因" length="100"  not-null="1" display="0">
		<dic render="LovCombo">
			<item key="1" text="先天" />
			<item key="2" text="早产" />
			<item key="3" text="难产" />
	...
	<item id="diagnosticUnit" alias="诊断机构" length="16" display="0"/>
	<item id="iq" alias="智商" type="int" length="4" maxValue="1000" display="0"/>
	<item id="action" alias="社会适应行为" length="100" display="0"/>
	<item id="pastMedicalTreatment" alias="既往医疗情况" length="100" not-null="1" display="0">
		<dic render="LovCombo">
	...
	<item id="manaDoctorId" alias="责任医生" type="string" length="20"
		 not-null="1" update="false" defaultValue="$user.userId" display="0">
	...
	<item id="manaUnitId" alias="管辖机构" type="string" length="20"
		colspan="2" anchor="100%" width="180" not-null="1" fixed="true"    defaultValue="%user.manageUnit.id" display="0">
		<dic id="chis.@manageUnit" includeParentMinLen="6"  render="Tree"
			parentKey="%user.manageUnit.id" rootVisible="false" />
	</item>
	<item id="explanation" alias="需要说明的情况" length="500" xtype="textarea" colspan="3" width="200" display="0"/>
	<item id="createDate" alias="登记时间" type="datetime"  xtype="datefield" update="false"
		fixed="true" defaultValue="%server.date.today" >
		<set type="exp">['$','%server.date.datetime']</set>
	</item>	
	<item id="closeFlag" alias="结案标识" type="string" length="1"
		display="1" defaultValue="n" >
		<dic>
			<item key="n" text="未结案" />
			<item key="y" text="已结案" />
		</dic>
