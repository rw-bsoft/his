...
<entry alias="残疾人训练登记" sort="id">
	...
	<item id="relation" alias="与残疾人关系" length="20" display="0">
		<dic>
			<item key="1" text="丈夫" />
			<item key="2" text="妻子" />
			<item key="3" text="儿子" />
	...
	<item id="deformityType" alias="肢体残疾类别" length="20" not-null="1" display="0">
		<dic render="LovCombo">
			<item key="1" text="偏瘫" />
			<item key="2" text="截瘫" />
			<item key="3" text="脑瘫" />
	...
	<item id="deformityDate" alias="残疾时间" type="date" not-null="1" maxValue="%server.date.today" display="0"/>
	...
	<item id="deformityPosition" alias="残疾部位" length="100" not-null="1" display="0">
		<dic render="LovCombo">
			<item key="141404" text="上肢" />
			<item key="141408" text="下肢" />
		</dic>
	</item>
	<item id="pastMedicalTreatment" alias="既往医疗情况" length="100" colspan="2" not-null="1" display="0">
		<dic render="LovCombo">
			<item key="1" text="手术" />
	...
	<item id="explanation" alias="需要说明的情况" length="500" xtype="textarea" colspan="3" display="0"/>
