...
<entry alias="训练计划">
	...
	<item id="healingTraining" alias="训练项目" length="100" colspan="3" not-null="1" display="2" xtype="textarea">
		
	</item>
	<item id="healingMaterial" alias="训练指导材料" length="100" colspan="3" not-null="1" display="2">
		<dic render="LovCombo">
			<item key="1" text = "《智力残疾儿童系统康复训练》(中国残联编)" />
			<item key="2" text = "《康复指导丛书》(中国残联编)" />
			<item key="3" text = "智残儿童康复训练的音像制品(中国残联编)" />
			<item key="4" text = "省残联认定的训练指导材料(中国残联编)" />
		</dic>
	</item>
	...
	<item id="healingMan" alias="康复指导员" type="string" length="20"
		defaultValue="%user.userId" display="2" not-null="1">
