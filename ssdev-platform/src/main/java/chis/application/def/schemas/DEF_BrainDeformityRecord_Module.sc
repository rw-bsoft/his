...
<entry alias="残疾人训练登记" sort="id">
	...
	<item id="explanation" alias="需要说明的情况" length="500" colspan="3" xtype="textarea" width="200" display="0"/>
	...
	<item id="closeFlag" alias="结案标识" type="string" length="1"
		display="1" defaultValue="y" >
		<dic id="chis.dictionary.closeFlag" />
	</item>
	<item id="createUnit" alias="录入单位" type="string" length="20" display="1"
