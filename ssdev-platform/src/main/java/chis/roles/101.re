...
<role id="chis.101" name="家庭助理" parent="base" type="T101" version="13863152101101">
	<accredit>
		<apps>
			...
			<app id="chis.application.healthmanage.HEALTHMANAGE">
				...
				<catagory id="MOV">
					...
					<module id="R04_1">
						<action id="BatchChangeForm" />
						<action id="BatchChangeDetailList" />
					</module>
					<module id="R04_2">
						<action id="save" />
						<action id="confirm" />
					...
					<module id="R05_1">
						<action id="ManageChangeForm" />
						<action id="ManageChangeDetailList" />
					</module>
					<module id="R05_2">
						<action id="save" />
						<action id="confirm" />
		...
		<storage acType="whitelist">
			<store id="chis.application.pub.schemas.EHR_CommonTaskList"
				acValue="1111">
				<conditions>
			...
			<store id="chis.application.hr.schemas.EHR_PastHistorySearch"
				acValue="1111">
				<conditions>
					<condition type="filter">['eq',['$','b.manaDoctorId'],["$",'%user.userId']]
					</condition>
				</conditions>
				<items>
					<others acValue="1111" />
			...
			<store id="chis.application.cvd.schemas.CVD_AssessRegister"
				acValue="1111">
				<conditions>
					<condition type="filter">['eq',['$','c.manaDoctorId'],["$",'%user.userId']]
					</condition>
				</conditions>
				<items>
					<others acValue="1111" />
			...
			<store id="chis.application.hc.schemas.HC_HealthCheck" acValue="1111">
				<conditions>
					<condition type="filter">['eq',['$','a.createUser'],["$",'%user.userId']]
					</condition>
				</conditions>
				<items>
					<others acValue="1111" />
			...
			<store id="chis.application.ppvr.schemas.EHR_PoorPeopleVisit"
				acValue="1111">
				<conditions>
					<condition type="filter">['eq',['$','a.inputUser'],["$",'%user.userId']]
					</condition>
				</conditions>
				<items>
					<others acValue="1111" />
			...
			<store id="chis.application.cdh.schemas.CDH_DefectRegister"
				acValue="1111">
				<conditions>
					<condition type="filter">['eq',['$','d.manaDoctorId'],["$",'%user.userId']]
					</condition>
				</conditions>
				<items>
					<others acValue="1111" />
			...
			<store id="chis.application.cdh.schemas.CDH_DeadRegister_Module"
				acValue="1111">
				<conditions>
					<condition type="filter">['eq',['$','b.manaDoctorId'],["$",'%user.userId']]
					</condition>
			...
			<store id="chis.application.mov.schemas.MOV_EHRConfirm"
				acValue="1111">
				<conditions>
					<condition type="filter">['or',['eq',['$','a.sourceDoctor'],['$','%user.userId']],
						['eq',['$','a.targetDoctor'],['$','%user.userId']],
						['eq',['$','a.applyUser'],['$','%user.userId']] ]</condition>
				</conditions>
				<items>
					<others acValue="1111" />
				</items>
			...
			<store id="chis.application.mov.schemas.MOV_ManaInfoBatchChange"
				acValue="1111">
				<conditions>
					<condition type="filter">['and',['eq',['$','a.archiveType'],['s','1']],['or',['eq',['$','a.applyUser'],['$','%user.userId']],['eq',['$','a.targetDoctor'],['$','%user.userId']]]]
					</condition>
				</conditions>
				<items>
					<others acValue="1111" />
			...
			<store id="chis.application.mov.schemas.MOV_ManaInfoChange"
				acValue="1111">
				<conditions>
					<condition type="filter">['eq',['$','a.applyUser'],['$','%user.userId']]
					</condition>
				</conditions>
				<items>
					<others acValue="1111" />
			...
			<store id="chis.application.hy.schemas.MDC_HypertensionFirst"
				acValue="1111">
				<conditions>
					<condition type="filter">['and',['eq',['$','b.manaDoctorId'],["$",'%user.userId']],['ne',['$','diagnosisType'],["$",'03']]]
					</condition>
				</conditions>
				<items>
					<item id="manaDoctorId">
			...
			<store id="chis.application.ohr.schemas.MDC_ChineseMedicineManageListView"
				acValue="1111">
				<conditions>
					<condition type="filter">['eq',['$','c.manaDoctorId'],['$','%user.userId']]]
					</condition>
			...
			<store id="chis.application.her.schemas.HER_EducationPlanExe"
				acValue="1111">
				<conditions>
					<condition type="filter">['eq',['$','a.executePerson'],['concat',['$','%user.manageUnit.id'],['s','@'],["$",'%user.userId']]]
					</condition>
				</conditions>
				<items>
					<others acValue="1111" />
			...
			<store id="chis.application.her.schemas.HER_EducationRecord"
				acValue="1111">
				<conditions>
					<condition type="filter">['eq',['$','b.executePerson'],["$",'%user.userId']]
					</condition>
				</conditions>
				<items>
					<others acValue="1111" />
			...
			<store id="chis.application.hy.schemas.MDC_Hypertension_FCBP"
				acValue="1111">
				<conditions>
					<condition type="filter">['eq',['$','a.measureDoctor'],["$",'%user.userId']]
					</condition>
				</conditions>
				<items>
					<others acValue="1111" />
