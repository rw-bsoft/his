...
<role id="chis.100" name="家庭医生" parent="base" pageCount="4" type="T01" version="1560826440411">
  <accredit>
    <apps>
      ...
      <app id="chis.application.jkjy.JKJY">
        <others/>
      </app>
    ...
    <storage acType="whitelist"> 
      ...
      <store id="chis.application.hr.schemas.EHR_HealthRecord" acValue="1111"> 
        <conditions> 
          <condition type="filter">['eq',['$','a.familyDoctorId'],["$",'%user.userId']]</condition> 
        </conditions>  
        <items> 
          <others acValue="1111"/> 
        </items> 
