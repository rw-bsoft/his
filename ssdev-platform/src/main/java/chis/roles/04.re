...
<role id="chis.04" name="中心主任" parent="base" type="T04" version="1386316355461">
	<accredit>
		<apps>
...
-->
		...
		<storage acType="whitelist"> 
			...
			<store id="chis.application.mov.schemas.MOV_EHRConfirm" acValue="1111"> 
				<conditions> 
					<condition type="filter">['or',['like',['$','a.targetUnit'],['concat',['$','%user.manageUnit.id'],['s','%']]], ['like',['$','a.applyUnit'],['concat',['$','%user.manageUnit.id'],['s','%']]] ]</condition> 
				</conditions>  
				<items> 
					<others acValue="1111"/> 
				</items> 
			...
			<store id="chis.application.mov.schemas.MOV_CDH" acValue="1111"> 
				<conditions> 
					<condition type="filter">['or',['like',['$','a.targetManaUnitId'],['concat',['$','%user.manageUnit.id'],['s','%']]], ['like',['$','a.applyUnit'],['concat',['$','%user.manageUnit.id'],['s','%']]] ]</condition> 
				</conditions>  
				<items> 
					<others acValue="1111"/> 
				</items> 
			...
			<store id="chis.application.her.schemas.HER_EducationPlanExe" acValue="1111"> 
				<conditions> 
					<condition type="filter">['like',['$','a.executeUnit'],['concat',['substring',['$','%user.manageUnit.id'], 0,9],['s','%']]]</condition> 
				</conditions>  
				<items> 
					<others acValue="1111"/> 
				</items> 
