...
<role id="chis.14" name="防保科长" parent="base" pageCount="4" type="T14" version="1576140331686">
  <accredit>
    <apps>
      ...
      <app id="chis.application.healthmanage.HEALTHMANAGE">
        ...
        <catagory id="HR">
          ...
          <module id="HC01">
            <action id="HealthCheckList"/>
            <action id="HealthCheckForm"/>
          </module>
          <module id="HC0101">
            <action id="printCheck"/>
          </module>
          ...
          <module id="D20_2">
            <action id="HealthCheckList"/>
            <action id="HealthCheckForm"/>
            <action id="LifestySituation"/>
            <action id="Examination"/>
            <action id="AccessoryExamination"/>
            <action id="InhospitalMedicine"/>
            <action id="NonimmuneInoculation"/>
            <action id="HealthAssessment"/>
            <action id="HealthCheckList"/>
            <action id="HealthCheckForm"/>
            <action id="LifestySituation"/>
            <action id="Examination"/>
        ...
        <catagory id="SCM">
          ...
          <module id="SCM01_0101">
            <action id="new"/>
            <action id="supplementary"/>
          </module>
          <module id="SCM01_0102">
            <action id="SCBag"/>
            <action id="SCInfo"/>
          </module>
          <module id="SCM01_0102_01"/>
          <module id="SCM01_0102_02">
            <action id="save"/>
            <action id="stop"/>
            <action id="printProcotol"/>
          </module>
          <module id="SCM02">
            <action id="SCBag"/>
            <action id="SCInfo"/>
          ...
          <module id="SCM02_01"/>
          <module id="SCM02_02_01">
            <action id="save"/>
          </module>
          <module id="SCM02_02_02">
            <action id="editor"/>
          </module>
          <module id="SCM01_03_01_01"/>
          <module id="SCM01_03_01"/>
          <module id="SCM01_03">
            <action id="psctForm"/>
            <action id="SCModule"/>
          </module>
      ...
      <app id="chis.application.diseasecontrol.DISEASECONTROL">
        ...
        <catagory id="DC">
          ...
          <module id="DC01_2_2_1"/>
          <module id="DC01_2_2_2">
            <action id="update"/>
          </module>
        </catagory>
        <catagory id="GDR">
      ...
      <app id="chis.application.diseasemanage.DISEASEMANAGE">
        ...
        <catagory id="DEF">
          ...
          <module id="DEFEvaluateWorkList01">
            <others/>
          </module>
          <module id="DEFTrainingWorkList01">
            <others/>
          </module>
          <module id="DEF01_1">
            <action id="modify"/>
          ...
          <module id="DEF01_1_1_1"/>
          <module id="DEF01_1_1_2"/>
          <module id="DEF01_1_1_3"/>
          <module id="DEF01_1_1_5"/>
          <module id="DEF01_1_1_6">
            <action id="cancel"/>
          </module>
          <module id="DEF01_1_1_7">
            <action id="cancel"/>
          </module>
          <module id="DEFTrainingWorkList02">
            <others/>
          </module>
          <module id="DEF01_1_1_4"/>
          <module id="DEF01_1_1_8">
            <action id="cancel"/>
          </module>
          <module id="DEF02">
            <others/>
          </module>
          <module id="DEFEvaluateWorkList02">
            <others/>
          </module>
          <module id="DEF02_1">
            <action id="modify"/>
          ...
          <module id="DEF02_1_1_1"/>
          <module id="DEF02_1_1_2"/>
          <module id="DEF02_1_1_3"/>
          <module id="DEF02_1_1_4"/>
          <module id="DEF02_1_1_5"/>
          <module id="DEF02_1_1_6">
            <action id="cancel"/>
          </module>
          <module id="DEF02_1_1_7">
            <action id="cancel"/>
          </module>
          <module id="DEF02_1_1_8">
            <action id="cancel"/>
          </module>
          <module id="DEF03">
            <others/>
          </module>
          <module id="DEFEvaluateWorkList03">
            <others/>
          </module>
          <module id="DEFTrainingWorkList03">
            <others/>
          </module>
          <module id="DEF03_1">
            <action id="modify"/>
          ...
          <module id="DEF03_1_1_1"/>
          <module id="DEF03_1_1_2"/>
          <module id="DEF03_1_1_3"/>
          <module id="DEF03_1_1_4"/>
          <module id="DEF03_1_1_5"/>
          <module id="DEF03_1_1_6">
            <action id="cancel"/>
          </module>
          <module id="DEF03_1_1_7">
            <action id="cancel"/>
          </module>
          <module id="DEF03_1_1_8">
            <action id="cancel"/>
          </module>
        </catagory>
        <catagory id="CVD">
      ...
      <app id="chis.application.gynecology.GYNECOLOGY">
        ...
        <catagory id="MHC">
          ...
          <module id="G20_02">
            <action id="DeliveryRecord2Form"/>
            <action id="DeliveryRecord2ChildForm"/>
          </module>
          <module id="G20_03"/>
          <module id="G20_04">
            <action id="MHC_DeliveryRecordChild"/>
            <action id="MHC_DeliveryRecordChildForm"/>
          </module>
          <module id="G20_05">
            <others/>
          </module>
      ...
      <app id="gp.application.def.DEF">
        <others/>
      </app>
      <app id="gp.application.dia.DIA">
        <others/>
      </app>
      <app id="gp.application.fdBase.FDBase">
        <others/>
      </app>
      <app id="gp.application.hy.HY">
        <others/>
      </app>
      <app id="gp.application.op.OP">
        <others/>
      </app>
      <app id="gp.application.psyc.PSYC">
        <others/>
      </app>
      <app id="gp.application.report.REPORT">
        <others/>
      </app>
      <app id="gp.application.rvcf.RVCF">
        <others/>
      </app>
      <app id="gp.application.spi.SPI">
        <others/>
      </app>
      <app id="gp.application.thr.THR">
        <others/>
      </app>
      ...
      <app id="chis.application.her.HER">
        <others/>
      </app>
      <app id="chis.application.hq.HQ">
        <others/>
      </app>
      ...
      <app id="chis.application.systemmanage.CHISSYSSET">
        <catagory id="CSS">
          <module id="CSS05">
            <others/>
          </module>
    ...
    <storage acType="whitelist"> 
      ...
      <store id="chis.application.hc.schemas.HC_HealthCheck" acValue="1111"> 
        <conditions> 
          <condition type="filter">['like',['$','a.createUnit'],['concat',['substring',['$','%user.manageUnit.id'], 0,9],['s','%']]]</condition> 
        </conditions>  
        <items> 
          <others acValue="1111"/> 
        </items> 
      ...
      <store id="chis.application.ppvr.schemas.EHR_PoorPeopleVisit" acValue="1111"> 
        <conditions> 
          <condition type="filter">['like', ['$','c.manaUnitId'], ['concat',['$','%user.manageUnit.id'],['s','%']] ]</condition> 
        </conditions>  
        <items> 
          <others acValue="1111"/> 
        </items> 
      ...
      <store id="chis.application.her.schemas.HER_EducationPlanSet" acValue="1111"> 
        <conditions> 
          <condition type="filter">['like',['$','a.planUnit'],['concat',['substring',['$','%user.manageUnit.id'], 0,9],['s','%']]]</condition> 
        </conditions>  
        <items> 
          <others acValue="1111"/> 
        </items> 
      ...
      <store id="chis.application.mhc.schemas.MHC_VisitRecord" acValue="1111"> 
        <conditions> 
          <condition type="filter">['like',['$','d.manaUnitId'],['concat',['substring',['$','%user.manageUnit.id'], 0,9],['s','%']]]</condition> 
        </conditions>  
        <items> 
          <others acValue="1111"/> 
        </items> 
      ...
      <store id="chis.application.mhc.schemas.MHC_Postnatal42dayRecord" acValue="1111"> 
        <conditions> 
          <condition type="filter">['like',['$','a.checkManaUnit'],['concat',['substring',['$','%user.manageUnit.id'], 0,9],['s','%']]]</condition> 
        </conditions>  
        <items> 
          <others acValue="1111"/> 
        </items> 
      </store>  
      <store id="chis.application.mhc.schemas.MHC_EndManagement" acValue="1111"> 
        <conditions> 
          <condition type="filter">['like',['$','a.checkManaUnit'],['concat',['substring',['$','%user.manageUnit.id'], 0,9],['s','%']]]</condition> 
        </conditions>  
        <items> 
      ...
      <store id="chis.application.mhc.schemas.MHC_PregnantStopManage" acValue="1111"> 
        <conditions> 
          <condition type="filter">['like',['$','c.manaUnitId'],['concat',['substring',['$','%user.manageUnit.id'],0,9],['s','%']]]</condition> 
        </conditions>  
        <items> 
          <others acValue="1111"/> 
        </items> 
      ...
      <store id="chis.application.mov.schemas.MOV_EHRConfirm" acValue="1111"> 
        <conditions> 
          <condition type="filter">['or',['like',['$','a.targetUnit'],['concat',['$','%user.manageUnit.id'],['s','%']]], ['like',['$','a.sourceUnit'],['concat',['$','%user.manageUnit.id'],['s','%']]], ['like',['$','a.applyUnit'],['concat',['$','%user.manageUnit.id'],['s','%']]] ]</condition> 
        </conditions>  
        <items> 
          <others acValue="1111"/> 
        </items> 
      ...
      <store id="chis.application.mov.schemas.MOV_CDH" acValue="1111"> 
        <conditions> 
          <condition type="filter">['or', ['like',['$','a.applyUnit'],['concat',['$','%user.manageUnit.id'],['s','%']]], ['and', ['eq',['$','a.moveType'],['s','1']], ['like',['$','a.sourceManaUnitId'],['concat',['$','%user.manageUnit.id'],['s','%']]] ], ['and', ['eq',['$','a.moveType'],['s','2']], ['like',['$','a.targetManaUnitId'],['concat',['$','%user.manageUnit.id'],['s','%']]] ] ]</condition> 
        </conditions>  
        <items> 
          <others acValue="1111"/> 
        </items> 
      </store>  
      <store id="chis.application.mov.schemas.MOV_CDHConfirm" acValue="1111"> 
        <items> 
          <item id="targetCdhDoctorId"> 
            <condition type="override"> 
              <o target="dic.parentKey" value="%user.manageUnit.id"/> 
            </condition> 
          </item>  
          <others acValue="1111"/> 
        </items> 
      </store>  
      <store id="chis.application.mov.schemas.MOV_MHC" acValue="1111"> 
        <conditions> 
          <condition type="filter">['or', ['like',['$','a.applyUnit'],['concat',['$','%user.manageUnit.id'],['s','%']]], ['and', ['eq',['$','a.moveType'],['s','1']], ['like',['$','a.sourceManaUnitId'],['concat',['$','%user.manageUnit.id'],['s','%']]] ], ['and', ['eq',['$','a.moveType'],['s','2']], ['like',['$','a.targetManaUnitId'],['concat',['$','%user.manageUnit.id'],['s','%']]] ] ]</condition> 
        </conditions>  
        <items> 
      ...
      <store id="chis.application.mov.schemas.MOV_MHCConfirm" acValue="1111"> 
        <items> 
          <item id="targetMhcDoctorId"> 
            <condition type="override"> 
              <o target="dic.parentKey" value="%user.manageUnit.id"/> 
            </condition> 
          </item>  
      ...
      <store id="chis.application.mov.schemas.MOV_PregnantRecordQuery" acValue="1111"> 
        <conditions> 
          <condition type="filter">['like',['$','a.manaUnitId'],['concat',['$','%user.manageUnit.id'],['s','%']]]</condition> 
        </conditions>  
        <items> 
      ...
      <store id="chis.application.mov.schemas.MOV_ManaInfoBatchChange" acValue="1111"> 
        <conditions> 
          <condition type="filter">['or',['like',['$','a.applyUnit'],['concat',['$','%user.manageUnit.id'],['s','%']]],['like',['$','a.targetUnit'],['concat',['$','%user.manageUnit.id'],['s','%']]]]</condition> 
        </conditions>  
        <items> 
          <others acValue="1111"/> 
        </items> 
      ...
      <store id="chis.application.mov.schemas.MOV_ManaInfoChange" acValue="1111"> 
        <conditions> 
          <condition type="filter">['like',['$','a.applyUnit'],['concat',['$','%user.manageUnit.id'],['s','%']]]</condition> 
        </conditions>  
        <items> 
          <others acValue="1111"/> 
        </items> 
      ...
      <store id="chis.application.hy.schemas.MDC_HypertensionFixGroupList" acValue="1111"> 
        <conditions> 
          <condition type="filter">['like',['$','a.manaUnitId'],['concat',['$','%user.manageUnit.id'],['s','%']]]</condition> 
        </conditions>  
        <items> 
      ...
      <store id="chis.application.sch.schemas.SCH_SchistospmaVisit" acValue="1111"> 
        <conditions> 
          <condition type="filter">['like',['$','manaUnitId'],['concat',['substring',['$','%user.manageUnit.id'], 0,9],['s','%']]]</condition> 
        </conditions>  
        <items> 
          <others acValue="1111"/> 
        </items> 
      ...
      <store id="chis.application.per.schemas.PER_CheckupRegister" acValue="1111"> 
        <conditions> 
          <condition type="filter">['like',['$','a.checkupOrganization'],['concat',['$','%user.manageUnit.id'],['s','%']]]</condition> 
        </conditions>  
        <items> 
          <others acValue="1111"/> 
        </items> 
      </store>  
      <store id="chis.application.phe.schemas.PHE_RelevantInformation" acValue="1111"> 
        <conditions> 
          <condition type="filter">['like',['$','a.reportUnit'],['concat',['$','%user.manageUnit.id'],['s','%']]]</condition> 
        </conditions>  
        <items> 
          <others acValue="1111"/> 
        </items> 
      </store>  
      <store id="chis.application.phe.schemas.PHE_EnvironmentalEvent" acValue="1111"> 
        <conditions> 
          <condition type="filter">['like',['$','a.reportUnit'],['concat',['$','%user.manageUnit.id'],['s','%']]]</condition> 
        </conditions>  
        <items> 
      ...
      <store id="chis.application.hsr.schemas.HSR_AssistantInformation" acValue="1111"> 
        <conditions> 
          <condition type="filter">['like',['$','a.unitName'],['concat',['$','%user.manageUnit.id'],['s','%']]]</condition> 
        </conditions>  
        <items> 
          <others acValue="1111"/> 
        </items> 
      </store>  
      <store id="chis.application.hsr.schemas.HSR_AssistingRegistration" acValue="1111"> 
        <conditions> 
          <condition type="filter">['like',['$','a.unitName'],['concat',['$','%user.manageUnit.id'],['s','%']]]</condition> 
        </conditions>  
        <items> 
      ...
      <store id="chis.application.idr.schemas.IDR_Report" acValue="1111"> 
        <conditions> 
          <condition type="filter">['like',['$','c.manaUnitId'], ['concat', ['substring',['$','%user.manageUnit.id'],0,9], ['s','%'] ] ]</condition> 
        </conditions>  
        <items> 
      ...
      <store id="chis.application.pub.schemas.PUB_DataValidity" acValue="1111"> 
        <conditions> 
          <condition type="filter">['like',['$','a.organization'], ['concat', ['substring',['$','%user.manageUnit.id'],0,9], ['s','%'] ] ]</condition> 
        </conditions>  
        <items> 
          <others acValue="1111"/> 
        </items> 
      </store>  
      <store id="chis.application.mhc.schemas.MHC_DeliveryOnRecord" acValue="1111"> 
        <conditions> 
          <condition type="filter">['like',['$','a.createUnit'],['concat',['substring',['$','%user.manageUnit.id'], 0,9],['s','%']]]</condition> 
        </conditions>  
        <items> 
      ...
      <store id="chis.application.mhc.schemas.DEA_DeathReportCard" acValue="1111"> 
        <conditions> 
      ...
      <store id="chis.application.hy.schemas.MDC_Hypertension_FCBP" acValue="1111"> 
        <conditions> 
          <condition type="filter">['like',['$','a.measureUnit'],['concat',['$','%user.manageUnit.id'],['s','%']]]</condition> 
        </conditions>  
        <items> 
          <others acValue="1111"/> 
        </items> 
