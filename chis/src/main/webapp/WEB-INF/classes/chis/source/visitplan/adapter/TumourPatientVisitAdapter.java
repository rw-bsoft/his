/**
 * @(#)TumourPatientVisitAdapter.java Created on 2014-4-27 下午1:43:16
 * 
...
public class TumourPatientVisitAdapter extends AbstractBusinessAdapter {
	...
	public Map<String, Object> createPlan(CreatationParams params,
		...
		if (params.getStringValue("groupCode") != null) {
			plan.put("groupCode", params.getStringValue("group"));
		}
		...
		if (null != params.getStringValue("group")) {
			plan.put("extend1",
					Integer.parseInt(params.getStringValue("group")));
		}
		return plan;
	}
