 ...
 */
public class HypertensionRiskIdLoader extends AbstractIdLoader {
	...
	public String getIdName() {
		return "MDC_HypertensionRisk.riskId";
	}
	...
	public Map<String, Boolean> getControlData(Map<String, Object> data,
		...
		try {
			...
			List<Map<String, Object>> list2 = (List<Map<String, Object>>) dao.doQuery(CNDHelper.toListCnd(cnd.toString()), null, BSCHISEntryNames.MDC_HypertensionRisk);
			if(list2 != null){
