...
chis.application.dr.script.DRReferralsReportListView = function(cfg) {
	cfg.actions = [ {
				id : "printList",
				name : "打印转诊单",
				iconCls : "print"
	...
	chis.application.dr.script.DRReferralsReportListView.superclass.constructor.apply(this,
			[cfg])
	this.on("winShow", this.onWinShow, this)
}

Ext.extend(chis.application.dr.script.DRReferralsReportListView, chis.script.BizTableFormView, {
	setField : function() {
