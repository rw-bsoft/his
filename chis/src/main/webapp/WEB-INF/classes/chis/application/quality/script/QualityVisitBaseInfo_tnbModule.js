...
chis.application.quality.script.QualityVisitBaseInfo_tnbModule = function(cfg) {
	cfg.autoLoadData = true
	chis.application.quality.script.QualityVisitBaseInfo_tnbModule.superclass.constructor.apply(
			this, [cfg]);
   	this.itemCollapsible = false 
	this.width = 900
	this.height = 500
}
Ext.extend(chis.application.quality.script.QualityVisitBaseInfo_tnbModule,
		chis.script.BizTabModule, {
	initPanel : function() {
		var panel = chis.application.quality.script.QualityVisitBaseInfo_tnbModule.superclass.initPanel
					.call(this)
	//	 this.activeModule(0);
		 this.panel=panel;
		 return panel;
