...
chis.application.conf.script.psy.PsychosisConfigManageModule = function(cfg) {
	cfg.autoLoadData = false;
	chis.application.conf.script.psy.PsychosisConfigManageModule.superclass.constructor.apply(
			this, [cfg])
...
Ext.extend(chis.application.conf.script.psy.PsychosisConfigManageModule,
		chis.script.BizCombinedModule2, {

			initPanel : function() {
				var panel = chis.application.conf.script.psy.PsychosisConfigManageModule.superclass.initPanel
						.call(this)
				this.panel = panel;
