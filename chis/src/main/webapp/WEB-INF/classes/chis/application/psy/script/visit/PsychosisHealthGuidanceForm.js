...
$import("chis.script.BizTableFormView,chis.application.her.script.util.HERQueryModule");

chis.application.psy.script.visit.PsychosisHealthGuidanceForm = function(cfg) {
	cfg.autoFieldWidth = false;
	cfg.labelWidth = 90;
	cfg.fldDefaultWidth = 200;
	chis.application.psy.script.visit.PsychosisHealthGuidanceForm.superclass.constructor
			.apply(this, [cfg]);
	this.JKCFRecords = {};
	this.formId = "_JSBSF";
};
...
Ext.extend(chis.application.psy.script.visit.PsychosisHealthGuidanceForm,
		chis.script.BizTableFormView, {
			...
			onReady : function() {
				...
				chis.application.psy.script.visit.PsychosisHealthGuidanceForm.superclass.onReady
						.call(this);
			},
			...
			initFormData : function(data) {
				chis.application.psy.script.visit.PsychosisHealthGuidanceForm.superclass.initFormData
						.call(this, data);
			...
			doPrintRecipe : function() {
				...
				var url = "resources/chis.prints.template.HealthRecipelManage.print?type="
						+ 1 + "&wayId=" + this.exContext.args.visitId+ "&guideWay=05";
