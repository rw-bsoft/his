...
chis.application.mpm.script.FieldMaintainMPList = function(cfg) {
	this.schema = cfg.entryName;
	chis.application.mpm.script.FieldMaintainMPList.superclass.constructor.apply(this, [cfg]);
	this.removeServiceId = "chis.templateService";
	this.removeAction = "removeFieldRelation";
}
Ext.extend(chis.application.mpm.script.FieldMaintainMPList, chis.script.BizSimpleListView, {
			doAddInfo : function() {
