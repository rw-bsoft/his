...
chis.application.def.script.intellect.IntellectDeformityRecordForm = function(cfg) {
	this.entryName = 'chis.application.def.schemas.DEF_IntellectDeformityRecord'
	chis.application.def.script.intellect.IntellectDeformityRecordForm.superclass.constructor.apply(this,
			[cfg])
	this.nowDate = this.mainApp.serverDate
//	this.loadServiceId = "chis.defIntellectService"
//	this.loadAction = "loadIntellectDeformityRecordData"
	this.saveServiceId = "chis.defIntellectService"
	this.saveAction = "saveIntellectDeformityRecord"
}
Ext.extend(chis.application.def.script.intellect.IntellectDeformityRecordForm, chis.script.BizTableFormView,
		{
			loadData : function() {
				if (!this.exContext.r) {
					return
			...
			doInitialize : function() {
				...
				var rst = util.rmi.miniJsonRequestSync({
							...
							serviceAction : "initializeIntellectDeformityRecordData"
						});
				if (rst.code > 300) {
			...
			onReady : function() {
				chis.application.def.script.intellect.IntellectDeformityRecordForm.superclass.onReady
						.call(this)
			...
			doClose : function() {
				...
				var cfg = this.loadModuleCfg("chis.application.def.DEF/DEF/DEF03_1_1_8")
				cfg.title = "智力残疾结案"
			...
			saveToServer : function(saveData) {
				...
				chis.application.def.script.intellect.IntellectDeformityRecordForm.superclass.saveToServer
						.call(this, saveData)
			}
		});