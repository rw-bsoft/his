...
chis.application.dbs.script.record.DiabetesRecordEndForm = function(cfg) {
	chis.application.dbs.script.record.DiabetesRecordEndForm.superclass.constructor
			.apply(this, [cfg]);
	this.on("winShow", this.onWinShow, this);
};

Ext.extend(chis.application.dbs.script.record.DiabetesRecordEndForm,
		chis.script.BizTableFormView, {
			onReady : function() {
				chis.application.dbs.script.record.DiabetesRecordEndForm.superclass.onReady
						.call(this);
