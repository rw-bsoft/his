...
chis.application.mpm.script.FieldMaintainAddList = function(cfg) {
	cfg.pageSize = 0;
	chis.application.mpm.script.FieldMaintainAddList.superclass.constructor
			.apply(this, [cfg]);
	this.enableCnd = false;
	this.disablePagingTbr = false;
};
Ext.extend(chis.application.mpm.script.FieldMaintainAddList,
