...
chis.application.conf.script.thr.TumourHighRiskConfigModule = function(cfg) {
	cfg.autoLoadData = false;
	chis.application.conf.script.thr.TumourHighRiskConfigModule.superclass.constructor
			.apply(this, [cfg]);
...
Ext.extend(chis.application.conf.script.thr.TumourHighRiskConfigModule,
		chis.script.BizCombinedModule2, {
			initPanel : function() {
				var panel = chis.application.conf.script.thr.TumourHighRiskConfigModule.superclass.initPanel
						.call(this)
				this.panel = panel;
