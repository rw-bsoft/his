...
chis.application.cdh.script.record.ChildrenHealthRecordWriteOffForm = function(cfg) {
	cfg.fldDefaultWidth = 145
	cfg.autoFieldWidth = false;
	cfg.autoLoadData = false;
	chis.application.cdh.script.record.ChildrenHealthRecordWriteOffForm.superclass.constructor
			.apply(this, [cfg])
	this.on("winShow", this.onWinShow, this)
}
Ext.extend(chis.application.cdh.script.record.ChildrenHealthRecordWriteOffForm,
		chis.script.BizTableFormView, {

			onReady : function() {
				chis.application.cdh.script.record.ChildrenHealthRecordWriteOffForm.superclass.onReady
						.call(this);
			...
			saveToServer : function(saveData) {
				var values = this.exContext["chis.application.cdh.schemas.CDH_HealthCard"].data;
							...
							if (cancellationReason == "1"
								...
								Ext.Msg.show({
									...
									fn : function(btn, text) {
										if (btn == "ok") {
											var req = {};
											req.serviceId = "chis.childrenHealthRecordService";
											req.serviceAction = "logOutChildrenRecord";
											req.body = values;
											this.logOut(req);
										}
									},
