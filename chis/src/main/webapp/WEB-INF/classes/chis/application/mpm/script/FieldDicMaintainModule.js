...
chis.application.mpm.script.FieldDicMaintainModule = function(cfg) {
	chis.application.mpm.script.FieldDicMaintainModule.superclass.constructor
			.apply(this, [cfg]);
...
Ext.extend(chis.application.mpm.script.FieldDicMaintainModule, chis.script.BizCombinedModule2, {
			initPanel : function() {
				var panel = chis.application.mpm.script.FieldDicMaintainModule.superclass.initPanel
						.call(this);
				this.panel = panel;
