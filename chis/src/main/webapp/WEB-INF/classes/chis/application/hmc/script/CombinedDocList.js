...
chis.application.hmc.script.CombinedDocList = function(cfg) {
	this.westWidth = 180
	this.height = 500
	...
	this.cnds = cfg.cnds;
	chis.application.hmc.script.CombinedDocList.superclass.constructor.apply(this, [cfg])
}

Ext.extend(chis.application.hmc.script.CombinedDocList, app.desktop.Module, {
			initPanel : function() {
...
//									rootVisible : false
			...
			createListTab : function() {
				...
				if (this.mainApp.jobId=="chis.22") {
					this.entryName = "chis.application.hr.schemas.EHR_HealthRecord2";
				} else {
					this.entryName = "chis.application.hr.schemas.EHR_HealthRecord";
				}
