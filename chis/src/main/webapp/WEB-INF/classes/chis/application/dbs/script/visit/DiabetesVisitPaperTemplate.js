...
//				+ '" name="visitWay" value="9"/>其他'
				...
				+ this.idPostfix
				+ '" value="4"/>拒绝</div><br/>&nbsp;病例种类：'
				+ '<input type="radio" name="diabetesType" id="diabetesType_1'
				+ this.idPostfix
				+ '" value="1"/>1型糖尿病'
				+ '<input type="radio" name="diabetesType" id="diabetesType_2'
				+ this.idPostfix
				+ '" value="2"/>2型糖尿病'
				+ '<input type="radio" name="diabetesType" id="diabetesType_3'
				+ this.idPostfix
				+ '" value="3"/>营养不良型'
				+ '<input type="radio" name="diabetesType" id="diabetesType_5'
				+ this.idPostfix
				+ '" value="5"/>IGT'
				+ '<input type="radio" name="diabetesType" id="diabetesType_6'
				+ this.idPostfix
				+ '" value="6"/>IFT'
				+ '<input type="radio" name="diabetesType" id="diabetesType_9'
				+ this.idPostfix
				+ '" value="9"/>其他&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;发生转型：'
				+ '<input type="radio" name="diabetesChange" id="diabetesType_y'
				+ this.idPostfix
				+ '" value="y" disabled="true"/>是'
				+ '<input type="radio" name="diabetesChange" id="diabetesType_n'
				+ this.idPostfix
				+ '" value="n" disabled="true" checked="checked"/>否</td></tr>'
				...
				+ this.idPostfix
				+ '" >'
				+ '<input type="checkbox" id="pulsation_1'
				+ this.idPostfix
				+ '" name="pulsation" onclick="onpulsationchange(value)" value="1"/>触及正常'
				+ '<input type="checkbox" id="pulsation_2'
				+ this.idPostfix
				+ '" name="pulsation" onclick="onpulsationchange(value)" value="2"/>双侧减弱'
				+ '<input type="checkbox" id="pulsation_3'
				+ this.idPostfix
				+ '" name="pulsation" onclick="onpulsationchange(value)" value="3"/>左侧减弱'
				+ '<input type="checkbox" id="pulsation_4'
				+ this.idPostfix
				+ '" name="pulsation" onclick="onpulsationchange(value)" value="4"/>右侧减弱'
				+ '<input type="checkbox" id="pulsation_5'
				+ this.idPostfix
				+ '" name="pulsation" onclick="onpulsationchange(value)" value="5"/>双侧消失'
				+ '<input type="checkbox" id="pulsation_6'
				+ this.idPostfix
				+ '" name="pulsation" onclick="onpulsationchange(value)" value="6"/>左侧消失'
				+ '<input type="checkbox" id="pulsation_7'
				+ this.idPostfix
				+ '" name="pulsation" onclick="onpulsationchange(value)" value="7"/>右侧消失'
				+ '</td></tr> '
				...
				+ '</div></td></tr> '
				+ '<tr> <td rowspan="4" align="center"  style="font-weight:bold;"   ><strong style="font-weight:bold;">辅助检查</strong></td>'
				...
				+ '</td> </tr><tr> '
				+ '<td align="center"  style="font-weight:bold;"><span id="CHXT'
				+ this.idPostfix
				+ '">餐后血糖值</span></td>'
				+ '<td colspan="2">'
				...
				+ '</td> </tr> '
				+ '<tr> '
				+ '<td align="center"  style="font-weight:bold;"><span id="SJXT'
				+ this.idPostfix
				+ '">随机血糖值</span></td>'
				+ '<td colspan="2">'
				+ '<input type="text" id="rbs'
				+ this.idPostfix
				+ '" name="rbs" class="input_btline"  value=""/>mmol/L'
				+ '&nbsp;&nbsp;<span>测量方式:</span>'
				+ '<input type="radio" id="rbsTest_1'
				+ this.idPostfix
				+ '" name="rbsTest" value="1"/>末梢血'
				+ '<input type="radio" id="rbsTest_2'
				+ this.idPostfix
				+ '" name="rbsTest" value="2"/>血浆'
				+ '</td> </tr> '
				+ '<tr> <td align="center"  style="font-weight:bold;"   >其他检查*</td> '
				+ '<td colspan="2">' 
					+'<table width="100%"><tr><td width="180" style="border:none;"> 糖化血红蛋白<input type="text" id="hbA1c'
					+ this.idPostfix
					+ '" name="hbA1c" class="input_btline widt80" value="请输入值" onclick="if(value==defaultValue){value=\'\';this.style.color=\'#000\'}" onBlur="if(!value){value=defaultValue;this.style.color=\'#999\';}" /> ％' 
					+ '</td><td style="border:none;"><div id="div_testDate'
					+ this.idPostfix
					+ '"></div></td></tr>'
					+ '<tr><td width="180" colspan="2" style="border:none;">其他<input type="text" id="othercheck'
					+ this.idPostfix
				...
				+ this.idPostfix
				+ '"/>其他</div>'
				+ '<input type="text" class="input_btline width170"  name="medicineOtherNot" id="medicineOtherNot'
				+ this.idPostfix
				...
				+ '&nbsp;&nbsp;&nbsp;&nbsp;'
				+ '<input type="radio" id="complicationChange_1'
				+ this.idPostfix
				+ '" name="complicationChange" value="1"/>有新并发症'
				+ '<input type="radio" id="complicationChange_2'
				+ this.idPostfix
				+ '" name="complicationChange" value="2"/>原有并发症加重'
				+ '<input type="radio" id="complicationChange_3'
				+ this.idPostfix
				+ '" name="complicationChange" value="3"/>无并发症'
				+ '</td>'
				+ '</tr>'
				...
				+ this.idPostfix
				+ '"></div>'
				+ '<input type="hidden" id="recordId_3'
				+ this.idPostfix
				...
				+ '<td colspan="2"  ><div id="div_referralReason'
				+ this.idPostfix 
				+ '"></div></td> '
				+ '</tr> '
				+ '<tr>'
				...
				+ this.idPostfix
				+ '"></div></td></tr> '
				+ '<tr><td colspan="2" align="center"  style="font-weight:bold;">随访医生签名</td>'
				+ '<td colspan="2"><div id="div_visitDoctor'
				+ this.idPostfix + '"></div></td></tr>'
				+ '<tr>'
				+ '<td colspan="2" align="center"  style="font-weight:bold;">是否增加二次随访</td> '
				+ '<td colspan="2" ><input type="radio" id="needdoublevisit_1'
				+ this.idPostfix
				+ '" name="needdoublevisit" value="1"/>是'
				+ '<input type="radio" id="needdoublevisit_2'
				+ this.idPostfix
				+ '" name="needdoublevisit" value="2"/>否'
				+ '</td></tr>'
				+ '<tr>'				
				+ '<tr>'
