...
chis.application.def.script.limb.LimbDeformityRecordLogoutFormView = function(cfg) {
	...
	chis.application.def.script.limb.LimbDeformityRecordLogoutFormView.superclass.constructor.apply(this,
			[cfg])
	this.on("winShow", this.onWinShow, this);
}
Ext.extend(chis.application.def.script.limb.LimbDeformityRecordLogoutFormView,
		chis.script.BizTableFormView, {
			...
			onReady : function() {
				chis.application.def.script.limb.LimbDeformityRecordLogoutFormView.superclass.onReady
						.call(this);
							...
							if (cancellationReason == "1"
								...
								Ext.Msg.show({
									...
									fn : function(btn, text) {
										if (btn == "ok") {
											var req = {};
											req.serviceId = "chis.defLimbService";
											req.serviceAction = "saveLogoutLimbDeformityRecord";
											req.body = values;
											this.logOut(req);
										}
									},
