...
chis.application.hc.script.MProgestationCheckForm = function(cfg) {
	cfg.showButtonOnTop = true;
	cfg.labelAlign = "left";
	cfg.labelWidth = 140;
	cfg.autoFieldWidth = false;
	cfg.fldDefaultWidth = 120;
	cfg.entryNames = "chis.application.hc.schemas.hc_m_progestationcheck";
	chis.application.hc.script.MProgestationCheckForm.superclass.constructor
			.apply(this, [cfg]);
...
Ext.extend(chis.application.hc.script.MProgestationCheckForm,
		chis.script.BizFieldSetFormView, {
			...
			doSave : function() {
				this.data.phrId = this.exContext.ids.phrId;
				this.data.empiId = this.exContext.ids.empiId;
				chis.application.hc.script.MProgestationCheckForm.superclass.doSave
						.call(this);
			},
...
//				
			...
			save : function(saveData) {
				...
				util.rmi.jsonRequest({
							serviceId : this.serviceId,
							serviceAction : 'saveMProgestationCheck',
							method : "execute",
			...
			onReady : function() {
				chis.application.hc.script.MProgestationCheckForm.superclass.onReady
						.call(this);
