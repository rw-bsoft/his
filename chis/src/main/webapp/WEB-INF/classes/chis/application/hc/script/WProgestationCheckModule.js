...
chis.application.hc.script.WProgestationCheckModule= function(cfg) {
	cfg.autoLoadData = false;
	chis.application.hc.script.WProgestationCheckModule.superclass.constructor
			.apply(this, [cfg]);
	this.itemWidth = 210;
};

Ext.extend(chis.application.hc.script.WProgestationCheckModule,
		chis.script.BizCombinedModule2, {
			initPanel : function(){
				var panel = chis.application.hc.script.WProgestationCheckModule.superclass.initPanel.call(this);
				this.panel = panel;
