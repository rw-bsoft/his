// 糖尿病档案管理主页面
$package("chis.application.dbs.script.assess");

$import("chis.script.BizSimpleListView",
		"chis.script.util.widgets.MyMessageTip");

chis.application.dbs.script.assess.DiabetesYearAssessListView = function(cfg) {
	this.needOwnerBar = true;
	chis.application.dbs.script.assess.DiabetesYearAssessListView.superclass.constructor
			.apply(this, [cfg]);
}

Ext.extend(chis.application.dbs.script.assess.DiabetesYearAssessListView,
		chis.script.BizSimpleListView, {
			onReady : function() {
				chis.application.dbs.script.assess.DiabetesYearAssessListView.superclass.onReady
						.call(this);
			...
			doCheck : function() {
				...
				var manageType = lastThreeDay.manageType;
				...
				if (manageType == "1") {
					MyMessageTip.msg("提示", "管理方式请选择分组管理！", true)
					return
				}
				if (month != endMonth) {
				...
				util.rmi.jsonRequest({
							...
							method : "execute",
							serviceAction : "saveDiabetesYearAssess"
