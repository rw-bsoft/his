...
chis.application.her.script.util.HERQueryForm = function(cfg) {
	cfg.actions = [{
				id : "select",
				name : "查询",
	...
	chis.application.her.script.util.HERQueryForm.superclass.constructor.apply(this, [cfg]);
	this.colCount = 2;
	this.on("addfield", this.onAddField, this);
};

Ext.extend(chis.application.her.script.util.HERQueryForm, chis.script.BizTableFormView, {
