...
chis.application.phe.script.PHE_EnvironmentalEventList=function(cfg){
	cfg.colCount = 4;
	cfg.autoFieldWidth = false;
	cfg.fldDefaultWidth = 120;
	cfg.width=850;
	chis.application.phe.script.PHE_EnvironmentalEventList.superclass.constructor.apply(this,[cfg]);
} 
Ext.extend(chis.application.phe.script.PHE_EnvironmentalEventList,chis.script.BizSimpleListView,{
	doCreateRelevant: function() {
	var module = this.createSimpleModule("DCPHE02_01",
			this.dcphe02form);
