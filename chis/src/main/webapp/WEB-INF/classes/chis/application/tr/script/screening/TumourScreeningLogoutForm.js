...
chis.application.tr.script.screening.TumourScreeningLogoutForm = function(cfg) {
	cfg.autoLoadSchema = false
	cfg.entryName = "chis.application.pub.schemas.EHR_WriteOff";
	cfg.saveServiceId = "chis.tumourScreeningService";
	cfg.saveAction = "logoutTumourScreening";
	cfg.actions = [{
				id : "save",
				name : "确定"
			}, {
	...
	chis.application.tr.script.screening.TumourScreeningLogoutForm.superclass.constructor
			.apply(this, [cfg]);
	this.on("winShow", this.onWinShow, this);
	this.on("save", this.onSave, this);
}

Ext.extend(chis.application.tr.script.screening.TumourScreeningLogoutForm,
		chis.script.BizTableFormView, {
			...
			onReady : function() {
				chis.application.tr.script.screening.TumourScreeningLogoutForm.superclass.onReady
						.call(this);
