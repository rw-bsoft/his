...
chis.application.dr.script.DRReferralsDownReferralsAuditList = function(cfg) {
	chis.application.dr.script.DRReferralsDownReferralsAuditList.superclass.constructor.apply(
			this, [cfg]);
}
/*******************************************************************************
 * 下转转入审核列表(大数据接口)页面内嵌HIS zhaojian 2019-08-28
 */
Ext.extend(chis.application.dr.script.DRReferralsDownReferralsAuditList,
		chis.script.BizModule, {
			initPanel : function() {
				...
				var result = util.rmi.miniJsonRequestSync({
					...
					body : {
						pdata : pdata,
						serviceurl : "downReferralsAuditList"//服务地址
					}
				});
