...
chis.application.mpm.script.FieldMaintainList = function(cfg) {
	this.schema = cfg.entryName;
	chis.application.mpm.script.FieldMaintainList.superclass.constructor.apply(
			this, [cfg]);
	this.removeServiceId = "chis.templateService";
	this.removeAction = "removeFieldMaintain";
}
Ext.extend(chis.application.mpm.script.FieldMaintainList,
