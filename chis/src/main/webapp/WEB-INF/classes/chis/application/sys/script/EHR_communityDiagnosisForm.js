...
chis.application.conf.script.admin.EHR_communityDiagnosisForm = function(cfg) {
	cfg.colCount = 3
	...
	cfg.autoScroll = true;
	chis.application.conf.script.admin.EHR_communityDiagnosisForm.superclass.constructor.apply(this,
			[cfg])
}
Ext.extend(chis.application.conf.script.admin.EHR_communityDiagnosisForm,
		chis.script.app.modules.form.TableFormView, {
			loadData : function() {
				...
				chis.application.conf.script.admin.EHR_communityDiagnosisForm.superclass.loadData.call(this)	
		},doNew : function() {
				chis.application.conf.script.admin.EHR_communityDiagnosisForm.superclass.doNew.call(this)
