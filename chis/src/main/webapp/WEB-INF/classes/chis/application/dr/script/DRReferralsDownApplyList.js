...
chis.application.dr.script.DRReferralsDownApplyList = function(cfg) {
	chis.application.dr.script.DRReferralsDownApplyList.superclass.constructor.apply(
			this, [cfg]);
}
/*******************************************************************************
 * 转诊申请列表(大数据接口)页面内嵌HIS zhaojian 2019-08-08
 */
Ext.extend(chis.application.dr.script.DRReferralsDownApplyList,
		chis.script.BizModule, {
			initPanel : function() {
				...
				var result = util.rmi.miniJsonRequestSync({
					...
					body : {
						pdata : pdata,
						serviceurl : "downReferralsManage"//服务地址
					}
				});
