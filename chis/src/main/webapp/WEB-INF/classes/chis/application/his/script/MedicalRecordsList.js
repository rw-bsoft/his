...
chis.application.his.script.MedicalRecordsList = function(cfg) {
	cfg.autoLoadData = false;
	cfg.autoLoadSchema = false;
	cfg.disablePagingTbr = false;
	cfg.listServiceId = "phis.medicalRecordsQueryService";
	cfg.serverParams = {
		serviceAction : "listMedicalRecords"
	};
	this.listAction="listMedicalRecords";
	chis.application.his.script.MedicalRecordsList.superclass.constructor
			.apply(this, [cfg]);

},

Ext.extend(chis.application.his.script.MedicalRecordsList,
