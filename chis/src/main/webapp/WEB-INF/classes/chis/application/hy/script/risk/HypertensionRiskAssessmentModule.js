...
chis.application.hy.script.risk.HypertensionRiskAssessmentModule = function(cfg) {
	cfg.itemWidth = 200
	chis.application.hy.script.risk.HypertensionRiskAssessmentModule.superclass.constructor.apply(this, [cfg])
	this.on("winShow", this.onWinShow, this)
	this.on("afterLoadModule",this.onAfterLoadModule,this)
}

Ext.extend(chis.application.hy.script.risk.HypertensionRiskAssessmentModule, chis.script.BizCombinedModule2, {
