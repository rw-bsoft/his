...
<chart caption="${title}" subcaption="${subTitle}" useRoundEdges='1' use3DLighting="1" numberScaleValue="10000,10000" numberScaleUnit="万,亿" labelDisplay="none"  yAxisName='' showValues='1' legendPosition ="RIGHT">
	<categories>
	<#list rs as r>
		<#if r_index = limit>
			<#break>
