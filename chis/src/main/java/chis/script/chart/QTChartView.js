$package("chis.script.chart")
$import("app.desktop.Module", "util.rmi.miniJsonRequestSync")
chis.script.chart.QTChartView = function(cfg) {
	chis.script.chart.QTChartView.superclass.constructor.apply(this, [cfg])
}

Ext.extend(chis.script.chart.QTChartView, app.desktop.Module, {
			initPanel : function() {
				// if (this.panel) {
				// return this.panel
				// }
				...
				var panel = new Ext.Panel({
							...
							items : [{
										...
										url : 'chis/script/chart/charts.swf',
										yAxis : yaxis,
										extraStyle : { // 横坐标文字旋转
											xAxis : {
												labelRotation : -45
