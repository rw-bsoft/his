...
chis.script.NotifyList = function(cfg) {
	chis.script.NotifyList.superclass.constructor.apply(this, [cfg])
}
Ext.extend(chis.script.NotifyList, app.desktop.Module, {
			...
			loadData : function() {
				...
				util.rmi.jsonRequest(req, function(code, msg, json) {
							...
							if (code == 200) {
								...
								if (msg == "NotLogon") {
									this.fireEvent("NotLogon", this.loadData,
											this);
									// } else {
