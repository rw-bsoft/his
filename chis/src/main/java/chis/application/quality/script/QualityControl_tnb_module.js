...
chis.application.quality.script.QualityControl_tnb_module = function(cfg) {
	cfg.autoLoadData = false;
	chis.application.quality.script.QualityControl_tnb_module.superclass.constructor.apply(
			this, [cfg]);
   	this.itemCollapsible = false
 	this.exContext = {};
 	this.frame = true;
}
Ext.extend(chis.application.quality.script.QualityControl_tnb_module,
