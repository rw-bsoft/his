...
chis.application.quality.script.QualityCkZkBg_module = function(cfg) {
	cfg.autoLoadData = false
	chis.application.quality.script.QualityCkZkBg_module.superclass.constructor.apply(
			this, [cfg]);
...
Ext.extend(chis.application.quality.script.QualityCkZkBg_module,
		chis.script.BizCombinedModule2, {
			initPanel : function() {
				var panel = chis.application.quality.script.QualityCkZkBg_module.superclass.initPanel
						.call(this)
				this.panel = panel;
