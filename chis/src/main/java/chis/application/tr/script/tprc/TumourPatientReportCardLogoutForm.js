...
chis.application.tr.script.tprc.TumourPatientReportCardLogoutForm = function(cfg) {
	...
	chis.application.tr.script.tprc.TumourPatientReportCardLogoutForm.superclass.constructor
			.apply(this, [cfg]);
	this.on("winShow", this.onWinShow, this);
	this.on("save", this.onSave, this);
}

Ext.extend(chis.application.tr.script.tprc.TumourPatientReportCardLogoutForm,
		chis.script.BizTableFormView, {
			...
			onReady : function() {
				chis.application.tr.script.tprc.TumourPatientReportCardLogoutForm.superclass.onReady
						.call(this);
