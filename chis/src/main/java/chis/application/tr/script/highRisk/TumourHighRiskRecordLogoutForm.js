...
chis.application.tr.script.highRisk.TumourHighRiskRecordLogoutForm = function(cfg) {
	cfg.autoLoadSchema = false
	cfg.entryName = "chis.application.pub.schemas.EHR_WriteOff";
	cfg.saveServiceId = "chis.tumourHighRiskService";
	cfg.saveAction = "logoutRecords";
	cfg.actions = [{
				id : "save",
				name : "确定"
			}, {
	...
	chis.application.tr.script.highRisk.TumourHighRiskRecordLogoutForm.superclass.constructor
			.apply(this, [cfg]);
	this.on("winShow", this.onWinShow, this);
	this.on("save", this.onSave, this);
}

Ext.extend(chis.application.tr.script.highRisk.TumourHighRiskRecordLogoutForm,
		chis.script.BizTableFormView, {
			...
			onReady : function() {
				chis.application.tr.script.highRisk.TumourHighRiskRecordLogoutForm.superclass.onReady
						.call(this);
