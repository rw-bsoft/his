...
chis.application.tr.script.highRisk.TumourHighRiskVisitPlanList = function(cfg) {
	chis.application.tr.script.highRisk.TumourHighRiskVisitPlanList.superclass.constructor
			.apply(this, [cfg]);
...
Ext.extend(chis.application.tr.script.highRisk.TumourHighRiskVisitPlanList,
		chis.script.BizSimpleListView, {
			loadData : function() {
				this.selectedPlanId = this.exContext.args.selectedPlanId;
				this.requestData.empiId = this.exContext.ids.empiId;
				this.requestData.recordId = this.exContext.ids["MDC_TumourHighRisk.THRID"];
				...
				chis.application.tr.script.highRisk.TumourHighRiskVisitPlanList.superclass.loadData
						.call(this);
			},
