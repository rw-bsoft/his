...
chis.application.hy.script.risk.HypertensionRiskWriteOffView = function(cfg) {
	if (!cfg) {
		cfg = {};
	}
	cfg.actions = [{
	...
	chis.application.hy.script.risk.HypertensionRiskWriteOffView.superclass.constructor
			.apply(this, [cfg]);
	this.on("winShow", this.onWinShow, this);
};

Ext.extend(chis.application.hy.script.risk.HypertensionRiskWriteOffView,
		chis.script.BizTableFormView, {
			onReady : function() {
				chis.application.hy.script.risk.HypertensionRiskWriteOffView.superclass.onReady
						.call(this);
			...
			doSave : function() {
				...
				values["phrId"] = this.record.data.phrId;
			...
			saveToServer : function(saveData) {
				...
				if (cancellationReason == '1' || cancellationReason == '2') {
					...
					var req = {};
					req.serviceId = "chis.hypertensionRiskService";
					req.serviceAction = "logoutHypertensionRisk";
					req.body = saveData;
					this.logOut(req);
				}
			},
