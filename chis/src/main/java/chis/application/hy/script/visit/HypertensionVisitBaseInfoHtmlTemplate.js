...
//				+ '" />其他' 
				...
				+ ' style="color:#999"/>'
				//+ '/'
				+ '<input type="text" hidden="true" id="targetHeartRate'
				+ this.idPostfix
				...
				+ '><input type="radio" value="1" name="medicineNot'
				+ this.idPostfix
				...
				+ '<td colspan="2" ><input type="radio" name="needdoublevisit'+ this.idPostfix+'" value="1"/>是'
				+ '<input type="radio" name="needdoublevisit'+ this.idPostfix+'" value="2"/>否'
				+ '</td></tr>'
				+ '<tr>'
