...
chis.application.hy.script.visit.HypertensionVisitPlanList = function(cfg) {
	chis.application.hy.script.visit.HypertensionVisitPlanList.superclass.constructor
			.apply(this, [cfg]);
...
Ext.extend(chis.application.hy.script.visit.HypertensionVisitPlanList,
		chis.script.BizSimpleListView, {
			...
			loadData : function() {
				...
				chis.application.hy.script.visit.HypertensionVisitPlanList.superclass.loadData.call(this);
			},
