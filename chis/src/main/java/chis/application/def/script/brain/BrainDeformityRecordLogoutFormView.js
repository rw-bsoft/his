...
chis.application.def.script.brain.BrainDeformityRecordLogoutFormView = function(cfg) {
	...
	chis.application.def.script.brain.BrainDeformityRecordLogoutFormView.superclass.constructor.apply(this,
			[cfg])
	this.on("winShow", this.onWinShow, this);
}
Ext.extend(chis.application.def.script.brain.BrainDeformityRecordLogoutFormView,
		chis.script.BizTableFormView, {
			...
			onReady : function() {
				chis.application.def.script.brain.BrainDeformityRecordLogoutFormView.superclass.onReady
						.call(this);
							...
							if (cancellationReason == "1"
								...
								Ext.Msg.show({
									...
									fn : function(btn, text) {
										if (btn == "ok") {
											var req = {};
											req.serviceId = "chis.defBrainService";
											req.serviceAction = "saveLogoutBrainDeformityRecord";
											req.body = values;
											this.logOut(req);
										}
									},
