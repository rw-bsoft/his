...
chis.application.sch.script.SchistospmaManageFormView = function(cfg) {
	cfg.colCount = 3;
	cfg.showButtonOnTop = true;
	chis.application.sch.script.SchistospmaManageFormView.superclass.constructor.apply(this,
			[cfg]);
	this.saveServiceId = "chis.schistospmaManageService";
	this.saveAction = "saveSchistospmaManage";
	this.on("winShow", this.onWinShow, this);
};

Ext.extend(chis.application.sch.script.SchistospmaManageFormView, chis.script.BizTableFormView, {
initPanel : function(sc) {
			...
			initFormData : function(data) {
				chis.application.sch.script.SchistospmaManageFormView.superclass.initFormData
						.call(this, data);
