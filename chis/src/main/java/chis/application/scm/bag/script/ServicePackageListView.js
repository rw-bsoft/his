...
chis.application.scm.bag.script.ServicePackageListView = function (cfg) {
	cfg.pageSize = 300;
    chis.application.scm.bag.script.ServicePackageListView.superclass.constructor.apply(this, [cfg]);
    this.on("loadData", this.afterLoad, this);
}

Ext.extend(chis.application.scm.bag.script.ServicePackageListView, chis.script.BizSimpleListView, {
    afterLoad: function () {
    ...
    doModify: function () {
        ...
        this.showSPModule("update", r.get("SPID"));
    },
    showSPModule: function (op, SPID) {
