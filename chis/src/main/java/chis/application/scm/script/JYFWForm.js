...
chis.application.scm.script.JYFWForm = function(cfg) {
	cfg.labelAlign = "left";
	...
	cfg.colCount = 2;
	//cfg.width = 710;
	chis.application.scm.script.JYFWForm.superclass.constructor.apply(this, [cfg]);
	Ext.apply(this,chis.application.scm.script.JYFWTemplate);
	this.on("save", this.onSave, this);
	this.on("loadData", this.onLoadData, this);
//	debugger;
}

Ext.extend(chis.application.scm.script.JYFWForm, chis.script.BizHtmlFormView, {
	...
	doNew : function() {
		...
		chis.application.scm.script.JYFWForm.superclass.fieldValidate.call(this);
	},
	...
	onReady : function() {
		chis.application.scm.script.JYFWForm.superclass.onReady.call(this);
		var form = this.form.getForm();
		var name =this.exContext.args.pData.personName;
		var sex =this.exContext.args.pData.sexCode.text;
		var age =this.exContext.args.pData.age;
		var telephone =this.exContext.args.pData.mobileNumber;
		document.getElementById("name"+ this.idPostfix).value=name;
		document.getElementById("sex"+ this.idPostfix).value=sex;
        document.getElementById("age"+ this.idPostfix).value=age;
        document.getElementById("telephone"+ this.idPostfix).value=telephone;
	},
