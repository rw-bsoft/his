...
chis.application.scm.script.JYFWList = function (cfg) {
    chis.application.scm.script.JYFWList.superclass.constructor
        .apply(this, [cfg]);
    this.sex = {"1": "男", "2": "女", "9": "未说明的性别", "0": "未知的性别"}
}

Ext.extend(chis.application.scm.script.JYFWList,
	...
	loadData: function(){
		...
		chis.application.scm.script.JYFWList.superclass.loadData.call(this);	
	},
...
//	},
	...
	onSelectEMPI : function(pData) {	
        ...
        if(typeof this.getSelectedRecord() != "undefined" && empiId == this.getSelectedRecord().data.empiId){
    		...
    		this.midiModules["JYFW_EHRView"] = module;		
    		module.getWin().show();
