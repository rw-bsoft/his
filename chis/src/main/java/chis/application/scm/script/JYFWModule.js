...
debugger;
chis.application.scm.script.JYFWModule = function(cfg) {
	chis.application.scm.script.JYFWModule.superclass.constructor.apply(this, [cfg]);
	this.itemWidth = 260;// 设置左列表宽度
};

Ext.extend(chis.application.scm.script.JYFWModule,
		chis.script.BizCombinedModule2, {
			initPanel : function() {
				debugger;
				var panel = chis.application.scm.script.JYFWModule.superclass.initPanel.call(this);
				this.panel = panel;
				debugger;
