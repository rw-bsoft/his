...
chis.application.scm.tj.script.DXFSModule = function(cfg) {
	this.isModify = false;
	chis.application.scm.tj.script.DXFSModule.superclass.constructor.apply(this, [ cfg ]);
}

Ext.extend(chis.application.scm.tj.script.DXFSModule,chis.script.BizCombinedModule2,
		{
			initPanel : function() {
				// alert("123");
				debugger;
