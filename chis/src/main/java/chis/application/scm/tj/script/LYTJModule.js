...
chis.application.scm.tj.script.LYTJModule = function(cfg) {
	this.isModify = false;
	chis.application.scm.tj.script.LYTJModule.superclass.constructor.apply(this, [ cfg ]);
}

Ext.extend(chis.application.scm.tj.script.LYTJModule,chis.script.BizCombinedModule2,
		{
			initPanel : function() {
				// alert("123");
				debugger;
				...
				url="http://192.168.10.201:8081/webroot/decision/view/report?viewlet=performstatistics.cpt&id=320124001";
