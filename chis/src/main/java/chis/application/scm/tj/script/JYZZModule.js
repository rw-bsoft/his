...
chis.application.scm.tj.script.JYZZModule = function(cfg) {
	this.isModify = false;
	chis.application.scm.tj.script.JYZZModule.superclass.constructor.apply(this, [ cfg ]);
}

Ext.extend(chis.application.scm.tj.script.JYZZModule,chis.script.BizCombinedModule2,
		{
			initPanel : function() {
				// alert("123");
				debugger;
				...
				url="http://192.168.10.201:8080/webroot/decision/view/report?viewlet=homedoc_referraldata.cpt";
