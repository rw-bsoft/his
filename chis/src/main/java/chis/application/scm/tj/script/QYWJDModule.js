...
chis.application.scm.tj.script.QYWJDModule = function(cfg) {
	this.isModify = false;
	chis.application.scm.tj.script.QYWJDModule.superclass.constructor.apply(this, [ cfg ]);
}

Ext.extend(chis.application.scm.tj.script.QYWJDModule,chis.script.BizCombinedModule2,
		{
			initPanel : function() {
				// alert("123");
				debugger;
				...
				url="http://192.168.10.201:8081/webroot/decision/view/report?viewlet=signnodoc.cpt";
