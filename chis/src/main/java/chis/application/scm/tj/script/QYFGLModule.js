...
chis.application.scm.tj.script.QYFGLModule = function(cfg) {
	this.isModify = false;
	chis.application.scm.tj.script.QYFGLModule.superclass.constructor.apply(this, [ cfg ]);
}

Ext.extend(chis.application.scm.tj.script.QYFGLModule,chis.script.BizCombinedModule2,
		{
			initPanel : function() {
				// alert("123");
				debugger;
				...
				url="http://192.168.10.201:8080/webroot/decision/view/report?viewlet=homedoc_signcoverage.cpt";
