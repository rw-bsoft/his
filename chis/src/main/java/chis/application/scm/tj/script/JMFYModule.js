...
chis.application.scm.tj.script.JMFYModule = function(cfg) {
	this.isModify = false;
	chis.application.scm.tj.script.JMFYModule.superclass.constructor.apply(this, [ cfg ]);
}

Ext.extend(chis.application.scm.tj.script.JMFYModule,chis.script.BizCombinedModule2,
		{
			initPanel : function() {
				// alert("123");
				debugger;
