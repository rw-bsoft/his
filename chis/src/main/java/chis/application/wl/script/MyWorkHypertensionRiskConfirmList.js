...
$import("chis.application.hy.script.risk.HypertensionRiskListView");

chis.application.wl.script.MyWorkHypertensionRiskConfirmList = function(cfg) {
	this.initCnd = cfg.cnds
	chis.application.wl.script.MyWorkHypertensionRiskConfirmList.superclass.constructor.apply(this, [cfg]);
}

Ext.extend(chis.application.wl.script.MyWorkHypertensionRiskConfirmList, chis.application.hy.script.risk.HypertensionRiskListView, {
	...
	doConfirm : function(){
		...
		var module = this.createSimpleModule("HypertensionRiskConfirmForm",
