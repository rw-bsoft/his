...
chis.application.fdsr.script.FdsrList = function (cfg) {
    chis.application.fdsr.script.FdsrList.superclass.constructor
        .apply(this, [cfg]);
    this.sex = {"1": "男", "2": "女", "9": "未说明的性别", "0": "未知的性别"}
}

Ext.extend(chis.application.fdsr.script.FdsrList,
	...
	loadData: function(){
		...
		chis.application.fdsr.script.FdsrList.superclass.loadData.call(this);	
	},
...
//	},
	...
	onSelectEMPI : function(pData) {	
        ...
        if(typeof this.getSelectedRecord() != "undefined" && empiId == this.getSelectedRecord().data.empiId){
    		...
    		this.midiModules["FDSR_EHRView"] = module;		
    		module.getWin().show();
