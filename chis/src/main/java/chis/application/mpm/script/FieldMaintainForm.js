...
chis.application.mpm.script.FieldMaintainForm = function(cfg) {
	...
	chis.application.mpm.script.FieldMaintainForm.superclass.constructor.apply(
			this, [cfg]);
}

Ext.extend(chis.application.mpm.script.FieldMaintainForm,
		chis.script.BizTableFormView, {
			...
			onReady : function() {
				chis.application.mpm.script.FieldMaintainForm.superclass.onReady
						.call(this);
				var form = this.form.getForm();
				var type = form.findField("type");
				if (type) {
