...
chis.application.mpm.script.DictionaryMaintainList = function(cfg) {
	this.schema = cfg.entryName;
	chis.application.mpm.script.DictionaryMaintainList.superclass.constructor
			.apply(this, [cfg]);
	this.removeServiceId = "chis.templateService";
	this.removeAction = "removeDicMaintain";
}
Ext.extend(chis.application.mpm.script.DictionaryMaintainList, chis.script.BizSimpleListView, {
