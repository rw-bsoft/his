...
chis.application.mpm.script.DictionaryMaintainForm = function(cfg) {
	...
	chis.application.mpm.script.DictionaryMaintainForm.superclass.constructor
			.apply(this, [cfg]);
	this.on("winShow", this.onWinShow, this)
}

Ext.extend(chis.application.mpm.script.DictionaryMaintainForm, chis.script.BizTableFormView, {
	onWinShow : function() {
		if (this.op == "update") {
