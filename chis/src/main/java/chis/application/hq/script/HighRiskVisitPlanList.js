...
chis.application.hq.script.HighRiskVisitPlanList = function(cfg) {
	chis.application.hq.script.HighRiskVisitPlanList.superclass.constructor
			.apply(this, [cfg]);
...
Ext.extend(chis.application.hq.script.HighRiskVisitPlanList,
		chis.script.BizSimpleListView, {
			...
			loadData : function() {
				...
				chis.application.hq.script.HighRiskVisitPlanList.superclass.loadData.call(this);
			},
