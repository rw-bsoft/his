...
chis.application.hc.script.InhospitalSituationList = function(cfg) {
	cfg.disablePagingTbr = true;
	cfg.enableCnd = false;
	cfg.autoLoadData = false;
	cfg.selectedIndex = 0;
	chis.application.hc.script.InhospitalSituationList.superclass.constructor
			.apply(this, [cfg]);
	this.on("remove", this.selectFirstRow, this);
};

Ext.extend(chis.application.hc.script.InhospitalSituationList,
		chis.script.BizSimpleListView, {
			...
			/**
			 * yub update时，更新grid中一条record的数据
			 * 
			 * @param {}
			 *            r 需要修改的record
			 * @param {}
