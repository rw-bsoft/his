...
chis.application.idr.script.Cdc52 = function(cfg) {
	chis.application.idr.script.Cdc52.superclass.constructor.apply(this,
			[cfg])
			
}
Ext.extend(chis.application.idr.script.Cdc52,app.desktop.Module, {
	initPanel : function(sc) {
		var url="http://10.96.36.154:8410/CDCPro/hospital/loginhospital.action" +
				"?gnbh=H1020318&username=sq_crb&password=1&otheruser=" +
