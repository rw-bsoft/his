...
chis.application.dbs.script.record.DiabetesRecordEndListView = function(cfg) {
	this.initCnd = cfg.cnds || ['eq', ['$', 'a.visitEffect'], ['s', '9']];
	this.needOwnerBar = true;
	chis.application.dbs.script.record.DiabetesRecordEndListView.superclass.constructor
			.apply(this, [cfg]);
};

Ext.extend(chis.application.dbs.script.record.DiabetesRecordEndListView,
		chis.script.BizSimpleListView, {
			...
			doCheck : function() {
				...
				var module = this.createSimpleModule(
						"DiabetesRecordEndForm", this.refEndForm);
