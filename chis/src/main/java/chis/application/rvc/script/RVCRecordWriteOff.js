...
chis.application.rvc.script.RVCRecordWriteOff = function(cfg) {
	...
	chis.application.rvc.script.RVCRecordWriteOff.superclass.constructor.apply(this,
			[cfg]);
	this.on("winShow", this.onWinShow, this);
	this.on("save", this.onSave, this)
}

Ext.extend(chis.application.rvc.script.RVCRecordWriteOff, chis.script.BizTableFormView, {
	onReady : function() {
		chis.application.rvc.script.RVCRecordWriteOff.superclass.onReady
				.call(this);
	...
	getSaveRequest : function(saveData) {
		...
		this.saveServiceId = "chis.retiredVeteranCadresService";
		this.saveAction = "logoutRVCRecord";
