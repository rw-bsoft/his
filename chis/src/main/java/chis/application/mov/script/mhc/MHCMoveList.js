...
chis.application.mov.script.mhc.MHCMoveList = function(cfg) {
	chis.application.mov.script.mhc.MHCMoveList.superclass.constructor.apply(this, [cfg]);
	this.removeServiceId = "chis.mhcMoveService";
	this.removeAction = "removeMHCMoveRecord";
	this.on("loadData", this.onLoadData, this);
	this.on("firstRowSelected", this.rowSelected, this)
};
Ext.extend(chis.application.mov.script.mhc.MHCMoveList, chis.script.BizSimpleListView, {

	doRequest : function() {
		var module = this.createSimpleModule("MHCApply", this.refApplyModule);
		module.initPanel();
	...
	doConfirm : function() {
		...
		var module = this.createSimpleModule("MHCConfirm",
	...
	onRowClick : function(grid, index, e) {
		chis.application.mov.script.mhc.MHCMoveList.superclass.onRowClick.call(this, grid,
				index, e);
		this.rowSelected();
	},
	...
	getPagingToolbar : function(store) {
		var pagingToolbar = chis.application.mov.script.mhc.MHCMoveList.superclass.getPagingToolbar
				.call(this, store);
