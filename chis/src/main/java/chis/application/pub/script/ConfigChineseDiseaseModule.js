...
chis.application.pub.script.ConfigChineseDiseaseModule = function(cfg) {
	...
	chis.application.pub.script.ConfigChineseDiseaseModule.superclass.constructor
			.apply(this, [cfg])
}

Ext.extend(chis.application.pub.script.ConfigChineseDiseaseModule,
		chis.script.BizModule, {
			...
			recordsSelect : function(records) {
				this.fireEvent("select", records,"2", this)
			},
			loadData : function() {
				this.list.loadData();
			},
