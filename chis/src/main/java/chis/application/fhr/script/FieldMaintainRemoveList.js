...
chis.application.fhr.script.FieldMaintainRemoveList = function(cfg) {
	chis.application.fhr.script.FieldMaintainRemoveList.superclass.constructor.apply(this,
			[cfg]);
	this.disablePagingTbr = false;
	this.on("winShow", this.onWinShow, this)
};
Ext.extend(chis.application.fhr.script.FieldMaintainRemoveList, chis.script.BizSelectListView, {
