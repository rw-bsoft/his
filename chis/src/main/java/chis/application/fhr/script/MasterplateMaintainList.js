...
chis.application.fhr.script.MasterplateMaintainList = function(cfg) {
	this.schema = cfg.entryName;
	chis.application.fhr.script.MasterplateMaintainList.superclass.constructor.apply(this, [cfg]);
	this.removeServiceId = "chis.templateService";
	this.removeAction = "removeMasterplateMaintain";
}
Ext.extend(chis.application.fhr.script.MasterplateMaintainList, chis.script.BizSimpleListView, {
