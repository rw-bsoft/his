 ...
 */
public class FdsrService extends AbstractActionService implements
		DAOSupportable {

	private static final Logger logger = LoggerFactory
			.getLogger(FdsrService.class);
	...
	protected void doSaveJYFW(Map<String, Object> jsonReq,
			Map<String, Object> jsonRes, BaseDAO dao, Context ctx)
			throws ServiceException {
		FdsrModel jyfw = new FdsrModel(dao);
		jyfw.saveJYFW(jsonReq, jsonRes, dao, ctx);
	}	
	 ...
	 * @throws JSONException
	 */
	protected void doQueryJYFW(Map<String, Object> jsonReq,
			Map<String, Object> jsonRes, BaseDAO dao, Context ctx)
			throws ServiceException {
		FdsrModel jyfw = new FdsrModel(dao);
		Map<String,Object> res = new HashMap<String,Object>();
		res = jyfw.queryJYFW(jsonReq, jsonRes, dao, ctx);	
