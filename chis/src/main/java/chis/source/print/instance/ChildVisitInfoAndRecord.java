...
public class ChildVisitInfoAndRecord extends BSCHISPrint implements IHandler {
	...
	public void getParameters(Map<String, Object> request,
		...
		sb.append(
				" select babyId as babyId, weightNow as weightNow,feedWay as feedWay, eatNum as eatNum,eatCount as eatCount,vomit as vomit ,stoolStatus as stoolStatus,stoolTimes as stoolTimes,temperature as temperature,"
						...
						+ " bregmaStatus as bregmaStatus,otherStatus1 as otherStatus1 ,eye as eye ,eyeAbnormal as eyeAbnormal ,limbs as limbs ,limbsAbnormal as limbsAbnormal,ear as ear,earAbnormal as earAbnormal ,neck as neck,nose as nose "
				...
				.append(" from " + BSCHISEntryNames.CDH_ChildVisitRecord)
				.append(" where visitId=:visitId ");

		try {
			recordeData = dao.doLoad(sb.toString(), param);
			// recordeData=dao.doLoad(BSCHISEntryNames.CDH_ChildVisitRecord,//
			// param);
			if (recordeData != null && recordeData.size() > 0) {
				...
				Map<String, Object> visitDoctorDatas = SchemaUtil
						.setDictionaryMessageForList(visitDoctorData,
								BSCHISEntryNames.CDH_ChildVisitRecord);
		...
		sb.append(
				...
				.append(" from " + BSCHISEntryNames.CDH_ChildVisitInfo)
		...
		try {
			...
			if (infoData != null && infoData.size() > 0) {
				...
				resultData = SchemaUtil.setDictionaryMessageForList(changeData,
						BSCHISEntryNames.CDH_ChildVisitInfo);
