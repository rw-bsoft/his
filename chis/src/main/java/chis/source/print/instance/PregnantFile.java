...
public class PregnantFile extends PersonalFile {
	...
	private Map<String, Object> getPregnantFirstVisitMap(Map<String, Object> map)
		...
		Dictionary index = DictionaryController.instance().get("chis.dictionary.pregnantIndex");
	...
	public List<Map<String, Object>> getPostnatalVisitDataSource(
			Map<String, Object> map) throws PrintException, ServiceException, ControllerException {
	...
	private void changeDic(Map<String, Object> parameters) throws ControllerException {
		...
		if (parameters.containsKey("umbilical")&&parameters.get("umbilical")!=null) {
			if (parameters.get("umbilical").equals("9")) {
				parameters.put("umbilical", "4");
			}
		}
		if (parameters.containsKey("jaundice")&&parameters.get("jaundice")!=null) {
			if (parameters.get("jaundice").equals("9")
					|| parameters.get("jaundice").equals("5")) {
				parameters.put("jaundice", "");
			}
		}
		if (parameters.containsKey("birthStatus")&&parameters.get("birthStatus")!=null) {
	...
	public List<String> getBabyId(Map<String, Object> map, String pregnantId) {
		String sql = new StringBuffer(
				...
				.toString();
		Session session = AppContextHolder.getBean(AppContextHolder.DEFAULT_SESSION_FACTORY,SessionFactory.class).openSession();
