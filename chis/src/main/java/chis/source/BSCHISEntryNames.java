...
//						 put("BAO","A41");   
	...
	public static final String JYFWJL = "chis.application.scm.schemas.JYFWJL";//家医服务记录（签约管理）
	public static final String FDSR = "chis.application.fdsr.schemas.FDSR";//家医服务记录
}
