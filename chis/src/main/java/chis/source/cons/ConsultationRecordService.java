 ...
 */
public class ConsultationRecordService extends AbstractActionService implements
		DAOSupportable {

	private static final Logger logger = LoggerFactory
			.getLogger(ConsultationRecordService.class);
	...
	public void doQueryPersonInfoByHealthNo(Map<String, Object> req,
		...
		ConsultationRecordModel irm = new ConsultationRecordModel(dao);
		try {
